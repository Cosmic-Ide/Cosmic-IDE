 ...
 */
@AutoValue
@JsonDeserialize(builder = DeleteCachedContentConfig.Builder.class)
public abstract class DeleteCachedContentConfig extends JsonSerializable {
     ...
     */
    public static DeleteCachedContentConfig fromJson(String jsonString) {
        return JsonSerializable.fromJsonString(jsonString, DeleteCachedContentConfig.class);
    }
    ...
    public abstract static class Builder {
        /**
         * For internal usage. Please use `DeleteCachedContentConfig.builder()` for instantiation.
         */
        @JsonCreator
