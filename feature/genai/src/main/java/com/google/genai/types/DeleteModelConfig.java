 ...
 */
@AutoValue
@JsonDeserialize(builder = DeleteModelConfig.Builder.class)
public abstract class DeleteModelConfig extends JsonSerializable {
    ...
    public abstract static class Builder {
        /**
         * For internal usage. Please use `DeleteModelConfig.builder()` for instantiation.
         */
        @JsonCreator
        ...
        public abstract DeleteModelConfig build();
    }
}
