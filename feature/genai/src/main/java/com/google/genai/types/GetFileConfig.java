 ...
 */
@AutoValue
@JsonDeserialize(builder = GetFileConfig.Builder.class)
public abstract class GetFileConfig extends JsonSerializable {
    ...
    public abstract static class Builder {
        /**
         * For internal usage. Please use `GetFileConfig.builder()` for instantiation.
         */
        @JsonCreator
        ...
        public abstract GetFileConfig build();
    }
}
