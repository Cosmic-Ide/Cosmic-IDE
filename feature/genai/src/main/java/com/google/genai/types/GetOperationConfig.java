...
public abstract class GetOperationConfig extends JsonSerializable {
     ...
     */
    public static GetOperationConfig fromJson(String jsonString) {
        return JsonSerializable.fromJsonString(jsonString, GetOperationConfig.class);
    }
    ...
    public abstract static class Builder {
        /**
         * For internal usage. Please use `GetOperationConfig.builder()` for instantiation.
         */
        @JsonCreator
