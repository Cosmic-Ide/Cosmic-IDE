 ...
 */
@AutoValue
@JsonDeserialize(builder = ListCachedContentsParameters.Builder.class)
public abstract class ListCachedContentsParameters extends JsonSerializable {
     ...
     */
    public static ListCachedContentsParameters fromJson(String jsonString) {
        return JsonSerializable.fromJsonString(jsonString, ListCachedContentsParameters.class);
    }
     ...
     */
    @JsonProperty("config")
    public abstract Optional<ListCachedContentsConfig> config();
    ...
    public abstract static class Builder {
        /**
         * For internal usage. Please use `ListCachedContentsParameters.builder()` for instantiation.
         */
        @JsonCreator
