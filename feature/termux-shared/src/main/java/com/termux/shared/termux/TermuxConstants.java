 ...
 *
 * The {@link #TERMUX_PACKAGE_NAME} must be the same as the applicationId of termux-app build.gradle.kts
 ...
 * - The "applicationId" in "build.gradle.kts" of termux-app. This is package name that android and app
 ...
 *      "build.gradle.kts" of termux-app.
 ...
 * "AndroidManifest.xml" and "applicationId" in "build.gradle.kts".
 *
...
public final class TermuxConstants {
    ...
    public static final String TERMUX_GITHUB_ORGANIZATION_NAME = "Cosmic-IDE"; // Default: "termux"
    ...
    /** Termux app name */
    public static final String TERMUX_APP_NAME = "Cosmic IDE"; // Default: "Termux"
    /** Termux package name */
    public static final String TERMUX_PACKAGE_NAME = "org.cosmicide"; // Default: "com.termux"
    /** Termux GitHub repo name */
    public static final String TERMUX_GITHUB_REPO_NAME = "Cosmic-IDE"; // Default: "termux-app"
