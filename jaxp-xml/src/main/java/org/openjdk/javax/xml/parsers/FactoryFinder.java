 ...
 */
class FactoryFinder {
    private static final String DEFAULT_PACKAGE = "org.openjdk.com.sun.org.apache.xerces.internal";
    /** Internal debug flag. */
    ...
    static <T> T newInstance(Class<T> type, String className, ClassLoader cl, boolean doFallback)
            throws org.openjdk.javax.xml.parsers.FactoryConfigurationError {
     ...
     * @param doFallback True if the current ClassLoader should be tried as a fallback if the class
     *     is not found using cl
     * @param useBSClsLoader True if cl=null actually meant bootstrap classLoader. This parameter is
     *     needed since DocumentBuilderFactory/SAXParserFactory defined null as context classLoader.
     */
    static <T> T newInstance(
        ...
        try {
            ...
            throw new org.openjdk.javax.xml.parsers.FactoryConfigurationError(
    ...
    private static <T> T findServiceProvider(final Class<T> type) {
        try {
            ...
            final org.openjdk.javax.xml.parsers.FactoryConfigurationError error =
