...
/**
 * This interface declares the constants used in this API. Numbers in the range 0 to 256 are
 * reserved for the specification, user defined events must use event codes outside that range.
 *
 * @since 1.6
 */
public interface XMLStreamConstants {
     ...
     *
     * @see org.openjdk.javax.xml.stream.events.DTD
     */
