...
public interface StartElement extends XMLEvent {
    ...
    /**
     * Returns an Iterator of non-namespace declared attributes declared on this START_ELEMENT,
     * returns an empty iterator if there are no attributes. The iterator must contain only
     * implementations of the javax.xml.stream.Attribute interface. Attributes are fundamentally
     ...
     *
     * <p>The iterator must contain only implementations of the javax.xml.stream.Namespace
     * interface.
     *
     * <p>A Namespace isA Attribute. One can iterate over a list of namespaces as a list of
     * attributes. However this method returns only the list of namespaces declared on this
     * START_ELEMENT and does not include the attributes declared on this START_ELEMENT.
     *
