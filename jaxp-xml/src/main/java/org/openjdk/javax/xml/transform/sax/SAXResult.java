...
public class SAXResult implements Result {
     ...
     *
     * <p>This is needed to handle XML comments and the like. If the lexical handler is not set, an
     * attempt should be made by the transformer to cast the {@link org.xml.sax.ContentHandler} to a
     * <code>LexicalHandler</code>.
     *
     * @param handler A non-null <code>LexicalHandler</code> for handling lexical parse events.
     */
    ...
    /**
     * Method setSystemId Set the systemID that may be used in association with the {@link
