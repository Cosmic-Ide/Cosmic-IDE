 ...
 * CENTER The <code>style</code> attribute of an HTML element is accessible through the <code>
 * ElementCSSInlineStyle</code> interface which is defined in the .
 *
...
public interface HTMLElement extends Element {
     ...
     * "class" keyword exposed by many languages. See the class attribute definition in HTML 4.0.
     */
