...
public interface HTMLFrameElement extends HTMLElement {
    ...
    /**
     * URI designating a long description of this image or frame. See the longdesc attribute
    ...
    /**
     * The frame name (object of the <code>target</code> attribute). See the name attribute
     * definition in HTML 4.0.
     */
    ...
    /**
     * When true, forbid user from resizing frame. See the noresize attribute definition in HTML
     * 4.0.
     */
    ...
    /**
     * Specify whether or not the frame should have scrollbars. See the scrolling attribute
     * definition in HTML 4.0.
     */
    ...
    /**
     * The document this frame contains, if there is any and it is available, or <code>null</code>
     * otherwise.
     *
     * @since DOM Level 2
     */
