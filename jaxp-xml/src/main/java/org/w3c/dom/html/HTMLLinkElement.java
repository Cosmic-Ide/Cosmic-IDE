...
/**
 * The <code>LINK</code> element specifies a link to an external resource, and defines this
 * document's relationship to that resource (or vice versa). See the LINK element definition in HTML
 * 4.0 (see also the <code>LinkStyle</code> interface in the module).
 *
...
public interface HTMLLinkElement extends HTMLElement {
    ...
    /**
     * Designed for use with one or more target media. See the media attribute definition in HTML
     * 4.0.
     */
