 ...
 * 4.0 specifies that only one of each of the <code>CAPTION</code> , <code>THEAD</code> , and <code>
 * TFOOT</code> elements may exist in a table. Therefore, if one exists, and the createTHead() or
 * createTFoot() method is called, the method returns the existing THead or TFoot element. See the
...
public interface HTMLTableElement extends HTMLElement {
    ...
    /**
     * Returns a collection of all the rows in the table, including all in <code>THEAD</code> ,
     * <code>TFOOT</code> , all <code>TBODY</code> elements.
     */
    ...
    /**
     * Specifies the horizontal and vertical separation between cells. See the cellspacing attribute
    ...
    /**
     * Specifies which external table borders to render. See the frame attribute definition in HTML
     * 4.0.
     */
    ...
    /**
     * Specifies which internal table borders to render. See the rules attribute definition in HTML
     * 4.0.
     */
    ...
    /**
     * Description about the purpose or structure of a table. See the summary attribute definition
     * in HTML 4.0.
     */
     ...
     * same section as the current <code>index</code> th row in the table. If <code>index</code> is
     * equal to the number of rows, the new row is appended. In addition, when the table is empty
     * the row is inserted into a <code>TBODY</code> which is created and inserted into the table.
     ...
     *     relative to all the rows contained inside the table, regardless of section parentage.
     * @return The newly created row.
     * @exception DOMException INDEX_SIZE_ERR: Raised if the specified index is greater than the
     ...
     * @exception DOMException INDEX_SIZE_ERR: Raised if the specified index is greater than or
