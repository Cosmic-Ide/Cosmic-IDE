...
public interface HTMLTableRowElement extends HTMLElement {
    /**
     * The index of this row, relative to the entire table, starting from 0. This is in document
     * tree order and not display order. The <code>rowIndex</code> does not take into account
     * sections ( <code>THEAD</code> , <code>TFOOT</code> , or <code>TBODY</code> ) within the
     * table.
     */
    public int getRowIndex();

    /**
     * The index of this row, relative to the current section ( <code>THEAD</code> , <code>TFOOT
     * </code> , or <code>TBODY</code> ), starting from 0.
     */
    ...
    /**
     * Background color for rows. See the bgcolor attribute definition in HTML 4.0. This attribute
    ...
    /**
     * Vertical alignment of data within cells of this row. See the valign attribute definition in
     * HTML 4.0.
     */
    ...
    /**
     * Insert an empty <code>TD</code> cell into this row. If <code>index</code> is equal to the
     * number of cells, the new cell is appended
     *
     * @param index The place to insert the cell, starting from 0.
     * @return The newly created cell.
     * @exception DOMException INDEX_SIZE_ERR: Raised if the specified <code>index</code> is greater
