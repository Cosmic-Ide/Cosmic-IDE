...
public interface HTMLTableSectionElement extends HTMLElement {
    /**
     * Horizontal alignment of data in cells. See the <code>align</code> attribute for
    ...
    /**
     * Vertical alignment of data in cells. See the <code>valign</code> attribute for
     * HTMLTheadElement for details.
     */
    ...
    /**
     * Insert a row into this section. The new row is inserted immediately before the current <code>
     * index</code> th row in this section. If <code>index</code> is equal to the number of rows in
     * this section, the new row is appended.
     *
     ...
     *
     * @param index The index of the row to be deleted. This index starts from 0 and is relative
