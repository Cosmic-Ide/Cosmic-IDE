...
public interface HTMLTextAreaElement extends HTMLElement {
     ...
     * contents of the corresponding form control, in an interactive user agent, changes. Changing
     ...
     * the contents of the element. If the entirety of the data can not fit into a single <code>
     * DOMString</code> , the implementation may truncate the data.
     */
