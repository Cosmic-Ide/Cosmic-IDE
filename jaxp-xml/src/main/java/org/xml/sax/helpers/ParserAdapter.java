 ...
 * </blockquote>
 *
 * <p>This class wraps a SAX1 {@link org.xml.sax.Parser Parser} and makes it act as a SAX2 {@link
 * org.xml.sax.XMLReader XMLReader}, with feature, property, and Namespace support. Note that it is
 * not possible to report {@link org.xml.sax.ContentHandler#skippedEntity skippedEntity} events,
 * since SAX1 does not make that information available.
 *
 * <p>This adapter does not test for duplicate Namespace-qualified attribute names.
 *
 * @since SAX 2.0
...
public class ParserAdapter implements XMLReader, DocumentHandler {
     ...
     *
     * <p>Use the "org.xml.sax.parser" property to locate the embedded SAX1 driver.
     *
     * @exception SAXException If the embedded driver cannot be instantiated or if the
    ...
    public ParserAdapter() throws SAXException {
        ...
        try {
            ...
            throw new SAXException(
                    "SAX1 driver class " + driver + " found but cannot be loaded", e2);
        } catch (InstantiationException e3) {
            throw new SAXException(
                    "SAX1 driver class " + driver + " loaded but cannot be instantiated", e3);
        } catch (ClassCastException e4) {
            throw new SAXException(
                    "SAX1 driver class " + driver + " does not implement org.xml.sax.Parser");
     ...
     * Construct a new parser adapter.
     *
     * <p>Note that the embedded parser cannot be changed once the adapter is created; to embed a
     * different parser, allocate a new ParserAdapter.
     *
     ...
     *
     * <p>The only features recognized are namespaces and namespace-prefixes.
     *
     * @param name The feature name, as a complete URI.
     * @param value The requested feature value.
     * @exception SAXNotRecognizedException If the feature can't be assigned or retrieved.
     * @exception SAXNotSupportedException If the feature can't be assigned that value.
     ...
     * @exception SAXNotRecognizedException If the feature value can't be assigned or retrieved.
     * @exception SAXNotSupportedException If the feature is not currently readable.
     * @see org.xml.sax.XMLReader#setFeature
     */
     ...
     *
     * <p>No properties are currently recognized.
     *
     * @param name The property name.
     * @param value The property value.
     * @exception SAXNotRecognizedException If the property value can't be assigned or retrieved.
     * @exception SAXNotSupportedException If the property can't be assigned that value.
     ...
     * @exception SAXNotRecognizedException If the property value can't be assigned or retrieved.
     * @exception SAXNotSupportedException If the property value is not currently readable.
     ...
     * @exception java.io.IOException If there is a problem reading the raw content of the document.
     * @exception SAXException If there is a problem processing the document.
     ...
     *
     * <p>If necessary, perform Namespace processing.
     *
                ...
                if (prefix != null) {
                    if (prefixes) {
                        if (uris)
                            ...
                            atts.addAttribute(
                                    nsSupport.XMLNS, prefix, attQName.intern(), type, value);
     ...
     *
     * <p>If the name has an undeclared prefix, use only the qname and make an ErrorHandler.error
     * callback in case the app is interested.
     *
     * @param qName The qualified (prefixed) name.
     * @param isAttribute true if this is an attribute name.
     * @return The name split into three parts.
     * @exception SAXException The client may throw an exception if there is an error callback.
     */
     ...
     * @exception SAXException The client may throw an exception.
     */
     ...
     *
     * <p>Use this method to detect illegal feature or property changes.
     *
     * @param type The type of thing (feature or property).
     * @param name The feature or property name.
     * @exception SAXNotSupportedException If a document is currently being parsed.
     */
     ...
     *
     * <p>This class is in the Public Domain, and comes with NO WARRANTY of any kind.
     *
     * <p>This wrapper class is used only when Namespace support is disabled -- it provides pretty
     * much a direct mapping from SAX1 to SAX2, except that names and types are interned whenever
     * requested.
     */
    final class AttributeListAdapter implements Attributes {
         ...
         *
         * <p>This method must be invoked before any of the others can be used.
         *
