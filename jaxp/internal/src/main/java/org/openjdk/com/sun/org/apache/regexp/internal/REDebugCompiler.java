...
public class REDebugCompiler extends RECompiler {
     ...
     * @param insertAt Index at which to insert the new node in the program * / void nodeInsert(char
     *     opcode, int opdata, int insertAt) { System.out.println( "====> " + opcode + " " + opdata
     *     + " " + insertAt ); PrintWriter writer = new PrintWriter( System.out ); dumpProgram(
     *     writer ); super.nodeInsert( opcode, opdata, insertAt ); System.out.println( "====< " );
     ...
     * @param pointTo Node to have the tail of the chain point to * / void setNextOfEnd(int node,
     *     int pointTo) { System.out.println( "====> " + node + " " + pointTo ); PrintWriter writer
     *     = new PrintWriter( System.out ); dumpProgram( writer ); super.setNextOfEnd( node, pointTo
     *     ); System.out.println( "====< " ); dumpProgram( writer ); writer.flush(); }/*
     */
