...
/**
 * <code>NodeInfo</code> defines a set of XSLT extension functions to be used from stylesheets.
 *
...
public class NodeInfo {
    ...
    public static String systemId(ExpressionContext context) {
        ...
        SourceLocator locator =
                ((DTMNodeProxy) contextNode).getDTM().getSourceLocatorFor(nodeHandler);
    ...
    /**
     * <code>systemId</code> returns the system id of the node passed as argument. If a node set is
     * passed as argument, the system id of the first node in the set is returned.
     *
     ...
     *
     * <p>Xalan does not currently record this value, and will return null.
     *
     * @param context an <code>ExpressionContext</code> value
     * @return a <code>String</code> value
     */
    ...
    /**
     * <code>publicId</code> returns the public identifier of the node passed as argument. If a node
     * set is passed as argument, the public identifier of the first node in the set is returned.
     *
     * <p>Xalan does not currently record this value, and will return null.
     *
     * @param nodeList a <code>NodeList</code> value
     ...
     * must set the custom TrAX attribute "http://xml.apache.org/xalan/features/source_location"
     * true in the TransformerFactory before generating the Transformer and executing the
     * stylesheet. Storage cost per node will be noticably increased in this mode.
     *
     * @param context an <code>ExpressionContext</code> value
     * @return an <code>int</code> value. This may be -1 to indicate that the line number is not
     *     known.
     */
    ...
    /**
     * <code>lineNumber</code> returns the line number of the node passed as argument. If a node set
     * is passed as argument, the line number of the first node in the set is returned.
     *
     * <p>NOTE: Xalan does not normally record location information for each node. To obtain it, you
     * must set the custom TrAX attribute "http://xml.apache.org/xalan/features/source_location"
     * true in the TransformerFactory before generating the Transformer and executing the
    ...
    /**
     * <code>columnNumber</code> returns the column number of the node passed as argument. If a node
     * set is passed as argument, the line number of the first node in the set is returned.
     *
     * <p>NOTE: Xalan does not normally record location information for each node. To obtain it, you
     * must set the custom TrAX attribute "http://xml.apache.org/xalan/features/source_location"
     * true in the TransformerFactory before generating the Transformer and executing the
