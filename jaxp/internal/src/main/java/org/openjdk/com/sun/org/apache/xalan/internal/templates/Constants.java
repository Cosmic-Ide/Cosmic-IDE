 ...
 */
package org.openjdk.com.sun.org.apache.xalan.internal.templates;
 ...
 * @xsl.usage advanced
 */
public class Constants extends org.openjdk.com.sun.org.apache.xml.internal.utils.Constants {

    /**
     * IDs for XSL element types. These are associated with the string literals in the
     * TransformerImpl class. Don't change the numbers. NOTE THAT THESE ARE NOT IN ALPHABETICAL
     * ORDER! (It's a pity Java doesn't have a real Enumerated Mnemonic datatype... or a C-like
     * preprocessor in lieu thereof which could be used to generate and maintain synch between these
     * lists.)
     */
    ...
    /**
     * Literals for XSL element names. Note that there are more names than IDs, because some names
     * map to the same ID.
     */
    ...
    public static final int EXSLT_ELEMNAME_FUNCTION = 88, EXSLT_ELEMNAME_FUNCRESULT = 89;

    /**
     * Literals for XSL attribute names. Note that there may be more names than IDs, because some
     * names may map to the same ID.
     */
    ...
    /**
     * IDs for XSL attribute types. These are associated with the string literals in the
     * TransformerImpl class. Don't change the numbers. NOTE THAT THESE ARE NOT IN ALPHABETICAL
     * ORDER!
     */
     ...
     *
     * <ul>
     *   <li>ATTRVAL_OUTPUT_METHOD_XML = Use an XML formatter to produce the output document (basic
     *       XSLT operation).
     *   <li>ATTRVAL_OUTPUT_METHOD_HTML: Use an HTML formatter to produce the output document. When
     *       generating HTML documents, this may yield better results; it does things like escaping
     *       characters in href attributes. ATTRVAL_OUTPUT_METHOD_TEXT: Use a Text formatter to
     *       produce the output document. Generally the right choice if your stylesheet wants to
     *       take over _all_ the details of formatting, most often when producing something that
     *       isn't an XML or HTML document.
     * </ul>
     */
