...
/*
import org.openjdk.com.sun.org.apache.xalan.internal.trace.PrintTraceListener;
...
public class Process {
    ...
    protected static void printArgOptions(ResourceBundle resbundle) {
        ...
        System.out.println(
                resbundle.getString("optionXSLTC")); // "    [-XSLTC (use XSLTC for transformation)]
        ...
        // System.out.println(resbundle.getString("optionE")); //"   [-E (Do not expand entity
        // refs)]");
        System.out.println(resbundle.getString("optionV")); // "   [-V (Version info)]");

        // System.out.println(resbundle.getString("optionVALIDATE")); //"   [-VALIDATE (Set whether
        ...
        System.out.println(
                resbundle.getString("optionTEXT")); // "   [-TEXT (Use simple Text formatter.)]");
        System.out.println(
                resbundle.getString("optionHTML")); // "   [-HTML (Use HTML formatter.)]");
        System.out.println(
                resbundle.getString(
    ...
    /**
     * Command line interface to transform an XML document according to the instructions found in an
     * XSL stylesheet.
     *
     * <p>The Process class provides basic functionality for performing transformations from the
     * command line. To see a list of arguments supported, call with zero arguments.
     *
     * <p>To set stylesheet parameters from the command line, use <code>-PARAM name expression
     * </code>. If you want to set the parameter to a string value, simply pass the string value
     * as-is, and it will be interpreted as a string. (Note: if the value has spaces in it, you may
     * need to quote it depending on your shell environment).
     *
    ...
    public static void _main(String argv[]) {
        ...
        ResourceBundle resbundle =
                (SecuritySupport.getResourceBundle(XResourceBundle.ERROR_RESOURCES));
        String flavor = "s2s";
            ...
            */
            ...
            for (int i = 0; i < argv.length; i++) {
                ...
                */
                    ...
                    if (i + 1 < argv.length) {
                        try {
                            entityResolver =
                                    (EntityResolver) ObjectFactory.newInstance(argv[++i], true);
                        } catch (ConfigurationError cnfe) {
                            msg =
                                    XSLMessages.createMessage(
                                            XSLTErrorResources.ER_CLASS_NOT_FOUND_FOR_OPTION,
                    ...
                    if (i + 1 < argv.length) {
                        try {
                            contentHandler =
                                    (ContentHandler) ObjectFactory.newInstance(argv[++i], true);
                        } catch (ConfigurationError cnfe) {
                            msg =
                                    XSLMessages.createMessage(
                                            XSLTErrorResources.ER_CLASS_NOT_FOUND_FOR_OPTION,
            ...
            try {
                ...
                */
                ...
                if (null == stylesheet) {
                    Source source =
                            stf.getAssociatedStylesheet(
                                    new StreamSource(inFileName), media, null, null);
                ...
                if (null != stylesheet) {
                    Transformer transformer =
                            flavor.equals("th") ? null : stylesheet.newTransformer();
                    ...
                    if (null != inFileName) {
                        if (flavor.equals("d2d")) {
                            ...
                            transformer.transform(
                                    new DOMSource(xmlDoc, inFileName), new DOMResult(outNode));
                            ...
                            for (int i = 0;
                                    i < 1;
                                    i++) // Loop for diagnosing bugs with inconsistent behavior
                            {
                                ...
                                try {
                                    org.openjdk.javax.xml.parsers.SAXParserFactory factory =
                                            org.openjdk.javax.xml.parsers.SAXParserFactory
                                                    .newInstance();
                                    ...
                                    reader = jaxpParser.getXMLReader();
                                        ...
                                        org.openjdk.javax.xml.parsers.ParserConfigurationException
                                                ex) {
                                    throw new org.xml.sax.SAXException(ex);
                                } catch (
                                        org.openjdk.javax.xml.parsers.FactoryConfigurationError
                                                ex1) {
                ...
                if (doDiag) {
                    Object[] msgArgs =
                            new Object[] {inFileName, xslFileName, new Long(millisecondsDuration)};
    ...
    /**
     * It is _much_ easier to debug under VJ++ if I can set a single breakpoint before this blows
     * itself out of the water... (I keep checking this in, it keeps vanishing. Grr!)
     */
    ...
    private static void printInvalidXSLTCOption(String option) {
        System.err.println(
                XSLMessages.createMessage("xslProc_invalid_xsltc_option", new Object[] {option}));
    }
    ...
    private static void printInvalidXalanOption(String option) {
        System.err.println(
                XSLMessages.createMessage("xslProc_invalid_xalan_option", new Object[] {option}));
    }
}
