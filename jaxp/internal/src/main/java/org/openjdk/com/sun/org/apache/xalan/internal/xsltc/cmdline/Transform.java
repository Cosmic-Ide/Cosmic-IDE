...
import org.openjdk.com.sun.org.apache.xalan.internal.xsltc.runtime.Parameter;
...
public final class Transform {
    ...
    public Transform(
            String className, String fileName, boolean uri, boolean debug, int iterations) {
        _fileName = fileName;
    ...
    private void doTransform() {
        try {
            ...
            if (_iterations == -1) {
                ...
                System.err.println(
                        "  throughput = "
                                + (1000.0 / (((double) mm) / ((double) _iterations)))
                                + " tps");
                System.err.println("-->");
            }
