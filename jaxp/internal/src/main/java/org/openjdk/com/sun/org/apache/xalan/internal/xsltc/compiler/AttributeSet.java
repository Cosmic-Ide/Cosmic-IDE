...
import org.openjdk.com.sun.org.apache.xalan.internal.xsltc.compiler.util.AttributeSetMethodGenerator;
...
final class AttributeSet extends TopLevelElement {
    ...
    /**
     * Returns the method name of this attribute set. This method name is generated by the compiler
     * (XSLTC)
     */
    ...
    /**
     * Call this method to prevent a method for being compiled for this set. This is used in case
     * several <xsl:attribute-set...> elements constitute a single set (with one name). The last
     * element will merge itself with any previous set(s) with the same name and disable the other
     * set(s).
     */
    public void ignore() {
        _ignore = true;
    ...
    /**
     * Parse the contents of this attribute set. Recognised attributes are "name" (required) and
