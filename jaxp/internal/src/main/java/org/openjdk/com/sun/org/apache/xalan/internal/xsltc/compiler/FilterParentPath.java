...
final class FilterParentPath extends Expression {
     ...
     * it is of reference type. This type coercion is needed for expressions like $x/LINE where $x
    ...
    public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        if (_hasDescendantAxis) {
            final int incl =
                    cpg.addMethodref(NODE_ITERATOR_BASE, "includeSelf", "()" + NODE_ITERATOR_SIG);
