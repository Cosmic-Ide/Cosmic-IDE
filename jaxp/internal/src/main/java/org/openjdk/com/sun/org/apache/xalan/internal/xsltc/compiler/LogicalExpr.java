...
final class LogicalExpr extends Expression {
    ...
    /**
     * Creates a new logical expression - either OR or AND. Note that the left- and right-hand side
     * expressions can also be logical expressions, thus creating logical trees representing
     * structures such as (a and (b or c) and d), etc...
     */
    ...
    /**
     * Override the SyntaxTreeNode.setParser() method to make sure that the parser is set for
     * sub-expressions
     */
