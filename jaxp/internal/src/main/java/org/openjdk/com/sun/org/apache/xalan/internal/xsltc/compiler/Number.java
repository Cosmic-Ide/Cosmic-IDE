...
import org.openjdk.com.sun.org.apache.bcel.internal.generic.IFNONNULL;
...
import org.openjdk.com.sun.org.apache.xalan.internal.xsltc.compiler.util.MatchGenerator;
import org.openjdk.com.sun.org.apache.xalan.internal.xsltc.compiler.util.MethodGenerator;
import org.openjdk.com.sun.org.apache.xalan.internal.xsltc.compiler.util.NodeCounterGenerator;
import org.openjdk.com.sun.org.apache.xalan.internal.xsltc.compiler.util.RealType;
...
final class Number extends Instruction implements Closure {
    ...
    private static final String[] ClassNames = {
        "org.openjdk.com.sun.org.apache.xalan.internal.xsltc.dom.SingleNodeCounter", // LEVEL_SINGLE
        "org.openjdk.com.sun.org.apache.xalan.internal.xsltc.dom.MultipleNodeCounter", // LEVEL_MULTIPLE
        "org.openjdk.com.sun.org.apache.xalan.internal.xsltc.dom.AnyNodeCounter" // LEVEL_ANY
    };
    ...
    private void compileDefault(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        if (fieldIndexes[_level] == -1) {
            ...
            fieldIndexes[_level] =
                    cpg.addFieldref(classGen.getClassName(), FieldNames[_level], NODE_COUNTER_SIG);
        }
     ...
     * {Any,Single,Multiple}NodeCounter. This constructor simply calls the same constructor in the
     * super class.
     */
    ...
    /**
     * This method compiles code that is common to matchesFrom() and matchesCount() in the auxillary
     * class.
     */
    private void compileLocals(
            NodeCounterGenerator nodeCounterGen, MatchGenerator matchGen, InstructionList il) {
        int field;
        ...
        local =
                matchGen.addLocalVariable(
                        "iterator", Util.getJCRefType(NODE_ITERATOR_SIG), null, null);
