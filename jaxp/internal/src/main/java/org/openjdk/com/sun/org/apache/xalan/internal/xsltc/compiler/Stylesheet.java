...
import org.openjdk.com.sun.org.apache.bcel.internal.generic.FieldGen;
import org.openjdk.com.sun.org.apache.bcel.internal.generic.GETFIELD;
import org.openjdk.com.sun.org.apache.bcel.internal.generic.GETSTATIC;
...
import org.openjdk.com.sun.org.apache.bcel.internal.generic.PUTSTATIC;
...
public final class Stylesheet extends SyntaxTreeNode {
    ...
    /**
     * Used to cache result of <code>getAllValidTemplates()</code>. Only set in top-level
     * stylesheets that include/import other stylesheets.
     */
    ...
    /**
     * A reference to the SourceLoader set by the user (a URIResolver if the JAXP API is being
     * used).
     */
    ...
    /**
     * Flag indicating if this is a simplified stylesheets. A template matching on "/" must be added
     * in this case.
     */
    ...
    /**
     * Get the minimum of the precedence of this stylesheet, any stylesheet imported by this
     * stylesheet and any include/import descendant of this stylesheet.
     */
    public int getMinimumDescendantPrecedence() {
        if (_minimumDescendantPrecedence == -1) {
            ...
            final int inclImpCount =
                    (_includedStylesheets != null) ? _includedStylesheets.size() : 0;
    ...
    /**
     * Returns true if at least one template in the stylesheet has params defined. Uses the variable
     * <code>_hasLocalParams</code> to cache the result.
     */
    ...
    /**
     * Parse the version and uri fields of the stylesheet and add an entry to the symbol table
     * mapping the name <tt>__stylesheet_</tt> to an instance of this class.
     */
     ...
     * read-only from the translet. All translet instances can share a single copy of this
     * informtion.
     */
    ...
    private void compileConstructor(ClassGenerator classGen, Output output) {
        ...
        il.append(
                new GETSTATIC(
                        cpg.addFieldref(_className, STATIC_NAMES_ARRAY_FIELD, NAMES_INDEX_SIG)));
        il.append(new PUTFIELD(cpg.addFieldref(TRANSLET_CLASS, NAMES_INDEX, NAMES_INDEX_SIG)));

        il.append(classGen.loadTranslet());
        il.append(
                new GETSTATIC(
                        cpg.addFieldref(_className, STATIC_URIS_ARRAY_FIELD, URIS_INDEX_SIG)));
        ...
        il.append(
                new GETSTATIC(
                        cpg.addFieldref(_className, STATIC_TYPES_ARRAY_FIELD, TYPES_INDEX_SIG)));
        ...
        il.append(
                new GETSTATIC(
                        cpg.addFieldref(
                                _className, STATIC_NAMESPACE_ARRAY_FIELD, NAMESPACE_INDEX_SIG)));
        il.append(
                new PUTFIELD(
        ...
        if (_hasIdCall) {
            ...
            il.append(
                    new PUTFIELD(
                            cpg.addFieldref(TRANSLET_CLASS, HASIDCALL_INDEX, HASIDCALL_INDEX_SIG)));
            constructor.markChunkEnd();
        }
     ...
     *
     * <p>Global variables/params and keys are first sorted to resolve dependencies between them.
     * The XSLT 1.0 spec does not allow a key to depend on a variable. However, for compatibility
     * with Xalan interpretive, that type of dependency is allowed. Note also that the buildKeys()
     * method is still generated as it is used by the LoadDocument class, but it no longer called
     * from transform().
     */
    ...
    private void compileTransform(ClassGenerator classGen) {
         ...
         */
        final org.openjdk.com.sun.org.apache.bcel.internal.generic.Type[] argTypes =
                new org.openjdk.com.sun.org.apache.bcel.internal.generic.Type[3];
        ...
        final int index =
                cpg.addMethodref(
                        TRANSLET_CLASS, "transferOutputSettings", "(" + OUTPUT_HANDLER_SIG + ")V");
