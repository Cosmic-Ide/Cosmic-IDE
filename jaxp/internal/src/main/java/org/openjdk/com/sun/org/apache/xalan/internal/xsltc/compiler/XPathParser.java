...
import org.openjdk.com.sun.java_cup.internal.runtime.*;
import org.openjdk.com.sun.java_cup.internal.runtime.Scanner;
import org.openjdk.com.sun.java_cup.internal.runtime.Symbol;
import org.openjdk.com.sun.java_cup.internal.runtime.lr_parser;
...
public class XPathParser extends lr_parser {
    ...
    /**
     * This method is similar to findNodeType(int, Object) except that it creates a StepPattern
     * instead of just returning a node type. It also differs in the way it handles "{uri}:*" and
     * "{uri}:@*". The last two patterns are expanded as "*[namespace-uri() = 'uri']" and
     * "@*[namespace-uri() = 'uri']", respectively. This expansion considerably simplifies the
     * grouping of patterns in the Mode class. For this expansion to be correct, the priority of the
     * pattern/template must be set to -0.25 (when no other predicates are present).
     */
    public StepPattern createStepPattern(int axis, Object test, Vector predicates) {
        ...
        if (test == null) { // "*"
            ...
            if (axis == Axis.NAMESPACE) {
                nodeType =
                        (name.toString().equals("*")) ? -1 : _xsltc.registerNamespacePrefix(name);
                ;
            } else {
    ...
    /**
     * Parse the expression passed to the current scanner. If this expression contains references to
     * local variables and it will be compiled in an external module (not in the main class) request
     * the current template to create a new variable stack frame.
     *
     * @param lineNumber Line where the current expression is defined.
     * @param external Set to <tt>true</tt> if this expression is compiled in a separate module.
     */
    ...
    final SyntaxTreeNode lookupName(QName name) {
        ...
        else return (_symbolTable.lookupName(name));
    }
    ...
    /**
     * Returns true if the axis applies to elements only. The axes child, attribute, namespace,
     * descendant result in non-empty nodesets only if the context node is of type element.
     */
    public boolean isElementAxis(int axis) {
        return (axis == Axis.CHILD
                || axis == Axis.ATTRIBUTE
                || axis == Axis.NAMESPACE
...
class CUP$XPathParser$actions {
    ...
    public final Symbol CUP$XPathParser$do_action(
            int CUP$XPathParser$act_num,
            lr_parser CUP$XPathParser$parser,
            ...
            case 140: // QName ::= ID
                {
                    ...
                    CUP$XPathParser$result =
                            new Symbol(
                                    37 /*QName*/,
                                    ((Symbol)
                                                    CUP$XPathParser$stack.elementAt(
                                                            CUP$XPathParser$top - 0))
                                            .left,
                                    ((Symbol)
                                                    CUP$XPathParser$stack.elementAt(
                                                            CUP$XPathParser$top - 0))
            ...
            case 123: // QName ::= QNAME
                {
                    QName RESULT = null;
                    int qnameleft =
                            ((Symbol) CUP$XPathParser$stack.elementAt(CUP$XPathParser$top - 0))
                                    .left;
                    int qnameright =
                            ((Symbol) CUP$XPathParser$stack.elementAt(CUP$XPathParser$top - 0))
                                    .right;
            ...
            case 119: // NodeTest ::= PIPARAM LPAREN Literal RPAREN
                {
                    Object RESULT = null;
                    int lleft =
                            ((Symbol) CUP$XPathParser$stack.elementAt(CUP$XPathParser$top - 1))
                                    .left;
                    int lright =
                            ((Symbol) CUP$XPathParser$stack.elementAt(CUP$XPathParser$top - 1))
                                    .right;
                    String l =
                            (String)
                                    ((Symbol)
                                                    CUP$XPathParser$stack.elementAt(
                                                            CUP$XPathParser$top - 1))
                                            .value;

                    QName name = parser.getQNameIgnoreDefaultNs("name");
                    Expression exp =
                            new EqualityExpr(Operators.EQ, new NameCall(name), new LiteralExpr(l));
            ...
            case 111: // NonemptyArgumentList ::= Argument COMMA NonemptyArgumentList
                {
                    Vector RESULT = null;
                    int argleft =
                            ((Symbol) CUP$XPathParser$stack.elementAt(CUP$XPathParser$top - 2))
                                    .left;
                    int argright =
                            ((Symbol) CUP$XPathParser$stack.elementAt(CUP$XPathParser$top - 2))
                                    .right;
            ...
            case 109: // FunctionCall ::= FunctionName LPAREN NonemptyArgumentList RPAREN
                {
                    Expression RESULT = null;
                    int fnameleft =
                            ((Symbol) CUP$XPathParser$stack.elementAt(CUP$XPathParser$top - 3))
                                    .left;
                    int fnameright =
                            ((Symbol) CUP$XPathParser$stack.elementAt(CUP$XPathParser$top - 3))
                                    .right;
            ...
            case 76: // AbbreviatedAbsoluteLocationPath ::= DSLASH RelativeLocationPath
                {
                    ...
                    RESULT =
                            new AbsoluteLocationPath(
                                    parser.insertStep(step, (RelativeLocationPath) rlp));

                    CUP$XPathParser$result =
                            new Symbol(
                                    24 /*AbbreviatedAbsoluteLocationPath*/,
                                    ((Symbol)
                                                    CUP$XPathParser$stack.elementAt(
                                                            CUP$XPathParser$top - 1))
                                            .left,
            ...
            case 75: // AbbreviatedRelativeLocationPath ::= RelativeLocationPath DSLASH Step
                {
                    ...
                    CUP$XPathParser$result =
                            new Symbol(
                                    22 /*AbbreviatedRelativeLocationPath*/,
                                    ((Symbol)
                                                    CUP$XPathParser$stack.elementAt(
                                                            CUP$XPathParser$top - 2))
                                            .left,
            ...
            case 35: // ChildOrAttributeAxisSpecifier ::= ATTRIBUTE DCOLON
                {
                    ...
                    CUP$XPathParser$result =
                            new Symbol(
                                    42 /*ChildOrAttributeAxisSpecifier*/,
                                    ((Symbol)
                                                    CUP$XPathParser$stack.elementAt(
                                                            CUP$XPathParser$top - 1))
                                            .left,
            ...
            case 14: // ProcessingInstructionPattern ::= PIPARAM LPAREN Literal RPAREN
                {
                    ...
                    CUP$XPathParser$result =
                            new Symbol(
                                    30 /*ProcessingInstructionPattern*/,
                                    ((Symbol)
                                                    CUP$XPathParser$stack.elementAt(
                                                            CUP$XPathParser$top - 3))
                                            .left,
