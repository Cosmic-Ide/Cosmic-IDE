...
public final class BooleanType extends Type {
    ...
    public org.openjdk.com.sun.org.apache.bcel.internal.generic.Type toJCType() {
        return org.openjdk.com.sun.org.apache.bcel.internal.generic.Type.BOOLEAN;
    }

    /**
     * Translates a real into an object of internal type <code>type</code>. The translation to int
     * is undefined since booleans are always converted to reals in arithmetic expressions.
     *
    ...
    /**
     * Expects a boolean on the stack and pushes a string. If the value on the stack is zero, then
     * the string 'false' is pushed. Otherwise, the string 'true' is pushed.
     *
     * @see Type#translateTo
     */
    ...
    /**
     * Expects a boolean on the stack and pushes a real. The value "true" is converted to 1.0 and
     * the value "false" to 0.0.
     *
     * @see Type#translateTo
     */
    ...
    /**
     * Expects a boolean on the stack and pushes a boxed boolean. Boxed booleans are represented by
     * an instance of <code>java.lang.Boolean</code>.
     *
     * @see Type#translateTo
     */
    ...
    public void translateUnBox(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        il.append(
                new INVOKEVIRTUAL(
                        cpg.addMethodref(BOOLEAN_CLASS, BOOLEAN_VALUE, BOOLEAN_VALUE_SIG)));
    }
