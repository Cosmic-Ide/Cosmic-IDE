...
/**
 * The class that implements any class that inherits from <tt>AbstractTranslet</tt>, i.e. any
 * translet. Methods in this class may be of the following kinds:
 *
 * <p>1. Main method: applyTemplates, implemented by intances of <tt>MethodGenerator</tt>.
 *
 * <p>2. Named methods: for named templates, implemented by instances of
 * <tt>NamedMethodGenerator</tt>.
 *
 * <p>3. Rt methods: for result tree fragments, implemented by instances of
...
public class ClassGenerator extends ClassGen {
    ...
    /**
     * Pretend this is the stylesheet class. Useful when compiling references to global variables
     * inside a predicate.
     */
    ...
    /**
     * Returns <tt>true</tt> or <tt>false</tt> depending on whether this class inherits from
     * <tt>AbstractTranslet</tt> or not.
     */
