    ...
    public Object[][] getContents() {
        return new Object[][] {
             ...
             */
            {
                ...
                "Els fragments de l'arbre de resultats no es poden classificar (es passen per alt"
                    + " els elements <xsl:sort>). Heu de classificar els nodes quan creeu l'arbre"
                    + " de resultats. "
            },
             ...
             */
            {
                ...
                "RESUM \n"
                    ...
                    + "   o b\u00e9 a la CLASSPATH de l'usuari o b\u00e9 al <fitxer_jar> que es pot"
                    + " especificar opcionalment.\n"
                    + "OPCIONS\n"
                    + "   -j <fitxer_jar>    especifica un fitxer jar des del qual es pot carregar"
                    + " el translet\n"
                    + "   -x habilita la sortida de missatges de depuraci\u00f3 addicionals\n"
                    + "   -s              inhabilita la crida de System.exit\n"
                    + "   -n <iteracions> executa la transformaci\u00f3 el nombre de vegades"
                    + " <iteracions> i\n"
             ...
             * of another message.  The substitution text is an error message.
             */
            {ErrorMsg.FATAL_ERR_MSG, "ERROR MOLT GREU: ''{0}''"},
             ...
             * this message.
             */
            {ErrorMsg.COMPILER_ERROR_KEY, "Errors del compilador:"},
             ...
             */
            {ErrorMsg.COMPILER_WARNING_KEY, "Avisos del compilador:"},
             ...
             */
            {ErrorMsg.RUNTIME_ERROR_KEY, "Errors de translet:"},
            {
