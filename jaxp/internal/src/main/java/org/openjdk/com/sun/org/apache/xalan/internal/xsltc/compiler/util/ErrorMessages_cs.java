...
public class ErrorMessages_cs extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
             ...
             */
            {ErrorMsg.INVALID_URI_ERR, "Neplatn\u00e9 URI ''{0}''."},
             ...
             */
            {ErrorMsg.ILLEGAL_CHILD_ERR, "Neplatn\u00fd prvek potomka."},
             ...
             * the name.
             */
            {ErrorMsg.ILLEGAL_ELEM_NAME_ERR, "Nelze volat prvek ''{0}''"},
             ...
             */
            {
                ...
                "SYNOPSIS\n"
                    ...
                    + "VOLBY\n"
                    + "   -o <output>    p\u0159i\u0159azuje n\u00e1zev <output>"
                    + " generovan\u00e9mu\n"
                    + "                  transletu. Standardn\u011b je n\u00e1zev transletu\n"
                    + "                  p\u0159evzat z n\u00e1zvu <stylesheet>. Tato volba\n"
                    + "                   se ignoruje, pokud se kompiluj\u00ed n\u00e1sobn\u00e9"
                    + " p\u0159edlohy styl\u016f.\n"
                    + "   -d <directory> ur\u010duje v\u00fdchoz\u00ed adres\u00e1\u0159 pro"
                    + " translet\n"
                    + "   -j <jarfile>   zabal\u00ed t\u0159\u00eddu transletu do souboru jar\n"
                    + "     pojmenovan\u00e9ho jako <jarfile>\n"
                    + "   -p <package>   ur\u010duje p\u0159edponu n\u00e1zvu bal\u00ed\u010dku pro"
                    + " v\u0161echny generovan\u00e9 \n"
                    + " t\u0159\u00eddy transletu.\n"
                    + "   -n             povoluje zarovn\u00e1n\u00ed \u0161ablony"
                    + " (v\u00fdchoz\u00ed chov\u00e1n\u00ed je v pr\u016fm\u011bru"
                    + " lep\u0161\u00ed\n"
                    + "                  .\n"
                    + "   -x             zapne dal\u0161\u00ed v\u00fdstup zpr\u00e1vy"
                    + " lad\u011bn\u00ed\n"
                    + "   -s             zak\u00e1\u017ee vol\u00e1n\u00ed System.exit\n"
                    + "   -u             interpretuje <stylesheet> argumenty jako URL\n"
                    + "   -i             vynut\u00ed kompil\u00e1tor \u010d\u00edst p\u0159edlohu"
                    + " styl\u016f ze stdin\n"
             ...
             */
            {
                ...
                "SYNOPSIS \n"
                    ...
                    + "   v u\u017eivatelsk\u00e9 cest\u011b CLASSPATH nebo ve voliteln\u011b"
                    + " ur\u010den\u00e9m souboru <jarfile>.\n"
                    + "VOLBY\n"
                    + "     -j <jarfile>    ur\u010duje soubor jarfile, ze kter\u00e9ho se zavede"
                    + " translet\n"
                    + "   -x      p\u0159evede dal\u0161\u00ed v\u00fdstup zpr\u00e1vy"
                    + " lad\u011bn\u00ed\n"
             ...
             */
            {ErrorMsg.WARNING_MSG, "VAROV\u00c1N\u00cd: ''{0}''"},
             ...
             * this message.
             */
            {ErrorMsg.COMPILER_ERROR_KEY, "Chyby kompil\u00e1toru:"},
