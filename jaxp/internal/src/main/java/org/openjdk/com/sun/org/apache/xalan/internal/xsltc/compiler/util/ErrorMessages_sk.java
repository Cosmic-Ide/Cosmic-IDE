...
public class ErrorMessages_sk extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
             ...
             */
            {ErrorMsg.INVALID_URI_ERR, "Neplatn\u00fd URI ''{0}''."},
             ...
             */
            {ErrorMsg.REQUIRED_ATTR_ERR, "Ch\u00fdba po\u017eadovan\u00fd atrib\u00fat ''{0}''."},
             ...
             * in the stylesheet.
             */
            {ErrorMsg.STRAY_WHEN_ERR, "<xsl:when> mo\u017eno pou\u017ei\u0165 len v <xsl:choose>."},
             ...
             */
            {ErrorMsg.UNNAMED_ATTRIBSET_ERR, "<xsl:attribute-set> ch\u00fdba atrib\u00fat 'name'."},
             ...
             * contains the name.
             */
            {ErrorMsg.ILLEGAL_ATTR_NAME_ERR, "Nem\u00f4\u017eete vola\u0165 atrib\u00fat ''{0}''"},
             ...
             */
            {ErrorMsg.ELEMENT_PARSE_ERR, "Nebolo mo\u017en\u00e9 analyzova\u0165 element ''{0}''"},
             ...
             * not be translated.
             */
            {ErrorMsg.NO_MAIN_TRANSLET_ERR, "Tento vzor neobsahuje triedu s n\u00e1zvom ''{0}''."},
             ...
             */
            {
                ...
                "SYNOPSIS\n"
                    ...
                    + "OPTIONS\n"
                    + "   -o <output>    prira\u010fuje n\u00e1zov <output> generovan\u00e9mu"
                    + " transletu \n"
                    + ". \u0160tandardne sa n\u00e1zov transletu \n"
                    + " berie z n\u00e1zvu <stylesheet>. T\u00e1to vo\u013eba sa ignoruje pri"
                    + " kompilovan\u00ed viacer\u00fdch \u0161t\u00fdlov dokumentov\n\n"
                    ...
                    + "   -p <package>   uv\u00e1dza predponu n\u00e1zvu bal\u00edku pre"
                    + " v\u0161etky generovan\u00e9 triedy transletu.\n\n"
                    + "   -n             povo\u013euje zoradenie vzorov v riadku"
                    + " (\u0161tandardn\u00e9 chovanie v priemere lep\u0161ie). \n\n"
                    + "   -x             zap\u00edna   v\u00fdstupy spr\u00e1v ladenia \n"
                    + "   -s             zakazuje volanie System.exit\n"
                    + "   -u             interpretuje<stylesheet> argumenty ako URL\n"
                    + "   -i             n\u00fati kompil\u00e1tor \u010d\u00edta\u0165"
                    + " \u0161t\u00fdl dokumentu z stdin\n"
             ...
             */
            {
                ...
                "SYNOPSIS \n"
                    ...
                    + " <jarfile>.\n"
                    + "VO\u013dBY\n"
                    + "   -j <jarfile>    uv\u00e1dza s\u00fabor jar, z ktor\u00e9ho sa m\u00e1"
                    + " zavies\u0165 translet\n"
                    + "   -x              zap\u00edna \u010fal\u0161\u00ed v\u00fdstup spr\u00e1v"
                    + " ladenia\n"
                    + "   -s              zakazuje volanie System.exit\n"
                    + "   -n <iterations> sp\u00fa\u0161\u0165a transform\u00e1ciu <iterations>"
                    + " r\u00e1z a \n"
             ...
             */
            {ErrorMsg.SYNTAX_ERR, "Chyba syntaxe v ''{0}''."},
             ...
             */
            {ErrorMsg.WARNING_MSG, "UPOZORNENIE:  ''{0}''"},
             ...
             * it the same amount as the first in English.
             */
            {ErrorMsg.FATAL_ERR_PLUS_WRAPPED_MSG, "KRITICK\u00c1 CHYBA:  ''{0}''\n           :{1}"},

            /*
             * Note to translators:  This message is used to indicate the severity
             * of another message.  The substitution text is an error message.
             */
            {ErrorMsg.FATAL_ERR_MSG, "KRITICK\u00c1 CHYBA:  ''{0}''"},
             ...
             * of another message.  The substitution text is an error message.
             */
            {ErrorMsg.ERROR_MSG, "CHYBA:  ''{0}''"},

            /*
             * Note to translators:  The substitution text is the name of a class.
             */
            {ErrorMsg.TRANSFORM_WITH_TRANSLET_STR, "Transform\u00e1cia pomocou transletu ''{0}'' "},
             ...
             * this message.
             */
            {ErrorMsg.COMPILER_ERROR_KEY, "Chyby preklada\u010da:"},
             ...
             */
            {ErrorMsg.RUNTIME_ERROR_KEY, "Chyby transletu:"},
            {
