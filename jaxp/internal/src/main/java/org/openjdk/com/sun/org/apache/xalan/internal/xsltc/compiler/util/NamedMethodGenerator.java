...
/**
 * This class is used for named templates. Named template methods have access to the DOM, the
 * current iterator, the handler and the current node.
 *
