...
/**
 * This class implements auxiliary classes needed to compile patterns in <tt>xsl:number</tt>. These
 * classes inherit from {Any,Single,Multiple}NodeCounter and override the <tt>matchFrom</tt> and
 * <tt>matchCount</tt> methods.
 *
...
public final class NodeCounterGenerator extends ClassGenerator {
    ...
    /**
     * The index of the translet pointer within the execution of matchFrom or matchCount. Overridden
     * from ClassGenerator.
     */
