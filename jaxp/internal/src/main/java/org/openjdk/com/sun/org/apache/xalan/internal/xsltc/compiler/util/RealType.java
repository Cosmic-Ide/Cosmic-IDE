...
import org.openjdk.com.sun.org.apache.bcel.internal.generic.IFNE;
...
public final class RealType extends NumberType {
    ...
    public org.openjdk.com.sun.org.apache.bcel.internal.generic.Type toJCType() {
        return org.openjdk.com.sun.org.apache.bcel.internal.generic.Type.DOUBLE;
    }
    ...
    /**
     * Translates a real into an object of internal type <code>type</code>. The translation to int
     * is undefined since reals are never converted to ints.
     *
    ...
    /**
     * Expects a real on the stack and pushes its string value by calling <code>
     * Double.toString(double d)</code>.
     *
     * @see Type#translateTo
     */
    public void translateTo(ClassGenerator classGen, MethodGenerator methodGen, StringType type) {
        ...
        il.append(
                new INVOKESTATIC(
                        cpg.addMethodref(BASIS_LIBRARY_CLASS, "realToString", "(D)" + STRING_SIG)));
    }
    ...
    /**
     * Translates a real into a non-synthesized boolean. It does not push a 0 or a 1 but instead
     * returns branchhandle list to be appended to the false list. A NaN must be converted to
     * "false".
     *
    ...
    public FlowList translateToDesynthesized(
        ...
        local =
                methodGen.addLocalVariable(
                        "real_to_boolean_tmp",
                        org.openjdk.com.sun.org.apache.bcel.internal.generic.Type.DOUBLE,
                        null,
                        null);
    ...
    /**
     * Expects a double on the stack and pushes a boxed double. Boxed double are represented by an
     * instance of <code>java.lang.Double</code>.
     *
     * @see Type#translateTo
     */
    ...
    /**
     * Translates a real into the Java type denoted by <code>clazz</code>. Expects a real on the
     * stack and pushes a number of the appropriate type after coercion.
     */
    ...
    /**
     * Translates an external (primitive) Java type into a real. Expects a java object on the stack
     * and pushes a real (i.e., a double).
     */
    ...
    public void translateUnBox(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        il.append(
                new INVOKEVIRTUAL(cpg.addMethodref(DOUBLE_CLASS, DOUBLE_VALUE, DOUBLE_VALUE_SIG)));
    }
