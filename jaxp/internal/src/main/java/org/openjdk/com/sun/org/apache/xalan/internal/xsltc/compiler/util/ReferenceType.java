...
public final class ReferenceType extends Type {
    ...
    public org.openjdk.com.sun.org.apache.bcel.internal.generic.Type toJCType() {
        return org.openjdk.com.sun.org.apache.bcel.internal.generic.Type.OBJECT;
    }

    /**
     * Translates a reference to an object of internal type <code>type</code>. The translation to
     * int is undefined since references are always converted to reals in arithmetic expressions.
     *
    ...
    public void translateTo(ClassGenerator classGen, MethodGenerator methodGen, RealType type) {
        ...
        int index =
                cpg.addMethodref(
                        BASIS_LIBRARY_CLASS, "numberF", "(" + OBJECT_SIG + DOM_INTF_SIG + ")D");
    ...
    public void translateTo(
            ClassGenerator classGen, MethodGenerator methodGen, ResultTreeType type) {
        final ConstantPoolGen cpg = classGen.getConstantPool();
        final InstructionList il = methodGen.getInstructionList();
        int index =
                cpg.addMethodref(
    ...
    public void translateTo(ClassGenerator classGen, MethodGenerator methodGen, Class clazz) {
        ...
        int referenceToBoolean =
                cpg.addMethodref(
                        BASIS_LIBRARY_CLASS, "referenceToBoolean", "(" + OBJECT_SIG + ")Z");
        ...
        if (clazz.getName().equals("java.lang.Object")) {
            ...
            il.append(new INVOKESTATIC(index));
                ...
                .equals("org.openjdk.com.sun.org.apache.xalan.internal.xsltc.DOM")) {
            ...
            il.append(new INVOKESTATIC(referenceToBoolean));
            Boolean.translateTo(classGen, methodGen, Reference);
        } else {
