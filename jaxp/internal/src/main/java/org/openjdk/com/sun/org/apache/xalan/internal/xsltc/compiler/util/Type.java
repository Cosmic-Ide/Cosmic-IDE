...
import org.openjdk.com.sun.org.apache.xalan.internal.xsltc.compiler.NodeTest;
...
public abstract class Type implements Constants {
    ...
    /**
     * Factory method to instantiate object types. Returns a pre-defined instance for
    ...
    /**
     * Factory method to instantiate object types. Returns a pre-defined instance for
     * java.lang.Object.class and java.lang.String.class.
     */
    ...
    /**
     * Returns true if this type is a simple type. Redefined in NumberType, BooleanType and
     * StringType.
     */
    ...
    public abstract org.openjdk.com.sun.org.apache.bcel.internal.generic.Type toJCType();

    /**
     * Returns the distance between two types. This measure is used to select overloaded
     * functions/operators. This method is typically redefined by the subclasses.
     */
    ...
    /**
     * Translates an object of this type to an object of type <code>type</code>. Expects an object
     * of the former type and pushes an object of the latter.
     */
    ...
    /**
     * Translates object of this type to an object of type <code>type</code>. Expects an object of
     * the former type and pushes an object of the latter if not boolean. If type <code>type</code>
     * is boolean then a branchhandle list (to be appended to the false list) is returned.
     */
    public FlowList translateToDesynthesized(
            ClassGenerator classGen, MethodGenerator methodGen, Type type) {
        FlowList fl = null;
    ...
    /**
     * Translates an object of this type to an non-synthesized boolean. It does not push a 0 or a 1
     * but instead returns branchhandle list to be appended to the false list.
     */
    public FlowList translateToDesynthesized(
    ...
    public void translateTo(ClassGenerator classGen, MethodGenerator methodGen, Class clazz) {
        ErrorMsg err =
                new ErrorMsg(ErrorMsg.DATA_CONVERSION_ERR, toString(), clazz.getClass().toString());
        classGen.getParser().reportError(Constants.FATAL, err);
    }

    /**
     * Translates an external (Java) type denoted by <code>clazz</code> to an object of this type.
     * This method is used to translate return values when external functions are called.
     */
    public void translateFrom(ClassGenerator classGen, MethodGenerator methodGen, Class clazz) {
        ErrorMsg err =
                new ErrorMsg(ErrorMsg.DATA_CONVERSION_ERR, clazz.getClass().toString(), toString());
        classGen.getParser().reportError(Constants.FATAL, err);
    }
    ...
    public void translateBox(ClassGenerator classGen, MethodGenerator methodGen) {
        ErrorMsg err =
                new ErrorMsg(ErrorMsg.DATA_CONVERSION_ERR, toString(), "[" + toString() + "]");
        classGen.getParser().reportError(Constants.FATAL, err);
    }
