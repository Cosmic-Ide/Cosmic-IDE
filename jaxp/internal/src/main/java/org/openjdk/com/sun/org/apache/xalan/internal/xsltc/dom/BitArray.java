...
public class BitArray implements Externalizable {
    ...
    /**
     * Set the mask for this bit array. The upper 8 bits of this mask indicate the DOM in which the
     * nodes in this array belong.
     */
    ...
    /**
     * This method returns the Nth bit that is set in the bit array. The current position is cached
     * in the following 4 variables and will help speed up a sequence of next() call in an index
     * iterator. This method is a mess, but it is fast and it works, so don't fuck with it.
     */
    ...
    /**
     * Merge two bit arrays. This currently only works for nodes from a single DOM (because there is
     * only one _mask per array).
     */
