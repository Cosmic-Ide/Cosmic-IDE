...
import org.openjdk.com.sun.org.apache.xml.internal.utils.LocaleUtility;
...
public class NodeSortRecordFactory {
    ...
    /**
     * Creates a NodeSortRecord producing object. The DOM specifies which tree to get the nodes to
     * sort from, the class name specifies what auxillary class to use to sort the nodes (this class
     * is generated by the Sort class), and the translet parameter is needed for methods called by
     * this object.
     *
     * @deprecated This constructor is no longer used in generated code. It exists only for
     *     backwards compatibility.
     */
    public NodeSortRecordFactory(
            DOM dom, String className, Translet translet, String order[], String type[])
    ...
    /**
     * Create an instance of a sub-class of NodeSortRecord. The name of this sub-class is passed to
