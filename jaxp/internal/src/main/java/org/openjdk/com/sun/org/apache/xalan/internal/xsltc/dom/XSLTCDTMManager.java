...
import org.openjdk.com.sun.org.apache.xalan.internal.xsltc.trax.DOM2SAX;
import org.openjdk.com.sun.org.apache.xalan.internal.xsltc.trax.StAXEvent2SAX;
import org.openjdk.com.sun.org.apache.xalan.internal.xsltc.trax.StAXStream2SAX;
...
public class XSLTCDTMManager extends DTMManagerDefault {
     ...
     * instance. The current implementation just returns a new XSLTCDTMManager instance.
     */
    ...
    /**
     * Creates a new instance of the XSLTC DTM Manager service. Creates a new instance of the
     * default class <code>com.sun.org.apache.xalan.internal.xsltc.dom.XSLTCDTMManager</code>.
     */
    ...
    public DTM getDTM(
            ...
            boolean doIndexing) {
        return getDTM(
                source, unique, whiteSpaceFilter, incremental, doIndexing, false, 0, true, false);
    }
     ...
     * @param incremental true if the DTM should be built incrementally, if possible.
     * @param doIndexing true if the caller considers it worth it to use indexing schemes.
     * @param hasUserReader true if <code>source</code> is a <code>SAXSource</code> object that has
     *     an <code>XMLReader</code>, that was specified by the user.
