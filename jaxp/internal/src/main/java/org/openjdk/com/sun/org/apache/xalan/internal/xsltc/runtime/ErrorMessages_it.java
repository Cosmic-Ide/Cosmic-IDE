    ...
    public Object[][] getContents() {
        return new Object[][] {
             ...
             */
            {
                ...
                "Il translet specificato ''{0}'' \u00E8 stato creato utilizzando una versione di"
                    + " XSLTC pi\u00F9 recente di quella della fase di esecuzione XSLTC in uso."
                    + " Ricompilare il foglio di stile o utilizzare una versione pi\u00F9 recente"
                    + " di XSLTC per eseguire questo translet."
            },
