...
public class ErrorMessages_sv extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
             ...
             */
            {BasisLibrary.RUN_TIME_INTERNAL_ERR, "Internt k\u00F6rningsfel i ''{0}''"},

            /*
             * Note to translators:  <xsl:copy> is a keyword that should not be
             * translated.
             */
            {BasisLibrary.RUN_TIME_COPY_ERR, "K\u00F6rningsfel vid k\u00F6rning av <xsl:copy>."},
             ...
             */
            {
                ...
                "Angiven translet, ''{0}'', har skapats med en XSLTC-version som \u00E4r senare"
                    + " \u00E4n den XSLTC-k\u00F6rning i bruk. F\u00F6r att kunna k\u00F6ra denna"
                    + " translet m\u00E5ste du omkompilera formatmallen eller anv\u00E4nda en"
                    + " senare version av XSLTC."
            },
