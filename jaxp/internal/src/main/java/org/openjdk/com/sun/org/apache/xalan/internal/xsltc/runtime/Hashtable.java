...
/**
 * IMPORTANT NOTE: This code was taken from Sun's Java1.1 JDK java.util.HashTable.java All
 * "synchronized" keywords and some methods we do not need have been all been removed.
 */
...
public class Hashtable {
    ...
    /**
     * Rehashes the contents of the hashtable into a hashtable with a larger capacity. This method
     * is called automatically when the number of keys in the hashtable exceeds this hashtable's
    ...
    /**
     * Returns a rather long string representation of this hashtable. Handy for debugging - leave it
     * here!!!
     */
    ...
    /**
     * A hashtable enumerator class. This class should remain opaque to the client. It will use the
