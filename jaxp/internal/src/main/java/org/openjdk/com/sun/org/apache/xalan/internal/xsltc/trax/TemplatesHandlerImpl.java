...
import org.openjdk.com.sun.org.apache.xalan.internal.xsltc.compiler.CompilerException;
import org.openjdk.com.sun.org.apache.xalan.internal.xsltc.compiler.Parser;
import org.openjdk.com.sun.org.apache.xalan.internal.xsltc.compiler.SourceLoader;
import org.openjdk.com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet;
import org.openjdk.com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode;
...
public class TemplatesHandlerImpl implements ContentHandler, TemplatesHandler, SourceLoader {
    ...
    /**
     * Implements org.openjdk.javax.xml.transform.sax.TemplatesHandler.getSystemId() Get the base ID
     * (URI or system ID) from where relative URLs will be resolved.
     *
    ...
    /**
     * Implements org.openjdk.javax.xml.transform.sax.TemplatesHandler.setSystemId() Get the base ID
     * (URI or system ID) from where relative URLs will be resolved.
     *
    ...
    /**
     * Implements org.openjdk.javax.xml.transform.sax.TemplatesHandler.getTemplates() When a
     * TemplatesHandler object is used as a ContentHandler or DocumentHandler for the parsing of
     * transformation instructions, it creates a Templates object, which the caller can get once the
     * SAX events have been completed.
     *
     * @return The Templates object that was created during the SAX event process, or null if no
    ...
    public void endDocument() throws SAXException {
        ...
        try {
            ...
            if (!_parser.errorsFound() && root != null) {
                ...
                if (xsltc.getTemplateInlining()) stylesheet.setTemplateInlining(true);
                else stylesheet.setTemplateInlining(false);
            ...
            if (!_parser.errorsFound()) {
                ...
                throw new SAXException(
                        ...
                        new TransformerException(errorMessage.toString()));
            }
