...
public class TransformerHandlerImpl implements TransformerHandler, DeclHandler {
    ...
    /**
     * Implements org.openjdk.javax.xml.transform.sax.TransformerHandler.getSystemId() Get the base
     * ID (URI or system ID) from where relative URLs will be resolved.
     *
    ...
    /**
     * Implements org.openjdk.javax.xml.transform.sax.TransformerHandler.setSystemId() Get the base
     * ID (URI or system ID) from where relative URLs will be resolved.
     *
    ...
    /**
     * Implements org.openjdk.javax.xml.transform.sax.TransformerHandler.getTransformer() Get the
     * Transformer associated with this handler, which is needed in order to set parameters and
     * output properties.
     *
    ...
    /**
     * Implements org.openjdk.javax.xml.transform.sax.TransformerHandler.setResult() Enables the
     * user of the TransformerHandler to set the to set the Result for the transformation.
     *
    ...
    /**
     * Implements org.xml.sax.ContentHandler.startDocument() Receive notification of the beginning
     * of a document.
     */
    @Override
    public void startDocument() throws SAXException {
        ...
        if (!_isIdentity) {
            ...
            try {
                dtmManager = _transformer.getTransformerFactory().createNewDTMManagerInstance();
            } catch (Exception e) {
    ...
    /**
     * Implements org.xml.sax.ContentHandler.startElement() Receive notification of the beginning of
     * an element.
     */
    @Override
    ...
    /**
     * Implements org.xml.sax.ContentHandler.endElement() Receive notification of the end of an
     * element.
     */
    @Override
    ...
    /**
     * Implements org.xml.sax.ContentHandler.processingInstruction() Receive notification of a
    ...
    /**
     * Implements org.xml.sax.ContentHandler.ignorableWhitespace() Receive notification of ignorable
     * whitespace in element content. Similar to characters(char[], int, int).
     */
    @Override
    ...
    /**
     * Implements org.xml.sax.ContentHandler.setDocumentLocator() Receive an object for locating the
    ...
    /**
     * Implements org.xml.sax.ContentHandler.skippedEntity() Receive notification of a skipped
     * entity.
     */
    @Override
    ...
    /**
     * Implements org.xml.sax.ContentHandler.startPrefixMapping() Begin the scope of a prefix-URI
     * Namespace mapping.
     */
    @Override
    ...
    /**
     * Implements org.xml.sax.ContentHandler.endPrefixMapping() End the scope of a prefix-URI
     * Namespace mapping.
     */
    @Override
