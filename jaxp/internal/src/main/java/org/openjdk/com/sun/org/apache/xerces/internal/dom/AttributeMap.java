...
/**
 * AttributeMap inherits from NamedNodeMapImpl and extends it to deal with the specifics of storing
...
public class AttributeMap extends NamedNodeMapImpl {
    ...
    public Node setNamedItem(Node arg) throws DOMException {
        ...
        if (argn.isOwned()) {
            if (errCheck && argn.getOwnerElement() != ownerNode) {
                String msg =
                        DOMMessageFormatter.formatMessage(
                                DOMMessageFormatter.DOM_DOMAIN, "INUSE_ATTRIBUTE_ERR", null);
     ...
     *
     * @param name The name of a node to remove. If the removed attribute is known to have a default
    ...
    /**
     * Same as removeNamedItem except that it simply returns null if the specified name is not
     * found.
     */
     ...
     * these contents. If node does not belong to this named node map, we throw a DOMException.
     *
    ...
    /**
     * Internal removeNamedItem method allowing to specify whether an exception must be thrown if
     ...
     *
     * <p>Removes an attribute specified by local name and namespace URI.
     *
    ...
    /**
     * Same as removeNamedItem except that it simply returns null if the specified local name and
     * namespace URI is not found.
     */
    ...
    /**
     * Internal removeNamedItemNS method allowing to specify whether an exception must be thrown if
     * the specified local name and namespace URI is not found.
     */
    protected final Node internalRemoveNamedItemNS(
            String namespaceURI, String name, boolean raiseEx) {
