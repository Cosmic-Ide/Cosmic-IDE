...
import org.openjdk.com.sun.org.apache.xerces.internal.utils.ObjectFactory;
...
public class CoreDocumentImpl extends ParentNode implements Document {
            ...
            try {
                Class xpathClass =
                        ObjectFactory.findProviderClass(
                                "org.openjdk.com.sun.org.apache.xpath.internal.domapi.XPathEvaluatorImpl",
                                true);
     ...
     * identifiers. The Hashtable has Elements as the keys and their identifiers as the values. When
     * an element is being imported, a check is done for an associated identifier. If one exists,
     * the identifier is registered with the new, imported element. If reversedIdentifiers is null,
     * the parameter is not applied.
     */
    private Node importNode(
            Node source, boolean deep, boolean cloningDoc, Hashtable reversedIdentifiers)
            throws DOMException {
        Node newnode = null;
            ...
            case ATTRIBUTE_NODE:
                {
                    ...
                    if (userData != null) setUserDataTable(node, userData);
                    break;
                }
