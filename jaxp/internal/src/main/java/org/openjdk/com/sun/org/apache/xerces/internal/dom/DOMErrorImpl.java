...
/**
 * <code>DOMErrorImpl</code> is an implementation that describes an error. <strong>Note:</strong>
 * The error object that describes the error might be reused by Xerces implementation, across
 * multiple calls to the handleEvent method on DOMErrorHandler interface.
 *
...
public class DOMErrorImpl implements DOMError {
    ...
    /**
     * The related platform dependent exception if any.exception is a reserved word, we need to
     * rename it.Change to "relatedException". (F2F 26 Sep 2001)
     */
