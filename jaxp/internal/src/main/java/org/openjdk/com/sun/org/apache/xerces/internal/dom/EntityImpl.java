...
public class EntityImpl extends ParentNode implements Entity {
    ...
    /**
     * DOM Level 3 WD - experimental the version number of this entity, when it is an external
     * parsed entity.
     */
    ...
    /**
     * DOM Level 3 WD - experimental the encoding of this entity, when it is an external parsed
     * entity.
     */
    ...
    /**
     * DOM Level 2: The public identifier associated with the entity. If not specified, this will be
     * null.
     */
    ...
    /**
     * NON-DOM encoding - An attribute specifying, as part of the text declaration, the encoding of
    ...
    /**
     * An attribute specifying the encoding used for this entity at the tiome of parsing, when it is
    ...
    /**
     * NON-DOM version - An attribute specifying, as part of the text declaration, the version
     * number of this entity, when it is an external parsed entity. This is null otherwise
     */
    ...
    /**
     * DOM Level 2: The system identifier associated with the entity. If not specified, this will be
     * null.
     */
    ...
    /**
     * DOM Level 2: Unparsed entities -- which contain non-XML data -- have a "notation name" which
     * tells applications how to deal with them. Parsed entities, which <em>are</em> in XML format,
     * don't need this and set it to null.
     */
