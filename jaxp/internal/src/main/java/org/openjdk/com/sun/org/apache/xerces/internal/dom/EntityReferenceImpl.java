...
public class EntityReferenceImpl extends ParentNode implements EntityReference {
    ...
    public String getBaseURI() {
        ...
        if (baseURI == null) {
            ...
            if (null != (doctype = getOwnerDocument().getDoctype())
                ...
                && baseURI.length() != 0) { // attribute value is always empty string
            try {
    ...
    /**
     * NON-DOM: compute string representation of the entity reference. This method is used to
     * retrieve a string value for an attribute node that has child nodes.
     *
     ...
     * creates them if they haven't been created yet. This doesn't support editing the Entity
     * though, since this only called once for all.
     */
     ...
     *
     * <p>Note: make sure that entity reference and its kids could be set readonly.
     */
     ...
     *
     * <p>It is unclear what the least-cost resynch mechanism is. If we expect the kids to be
     * shallow, and/or expect changes to the Entity contents to be rare, wiping them all out and
     * recloning is simplest.
     *
