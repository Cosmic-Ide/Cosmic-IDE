 ...
 *
 * <p>This class inherits from CharacterDataImpl to reuse its setNodeValue method.
 *
 * @xerces.internal
...
public class ProcessingInstructionImpl extends CharacterDataImpl implements ProcessingInstruction {
    ...
    /**
     * A PI's data content tells the processor what we actually want it to do. It is defined
     * slightly differently in HTML and XML.
     *
     * <p>In XML, the data begins with the non-whitespace character immediately after the target
     * -- @see getTarget().
     *
     * <p>In HTML, the data begins with the character immediately after the "&lt;?" token that
     * begins the PI.
     *
