...
public class TreeWalkerImpl implements TreeWalker {
    ...
    public TreeWalkerImpl(
            Node root, int whatToShow, NodeFilter nodeFilter, boolean entityReferenceExpansion) {
        fCurrentNode = root;
        fRoot = root;
    ...
    /**
     * Return the parent Node from the current node, after applying filter, whatToshow. If result is
     * not null, set the current Node.
     */
    ...
    /**
     * Return the first child Node from the current node, after applying filter, whatToshow. If
     * result is not null, set the current Node.
     */
    ...
    /**
     * Return the last child Node from the current node, after applying filter, whatToshow. If
     * result is not null, set the current Node.
     */
    ...
    /**
     * Return the previous sibling Node from the current node, after applying filter, whatToshow. If
     * result is not null, set the current Node.
     */
    ...
    /**
     * Return the next sibling Node from the current node, after applying filter, whatToshow. If
     * result is not null, set the current Node.
     */
    ...
    /**
     * Return the previous Node from the current node, after applying filter, whatToshow. If result
     * is not null, set the current Node.
     */
    ...
    /**
     * Return the next Node from the current node, after applying filter, whatToshow. If result is
     * not null, set the current Node.
     */
    ...
    /**
     * Internal function. Return the parent Node, from the input node after applying filter,
     * whatToshow. The current node is not consulted or set.
     */
    ...
    /**
     * Internal function. Return the nextSibling Node, from the input node after applying filter,
     * whatToshow. The current node is not consulted or set.
     */
    ...
    /**
     * Internal function. Return the nextSibling Node, from the input node after applying filter,
     * whatToshow. NEVER TRAVERSES ABOVE THE SPECIFIED ROOT NODE. The current node is not consulted
     * or set.
     */
    ...
    /**
     * Internal function. Return the previous sibling Node, from the input node after applying
     * filter, whatToshow. The current node is not consulted or set.
     */
    ...
    /**
     * Internal function. Return the previousSibling Node, from the input node after applying
     * filter, whatToshow. NEVER TRAVERSES ABOVE THE SPECIFIED ROOT NODE. The current node is not
     * consulted or set.
     */
    ...
    /**
     * Internal function. Return the first child Node, from the input node after applying filter,
     * whatToshow. The current node is not consulted or set.
     */
    ...
    /**
     * Internal function. Return the last child Node, from the input node after applying filter,
     * whatToshow. The current node is not consulted or set.
     */
