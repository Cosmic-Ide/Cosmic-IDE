...
import org.openjdk.com.sun.org.apache.xerces.internal.impl.io.ASCIIReader;
import org.openjdk.com.sun.org.apache.xerces.internal.impl.io.UCSReader;
import org.openjdk.com.sun.org.apache.xerces.internal.impl.io.UTF8Reader;
...
import org.openjdk.com.sun.org.apache.xerces.internal.xni.*;
...
public class XMLEntityScanner implements XMLLocator {
    ...
    public int scanContent(XMLString content) throws IOException {
        ...
        if (c == '\n' || (c == '\r' && isExternal)) {
            ...
            if (fCurrentEntity.position == fCurrentEntity.count - 1) {
                // CHANGED: dont replace the value.. append to the buffer. This gives control to the
                // callee
     ...
     * <p><strong>Note:</strong> The characters are consumed.
     *
     * <p><strong>Note:</strong> This assumes that the length of the delimiter and that the
        ...
        do {
            ...
            if (c == '\n' || (c == '\r' && isExternal)) {
                ...
                if (fCurrentEntity.position == fCurrentEntity.count - 1) {
                    ...
                    if (DEBUG_BUFFER) {
                        System.out.print(
                                "]newline, " + offset + ", " + fCurrentEntity.position + ": ");
                        print();
                        System.out.println();
                    }
                    return true;
    ...
    /**
     * @param legnth This function checks that following number of characters are available. to the
     *     underlying buffer.
