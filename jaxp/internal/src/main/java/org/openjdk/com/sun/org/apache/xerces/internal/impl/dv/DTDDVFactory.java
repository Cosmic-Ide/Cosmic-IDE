...
/**
 * The factory to create and return DTD types. The implementation should store the created datatypes
 * in static data, so that they can be shared by multiple parser instance, and multiple threads.
 *
 * @xerces.internal
...
public abstract class DTDDVFactory {
    ...
    private static final String DEFAULT_FACTORY_CLASS =
            "org.openjdk.com.sun.org.apache.xerces.internal.impl.dv.dtd.DTDDVFactoryImpl";
