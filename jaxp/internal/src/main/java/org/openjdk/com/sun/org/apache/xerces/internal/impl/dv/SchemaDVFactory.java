 ...
 *
 * <p>1. to get the instance of specified SchemaDVFactory implementation
 *
 * <p>2. to create/return built-in schema simple types
 *
 * <p>3. to create user defined simple types.
 *
 * <p>Implementations of this abstract class can be used to get built-in simple types and create
 * user-defined simle types.
 *
 * <p>The implementation should store the built-in datatypes in static data, so that they can be
 * shared by multiple parser instance, and multiple threads.
 *
 * @xerces.internal
...
public abstract class SchemaDVFactory {
    ...
    private static final String DEFAULT_FACTORY_CLASS =
            "org.openjdk.com.sun.org.apache.xerces.internal.impl.dv.xs.SchemaDVFactoryImpl";

    /**
     * Get a default instance of SchemaDVFactory implementation.
     *
     * @return an instance of SchemaDVFactory implementation
     * @exception DVFactoryException cannot create an instance of the specified class name or the
     *     default class name
     */
     ...
     * WG how to define the ur-types and if all simple types should be derived from a complex type,
     * so as of now we ignore the fact that anySimpleType is derived from anyType, and pass 'null'
     * as the base of anySimpleType. It needs to be changed as per the decision taken.
     *
     ...
     */
    public abstract XSSimpleType createTypeRestriction(
            String name,
     ...
     * @return the newly created simple type
     */
    public abstract XSSimpleType createTypeList(
            String name,
            String targetNamespace,
            short finalSet,
     ...
     * @return the newly created simple type
     */
    public abstract XSSimpleType createTypeUnion(
            String name,
            String targetNamespace,
            short finalSet,
