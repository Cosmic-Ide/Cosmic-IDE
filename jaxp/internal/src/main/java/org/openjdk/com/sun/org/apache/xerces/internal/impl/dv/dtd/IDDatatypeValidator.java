...
/**
 * IDDatatypeValidator - ID represents the ID attribute type from XML 1.0 Recommendation. The value
 * space od ID is the set of all strings that match the NCName production and have been used in an
