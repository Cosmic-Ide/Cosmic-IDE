...
/**
 * NOTATIONValidator defines the interface that data type validators must obey. These validators can
 * be supplied by the application writer and may be useful as standalone code as well as plugins to
...
public class NOTATIONDatatypeValidator implements DatatypeValidator {
    ...
    /**
     * Checks that "content" string is valid NOTATION value. If invalid a Datatype validation
     * exception is thrown.
     *
