...
public class XML11DTDDVFactoryImpl extends DTDDVFactoryImpl {
    ...
    /**
     * return a dtd type of the given name This will call the super class if and only if it does not
    ...
    /**
     * get all built-in DVs, which are stored in a hashtable keyed by the name New XML 1.1 datatypes
     * are inserted.
     *
