...
import org.openjdk.com.sun.org.apache.xerces.internal.impl.dv.util.Base64;
import org.openjdk.com.sun.org.apache.xerces.internal.impl.dv.util.ByteListImpl;
...
public class Base64BinaryDV extends TypeValidator {
    ...
    public short getAllowedFacets() {
        return (XSSimpleTypeDecl.FACET_LENGTH
                | XSSimpleTypeDecl.FACET_MINLENGTH
    ...
    public Object getActualValue(String content, ValidationContext context)
        ...
        if (decoded == null)
            throw new InvalidDatatypeValueException(
                    "cvc-datatype-valid.1.2.1", new Object[] {content, "base64Binary"});
    ...
    private static final class XBase64 extends ByteListImpl {
        ...
        public boolean equals(Object obj) {
            if (!(obj instanceof XBase64)) return false;
            byte[] odata = ((XBase64) obj).data;
            int len = data.length;
            if (len != odata.length) return false;
            for (int i = 0; i < len; i++) {
