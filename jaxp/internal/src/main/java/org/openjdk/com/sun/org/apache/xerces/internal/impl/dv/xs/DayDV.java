...
public class DayDV extends AbstractDateTimeDV {
    ...
    public Object getActualValue(String content, ValidationContext context)
        ...
        try {
            ...
            throw new InvalidDatatypeValueException(
                    "cvc-datatype-valid.1.2.1", new Object[] {content, "gDay"});
        }
    }
     ...
     *
     * @param str The lexical representation of gDay object ---DD with possible time zone Z or
     *     (-),(+)hh:mm Pattern: ---(\\d\\d)(Z|(([-+])(\\d\\d)(:(\\d\\d))?
