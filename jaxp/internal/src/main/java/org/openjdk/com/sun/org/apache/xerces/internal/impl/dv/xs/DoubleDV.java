...
import org.openjdk.com.sun.org.apache.xerces.internal.xs.datatypes.XSDouble;
...
public class DoubleDV extends TypeValidator {
    ...
    // convert a String to Double form, we have to take care of cases specified in spec like INF,
    // -INF and NaN
    public Object getActualValue(String content, ValidationContext context)
        ...
        try {
            ...
            throw new InvalidDatatypeValueException(
                    "cvc-datatype-valid.1.2.1", new Object[] {content, "double"});
        }
    } // getActualValue()
    ...
    /**
     * Returns true if it's possible that the given string represents a valid floating point value
    ...
    private static final class XDouble implements XSDouble {
        ...
        public boolean equals(Object val) {
            ...
            if (!(val instanceof XDouble)) return false;
            XDouble oval = (XDouble) val;

            // NOTE: we don't distinguish 0.0 from -0.0
            if (value == oval.value) return true;
        ...
        public boolean isIdentical(XDouble val) {
            ...
            if (value != value && val.value != val.value) return true;
        ...
        private int compareTo(XDouble val) {
            ...
            // this < other
            if (value < oval) return -1;
            // this > other
            if (value > oval) return 1;
            // this == other
            // NOTE: we don't distinguish 0.0 from -0.0
            if (value == oval) return 0;

            // one of the 2 values or both is/are NaN(s)

            if (value != value) {
                // this = NaN = other
                if (oval != oval) return 0;
                // this is NaN <> other
        ...
        public synchronized String toString() {
            if (canonical == null) {
                if (value == Double.POSITIVE_INFINITY) canonical = "INF";
                else if (value == Double.NEGATIVE_INFINITY) canonical = "-INF";
                else if (value != value) canonical = "NaN";
                // NOTE: we don't distinguish 0.0 from -0.0
                else if (value == 0) canonical = "0.0E1";
                else {
