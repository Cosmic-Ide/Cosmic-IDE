...
import org.openjdk.com.sun.org.apache.xerces.internal.xs.datatypes.XSFloat;
...
public class FloatDV extends TypeValidator {
    ...
    // convert a String to Float form, we have to take care of cases specified in spec like INF,
    // -INF and NaN
    public Object getActualValue(String content, ValidationContext context)
        ...
        try {
            ...
            throw new InvalidDatatypeValueException(
                    "cvc-datatype-valid.1.2.1", new Object[] {content, "float"});
        }
    } // getActualValue()
    ...
    private static final class XFloat implements XSFloat {
        ...
        public boolean equals(Object val) {
            ...
            if (!(val instanceof XFloat)) return false;
        ...
        public synchronized String toString() {
            if (canonical == null) {
                if (value == Float.POSITIVE_INFINITY) canonical = "INF";
                else if (value == Float.NEGATIVE_INFINITY) canonical = "-INF";
