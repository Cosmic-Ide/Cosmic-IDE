...
import org.openjdk.com.sun.org.apache.xerces.internal.impl.dv.util.HexBin;
...
public class HexBinaryDV extends TypeValidator {
    ...
    public Object getActualValue(String content, ValidationContext context)
        ...
        if (decoded == null)
            throw new InvalidDatatypeValueException(
                    "cvc-datatype-valid.1.2.1", new Object[] {content, "hexBinary"});
    ...
    private static final class XHex extends ByteListImpl {
        ...
        public boolean equals(Object obj) {
            if (!(obj instanceof XHex)) return false;
