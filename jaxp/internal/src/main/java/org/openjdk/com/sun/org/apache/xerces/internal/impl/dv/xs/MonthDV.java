...
public class MonthDV extends AbstractDateTimeDV {
    ...
    public Object getActualValue(String content, ValidationContext context)
        ...
        try {
            ...
            throw new InvalidDatatypeValueException(
                    "cvc-datatype-valid.1.2.1", new Object[] {content, "gMonth"});
        }
    }
     ...
     *
     * @param str The lexical representation of gMonth object --MM with possible time zone Z or
     *     (-),(+)hh:mm
     ...
     *
     * <p>REVISIT: this one is lack of the third parameter: boolean strict, so it doesn't override
     * the method in the base. But maybe this method is not correctly implemented, and I did
     * encounter errors when trying to add the extra parameter. I'm leaving it as is. -SG
     *
     * @param date1
     * @param date2
