...
package org.openjdk.com.sun.org.apache.xerces.internal.impl.io;
...
public class UTF8Reader extends Reader {
    ...
    /**
     * Constructs a UTF-8 reader from the specified input stream using the default buffer size and
     ...
     */
    public UTF8Reader(
            InputStream inputStream, int size, MessageFormatter messageFormatter, Locale locale) {
     ...
     * method.
     *
     * @return The character read, as an integer in the range 0 to 16383 (<tt>0x00-0xffff</tt>), or
    ...
    public int read() throws IOException {
        ...
        if (fSurrogate == -1) {
            ...
            // get first byte
            int b0 = index == fOffset ? fInputStream.read() : fBuffer[index++] & 0x00FF;
            if (b0 == -1) {
                return -1;
            }
            ...
            // Unicode: [0000 0yyy] [yyxx xxxx]
                ...
                int b1 = index == fOffset ? fInputStream.read() : fBuffer[index++] & 0x00FF;
                if (b1 == -1) {
                    expectedByte(2, 2);
                }
                if ((b1 & 0xC0) != 0x80) {
            ...
            // Unicode: [zzzz yyyy] [yyxx xxxx]
                ...
                int b2 = index == fOffset ? fInputStream.read() : fBuffer[index++] & 0x00FF;
                if (b2 == -1) {
                    expectedByte(3, 3);
                }
                if ((b2 & 0xC0) != 0x80) {
            ...
            //          * uuuuu = wwww + 1
                ...
                int b3 = index == fOffset ? fInputStream.read() : fBuffer[index++] & 0x00FF;
                if (b3 == -1) {
                    expectedByte(4, 4);
                }
                if ((b3 & 0xC0) != 0x80) {
    ...
    public void mark(int readAheadLimit) throws IOException {
        throw new IOException(
                fFormatter.formatMessage(
                        fLocale, "OperationNotSupported", new Object[] {"mark()", "UTF-8"}));
    } // mark(int)
