...
package org.openjdk.com.sun.org.apache.xerces.internal.impl.xpath;
...
public class XPath {
    ...
    /**
     * Used by the {@link #parseExpression(NamespaceContext)} method to verify the assumption.
     *
     * <p>If <tt>b</tt> is false, this method throws XPathException to report the error.
     */
    ...
    /**
     * Used by the {@link #parseExpression(NamespaceContext)} method to build a {@link LocationPath}
     * object from the accumulated {@link Step}s.
     */
    ...
    /**
     * This method is implemented by using the XPathExprScanner and examining the list of tokens
     * that it returns.
     */
    private void parseExpression(final NamespaceContext context) throws XPathException {
        ...
        // scanner
        XPath.Scanner scanner =
                new XPath.Scanner(fSymbolTable) {
                    protected void addToken(XPath.Tokens tokens, int token) throws XPathException {
                        if (token == XPath.Tokens.EXPRTOKEN_ATSIGN
                ...
                case XPath.Tokens.EXPRTOKEN_PERIOD:
                    {
                        ...
                        if (stepsVector.size() == 0) {
                            ...
                            if (xtokens.hasMore()
                                    && xtokens.peekToken()
                                            == XPath.Tokens.EXPRTOKEN_OPERATOR_DOUBLE_SLASH) {
                                // consume '//'
                                xtokens.nextToken();
    ...
    /** Used by {@link #parseExpression} to parse a node test from the token list. */
    ...
    public static class LocationPath implements Cloneable {
        ...
        public String toString() {
            ...
            for (int i = 0; i < steps.length; i++) {
                if (i > 0
                        && (steps[i - 1].axis.type != Axis.DESCENDANT
    ...
    private static final class Tokens {
        ...
        /**
         * [28] ExprToken ::= '(' | ')' | '[' | ']' | '.' | '..' | '@' | ',' | '::' | NameTest |
         * NodeType | Operator | FunctionName | AxisName | Literal | Number | VariableReference
         */
        ...
        public Tokens(SymbolTable symbolTable) {
            ...
            fTokenNames.put(
                    new Integer(EXPRTOKEN_NAMETEST_NAMESPACE), "EXPRTOKEN_NAMETEST_NAMESPACE");
            ...
            fTokenNames.put(
                    new Integer(EXPRTOKEN_OPERATOR_DOUBLE_SLASH),
                    "EXPRTOKEN_OPERATOR_DOUBLE_SLASH");
            ...
            fTokenNames.put(
                    new Integer(EXPRTOKEN_OPERATOR_NOT_EQUAL), "EXPRTOKEN_OPERATOR_NOT_EQUAL");
            fTokenNames.put(new Integer(EXPRTOKEN_OPERATOR_LESS), "EXPRTOKEN_OPERATOR_LESS");
            fTokenNames.put(
                    new Integer(EXPRTOKEN_OPERATOR_LESS_EQUAL), "EXPRTOKEN_OPERATOR_LESS_EQUAL");
            fTokenNames.put(new Integer(EXPRTOKEN_OPERATOR_GREATER), "EXPRTOKEN_OPERATOR_GREATER");
            fTokenNames.put(
                    new Integer(EXPRTOKEN_OPERATOR_GREATER_EQUAL),
                    "EXPRTOKEN_OPERATOR_GREATER_EQUAL");
            fTokenNames.put(new Integer(EXPRTOKEN_FUNCTION_NAME), "EXPRTOKEN_FUNCTION_NAME");
            fTokenNames.put(
                    new Integer(EXPRTOKEN_AXISNAME_ANCESTOR), "EXPRTOKEN_AXISNAME_ANCESTOR");
            fTokenNames.put(
                    new Integer(EXPRTOKEN_AXISNAME_ANCESTOR_OR_SELF),
                    "EXPRTOKEN_AXISNAME_ANCESTOR_OR_SELF");
            fTokenNames.put(
                    new Integer(EXPRTOKEN_AXISNAME_ATTRIBUTE), "EXPRTOKEN_AXISNAME_ATTRIBUTE");
            fTokenNames.put(new Integer(EXPRTOKEN_AXISNAME_CHILD), "EXPRTOKEN_AXISNAME_CHILD");
            fTokenNames.put(
                    new Integer(EXPRTOKEN_AXISNAME_DESCENDANT), "EXPRTOKEN_AXISNAME_DESCENDANT");
            fTokenNames.put(
                    new Integer(EXPRTOKEN_AXISNAME_DESCENDANT_OR_SELF),
                    "EXPRTOKEN_AXISNAME_DESCENDANT_OR_SELF");
            fTokenNames.put(
                    new Integer(EXPRTOKEN_AXISNAME_FOLLOWING), "EXPRTOKEN_AXISNAME_FOLLOWING");
            fTokenNames.put(
                    new Integer(EXPRTOKEN_AXISNAME_FOLLOWING_SIBLING),
                    "EXPRTOKEN_AXISNAME_FOLLOWING_SIBLING");
            fTokenNames.put(
                    new Integer(EXPRTOKEN_AXISNAME_NAMESPACE), "EXPRTOKEN_AXISNAME_NAMESPACE");
            fTokenNames.put(new Integer(EXPRTOKEN_AXISNAME_PARENT), "EXPRTOKEN_AXISNAME_PARENT");
            fTokenNames.put(
                    new Integer(EXPRTOKEN_AXISNAME_PRECEDING), "EXPRTOKEN_AXISNAME_PRECEDING");
            fTokenNames.put(
                    new Integer(EXPRTOKEN_AXISNAME_PRECEDING_SIBLING),
                    "EXPRTOKEN_AXISNAME_PRECEDING_SIBLING");
            ...
            fTokenNames.put(
                    new Integer(EXPRTOKEN_VARIABLE_REFERENCE), "EXPRTOKEN_VARIABLE_REFERENCE");
        }
         ...
         * XPathException("c-general-xpath");</tt>.
         */
         ...
         * throws <tt>new XPathException("c-general-xpath");</tt>.
         */
    ...
    private static class Scanner {
        ...
        private static final byte[] fASCIICharMap = {
            ...
            0, 0, 0, 2, 3, 4, 1, 5, 1, 1, 4, 6, 7, 8, 9, 10, 11, 12, 13, 14, 14, 14, 14, 14, 14, 14,
            14, 14, 14, 15, 1, 16, 17, 18, 1, 19, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20,
            20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 21, 1, 22, 1, 23, 1, 20, 20, 20,
                ...
                switch (chartype) {
                    ...
                    case CHARTYPE_PERIOD: // '.', '..' or '.' Digits
                        ...
                        if (ch == '.') { // '..'
                            ...
                            currentOffset =
                                    scanNumber(
                                            tokens, data, endOffset, currentOffset /*, encoding*/);
                        } else if (ch == '/') {
                            addToken(tokens, XPath.Tokens.EXPRTOKEN_PERIOD);
                            starIsMultiplyOperator = true;
                            currentOffset++;
                    ...
                    case CHARTYPE_QUOTE: // '\"' or '\''
                        ...
                        tokens.addToken(
                                symbolTable.addSymbol(
                                        data.substring(litOffset, litOffset + litLength)));
                        if (++currentOffset == endOffset) {
                            break;
                        }
                        break;
                    ...
                    case CHARTYPE_DIGIT:
                        ...
                        starIsMultiplyOperator = true;
                        currentOffset =
                                scanNumber(tokens, data, endOffset, currentOffset /*, encoding*/);
                        break;
                        //
                        // [36] VariableReference ::= '$' QName
                        //
                    case CHARTYPE_DOLLAR:
                        ...
                        nameHandle =
                                symbolTable.addSymbol(data.substring(nameOffset, currentOffset));
                        if (ch != ':') {
                    ...
                    case CHARTYPE_UNDERSCORE:
                        ...
                        //
                        //  Otherwise, the token must not be recognized as an OperatorName, a
                        // NodeType, a
                        ...
                        if (isAxisName
                            ...
                            if (nameHandle == fAncestorSymbol) {
                                ...
                                addToken(
                                        tokens, XPath.Tokens.EXPRTOKEN_AXISNAME_DESCENDANT_OR_SELF);
