...
public class XSDDescription extends XMLResourceIdentifierImpl implements XMLSchemaDescription {
     ...
     * xsi:schemaLocation/noNamespaceSchemaLocation attribute(s) in the instance document. This
     * value is only used if we don't defer the loading of schema documents.
     */
    public static final short CONTEXT_INSTANCE = 4;
    /**
     * Indicate that the parse of the current schema document is triggered by the occurrence of an
     * element whose namespace is the target namespace of this schema document. This value is only
     * used if we do defer the loading of schema documents until a component from that namespace is
     * referenced from the instance.
     */
    public static final short CONTEXT_ELEMENT = 5;
    /**
     * Indicate that the parse of the current schema document is triggered by the occurrence of an
     * attribute whose namespace is the target namespace of this schema document. This value is only
     * used if we do defer the loading of schema documents until a component from that namespace is
     * referenced from the instance.
     */
    ...
    /**
     * Indicate that the parse of the current schema document is triggered by the occurrence of an
     * "xsi:type" attribute, whose value (a QName) has the target namespace of this schema document
     * as its namespace. This value is only used if we do defer the loading of schema documents
    ...
    /**
     * If the context is "include" or "redefine", then return the target namespace of the enclosing
     * schema document; otherwise, the expected target namespace of this document.
     *
    ...
    /**
     * For import and references from the instance document, it's possible to have multiple hints
     * for one namespace. So this method returns an array, which contains all location hints.
     *
     * @return an array of all location hints associated to the expected target namespace
     */
    ...
    /**
     * If a call is triggered by an element/attribute/xsi:type in the instance, this call returns
     * the name of such triggering component: the name of the element/attribute, or the value of the
     * xsi:type.
     *
    ...
    /**
     * If a call is triggered by an attribute or xsi:type, then this mehtod returns the enclosing
     * element of such element.
     *
    ...
    /**
     * If a call is triggered by an element/attribute/xsi:type in the instance, this call returns
     * all attribute of such element (or enclosing element).
     *
    ...
    public boolean equals(Object descObj) {
        ...
        if (fNamespace != null) return fNamespace.equals(desc.getTargetNamespace());
