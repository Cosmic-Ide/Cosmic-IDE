...
public class XSParticleDecl implements XSParticle {
    ...
    public String toString() {
        if (fDescription == null) {
            ...
            if (!(fMinOccurs == 0 && fMaxOccurs == 0 || fMinOccurs == 1 && fMaxOccurs == 1)) {
                ...
                if (fMaxOccurs == SchemaSymbols.OCCURRENCE_UNBOUNDED) buffer.append("-UNBOUNDED");
                else if (fMinOccurs != fMaxOccurs) buffer.append('-').append(fMaxOccurs);
                buffer.append('}');
            }
    ...
    /**
     * append the string description of this particle to the string buffer this is for error
     * message.
     */
