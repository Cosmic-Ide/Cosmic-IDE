...
/**
 * Interface for a field activator. The field activator is responsible for activating fields within
 * a specific scope; the caller merely requests the fields to be activated.
 *
 * @xerces.internal
...
public interface FieldActivator {
    ...
    /**
     * Request to activate the specified field. This method returns the matcher for the field. It's
     * also important for the implementor to ensure that it marks whether a Field is permitted to
     * match a value--that is, to call the setMayMatch(Field, Boolean) method.
     *
     * @param field The field to activate.
     * @param initialDepth the 0-indexed depth in the instance document at which the Selector began
     *     to match.
     */
