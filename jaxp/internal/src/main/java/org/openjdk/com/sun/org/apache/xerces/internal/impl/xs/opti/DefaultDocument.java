...
public class DefaultDocument extends NodeImpl implements Document {
    ...
    /**
     * public void setInputEncoding(String actualEncoding){ throw new
    ...
    /**
     * An attribute specifying, as part of the XML declaration, the encoding of this document. This
     * is <code>null</code> when unspecified.
     *
     * @since DOM Level 3 public void setXmlEncoding(String encoding){ throw new
     *     DOMException(DOMException.NOT_SUPPORTED_ERR, "Method not supported"); }
     */
    ...
    /**
     * An attribute specifying whether errors checking is enforced or not. When set to <code>false
     * </code>, the implementation is free to not test every possible error case normally defined on
     * DOM operations, and not raise any <code>DOMException</code>. In case of error, the behavior
    ...
    /**
     * The location of the document or <code>null</code> if undefined. <br>
