 ...
 * general) persist between DOM editing sessions. The <code>normalize()</code> method on <code>Node
 * </code> merges any such adjacent <code>Text</code> objects into a single node for each block of
 * text.
 *
 ...
 *
 * <p>This is an empty implementation.
 *
 * @xerces.internal
 */
public class DefaultText extends NodeImpl implements Text {
     ...
     * into a single <code>DOMString</code>. In such cases, the user may call <code>substringData
     * </code> to retrieve the data in appropriately sized pieces.
     *
    ...
    /**
     * The number of 16-bit units that are available through <code>data</code> and the <code>
     * substringData</code> method below. This may have the value zero, i.e., <code>CharacterData
     ...
     *     negative or greater than the number of 16-bit units in <code>data</code>, or if the
     *     specified <code>count</code> is negative. <br>
     *     DOMSTRING_SIZE_ERR: Raised if the specified range of text does not fit into a <code>
     *     DOMString</code>.
     */
    ...
    /**
     * Append the string to the end of the character data of the node. Upon success, <code>data
     * </code> provides access to the concatenation of <code>data</code> and the <code>DOMString
     * </code> specified.
     *
    ...
    /**
     * Remove a range of 16-bit units from the node. Upon success, <code>data</code> and <code>
     * length</code> reflect the change.
     *
     * @param offset The offset from which to start removing.
     * @param count The number of 16-bit units to delete. If the sum of <code>offset</code> and
     *     <code>count</code> exceeds <code>length</code> then all 16-bit units from <code>offset
     *     </code> to the end of the data are deleted.
     * @exception DOMException INDEX_SIZE_ERR: Raised if the specified <code>offset</code> is
     *     negative or greater than the number of 16-bit units in <code>data</code>, or if the
     *     specified <code>count</code> is negative. <br>
     *     NO_MODIFICATION_ALLOWED_ERR: Raised if this node is readonly.
     ...
     *     <code>count</code> exceeds <code>length</code>, then all 16-bit units to the end of the
     *     data are replaced; (i.e., the effect is the same as a <code>remove</code> method call
     *     with the same range, followed by an <code>append</code> method invocation).
