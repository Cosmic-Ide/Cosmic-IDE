...
public class DefaultXMLDocumentHandler
    ...
    public void startDocument(
            XMLLocator locator, String encoding, NamespaceContext context, Augmentations augs)
            throws XNIException {}
    ...
    /**
     * The start of a namespace prefix mapping. This method will only be called when namespace
    ...
    /**
     * The end of a namespace prefix mapping. This method will only be called when namespace
     * processing is enabled.
     *
     * @param prefix The namespace prefix.
     * @param augs Additional information that may include infoset augmentations
    ...
    */
     ...
     *
     * @param name The name of the entity.
     * @param identifier An object containing all location information pertinent to this unparsed
     *     entity declaration.
