 ...
 *
 * <p>&lt;any id = ID maxOccurs = (nonNegativeInteger | unbounded) : 1 minOccurs =
 * nonNegativeInteger : 1 namespace = ((##any | ##other) | List of (anyURI | (##targetNamespace |
 * ##local)) ) : ##any processContents = (lax | skip | strict) : strict {any attributes with
 * non-schema namespace . . .}&gt; Content: (annotation?) &lt;/any&gt;
 *
 * <p>&lt;anyAttribute id = ID namespace = ((##any | ##other) | List of (anyURI | (##targetNamespace
 * | ##local)) ) : ##any processContents = (lax | skip | strict) : strict {any attributes with
 * non-schema namespace . . .}&gt; Content: (annotation?) &lt;/anyAttribute&gt;
 *
 * @xerces.internal
...
class XSDWildcardTraverser extends XSDAbstractTraverser {
     ...
     * @return the wildcard node index
     */
    XSWildcardDecl traverseAnyAttribute(
     ...
     * @return the wildcard node index
     */
    XSWildcardDecl traverseWildcardDecl(
