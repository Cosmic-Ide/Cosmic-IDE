 ...
 * #compare(Duration)} method implements this relationship.
 *
 ...
 *
 * <p>Also, division of a duration by a number is not provided because the {@link Duration} class
 * can only deal with finite precision decimal numbers. For example, one cannot represent 1 sec
 * divided by 3.
 *
 ...
 *
 * <p>Because some operations of {@link Duration} rely on {@link Calendar} even though {@link
 * Duration} can hold very large or very small values, some of the methods may not work correctly on
 * such {@link Duration}s. The impacted methods document their dependency on {@link Calendar}.
 *
...
class DurationImpl extends Duration implements Serializable {
    ...
    /** Years of this <code>Duration</code>. */
    /**
     * These were final since Duration is immutable. But new subclasses need to be able to set after
     * conversion. It won't break the immutable nature of them since there's no other way to set new
     * values to them
     */
    ...
    /** Days of this <code>Duration</code>. */
    protected BigInteger days;

    /** Hours of this <code>Duration</code>. */
    protected BigInteger hours;

    /** Minutes of this <code>Duration</code>. */
    protected BigInteger minutes;

    /** Seconds of this <code>Duration</code>. */
     ...
     *
     * <p>All the parameters are optional as long as at least one field is present. If specified,
     * parameters have to be zero or positive.
     *
     ...
     * @throws IllegalArgumentException If years, months, days, hours, minutes and seconds
     *     parameters are all <code>null</code>. Or if any of those parameters are negative.
     */
    ...
    /**
     * Makes sure that the given number is non-negative. If it is not, throw {@link
        ...
        if (n != null && n.signum() < 0) {
            throw new IllegalArgumentException(
                    DatatypeMessageFormatter.formatMessage(
                            null, "NegativeField", new Object[] {f.toString()}));
        }
    }
     ...
     * Constructs a new Duration object by specifying each field individually.
     *
     * <p>This method is functionally equivalent to invoking another constructor by wrapping all
     * non-zero parameters into {@link BigInteger} and {@link BigDecimal}. Zero value of int
     * parameter is equivalent of null value of the corresponding field.
     *
    ...
    protected DurationImpl(final long durationInMilliSeconds) {
        ...
        int2long =
                (gregorianCalendar.get(Calendar.SECOND) * 1000)
                        + gregorianCalendar.get(Calendar.MILLISECOND);
        this.seconds = BigDecimal.valueOf(int2long, 3);
    }

    /**
     * Constructs a new Duration object by parsing its string representation "PnYnMnDTnHnMnS" as
     * defined in XML Schema 1.0 section 3.2.6.1.
     *
     * <p>The string representation may not have any leading and trailing whitespaces.
     *
     * <p>For example, this method parses strings like "P1D" (1 day), "-PT100S" (-100 sec.),
     * "P1DT12H" (1 days and 12 hours).
     *
     ...
     * </pre>
     *
     * Returns a non-null valid duration object that holds the value indicated by the
    ...
    private static void organizeParts(
            String whole, String[] parts, int[] partsIndex, int len, String tokens)
     ...
     *
     * <ul>
     *   <li>{@link DatatypeConstants#LESSER} if this <code>Duration</code> is shorter than <code>
     *       duration</code> parameter
     *   <li>{@link DatatypeConstants#EQUAL} if this <code>Duration</code> is equal to <code>
     *       duration</code> parameter
     *   <li>{@link DatatypeConstants#GREATER} if this <code>Duration</code> is longer than <code>
     *       duration</code> parameter
     *   <li>{@link DatatypeConstants#INDETERMINATE} if a conclusive partial order relation cannot
     *       be determined
     * </ul>
     *
     * @param duration to compare
     * @return the relationship between <code>this</code> <code>Duration</code>and <code>duration
     *     </code> parameter as {@link DatatypeConstants#LESSER}, {@link DatatypeConstants#EQUAL},
     *     {@link DatatypeConstants#GREATER} or {@link DatatypeConstants#INDETERMINATE}.
     ...
     *     EQUAL if the order relation between date1 and date2 is EQUAL. If the strict parameter is
     *     true, return LESS_THAN if date1 is less than date2 and return GREATER_THAN if date1 is
     *     greater than date2. If the strict parameter is false, return LESS_THAN if date1 is less
     *     than OR equal to date2 and return GREATER_THAN if date1 is greater than OR equal to date2
     */
     ...
     *
     * <p>The result is formatter according to the XML Schema 1.0 spec and can be always parsed back
     * later into the equivalent duration object by the {@link #DurationImpl(String)} constructor.
     *
     * <p>Formally, the following holds for any {@link Duration} object x.
     *
     * <pre>
     * new Duration(x.toString()).equals(x)
     * </pre>
    ...
    public boolean isSet(DatatypeConstants.Field field) {
        ...
        if (field == null) {
            ...
            throw new NullPointerException(
                    ...
                    DatatypeMessageFormatter.formatMessage(
                            null, "FieldCannotBeNull", new Object[] {methodName}));
        }
        ...
        String methodName =
                "org.openjdk.javax.xml.datatype.Duration" + "#isSet(DatatypeConstants.Field field)";

        throw new IllegalArgumentException(
                DatatypeMessageFormatter.formatMessage(
                        null, "UnknownField", new Object[] {methodName, field.toString()}));
    }
     ...
     *     MONTHS, DAYS, HOURS, and MINUTES, this method returns a {@link BigInteger} object. For
    ...
    public Number getField(DatatypeConstants.Field field) {
        ...
        /**
         * throw new IllegalArgumentException( "org.openjdk.javax.xml.datatype.Duration" +
     ...
     *
     * <p>This method is a convenience method around the {@link #getField(DatatypeConstants.Field)}
     * method.
     *
     * <p>Note that since this method returns <tt>int</tt>, this method will return an incorrect
     * value for {@link Duration}s with the year field that goes beyond the range of <tt>int</tt>.
     ...
     *
     * <p>If field is not set, i.e. == null, 0 is returned.
     *
     ...
     * </pre>
     *
     * <p>Since the {@link Duration} class is immutable, this method doesn't change the value of
     ...
     *
     * <p>If the field is unset, return 0.
     *
    ...
    /** 1 unit of FIELDS[i] is equivalent to <code>FACTORS[i]</code> unit of FIELDS[i+1]. */
     ...
     *
     * <p>Firstly, we can assume that two {@link Duration}s to be added are both positive without
     * losing generality (i.e., <code>(-X)+Y=Y-X</code>, <code>X+(-Y)=X-Y</code>, <code>
     * (-X)+(-Y)=-(X+Y)</code>)
     *
     * <p>Addition of two positive {@link Duration}s are simply defined as field by field addition
     * where missing fields are treated as 0.
     *
     * <p>A field of the resulting {@link Duration} will be unset if and only if respective fields
     * of two input {@link Duration}s are unset.
     *
    ...
    public Duration add(final Duration rhs) {
        ...
        buf[0] =
                sanitize((BigInteger) lhs.getField(DatatypeConstants.YEARS), lhs.getSign())
                        .add(
                                sanitize(
                                        (BigInteger) rhs.getField(DatatypeConstants.YEARS),
                                        rhs.getSign()));
        buf[1] =
                sanitize((BigInteger) lhs.getField(DatatypeConstants.MONTHS), lhs.getSign())
                        .add(
                                sanitize(
                                        (BigInteger) rhs.getField(DatatypeConstants.MONTHS),
                                        rhs.getSign()));
        buf[2] =
                sanitize((BigInteger) lhs.getField(DatatypeConstants.DAYS), lhs.getSign())
                        .add(
                                sanitize(
                                        (BigInteger) rhs.getField(DatatypeConstants.DAYS),
                                        rhs.getSign()));
        buf[3] =
                sanitize((BigInteger) lhs.getField(DatatypeConstants.HOURS), lhs.getSign())
                        .add(
                                sanitize(
                                        (BigInteger) rhs.getField(DatatypeConstants.HOURS),
                                        rhs.getSign()));
        buf[4] =
                sanitize((BigInteger) lhs.getField(DatatypeConstants.MINUTES), lhs.getSign())
                        .add(
                                sanitize(
                                        (BigInteger) rhs.getField(DatatypeConstants.MINUTES),
                                        rhs.getSign()));
        buf[5] =
                sanitize((BigDecimal) lhs.getField(DatatypeConstants.SECONDS), lhs.getSign())
                        .add(
                                sanitize(
                                        (BigDecimal) rhs.getField(DatatypeConstants.SECONDS),
                                        rhs.getSign()));
        ...
        return new DurationImpl(
                ...
                (buf[5].signum() == 0
                                ...
                                && rhs.getField(DatatypeConstants.SECONDS) == null)
                        ? null
                        : sanitize(buf[5], s));
    }
    ...
    /**
     * Compute <code>value*signum</code> where <code>value==null</code> is treated as <code>value==0
     * </code>.
     *
     * @param value Value to sanitize.
     * @param signum 0 to sanitize to 0, > 0 to sanitize to <code>value</code>, < 0 to sanitize to
     ...
     * the operation fails in {@link IllegalStateException}.
     *
     * <p>Formally the computation is defined as follows. First, we can assume that two {@link
     * Duration}s are both positive without losing generality. (i.e., <code>(-X)-Y=-(X+Y)</code>,
     * <code>X-(-Y)=X+Y</code>, <code>(-X)-(-Y)=-(X-Y)</code>)
     *
     * <p>Then two durations are subtracted field by field. If the sign of any non-zero field
     * <tt>F</tt> is different from the sign of the most significant field, 1 (if <tt>F</tt> is
     * negative) or -1 (otherwise) will be borrowed from the next bigger unit of <tt>F</tt>.
     *
     ...
     *
     * <p>Any fractional parts of this {@link Duration} object beyond milliseconds will be simply
     * ignored. For example, if this duration is "P1.23456S", then 1 is added to SECONDS, 234 is
     * added to MILLISECONDS, and the rest will be unused.
     *
     * <p>Note that because {@link Calendar#add(int, int)} is using <tt>int</tt>, {@link Duration}
     * with values beyond the range of <tt>int</tt> in its fields will cause overflow/underflow to
     * the given {@link Calendar}. {@link XMLGregorianCalendar#add(Duration)} provides the same
     * basic operation as this method while avoiding the overflow/underflow issues.
     *
    ...
    private static class DurationStream implements Serializable {
        ...
        private Object readResolve() throws ObjectStreamException {
            ...
            //                throw new StreamCorruptedException("unable to parse "+lexical+" as
            // duration");
            //            }
        }
     ...
     *
     * <p>In future, this should be replaced by <code>cal.getTimeInMillis()</code>
     */
