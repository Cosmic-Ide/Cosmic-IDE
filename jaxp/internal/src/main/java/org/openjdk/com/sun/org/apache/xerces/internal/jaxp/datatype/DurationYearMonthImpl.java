...
/**
 * Represent a subtype <code>xdt:yearMonthDuration</code> of a <code>Duration</code> as specified in
 * <a href="http://www.w3.org/TR/xpath-datamodel#yearMonthDuration">XQuery 1.0 and XPath 2.0 Data
 * Model, xdt:yearMonthDuration</a>.
 *
 * <p>The DurationYearMonth object represents a period of Gregorian time, with a lexical
 * representation, "<em>PnYnM</em>" that contains only year and month components.
 *
...
class DurationYearMonthImpl extends DurationImpl {
     ...
     * @throws IllegalArgumentException If years, months parameters are all <code>null</code>. Or if
    ...
    /**
     * Construct a <code>Duration</code> of type <code>xdt:yearMonthDuration</code> using the
    ...
    /**
     * Construct a <code>Duration</code> of type <code>xdt:yearMonthDuration</code> using the
     * specified milliseconds as defined in <a
     * href="http://www.w3.org/TR/xpath-datamodel#yearMonthDuration">XQuery 1.0 and XPath 2.0 Data
     * Model, xdt:yearMonthDuration</a>.
     *
     ...
     * in the namespace {@link org.openjdk.javax.xml.XMLConstants#W3C_XPATH_DATATYPE_NS_URI}.
     *
    ...
    /**
     * Construct a <code>Duration</code> of type <code>xdt:yearMonthDuration</code> by parsing its
