...
import org.openjdk.com.sun.org.apache.xerces.internal.dom.DeferredDocumentImpl;
import org.openjdk.com.sun.org.apache.xerces.internal.dom.DocumentImpl;
import org.openjdk.com.sun.org.apache.xerces.internal.dom.DocumentTypeImpl;
import org.openjdk.com.sun.org.apache.xerces.internal.dom.ElementDefinitionImpl;
...
import org.openjdk.com.sun.org.apache.xerces.internal.dom.EntityImpl;
import org.openjdk.com.sun.org.apache.xerces.internal.dom.EntityReferenceImpl;
import org.openjdk.com.sun.org.apache.xerces.internal.dom.NodeImpl;
import org.openjdk.com.sun.org.apache.xerces.internal.dom.NotationImpl;
...
import org.openjdk.com.sun.org.apache.xerces.internal.dom.TextImpl;
...
/**
 * This is the base class of all DOM parsers. It implements the XNI callback methods to create the
 * DOM tree. After a successful parse of an XML document, the DOM Document object can be queried
 * using the <code>getDocument</code> method. The actual pipeline is defined in parser
 * configuration.
 *
...
public class AbstractDOMParser extends AbstractXMLDocumentParser {
    ...
    private static final String[] RECOGNIZED_PROPERTIES = {
        DOCUMENT_CLASS_NAME, CURRENT_ELEMENT_NODE,
    };
    ...
    /**
     * This method allows the programmer to decide which document factory to use when constructing
     * the DOM tree. However, doing so will lose the functionality of the default factory. Also, a
     * document class other than the default will lose the ability to defer node expansion on the
     * DOM tree produced.
     *
    ...
    public void startGeneralEntity(
        ...
        if (DEBUG_EVENTS) {
            ...
            if (DEBUG_BASEURI) {
                System.out.println(
                        "   expandedSystemId( **baseURI): " + identifier.getExpandedSystemId());
        ...
        if (!fDeferNodeExpansion) {
            ...
            int er =
                    fDeferredDocumentImpl.createDeferredEntityReference(
                            name, identifier.getExpandedSystemId());
    ...
    public void textDecl(String version, String encoding, Augmentations augs) throws XNIException {
        ...
        if (!fDeferNodeExpansion) {
            if (fCurrentEntityDecl != null && !fFilterReject) {
                ...
                if (version != null) fCurrentEntityDecl.setXmlVersion(version);
            }
        } else {
    ...
    public void processingInstruction(String target, XMLString data, Augmentations augs)
        ...
        if (!fDeferNodeExpansion) {
            ...
            int pi =
                    fDeferredDocumentImpl.createDeferredProcessingInstruction(
            ...
            if (fDocumentClassName.equals(DEFAULT_DOCUMENT_CLASS_NAME)) {
                ...
                try {
                    ...
                    if (defaultDocClass.isAssignableFrom(documentClass)) {
                        ...
                        Class psviDocClass =
                                ObjectFactory.findProviderClass(PSVI_DOCUMENT_CLASS_NAME, true);
    ...
    public void xmlDecl(String version, String encoding, String standalone, Augmentations augs)
        ...
        if (!fDeferNodeExpansion) {
            ...
            //          instead of specific class
            if (fDocumentImpl != null) {
                if (version != null) fDocumentImpl.setXmlVersion(version);
                fDocumentImpl.setXmlEncoding(encoding);
                fDocumentImpl.setXmlStandalone("yes".equals(standalone));
            }
        } else {
            if (version != null) fDeferredDocumentImpl.setXmlVersion(version);
    ...
    public void doctypeDecl(
        ...
        if (!fDeferNodeExpansion) {
            ...
            fDocumentTypeIndex =
                    fDeferredDocumentImpl.createDeferredDocumentType(
    ...
    public void startElement(QName element, XMLAttributes attributes, Augmentations augs)
        ...
        if (!fDeferNodeExpansion) {
            ...
            int el =
                    fDeferredDocumentImpl.createDeferredElement(
                            fNamespaceAware ? element.uri : null, element.rawname);
            Object type = null;
            int attrCount = attributes.getLength();
    ...
    public void endGeneralEntity(String name, Augmentations augs) throws XNIException {
        ...
        if (!fDeferNodeExpansion) {
            ...
            if (fCreateEntityRefNodes) {
                ...
                if (lastChild != -1) fDeferredDocumentImpl.setAsLastChild(parentIndex, lastChild);
                else {
    ...
    /**
     * Record baseURI information for the Element (by adding xml:base attribute) or for the
     * ProcessingInstruction (by setting a baseURI field) Non deferred DOM.
     *
     * @param node
     */
    ...
    /**
     * Record baseURI information for the Element (by adding xml:base attribute) or for the
     * ProcessingInstruction (by setting a baseURI field) Deferred DOM.
     *
     * @param node
     */
    protected final void handleBaseURI(int node) {
        ...
        if (nodeType == Node.ELEMENT_NODE) {
            ...
            if (baseURI != null && !baseURI.equals(fDeferredDocumentImpl.getDocumentURI())) {
                fDeferredDocumentImpl.setDeferredAttribute(
                        node, "xml:base", "http://www.w3.org/XML/1998/namespace", baseURI, true);
            }
        } else if (nodeType == Node.PROCESSING_INSTRUCTION_NODE) {
    ...
    public void endDTD(Augmentations augs) throws XNIException {
        ...
        String internalSubset =
                fInternalSubset != null && fInternalSubset.length() > 0
                        ? fInternalSubset.toString()
                        : null;
        if (fDeferNodeExpansion) {
    ...
    public void startConditional(short type, Augmentations augs)
            throws XNIException {} // startConditional(short)
     ...
     *
     * @param name The name of the entity. Parameter entity names start with '%', whereas the name
     *     of a general entity is just the entity name.
    ...
    public void internalEntityDecl(
            String name, XMLString text, XMLString nonNormalizedText, Augmentations augs)
            throws XNIException {
            ...
            if (!found) {
                int entityIndex =
                        fDeferredDocumentImpl.createDeferredEntity(
                                name, null, null, null, (String) fBaseURIStack.peek());
    ...
    public void externalEntityDecl(
            String name, XMLResourceIdentifier identifier, Augmentations augs) throws XNIException {
    ...
    /**
     * This method notifies of the start of a parameter entity. The parameter entity name start with
     * a '%' character.
     *
    ...
    /**
     * This method notifies the end of a parameter entity. Parameter entity names begin with a '%'
     * character.
     *
     * @param name The name of the parameter entity.
     * @param augs Additional information that may include infoset augmentations.
    ...
    public void notationDecl(String name, XMLResourceIdentifier identifier, Augmentations augs)
        ...
        if (fDocumentTypeIndex != -1) {
            ...
            if (!found) {
                int notationIndex =
                        fDeferredDocumentImpl.createDeferredNotation(
    ...
    public void ignoredCharacters(XMLString text, Augmentations augs)
            throws XNIException {} // ignoredCharacters(XMLString, Augmentations)
     ...
     * @param enumeration If the type has the value "ENUMERATION" or "NOTATION", this array holds
     *     the allowed attribute values; otherwise, this array is null.
    ...
    public void attributeDecl(
        ...
        if (fDeferredDocumentImpl != null) {
            ...
            if (defaultValue != null) {
                ...
                if (elementDefIndex == -1) {
                    elementDefIndex =
                            fDeferredDocumentImpl.createDeferredElementDefinition(elementName);
                ...
                int attrIndex =
                        fDeferredDocumentImpl.createDeferredAttribute(
        ...
        // full expansion
            ...
            if (defaultValue != null) {
                ...
                ElementDefinitionImpl elementDef =
                        (ElementDefinitionImpl) elements.getNamedItem(elementName);
                if (elementDef == null) {
    ...
    public void startAttlist(String elementName, Augmentations augs)
            throws XNIException {} // startAttlist(String)
     ...
     * @throws XNIException Thrown by handler to signal an error.
     */
    public void endAttlist(Augmentations augs) throws XNIException {} // endAttlist()
            ...
            if (fDocumentImpl != null) {
                ...
                attr =
                        fDocumentImpl.createAttributeNS(
                                attrQName.uri, attrQName.rawname, attrQName.localpart);
            } else {
