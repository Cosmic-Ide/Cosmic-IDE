...
import org.openjdk.com.sun.org.apache.xerces.internal.util.EntityResolver2Wrapper;
import org.openjdk.com.sun.org.apache.xerces.internal.util.EntityResolverWrapper;
...
import org.openjdk.com.sun.org.apache.xerces.internal.xs.PSVIProvider;
...
/**
 * This is the base class of all SAX parsers. It implements both the SAX1 and SAX2 parser
 * functionality, while the actual pipeline is defined in the parser configuration.
 *
                ...
                XMLReader // SAX1, SAX2
{
    ...
    private static final String[] RECOGNIZED_FEATURES = {
        NAMESPACES, NAMESPACE_PREFIXES, STRING_INTERNING,
    };
    ...
    private static final String[] RECOGNIZED_PROPERTIES = {
        LEXICAL_HANDLER, DECLARATION_HANDLER, DOM_NODE,
    };
    ...
    /**
     * True if a parse is in progress. This state is needed because some features/properties cannot
     * be set while parsing (e.g. validation and namespaces).
     */
     ...
     * parameter entity names start with '%'; and general entity names are just the entity name.
     *
     * <p><strong>Note:</strong> Since the document is an entity, the handler will be notified of
     * the start of the document entity by calling the startEntity method with the entity name
     * "[xml]" <em>before</em> calling the startDocument method. When exposing entity boundaries
     * through the SAX API, the document entity is never reported, however.
     *
     ...
     * entity names start with '%'; and general entity names are just the entity name.
     *
     * <p><strong>Note:</strong> Since the document is an entity, the handler will be notified of
     * the end of the document entity by calling the endEntity method with the entity name "[xml]"
     * <em>after</em> calling the endDocument method. When exposing entity boundaries through the
    ...
    /**
     * This method notifies of the start of parameter entity. The DTD has the pseudo-name of "[dtd]"
     * parameter entity names start with '%'; and general entity names are just the entity name.
     *
     * <p><strong>Note:</strong> Since the document is an entity, the handler will be notified of
     * the start of the document entity by calling the startEntity method with the entity name
    ...
    public void attributeDecl(
        ...
        try {
            ...
            if (fDeclHandler != null) {
                ...
                String elemAttr =
                        new StringBuffer(elementName).append("<").append(attributeName).toString();
        ...
        try {
            ...
            if (fUseEntityResolver2 && resolver instanceof EntityResolver2) {
                ...
                if (xer instanceof EntityResolverWrapper) {
                    ...
                    fConfiguration.setProperty(
                            ENTITY_RESOLVER, new EntityResolverWrapper(resolver));
                }
            }
        } catch (XMLConfigurationException e) {
            // do nothing
     ...
     * @exception SAXException An exception thrown if the parser does not support the specified
     *     locale.
     ...
     *
     * <p>If the application does not register a document handler, all document events reported by
     * the SAX parser will be silently ignored (this is the default behaviour implemented by
     * HandlerBase).
     *
     * <p>Applications may register a new or different handler in the middle of a parse, and the SAX
     * parser must begin using the new handler immediately.
    ...
    /**
     * Set the state of any feature in a SAX2 parser. The parser might not recognize the feature,
     ...
     * @exception SAXNotSupportedException If the requested feature is known, but the requested
        ...
        try {
            ...
            if (featureId.startsWith(Constants.SAX_FEATURE_PREFIX)) {
                ...
                if (suffixLength == Constants.LEXICAL_HANDLER_PARAMETER_ENTITIES_FEATURE.length()
                        && featureId.endsWith(
                                Constants.LEXICAL_HANDLER_PARAMETER_ENTITIES_FEATURE)) {
     ...
     *
     * <p>Query the current state of any feature in a SAX2 parser. The parser might not recognize
     * the feature.
     *
        ...
        try {
            ...
            if (propertyId.startsWith(Constants.SAX_PROPERTY_PREFIX)) {
                final int suffixLength =
                        propertyId.length() - Constants.SAX_PROPERTY_PREFIX.length();
                    ...
                    try {
                        ...
                        throw new SAXNotSupportedException(
                                SAXMessageFormatter.formatMessage(
                                        ...
                                        "incompatible-class",
                                        new Object[] {
                                            propertyId, "org.xml.sax.ext.LexicalHandler"
                                        }));
                    }
                    return;
                }
                    ...
                    try {
                        ...
                        throw new SAXNotSupportedException(
                                SAXMessageFormatter.formatMessage(
                                        fConfiguration.getLocale(),
                                        "incompatible-class",
                                        new Object[] {propertyId, "org.xml.sax.ext.DeclHandler"}));
                    }
                    return;
                }
                //
     ...
     *
     * <p>Return the current value of a property in a SAX2 parser. The parser might not recognize
     * the property.
     *
     * @param propertyId The unique identifier (URI) of the property being set.
     ...
     * Set the DTD declaration event handler.
     *
     * <p>This method is the equivalent to the property:
     *
     * <pre>
     * http://xml.org/sax/properties/declaration-handler
     * </pre>
    ...
    public ElementPSVI getElementPSVI() {
        return (fAugmentations != null)
                ? (ElementPSVI) fAugmentations.getItem(Constants.ELEMENT_PSVI)
                : null;
    }
    ...
    public AttributePSVI getAttributePSVIByName(String uri, String localname) {
        return (AttributePSVI)
                fAttributesProxy
                        .fAttributes
                        .getAugmentations(uri, localname)
                        .getItem(Constants.ATTRIBUTE_PSVI);
    }
