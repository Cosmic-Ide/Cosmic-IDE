...
/**
 * This is the base class for all XML document parsers. XMLDocumentParser provides a common
 * implementation shared by the various document parsers in the Xerces package. While this class is
 * provided for convenience, it does not prevent other kinds of parsers to be constructed using the
 * XNI interfaces.
 *
...
public abstract class AbstractXMLDocumentParser extends XMLParser
    ...
    public void startDocument(
            ...
            Augmentations augs)
            throws XNIException {} // startDocument(XMLLocator,String)
    ...
    public void xmlDecl(String version, String encoding, String standalone, Augmentations augs)
            throws XNIException {} // xmlDecl(String,String,String)
    ...
    public void doctypeDecl(
            ...
            throws XNIException {} // doctypeDecl(String,String,String)
    ...
    public void startElement(QName element, XMLAttributes attributes, Augmentations augs)
            throws XNIException {} // startElement(QName,XMLAttributes)
    ...
    public void characters(XMLString text, Augmentations augs)
            throws XNIException {} // characters(XMLString)
    ...
    public void ignorableWhitespace(XMLString text, Augmentations augs)
            throws XNIException {} // ignorableWhitespace(XMLString)
    ...
    public void endElement(QName element, Augmentations augs)
            throws XNIException {} // endElement(QName)
     ...
     * @throws XNIException Thrown by handler to signal an error.
     */
    public void startCDATA(Augmentations augs) throws XNIException {} // startCDATA()
     ...
     * @throws XNIException Thrown by handler to signal an error.
     */
    public void endCDATA(Augmentations augs) throws XNIException {} // endCDATA()
     ...
     * @throws XNIException Thrown by handler to signal an error.
     */
    public void endDocument(Augmentations augs) throws XNIException {} // endDocument()
    ...
    public void startGeneralEntity(
            ...
            throws
                    XNIException {} // startGeneralEntity(String,XMLResourceIdentifier,String,Augmentations)
    ...
    public void textDecl(String version, String encoding, Augmentations augs)
            throws XNIException {} // textDecl(String, String, Augmentations)
    ...
    public void endGeneralEntity(String name, Augmentations augs)
            throws XNIException {} // endGeneralEntity(String,Augmentations)
    ...
    public void comment(XMLString text, Augmentations augs)
            throws XNIException {} // comment (XMLString, Augmentations)
    ...
    public void processingInstruction(String target, XMLString data, Augmentations augs)
            throws XNIException {} // processingInstruction(String, XMLString, Augmentations)
    ...
    public void startExternalSubset(XMLResourceIdentifier identifier, Augmentations augmentations)
            throws XNIException {} // startExternalSubset(Augmentations)
    ...
    public void endExternalSubset(Augmentations augmentations)
            throws XNIException {} // endExternalSubset(Augmentations)
    ...
    public void startParameterEntity(
            String name, XMLResourceIdentifier identifier, String encoding, Augmentations augs)
            throws
                    XNIException {} // startParameterEntity(String,XMLResourceIdentifier,String,Augmentations)
    ...
    public void endParameterEntity(String name, Augmentations augs)
            throws XNIException {} // endParameterEntity(String,Augmentations)
    ...
    public void elementDecl(String name, String contentModel, Augmentations augs)
            throws XNIException {} // elementDecl(String,String)
    ...
    public void notationDecl(String name, XMLResourceIdentifier identifier, Augmentations augs)
            throws XNIException {} // notationDecl(String,XMLResourceIdentifier, Augmentations)
    ...
    public void startContentModel(String elementName, Augmentations augs)
            throws XNIException {} // startContentModel(String, Augmentations)
     ...
     * @see #startGroup
     */
    public void any(Augmentations augs) throws XNIException {} // any(Augmentations)
     ...
     * @see #startGroup
     */
    public void empty(Augmentations augs) throws XNIException {} // empty(Augmentations)
     ...
     * @see #empty
     */
    public void startGroup(Augmentations augs) throws XNIException {} // stargGroup(Augmentations)
     ...
     * @see #startGroup
     */
    public void pcdata(Augmentations augs) throws XNIException {} // pcdata(Augmentations)
    ...
    public void element(String elementName, Augmentations augs)
            throws XNIException {} // element(String, Augmentations)
    ...
    public void separator(short separator, Augmentations augs)
            throws XNIException {} // separator(short, Augmentations)
    ...
    public void occurrence(short occurrence, Augmentations augs)
            throws XNIException {} // occurence(short, Augmentations)
    ...
    public void endContentModel(Augmentations augs)
            throws XNIException {} // endContentModel(Augmentations)
