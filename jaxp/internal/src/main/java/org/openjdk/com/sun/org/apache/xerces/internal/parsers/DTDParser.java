...
import org.openjdk.com.sun.org.apache.xerces.internal.impl.dtd.XMLElementDecl;
...
public abstract class DTDParser extends XMLGrammarParser
     ...
     * start of the DTD entity by calling the startEntity method with the entity name "[dtd]"
     * <em>before</em> calling the startDTD method.
     *
     * @param name The name of the entity.
     * @param publicId The public identifier of the entity if the entity is external, null
     *     otherwise.
     * @param systemId The system identifier of the entity if the entity is external, null
     *     otherwise.
    ...
    public void processingInstruction(String target, XMLString data, Augmentations augmentations)
            throws XNIException {} // processingInstruction
    ...
    public void startExternalSubset(XMLResourceIdentifier identifier, Augmentations augmentations)
            throws XNIException {} // startExternalSubset
    ...
    public void endExternalSubset(Augmentations augmentations)
            throws XNIException {} // endExternalSubset
    ...
    public void elementDecl(String name, String contentModel, Augmentations augmentations)
            throws XNIException {} // elementDecl
    ...
    public void startAttlist(String elementName, Augmentations augmentations)
            throws XNIException {} // startAttlist
    ...
    public void attributeDecl(
            ...
            throws XNIException {} // attributeDecl
     ...
     * @throws XNIException Thrown by handler to signal an error.
     */
    public void endAttlist(Augmentations augmentations) throws XNIException {} // endAttlist
    ...
    public void internalEntityDecl(
            ...
            throws XNIException {} // internalEntityDecl(String,XMLString,XMLString)
    ...
    public void externalEntityDecl(
            ...
            throws XNIException {} // externalEntityDecl
    ...
    public void unparsedEntityDecl(
            ...
            String notation,
            Augmentations augmentations)
            throws XNIException {} // unparsedEntityDecl
    ...
    public void notationDecl(
            String name, XMLResourceIdentifier identifier, Augmentations augmentations)
            throws XNIException {} // notationDecl
    ...
    public void startConditional(short type, Augmentations augmentations)
            throws XNIException {} // startConditional
     ...
     * @throws XNIException Thrown by handler to signal an error.
     */
    public void endConditional(Augmentations augmentations) throws XNIException {} // endConditional
     ...
     * @throws XNIException Thrown by handler to signal an error.
     */
    public void endDTD(Augmentations augmentations) throws XNIException {} // endDTD
     ...
     * @throws XNIException Thrown by handler to signal an error.
     * @see XMLElementDecl#TYPE_EMPTY
     * @see XMLElementDecl#TYPE_ANY
     * @see XMLElementDecl#TYPE_MIXED
     * @see XMLElementDecl#TYPE_CHILDREN
     */
    public void startContentModel(String elementName, short type)
            throws XNIException {} // startContentModel

    /**
     * A referenced element in a mixed content model. If the mixed content model only allows text
     * content, then this method will not be called for that model. However, if this method is
     * called for a mixed content model, then the zero or more occurrence count is implied.
     *
     * <p><strong>Note:</strong> This method is only called after a call to the startContentModel
     * method where the type is TYPE_MIXED.
     *
     * @param elementName The name of the referenced element.
     * @throws XNIException Thrown by handler to signal an error.
     * @see XMLElementDecl#TYPE_MIXED
     */
    public void mixedElement(String elementName) throws XNIException {} // mixedElement

    /**
     * The start of a children group.
     *
     * <p><strong>Note:</strong> This method is only called after a call to the startContentModel
     * method where the type is TYPE_CHILDREN.
     *
     * <p><strong>Note:</strong> Children groups can be nested and have associated occurrence
     * counts.
     *
     * @throws XNIException Thrown by handler to signal an error.
     * @see XMLElementDecl#TYPE_CHILDREN
     */
    public void childrenStartGroup() throws XNIException {} // childrenStartGroup
     ...
     * @see XMLElementDecl#TYPE_CHILDREN
     */
    public void childrenElement(String elementName) throws XNIException {} // childrenElement
     ...
     * @see XMLElementDecl#TYPE_CHILDREN
     */
    public void childrenSeparator(short separator) throws XNIException {} // childrenSeparator
     ...
     * method where the type is TYPE_CHILDREN.
     *
     * @param occurrence The occurrence count for the last children element or children group.
     * @throws XNIException Thrown by handler to signal an error.
     ...
     * @see XMLElementDecl#TYPE_CHILDREN
     */
    public void childrenOccurrence(short occurrence) throws XNIException {} // childrenOccurrence
     ...
     * @see XMLElementDecl#TYPE_CHILDREN
     */
    public void childrenEndGroup() throws XNIException {} // childrenEndGroup
     ...
     * @throws XNIException Thrown by handler to signal an error.
     */
    public void endContentModel() throws XNIException {} // endContentModel
} // class DTDParser
