...
public class DOMErrorHandlerWrapper implements XMLErrorHandler, DOMErrorHandler {
    ...
    private static class DOMErrorTypeMap {
        ...
        static {
            // initialize error type table: internal error codes (represented by domain and key)
            // need to be mapped to a DOM error type.

            // REVISIT: do well-formedness issues involving XML declaration <?xml ... ?> need to be
            // added to hash table (no XML declaration node in DOM, but Document includes
            // xmlEncoding, xmlStandalone, xmlVersion, etc.
            ...
            fgDOMErrorTypeTable.put(
                    ...
                    "doctype-not-allowed");
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(XMLMessageFormatter.XML_DOMAIN, "ETagRequired"),
                    "wf-invalid-character-in-node-name");
            fgDOMErrorTypeTable.put(
            ...
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN, "MarkupNotRecognizedInContent"),
                    "wf-invalid-character");
            fgDOMErrorTypeTable.put(
            ...
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN, "EncodingByteOrderUnsupported"),
                    "unsupported-encoding");
            fgDOMErrorTypeTable.put(
            ...
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN, "MSG_MARKUP_NOT_RECOGNIZED_IN_DTD"),
                    "wf-invalid-character");
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN,
            ...
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN, "MSG_CLOSE_PAREN_REQUIRED_IN_CHILDREN"),
                    "wf-invalid-character");
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN,
            ...
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN, "MSG_CLOSE_PAREN_REQUIRED_IN_MIXED"),
                    "wf-invalid-character");
            fgDOMErrorTypeTable.put(
            ...
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN, "MSG_DUPLICATE_ATTRIBUTE_DEFINITION"),
                    "wf-invalid-character");
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN,
            ...
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN, "MSG_NMTOKEN_REQUIRED_IN_ENUMERATION"),
                    "wf-invalid-character");
            fgDOMErrorTypeTable.put(
            ...
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN, "MSG_DISTINCT_TOKENS_IN_ENUMERATION"),
                    "wf-invalid-character");
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN, "MSG_DISTINCT_NOTATION_IN_ENUMERATION"),
                    "wf-invalid-character");
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN,
            ...
            fgDOMErrorTypeTable.put(
                    ...
                    "wf-invalid-character-in-node-name"); // considered error in name of node
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN,
            ...
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN, "MSG_DUPLICATE_ENTITY_DEFINITION"),
                    "wf-invalid-character-in-node-name");
            fgDOMErrorTypeTable.put(
            ...
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN, "MSG_URI_FRAGMENT_IN_SYSTEMID"),
                    "wf-invalid-character");
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(
                            XMLMessageFormatter.XML_DOMAIN,
            ...
            // REVISIT: do EntityNotDeclared, RecursiveReference, RecursiveGeneralReference,
            // RecursivePEReference belong here?
            fgDOMErrorTypeTable.put(
            ...
            fgDOMErrorTypeTable.put(
                    ...
                    "unsupported-encoding");
            fgDOMErrorTypeTable.put(
                    new XMLErrorCode(XMLMessageFormatter.XML_DOMAIN, "IllegalQName"),
                    "wf-invalid-character-in-node-name");
            fgDOMErrorTypeTable.put(
