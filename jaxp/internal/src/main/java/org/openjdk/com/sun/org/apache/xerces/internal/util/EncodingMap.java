 ...
 * encoding names, and vice versa. The encoding names used in XML instance documents
 * <strong>must</strong> be the IANA encoding names specified or one of the aliases for those names
 * which IANA defines.
 *
 * <p>
 *
...
public class EncodingMap {
    ...
    static {
        ...
        fIANA2JavaMap.put(
                "ISO-8859-8-I",
                "ISO8859_8"); // added since this encoding only differs w.r.t. presentation
     ...
     * @deprecated Use of this method is not recommended. Its effect is JVM wide and may cause
     *     unforeseen behaviour for other applications running in the system.
     */
