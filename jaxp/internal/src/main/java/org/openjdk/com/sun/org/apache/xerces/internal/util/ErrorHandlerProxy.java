 ...
 *
 * <p>The derived class should override the {@link #getErrorHandler()} method so that it will return
 * the correct {@link XMLErrorHandler} instance. This method will be called whenever an
 * error/warning is found.
 *
 * <p>Experience shows that it is better to store the actual {@link XMLErrorHandler} in one place
 * and looks up that variable, rather than copying it into every component that needs an error
 * handler and update all of them whenever it is changed, IMO.
 *
