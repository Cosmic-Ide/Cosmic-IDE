...
/**
 * This class defines the basic properties of characters in XML 1.1. The data in this class can be
 * used to verify that a character is a valid XML 1.1 character or if the character is a space, name
 * start, or name character.
 *
