...
/**
 * Its better to extend the functionality of existing XMLAttributesImpl and also make it of type
 * Iterator. We can directly give an object of type iterator from StartElement event. We should also
 * have Attribute object of type org.openjdk.javax.xml.stream.Attribute internally. It would avoid
 * the need of creating new org.openjdk.javax.xml.stream.Attribute object at the later stage.
 *
 * <p>Should we change XMLAttributes interface to implement Iteraotr ? I think its better avoid
 * touching XNI as much as possible. - NB.
 */
public class XMLAttributesIteratorImpl extends XMLAttributesImpl implements Iterator {
    ...
    public void remove() {
        ...
        if (fLastReturnedItem == fAttributes[fCurrent - 1]) {
            ...
            // either the next method has been called yet, or the remove method has already been
            // called
    ...
    /**
     * xxx: should we be doing this way ? Attribute event defines so many functions which doesn't
     * make any sense for Attribute.
     */
    /*
