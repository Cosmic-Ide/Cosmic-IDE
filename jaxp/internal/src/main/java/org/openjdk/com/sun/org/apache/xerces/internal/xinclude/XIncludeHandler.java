...
import org.openjdk.com.sun.org.apache.xerces.internal.impl.io.MalformedByteSequenceException;
...
import org.openjdk.com.sun.org.apache.xerces.internal.util.HTTPInputSource;
...
import org.openjdk.com.sun.org.apache.xerces.internal.xni.parser.XMLDTDFilter;
...
import org.openjdk.com.sun.org.apache.xerces.internal.xpointer.XPointerProcessor;
...
public class XIncludeHandler implements XMLComponent, XMLDocumentFilter, XMLDTDFilter {
    ...
    private static final Object[] PROPERTY_DEFAULTS = {
        null, null, null, new Integer(XMLEntityManager.DEFAULT_BUFFER_SIZE)
    };
    ...
    protected boolean handleIncludeElement(XMLAttributes attributes) throws XNIException {
        ...
        if (includedSource == null) {
            ...
            if (accept != null || acceptLanguage != null) {
                ...
                includedSource =
                        new XMLInputSource(null, href, fCurrentBaseURI.getExpandedSystemId());
            }
        }
        ...
        if (parse.equals(XINCLUDE_PARSE_XML)) {
            ...
            if ((xpointer != null && fXPointerChildConfig == null)
                ...
                if (xpointer != null)
                    parserName =
                            "org.openjdk.com.sun.org.apache.xerces.internal.parsers.XPointerParserConfiguration";
            ...
            // encoding errors
                ...
                if (textReader != null) {
                    try {
                        ...
                        reportResourceError(
                                "TextResourceError", new Object[] {href, e.getMessage()});
                        return false;
                    }
                }
            }
    ...
    /**
     * Checks if the file indicated by the given XMLLocator has already been included in the current
     * stack.
     *
    ...
    private void reportError(String key, Object[] args, short severity) {
        if (fErrorReporter != null) {
            fErrorReporter.reportError(
                    XIncludeMessageFormatter.XINCLUDE_DOMAIN, key, args, severity);
        }
