...
/**
 * This handler interface contains methods necessary to receive information about document elements
 * and content.
 *
 * <p><strong>Note:</strong> Some of these methods overlap methods found in the XMLDocumentHandler
 * interface.
 *
...
public interface XMLDocumentFragmentHandler {
     ...
     *     during the parsing of this fragment. However, it is <em>strongly</em> recommended that a
     *     locator be supplied that can at least report the base system identifier.
     * @param namespaceContext The namespace context in effect at the start of this document
     *     fragment. This object only represents the current context. Implementors of this class are
     *     responsible for copying the namespace bindings from the the current context (and its
     *     parent contexts) if that information is important.
     * @param augmentations Additional information that may include infoset augmentations.
     * @throws XNIException Thrown by handler to signal an error.
     */
    public void startDocumentFragment(
            XMLLocator locator, NamespaceContext namespaceContext, Augmentations augmentations)
            throws XNIException;
