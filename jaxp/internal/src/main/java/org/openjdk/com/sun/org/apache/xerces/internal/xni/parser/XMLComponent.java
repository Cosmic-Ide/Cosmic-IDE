...
/**
 * The component interface defines methods that must be implemented by components in a parser
 * configuration. The component methods allow the component manager to initialize the component
 * state and notify the component when feature and property values change.
 *
