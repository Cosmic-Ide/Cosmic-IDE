...
/**
 * The component manager manages a parser configuration and the components that make up that
 * configuration. The manager notifies each component before parsing to allow the components to
 * initialize their state; and also any time that a parser feature or property changes.
 *
 * <p>The methods of the component manager allow components to query features and properties that
