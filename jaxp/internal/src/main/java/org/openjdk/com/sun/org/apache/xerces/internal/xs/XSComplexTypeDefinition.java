...
public interface XSComplexTypeDefinition extends XSTypeDefinition {
    // Content Model Types
    /**
     * Represents an empty content type. A content type with the distinguished value empty validates
     * elements with no character or element information item children.
     */
    public static final short CONTENTTYPE_EMPTY = 0;
    /**
     * Represents a simple content type. A content type which is simple validates elements with
     * character-only children.
     */
    public static final short CONTENTTYPE_SIMPLE = 1;
    /**
     * Represents an element-only content type. An element-only content type validates elements with
    ...
    /**
     * [derivation method]: either <code>DERIVATION_EXTENSION</code>, <code>DERIVATION_RESTRICTION
     * </code>, or <code>DERIVATION_NONE</code> (see <code>XSConstants</code>).
     */
    public short getDerivationMethod();

    /**
     * [abstract]: a boolean. Complex types for which <code>abstract</code> is true must not be used
     * as the type definition for the validation of element information items.
     */
     ...
     * <code>CONTENTTYPE_SIMPLE</code>), mixed ( <code>CONTENTTYPE_MIXED</code>), or element-only (
    ...
    /**
     * [prohibited substitutions]: A subset of {extension, restriction} or <code>DERIVATION_NONE
     * </code> represented as a bit flag (see <code>XSConstants</code>).
     */
