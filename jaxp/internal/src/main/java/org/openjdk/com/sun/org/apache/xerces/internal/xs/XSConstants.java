...
public interface XSConstants {
    ...
    /**
     * The object describes a constraining facet. Note: this object does not describe pattern and
     * enumeration facets.
     */
    ...
    /**
     * <code>XSTypeDefinition</code> final set or <code>XSElementDeclaration</code> disallowed
     * substitution group.
     */
    ...
    // Scope
    /**
     * The scope of a declaration within named model groups or attribute groups is <code>absent
     * </code>. The scope of such a declaration is determined when it is used in the construction of
    ...
    /**
     * <code>Locally scoped</code> declarations are available for use only within the complex type.
     */
    ...
    /**
     * The type represents a list type definition whose item type (itemType) is a union type
     * definition
     */
