...
public interface XSIDCDefinition extends XSObject {
    ...
    /** See the definition of <code>key</code> in the identity-constraint category. */
    public static final short IC_KEY = 1;
    /** See the definition of <code>keyref</code> in the identity-constraint category. */
    public static final short IC_KEYREF = 2;
    /** See the definition of <code>unique</code> in the identity-constraint category. */
    ...
    /**
     * [referenced key]: required if [identity-constraint category] is keyref, <code>null</code>
     * otherwise. An identity-constraint definition with [ identity-constraint category] equal to
     * key or unique.
     */
