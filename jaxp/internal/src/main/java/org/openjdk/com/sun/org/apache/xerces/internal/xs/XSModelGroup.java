...
public interface XSModelGroup extends XSTerm {
    ...
    /**
     * This content model represents a simplified version of the SGML &amp;-Connector and is limited
     * to the top-level of any content model. No element in the all content model may appear more
     * than once.
     */
    public static final short COMPOSITOR_ALL = 3;

    /**
     * [compositor]: one of all, choice or sequence. The valid constant values are: <code>
     * COMPOSITOR_SEQUENCE, COMPOSITOR_CHOICE, COMPOSITOR_ALL</code>.
     */
