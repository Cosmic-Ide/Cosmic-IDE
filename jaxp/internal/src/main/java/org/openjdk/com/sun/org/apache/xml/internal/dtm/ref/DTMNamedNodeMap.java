...
public class DTMNamedNodeMap implements NamedNodeMap {
     ...
     * present in this map, it is replaced by the new one. <br>
     ...
     * aliased.
     *
     * @param newNode node to store in this map. The node will later be accessible using the value
     *     of its <code>nodeName</code> attribute.
    ...
    /**
     * Retrieves a node specified by local name and namespace URI. HTML-only DOM implementations do
