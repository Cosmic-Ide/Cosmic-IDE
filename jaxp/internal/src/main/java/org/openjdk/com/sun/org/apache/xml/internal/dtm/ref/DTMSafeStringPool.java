...
/**
 * Like DTMStringPool, but threadsafe. It's been proposed that DTMs share their string pool(s); that
 * raises threadsafety issues which this addresses. Of course performance is inferior to that of the
 * bare-bones version.
 *
