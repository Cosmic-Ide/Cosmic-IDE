...
public class DOM2DTMdefaultNamespaceDeclarationNode implements Attr, TypeInfo {
    ...
    /**
     * Non-DOM method, part of the temporary kluge %REVIEW% This would be a pruning problem, but
     * since it will always be added to the root element and we prune on elements, we shouldn't have
     * to worry.
     */
