 ...
 */
package org.openjdk.com.sun.org.apache.xml.internal.dtm.ref.sax2dtm;

import org.openjdk.com.sun.org.apache.xml.internal.dtm.*;
...
import org.openjdk.com.sun.org.apache.xml.internal.dtm.ref.*;
import org.openjdk.com.sun.org.apache.xml.internal.dtm.ref.DTMDefaultBaseIterators;
import org.openjdk.com.sun.org.apache.xml.internal.dtm.ref.DTMManagerDefault;
import org.openjdk.com.sun.org.apache.xml.internal.dtm.ref.DTMStringPool;
import org.openjdk.com.sun.org.apache.xml.internal.dtm.ref.DTMTreeWalker;
import org.openjdk.com.sun.org.apache.xml.internal.dtm.ref.IncrementalSAXSource;
import org.openjdk.com.sun.org.apache.xml.internal.dtm.ref.NodeLocator;
...
import org.openjdk.com.sun.org.apache.xml.internal.utils.IntStack;
import org.openjdk.com.sun.org.apache.xml.internal.utils.IntVector;
import org.openjdk.com.sun.org.apache.xml.internal.utils.StringVector;
import org.openjdk.com.sun.org.apache.xml.internal.utils.SuballocatedIntVector;
...
/**
 * This class implements a DTM that tends to be optimized more for speed than for compactness, that
 * is constructed via SAX2 ContentHandler events.
 */
public class SAX2DTM extends DTMDefaultBaseIterators
     ...
     *
     * <p>%REVIEW% Should this have an option of being shared across DTMs? Sequentially only; not
     * threadsafe... Currently, I think not.
     *
     * <p>%REVIEW% Initial size was pushed way down to reduce weight of RTFs. pending reduction in
     * number of RTF DTMs. Now that we're sharing a DTM between RTFs, and tail-pruning... consider
     * going back to the larger/faster.
     *
     * <p>Made protected rather than private so SAX2RTFDTM can access it.
     */
    ...
    /**
     * The parent stack, needed only for construction. Made protected rather than private so
     * SAX2RTFDTM can access it.
     */
    protected transient IntStack m_parents;

    /**
     * The current previous node, needed only for construction time. Made protected rather than
     * private so SAX2RTFDTM can access it.
     */
    protected transient int m_previous = 0;

    /**
     * Namespace support, only relevent at construction time. Made protected rather than private so
     * SAX2RTFDTM can access it.
     */
    ...
    /**
     * End document has been reached. Made protected rather than private so SAX2RTFDTM can access
     * it.
     */
    ...
    /**
     * Vector of entities. Each record is composed of four Strings: publicId, systemID,
     * notationName, and name.
     */
    ...
    /**
     * The starting offset within m_chars for the text or CDATA_SECTION node currently being
     * acumulated, or -1 if there is no text node in progress
     */
     ...
     *
     * <p>Made protected for access by SAX2RTFDTM.
     */
    ...
    /**
     * Ask the CoRoutine parser to doTerminate and clear the reference. If the CoRoutine parser has
     * already been cleared, this will have no effect.
     *
     ...
     *     <p>Note that IncrementalSAXSource_Filter is package private, hence it can be statically
     *     referenced using instanceof (CR 6537912).
     */
    public ContentHandler getContentHandler() {

        if (m_incrementalSAXSource
                .getClass()
                .getName()
                .equals(
                        "org.openjdk.com.sun.org.apache.xml.internaldtm.ref.IncrementalSAXSource_Filter"))
     ...
     * @param normalize true if the content should be normalized according to the rules for the
     *     XPath <a href="http://www.w3.org/TR/xpath#function-normalize-space">normalize-space</a>
     *     function.
     * @throws SAXException
     */
    public void dispatchCharactersEvents(int nodeHandle, ContentHandler ch, boolean normalize)
        ...
        if (isTextType(type)) {
            ...
            if (DTM.NULL != firstChild) {
                ...
                if (normalize)
                    FastStringBuffer.sendNormalizedSAXcharacters(
                            str.toCharArray(), 0, str.length(), ch);
    ...
    protected void addNewDTMID(int nodeIndex) {
        try {
            ...
            error(
                    XMLMessages.createXMLMessage(
                            XMLErrorResources.ER_NO_DTMIDS_AVAIL,
    ...
    /**
     * Store the source location of the current node. This method must be called as every node is
     * added to the DTM or for no node.
     */
    protected void setSourceLocation() {
        ...
        if (m_sourceSystemId.size() != m_size) {
            String msg =
                    "CODING ERROR in Source Location: " + m_size + " != " + m_sourceSystemId.size();
    ...
    public int getAttributeNode(int nodeHandle, String namespaceURI, String name) {
        ...
        for (int attrH = getFirstAttribute(nodeHandle);
                DTM.NULL != attrH;
                attrH = getNextAttribute(attrH)) {
            String attrNS = getNamespaceURI(attrH);
            String attrName = getLocalName(attrH);
            boolean nsMatch =
                    namespaceURI == attrNS || (namespaceURI != null && namespaceURI.equals(attrNS));
    ...
    public int getElementById(String elementId) {
        ...
        do {
            ...
            if (null != intObj) return makeNodeHandle(intObj.intValue());

            if (!isMore || m_endDocumentOccured) break;
    ...
    /**
     * Check whether accumulated text should be stripped; if not, append the appropriate flavor of
     * text/cdata node.
     */
     ...
     *
     * <p>Always return null, so that the parser will use the system identifier provided in the XML
     * document. This method implements the SAX default behaviour: application writers can override
     * it in a subclass to do special translations such as catalog lookups or URI redirection.
     *
     ...
     *
     * <p>By default, do nothing. Application writers may override this method in a subclass if they
     * wish to keep track of the notations declared in a document.
     *
     ...
     *
     * <p>By default, do nothing. Application writers may override this method in a subclass to keep
     * track of the unparsed entities declared in a document.
     *
     ...
     *
     * <p>By default, do nothing. Application writers may override this method in a subclass if they
     * wish to store the locator for use with other document events.
     *
     ...
     * specific actions at the start of each Namespace prefix scope (such as storing the prefix
     * mapping).
     *
    ...
    public void startPrefixMapping(String prefix, String uri) throws SAXException {
        ...
        if (DEBUG) System.out.println("startPrefixMapping: prefix: " + prefix + ", uri: " + uri);
     ...
     *
     * <p>By default, do nothing. Application writers may override this method in a subclass to take
     * specific actions at the end of each prefix mapping.
     *
     * @param prefix The Namespace prefix being declared.
     * @throws SAXException Any SAX exception, possibly wrapping another exception.
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        int elemNode =
                addNode(DTM.ELEMENT_NODE, exName, m_parents.peek(), m_previous, prefixIndex, true);
        ...
        for (int i = 0; i < n; i++) {
            ...
            if ((null != attrQName)
                ...
                if (declAlreadyDeclared(prefix)) continue; // go to the next attribute.
     ...
     *
     * <p>By default, do nothing. Application writers may override this method to take specific
     * actions for each chunk of ignorable whitespace (such as adding data to a node or buffer, or
     * printing it to a file).
     *
     ...
     *
     * <p>By default, do nothing. Application writers may override this method in a subclass to take
     * specific actions for each processing instruction, such as setting status variables or
    ...
    public void processingInstruction(String target, String data) throws SAXException {
        ...
        int exName =
                m_expandedNameTable.getExpandedTypeID(
                        null, target, DTM.PROCESSING_INSTRUCTION_NODE);
     ...
     *
     * <p>The default implementation does nothing. Application writers may override this method in a
     * subclass to take specific actions for each warning, such as inserting the message in a log
     ...
     *
     * <p>The default implementation throws a SAXParseException. Application writers may override
     * this method in a subclass if they need to take specific actions for each fatal error (such as
     * collecting all of the errors into a single report): in any case, the application must stop
     * all regular processing when this method is invoked, since the document is no longer reliable,
     ...
     *
     * <p>Any declarations are assumed to be in the internal subset unless otherwise indicated by a
     * {@link #startEntity startEntity} event.
     *
     * <p>Note that the start/endDTD events will appear within the start/endDocument events from
     ...
     *
     * <p><strong>NOTE:</entity> entity references in attribute values -- and the start and end of
     * the document entity -- are never reported.
     *
     * <p>The start and end of the external DTD subset are reported using the pseudo-name "[dtd]".
     * All other events must be properly nested within start/end entity events.
     *
     * <p>Note that skipped entities will be reported through the {@link
     * org.xml.sax.ContentHandler#skippedEntity skippedEntity} event, which is part of the
     ...
     *
     * <p>The contents of the CDATA section will be reported through the regular {@link
     * org.xml.sax.ContentHandler#characters characters} event.
     *
     * @throws SAXException The application may raise an exception.
     * @see #endCDATA
     */
    ...
    public void comment(char ch[], int start, int length) throws SAXException {
        ...
        m_previous =
                addNode(DTM.COMMENT_NODE, exName, m_parents.peek(), m_previous, dataIndex, false);
    }

    /**
     * Set a run time property for this DTM instance.
     *
     * <p>%REVIEW% Now that we no longer use this method to support getSourceLocatorFor, can we
     * remove it?
     *
     ...
     * XalanProperties.SOURCE_LOCATION flag was set True using setProperty; if it was never set, or
     * was set false, we will return null.
     *
     * <p>(We _could_ return a locator with the document's base URI and bogus line/column
     * information. Trying that; see the else clause.)
     */
