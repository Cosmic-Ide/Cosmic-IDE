...
public class XMLErrorResources_fr extends ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        {ER_SCHEME_REQUIRED, "Mod\u00E8le obligatoire."},
        {ER_NO_SCHEME_IN_URI, "Mod\u00E8le introuvable dans l''URI: {0}"},
        ...
        {ER_SYSTEMID_UNKNOWN, "ID syst\u00E8me inconnu"},
        ...
        },
        {
            ...
            "Tentative de sortie d''un caract\u00E8re avec une valeur enti\u00E8re {0}, non"
                + " repr\u00E9sent\u00E9 dans l''encodage de sortie sp\u00E9cifi\u00E9 pour {1}."
        },
        {
            ER_COULD_NOT_LOAD_METHOD_PROPERTY,
