...
public class XMLErrorResources_pt_BR extends ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        {ER_NO_DEFAULT_IMPL, "Nenhuma implementa\u00E7\u00E3o default encontrada "},
        {ER_CHUNKEDINTARRAY_NOT_SUPPORTED, "ChunkedIntArray({0}) n\u00E3o suportado atualmente"},
        ...
        {ER_NO_PARSE_CALL_WHILE_PARSING, "o parsing n\u00E3o pode ser chamado durante o parsing"},
        {
            ER_TYPED_ITERATOR_AXIS_NOT_IMPLEMENTED,
            "Erro: iterador digitado para o eixo {0} n\u00E3o implementado"
        },
        {ER_ITERATOR_AXIS_NOT_IMPLEMENTED, "Erro: iterador para o eixo {0} n\u00E3o implementado "},
        ...
        {ER_COULD_NOT_RESOLVE_NODE, "N\u00E3o foi poss\u00EDvel resolver o n\u00F3 para um handle"},
        {ER_STARTPARSE_WHILE_PARSING, "startParse n\u00E3o pode ser chamado durante o parsing"},
        ...
        {ER_EXCEPTION_CREATING_POOL, "exce\u00E7\u00E3o ao criar a nova inst\u00E2ncia do pool"},
        {
            ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE,
            "O caminho cont\u00E9m uma sequ\u00EAncia inv\u00E1lida de caracteres de escape"
        },
        {ER_SCHEME_REQUIRED, "O esquema \u00E9 obrigat\u00F3rio!"},
        {ER_NO_SCHEME_IN_URI, "Nenhum esquema encontrado no URI: {0}"},
        ...
        {ER_PORT_WHEN_HOST_NULL, "A porta n\u00E3o pode ser definida quando o host \u00E9 nulo"},
        {ER_INVALID_PORT, "N\u00FAmero de porta inv\u00E1lido"},
        {
        ...
        {ER_CREATEDOCUMENT_NOT_SUPPORTED, "createDocument() n\u00E3o suportado no XPathContext!"},
        {
        ...
        {ER_RESOURCE_COULD_NOT_LOAD, "O recurso [ {0} ] n\u00E3o foi carregado: {1} \n {2} \t {3}"},
         ...
         */
        {ER_STRAY_ATTRIBUTE, "Atributo ''{0}'' fora do elemento."},
         ...
         */
        {ER_STRAY_NAMESPACE, "Declara\u00E7\u00E3o de namespace ''{0}''=''{1}'' fora do elemento."},
        {
