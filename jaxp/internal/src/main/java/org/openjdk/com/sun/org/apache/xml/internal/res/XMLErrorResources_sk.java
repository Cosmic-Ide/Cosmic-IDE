...
public class XMLErrorResources_sk extends ListResourceBundle {
    ...
    private static final Object[][] _contents =
            new Object[][] {
                ...
                {ER_COROUTINE_PARAM, "Chyba parametra korutiny ({0})"},
                {
                ...
                {ER_SCHEME_NOT_CONFORMANT, "Nezhodn\u00e1 sch\u00e9ma."},
                {
                ...
                {ER_SYSTEMID_UNKNOWN, "Nezn\u00e1me SystemId"},
                {ER_LOCATION_UNKNOWN, "Nezn\u00e1me miesto v\u00fdskytu chyby"},
                {
                ...
                {ER_ARG_LOCALNAME_NULL, "Argument 'localName' je null"},
                 ...
                 */
                {ER_STRAY_ATTRIBUTE, "Atrib\u00fat ''{0}'' je mimo elementu."},
