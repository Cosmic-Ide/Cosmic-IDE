...
public class CatalogException extends Exception {
     ...
     *
     * <p>If there is an embedded exception, and if the CatalogException has no detail message of
     * its own, this method will return the detail message from the embedded exception.
     *
