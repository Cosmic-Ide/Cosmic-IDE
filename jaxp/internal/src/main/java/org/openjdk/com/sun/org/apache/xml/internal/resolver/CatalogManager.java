...
public class CatalogManager {
     ...
     *
     * <p>This property is used when the catalogFiles property is interrogated. If true, then
     * relative catalog entry file names are returned. If false, relative catalog entry file names
     * are made absolute with respect to the properties file before returning them.
     *
     * <p>This property <emph>only applies</emph> when the catalog files come from a properties
     * file. If they come from a system property or the default list, they are never considered
     * relative. (What would they be relative to?)
     *
