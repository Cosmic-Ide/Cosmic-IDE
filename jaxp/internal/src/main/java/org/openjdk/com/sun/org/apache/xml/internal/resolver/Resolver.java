...
/**
 * An extension to OASIS Open Catalog files, this class supports suffix-based matching and an
 * external RFC2483 resolver.
 *
 * @see Catalog
...
public class Resolver extends Catalog {
     ...
     *
     * <p>System suffix entries match system identifiers that end in a specified suffix.
     */
     ...
     *
     * <p>This is a bit of a hack. There's no actual SYSTEMREVERSE entry, but this entry type is
     * used to indicate that a reverse lookup is being performed. (This allows the Resolver to
     * implement RFC2483 I2N and I2NS.)
     */
    ...
    public void setupReaders() {
        ...
        saxReader.setCatalogParser(
                ...
                "catalog",
                "org.openjdk.com.sun.org.apache.xml.internalresolver.readers.ExtendedXMLCatalogReader");
     ...
     *
     * <p>In the Resolver (as opposed to the Catalog) class, if the URI isn't found by the usual
     * algorithm, URISUFFIX entries are considered.
     *
     ...
     *
     * <p>In the Resolver (as opposed to the Catalog) class, if the URI isn't found by the usual
     * algorithm, SYSTEMSUFFIX entries are considered.
     *
    ...
    /**
     * Return the applicable PUBLIC or SYSTEM identifier, resorting to external resolvers if
     * necessary.
     *
     ...
     *
     * <p>Note that a system or public identifier in the current catalog (or subordinate catalogs)
     * will be used in preference to an external resolver. Further, if a systemId is present, the
     * external resolver(s) will be queried for that before the publicId.
     *
     ...
     *
     * <p>If one or more SYSTEM entries exists in the Catalog for the system ID specified, return
     * the mapped values.
     *
     * <p>The caller is responsible for doing any necessary normalization of the system identifier
     * before calling this method. For example, a relative system identifier in a document might be
     * converted to an absolute system identifier before attempting to resolve it.
     *
     * <p>Note that this function will force all subordinate catalogs to be loaded.
     *
     * <p>On Windows-based operating systems, the comparison between the system identifier provided
     * and the SYSTEM entries in the Catalog is case-insensitive.
     *
     ...
     *
     * <p>If one or more SYSTEM entries exists in the catalog file for the system ID specified,
     ...
     *
     * <p>This method searches the Catalog and returns all of the system identifiers specified for
     * the given entity type with the given name, public, and system identifiers. In some contexts,
     * these may be null.
     *
