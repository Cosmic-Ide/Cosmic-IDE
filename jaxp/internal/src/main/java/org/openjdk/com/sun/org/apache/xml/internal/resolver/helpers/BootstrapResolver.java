...
public class BootstrapResolver implements EntityResolver, URIResolver {
    ...
    public BootstrapResolver() {
        URL url =
                this.getClass()
                        .getResource(
                                "/org/openjdk/com/sun/org/apache/xml/internal/resolver/etc/catalog.dtd");
        if (url != null) {
        ...
        url =
                this.getClass()
                        .getResource(
                                "/org/openjdk/com/sun/org/apache/xml/internal/resolver/etc/catalog.rng");
        if (url != null) {
        ...
        url =
                this.getClass()
                        .getResource(
                                "/org/openjdk/com/sun/org/apache/xml/internal/resolver/etc/catalog.xsd");
        if (url != null) {
