 ...
 *
 * <p>The Catalog class requires that classes implement this interface in order to be used to read
 * catalogs. Examples of CatalogReaders include the TextCatalogReader, the SAXCatalogReader, and the
 * DOMCatalogReader.
 *
 * @see Catalog
...
public interface CatalogReader {
     ...
     *
     * <p>This class reads a catalog from a URL.
     *
     * @param catalog The catalog for which this reader is called.
     * @param fileUrl The URL of a document to be read.
     * @throws MalformedURLException if the specified URL cannot be turned into a URL object.
