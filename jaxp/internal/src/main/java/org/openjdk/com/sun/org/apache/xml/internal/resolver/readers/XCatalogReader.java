...
/**
 * Parse "xcatalog" XML Catalog files, this is the XML Catalog format developed by John Cowan and
 * supported by Apache.
 *
 * @see Catalog
...
public class XCatalogReader extends SAXCatalogReader implements SAXCatalogParser {
    ...
    /**
     * The SAX <code>startElement</code> method recognizes elements from the plain catalog format
     * and instantiates CatalogEntry objects for them.
     *
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts)
        ...
        if (localName.equals("Base")) {
            ...
            catalog.getCatalogManager()
                    .debug
                    .message(4, "Remap", atts.getValue("SystemId"), atts.getValue("HRef"));
        ...
        if (entryType >= 0) {
            try {
                ...
                if (cex.getExceptionType() == CatalogException.INVALID_ENTRY_TYPE) {
                    catalog.getCatalogManager()
                            .debug
                            .message(1, "Invalid catalog entry type", localName);
                } else if (cex.getExceptionType() == CatalogException.INVALID_ENTRY) {
                    catalog.getCatalogManager()
                            .debug
                            .message(1, "Invalid catalog entry", localName);
                }
            }
        }
    }
