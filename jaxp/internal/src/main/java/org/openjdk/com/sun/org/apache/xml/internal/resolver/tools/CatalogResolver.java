...
public class CatalogResolver implements EntityResolver, URIResolver {
     ...
     *
     * <p>Presented with an optional public identifier and a system identifier, this function
     * attempts to locate a mapping in the catalogs.
     *
    ...
    public String getResolvedEntity(String publicId, String systemId) {
        ...
        if (catalog == null) {
            catalogManager.debug.message(
                    1, "Catalog resolution attempted with null catalog; ignored");
            return null;
        }
        ...
        if (systemId != null) {
            try {
                ...
                catalogManager.debug.message(
                        1, "Malformed URL exception trying to resolve", publicId);
                resolved = null;
     ...
     * attempts to locate a mapping in the catalogs.
     *
     * <p>If such a mapping is found, the resolver attempts to open the mapped value as an
     * InputSource and return it. Exceptions are ignored and null is returned if the mapped value
     * cannot be opened as an input source.
     *
            ...
            try {
                ...
                if (!absBase.equals(base)) {
                    ...
                    throw new TransformerException(
                            "Malformed URL " + href + "(base " + base + ")", mue);
                }
            }
        }
     ...
     * should). See below: <tt>"If an application wants to set the ErrorHandler or EntityResolver
     * for an XMLReader used during a transformation, it should use a URIResolver to return the
     * SAXSource which provides (with getXMLReader) a reference to the XMLReader"</tt>
     *
