...
import org.openjdk.com.sun.org.apache.xml.internal.resolver.*;
 ...
 *
 * <p>This class implements a SAX XMLReader that performs entity resolution using the
 * CatalogResolver. The actual, underlying parser is obtained from a SAXParserFactory.
 *
 * @see CatalogResolver
...
public class ResolvingXMLReader extends ResolvingXMLFilter {
     ...
     *
     * <p>In order to do its job, a ResolvingXMLReader must in fact be a filter. So the only
     * difference between this code and the filter code is that the constructor builds a new reader.
     */
