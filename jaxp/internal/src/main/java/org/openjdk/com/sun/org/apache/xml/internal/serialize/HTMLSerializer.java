...
/**
 * Implements an HTML/XHTML serializer supporting both DOM and SAX pretty serializing. HTML/XHTML
 * mode is determined in the constructor. For usage instructions see {@link Serializer}.
 *
 ...
 * stripped.
 *
 * <p>XHTML is slightly different than HTML:
 *
 * <ul>
 ...
 *     use JAXP's Transformation API for XML (TrAX) for serializing HTML. See the Xerces
...
public class HTMLSerializer extends BaseMarkupSerializer {
    ...
    /**
     * Constructs a new HTML/XHTML serializer depending on the value of <tt>xhtml</tt>. The
     * serializer cannot be used without calling {@link #setOutputCharStream} or {@link
            ...
            if (!hasNamespaceURI) htmlName = rawName;
                ...
                if (namespaceURI.equals(XHTMLNamespace)
                        || (fUserXHTMLNamespace != null
                                && fUserXHTMLNamespace.equals(namespaceURI))) htmlName = localName;
                else htmlName = null;
            }
