 ...
 * But for optimization this class adds a Hashtable for faster lookup of an index by qName, which is
...
public final class AttributesImplSerializer extends AttributesImpl {
     ...
     * now we haven't kept any information in the Hashtable, so we now update the Hashtable. Future
     * additional attributes will update the Hashtable as they are added.
     *
     * @param numAtts
     */
