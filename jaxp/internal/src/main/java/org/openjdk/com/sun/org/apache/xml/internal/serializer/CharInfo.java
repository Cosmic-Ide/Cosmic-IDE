...
final class CharInfo {
    ...
    private static CharInfo getCharInfoBasedOnPrivilege(
            final String entitiesFileName, final String method, final boolean internal) {
        return (CharInfo)
    ...
    /**
     * Factory that reads in a resource file that describes the mapping of characters to entity
     * references.
     *
     * <p>Resource files must be encoded in UTF-8 and have a format like:
     *
     * <pre>
     * # First char # is a comment
     * Entity numericValue
     ...
     *
     * @param entitiesResource Name of entities resource file that should be loaded, which describes
     *     that mapping of characters to entity references.
