...
/**
 * This class is a factory to generate a set of default properties of key/value pairs that are used
 * to create a serializer through the factory {@link SerializerFactory SerilizerFactory}. The
 * properties generated by this factory may be modified to non-default values before the
 * SerializerFactory is used to create a Serializer.
 *
 * <p>The given output types supported are "xml", "text", and "html". These type strings can be
 * obtained from the {@link Method Method} class in this package.
 *
 * <p>Other constants defined in this class are the non-standard property keys that can be used to
 * set non-standard property values on a java.util.Properties object that is used to create or
 * configure a serializer. Here are the non-standard keys:
 *
 * <ul>
 *   <li><b>S_KEY_INDENT_AMOUNT </b> - The non-standard property key to use to set the indentation
 *       amount. The "indent" key needs to have a value of "yes", and this properties value is a the
 *       number of whitespaces to indent by per indentation level.
 *   <li><b>S_KEY_CONTENT_HANDLER </b> - This non-standard property key is used to set the name of
 *       the fully qualified Java class that implements the ContentHandler interface. The output of
 *       the serializer will be SAX events sent to this an object of this class.
 *   <li><b>S_KEY_ENTITIES </b> - This non-standard property key is used to specify the name of the
 *       property file that specifies character to entity reference mappings. A line in such a file
 *       is has the name of the entity and the numeric (base 10) value of the corresponding
 *       character, like this one: <br>
 *       quot=34 <br>
 *   <li><b>S_USE_URL_ESCAPING </b> - This non-standard property key is used to set a value of "yes"
 *       if the href values for HTML serialization should use %xx escaping.
 *   <li><b>S_OMIT_META_TAG </b> - This non-standard property key is used to set a value of "yes" if
 *       the META tag should be omitted where it would otherwise be supplied.
 * </ul>
 *
...
public final class OutputPropertiesFactory {
    ...
    // ************************************************************
    /**
     * This is not a public API. This is the built-in extensions namespace, reexpressed in
     * {namespaceURI} syntax suitable for prepending to a localname to produce a "universal name".
     */
    ...
    /**
     * The non-standard property key to use to set the number of whitepaces to indent by, per
     * indentation level, if indent="yes".
     */
    ...
    /**
     * This non-standard property key is used to set the name of the fully qualified Java class that
     * implements the ContentHandler interface. Fully qualified name of class with a default
     * constructor that implements the ContentHandler interface, where the result tree events will
     * be sent to.
     */
    ...
    /**
     * This non-standard property key is used to specify the name of the property file that
     * specifies character to entity reference mappings.
     */
    public static final String S_KEY_ENTITIES = S_BUILTIN_EXTENSIONS_UNIVERSAL + "entities";

    /**
     * This non-standard property key is used to set a value of "yes" if the href values for HTML
     * serialization should use %xx escaping.
     */
    public static final String S_USE_URL_ESCAPING =
            S_BUILTIN_EXTENSIONS_UNIVERSAL + "use-url-escaping";

    /**
     * This non-standard property key is used to set a value of "yes" if the META tag should be
     * omitted where it would otherwise be supplied.
     */
    ...
    /**
     * This is not a public API, it is only public because it is used by outside of this package, it
     * is the length of the old built-in extension namespace.
     */
    public static final int S_BUILTIN_OLD_EXTENSIONS_UNIVERSAL_LEN =
            S_BUILTIN_OLD_EXTENSIONS_UNIVERSAL.length();

    /**
     * This non-standard, Oracle-impl only property key is used as if OutputKeys.STANDALONE is
     * specified but without writing it out in the declaration; It can be used to reverse the change
     * by Xalan patch 1495. Since Xalan patch 1495 can cause incompatible behavior, this property is
     * add for application to neutralize the effect of Xalan patch 1495
     */
    /**
     * Is Standalone
     *
    ...
    private static final String PROP_DIR =
            "org/openjdk/com/sun/org/apache/xml/internal/serializer/";
    ...
    /**
     * Creates an empty OutputProperties with the property key/value defaults specified by a
     * property file. The method argument is used to construct a string of the form
     * output_[method].properties (for instance, output_html.properties). The output_xml.properties
     * file is always used as the base.
     *
     ...
     * "xslt.output.xxx", clip off "xslt.output.". If a key name *or* a key value is discovered,
     * check for \u003a in the text, and fix it up to be ":", since earlier versions of the JDK do
     * not handle the escape sequence (at least in key names).
     *
        ...
        try {
            ...
            if (defaults == null) {
                ...
                throw new WrappedRuntimeException(
                        ...
                        se);
                // "Could not load '"+resourceName+"' (check CLASSPATH, applet security), now using
                // just the defaults ", se);
            }
        } finally {
            if (bis != null) {
                bis.close();
    ...
    /**
     * Fix up a string in an output properties file according to the rules of {@link
     * #loadPropertiesFile}.
     *
