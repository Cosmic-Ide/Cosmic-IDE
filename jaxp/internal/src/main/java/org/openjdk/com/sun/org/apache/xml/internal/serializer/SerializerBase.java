...
public abstract class SerializerBase implements SerializationHandler, SerializerConstants {
    ...
    /**
     * Pairs of local names and corresponding URIs of CDATA sections. This list comes from the
     * cdata-section-elements attribute. Every second one is a local name, and every other second
     * one is the URI for the local name.
     */
     ...
     * attribute, and the m_cdataSectionStates stack onto which whether the current element is in
     * the list is pushed (true or false). Other hidden parameters are the current elements
     * namespaceURI, localName and qName
     */
    ...
    //    {
    //        if (m_tracer != null)
    //            m_tracer.fireGenerateEvent(SerializerTrace.EVENTTYPE_CHARACTERS, chars,
    // start,length);
    //    }
    //
