 ...
 *
 * <p>The properties object passed to the getSerializer() method should be created by the
 * OutputPropertiesFactory. Although the properties object used to create a serializer does not need
 * to be obtained from OutputPropertiesFactory, using this factory ensures that the default
 * key/value properties are set for the given output "method".
 *
 ...
 * elements. If the element is in a namespace then value is passed in this format: {uri}localName
 *
...
public final class SerializerFactory {
     ...
     * @throws IllegalArgumentException if method is null or an appropriate serializer can't be
     *     found
