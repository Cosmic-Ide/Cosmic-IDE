...
/**
 * This class accepts SAX-like calls, then sends true SAX calls to a wrapped SAX handler. There is
 * optimization done knowing that the ultimate output is HTML.
 *
 * <p>This class is not a public API.
 *
 * @xsl.usage internal
 */
public final class ToHTMLSAXHandler extends ToSAXHandler {
     ...
     * Does nothing
     *
     * @param indent the number of spaces to indent per indentation level (ignored)
    ...
    /**
     * Receive notification of a comment anywhere in the document. This callback will be used for
     * comments inside or outside the document element.
     *
    ...
    public void comment(char[] ch, int start, int length) throws SAXException {
        flushPending();
        if (m_lexHandler != null) m_lexHandler.comment(ch, start, length);
    ...
    /**
     * This method is called when all the data needed for a call to the SAX handler's startElement()
     * method has been gathered.
     */
     ...
     *
     * @param elementNamespaceURI the URI of the namespace of the element (optional)
     * @param elementLocalName the element name, but without prefix (optional)
    ...
    public void endElement(String elementName) throws SAXException {
        ...
        // time to fire off endElement event
        if (m_tracer != null) super.fireEndElem(elementName);
    }
    ...
    public void characters(char[] ch, int off, int len) throws SAXException {
        ...
        if (m_tracer != null) super.fireCharEvent(ch, off, len);
    }
