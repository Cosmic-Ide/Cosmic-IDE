...
/**
 * This class is used to provide a base behavior to be inherited by other To...SAXHandler
 * serializers.
 *
...
public abstract class ToSAXHandler extends SerializerBase {
    ...
    /**
     * A startPrefixMapping() call on a ToSAXHandler will pass that call on to the wrapped
     * ContentHandler, but should we also mirror these calls with matching attributes, if so this
     * field is true. For example if this field is true then a call such as
     * startPrefixMapping("prefix1","uri1") will also cause the additional internally generated
     * attribute xmlns:prefix1="uri1" to be effectively added to the attributes passed to the
     * wrapped ContentHandler.
     */
    private boolean m_shouldGenerateNSAttribute = true;

    /**
     * If this is true, then the content handler wrapped by this serializer implements the
     * TransformState interface which will give the content handler access to the state of the
     * transform.
     */
    ...
    /**
     * Do nothing as this is an abstract class. All subclasses will need to define their behavior if
     * it is different.
     *
    ...
    public void startElement(String arg0, String arg1, String arg2, Attributes arg3)
        ...
        if (m_tracer != null) super.fireStartElem(arg2);
    }
    ...
    /**
     * Set whether or not namespace declarations (e.g. xmlns:foo) should appear as attributes of
     * elements
     *
     ...
     * startPrefixMapping("prefix1","uri1") should also be mirrored with self generated additional
     * attributes of elements that declare the namespace, for example the attribute
     * xmlns:prefix1="uri1"
     */
    ...
    /**
     * Pass in a reference to a TransformState object, which can be used during SAX ContentHandler
     * events to obtain information about he state of the transformation. This method will be called
     * before each startDocument event.
     *
    ...
    /**
     * This method gets the node's value as a String and uses that String as if it were an input
    ...
    public void error(SAXParseException exc) throws SAXException {
        ...
        if (m_saxHandler instanceof ErrorHandler) ((ErrorHandler) m_saxHandler).error(exc);
    }
