...
/**
 * This class is not a public API. It is only public because it is used in other packages. This
 * class converts SAX or SAX-like calls to a serialized document for xsl:output method of "text".
 *
 * @xsl.usage internal
 */
public final class ToTextStream extends ToStream {
     ...
     * SerializerToXML#writeNormalizedChars because it does not attempt to do XML escaping at all.
     *
     * @param ch The characters from the XML document.
     * @param start The start position in the array.
     * @param length The number of characters to read from the array.
    ...
    /**
     * Called when a Comment is to be constructed. Note that Xalan will normally invoke the other
     * version of this method. %REVIEW% In fact, is this one ever needed, or was it a mistake?
     *
