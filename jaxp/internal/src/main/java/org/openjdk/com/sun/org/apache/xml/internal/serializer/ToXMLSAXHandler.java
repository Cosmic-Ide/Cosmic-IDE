...
/**
 * This class receives notification of SAX-like events, and with gathered information over these
 * calls it will invoke the equivalent SAX methods on a handler, the ultimate xsl:output method is
 * known to be "xml".
 *
 * <p>This class is not a public API, it is only public because it is used by Xalan.
 *
 * @xsl.usage internal
 */
public final class ToXMLSAXHandler extends ToSAXHandler {
    ...
    /**
     * Closes ane open cdata tag, and unlike the this.endCDATA() method (from the LexicalHandler)
     * interface, this "internal" method will send the endCDATA() call to the wrapped handler.
     */
     ...
     * @param prefix The prefix that maps to the URI
     * @param uri The URI for the namespace
     * @param shouldFlush a flag indicating if the mapping applies to the current element or an up
     *     coming child (not used).
     */
    ...
    public void endDTD() throws SAXException {
        if (m_lexHandler != null) m_lexHandler.endDTD();
    }
    ...
    public void startEntity(String arg0) throws SAXException {
        if (m_lexHandler != null) m_lexHandler.startEntity(arg0);
    }
    ...
    /**
     * Start an element in the output document. This might be an XML element (<elem>data</elem>
     * type) or a CDATA section.
     */
    ...
    public void characters(char[] ch, int off, int len) throws SAXException {
        ...
        if (m_tracer != null) fireCharEvent(ch, off, len);
    }
    ...
    /**
     * Send a namespace declaration in the output document. The namespace declaration will not be
     * include if the namespace is already in scope with the same prefix.
     */
    ...
    /**
     * @see org.xml.sax.ContentHandler#processingInstruction(String, String) Send a processing
    ...
    /**
     * Undeclare the namespace that is currently pointed to by a given prefix. Inform SAX handler if
     * prefix was previously mapped.
     */
