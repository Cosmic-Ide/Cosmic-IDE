...
/**
 * This class converts SAX or SAX-like calls to a serialized xml document. The xsl:output method is
 * "xml".
 *
 * <p>This class is used explicitly in code generated by XSLTC, so it is "public", but it should be
 * viewed as internal or package private, this is not an API.
 *
 * @xsl.usage internal
 */
public final class ToXMLStream extends ToStream {
    ...
    /**
     * Starts a whitespace preserving section. All characters printed within a preserving section
     * are printed without indentation and without consolidating multiple spaces. This is equivalent
     * to the <tt>xml:space=&quot;preserve&quot;</tt> attribute. Only XML and HTML serializers need
     * to support this method.
     *
     * <p>The contents of the whitespace preserving section will be delivered through the regular
    ...
    public void processingInstruction(String target, String data) throws org.xml.sax.SAXException {
        ...
        if (target.equals(Result.PI_DISABLE_OUTPUT_ESCAPING)) {
            ...
            try {
                ...
                /**
                 * Before Xalan 1497, a newline char was printed out if not inside of an element.
                 * The whitespace is not significant is the output is standalone
                 */
     ...
     * @param xslAttribute true if this attribute is from an xsl:attribute, false if declared within
     *     the elements opening tag.
     * @throws SAXException
     */
    ...
    /**
     * This method is used to notify the serializer of a namespace mapping (or node) that applies to
     * the current element whose startElement() call has already been seen. The official SAX
     * startPrefixMapping(prefix,uri) is to define a mapping for a child element that is soon to be
     * seen with a startElement() call. The official SAX call does not apply to the current element,
    ...
    /**
     * From XSLTC Declare a prefix to point to a namespace URI. Inform SAX handler if this is a new
     * prefix mapping.
     */
    ...
    /**
     * This method checks for the XML version of output document. If XML version of output document
     * is not specified, then output document is of version XML 1.0. If XML version of output
     * doucment is specified, but it is not either XML 1.0 or XML 1.1, a warning message is
     * generated, the XML Version of output document is set to XML 1.0 and processing continues.
     *
