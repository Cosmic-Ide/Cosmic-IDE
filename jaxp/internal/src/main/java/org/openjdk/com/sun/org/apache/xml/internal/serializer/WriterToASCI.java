...
/**
 * This class writes ASCII to a byte stream as quickly as possible. For the moment it does not do
 * buffering, though I reserve the right to do some buffering down the line if I can prove that it
 * will be faster even if the output stream is buffered.
 *
