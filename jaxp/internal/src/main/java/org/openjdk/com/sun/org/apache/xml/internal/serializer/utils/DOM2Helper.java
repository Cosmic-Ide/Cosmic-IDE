...
/**
 * This class provides a DOM level 2 "helper", which provides services currently not provided be the
 * DOM standard.
 *
 ...
 *
 * <p>The differences from the original class are: it doesn't extend DOMHelper, not depricated,
 * dropped method isNodeAfter(Node node1, Node node2) dropped method parse(InputSource) dropped
 * method supportSAX() dropped method setDocument(doc) dropped method checkNode(Node) dropped method
 * getDocument() dropped method getElementByID(String id, Document doc) dropped method
 * getParentOfNode(Node node) dropped field Document m_doc; made class non-public
 *
