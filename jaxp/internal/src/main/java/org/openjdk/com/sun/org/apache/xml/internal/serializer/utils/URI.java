 ...
 *
 * <p>This class is a copy of the one in com.sun.org.apache.xml.internal.utils. It exists to cut the
 * serializers dependancy on that package.
 *
 * <p>A minor change from the original is that this class no longer implements Serializable, and the
 * serialVersionUID magic field is dropped, and the class is no longer "public".
 *
 * @xsl.usage internal
 */
final class URI {
        ...
        if (p_scheme == null || p_scheme.trim().length() == 0) {
            throw new MalformedURIException(
                    Utils.messages.createMessage(
                            MsgKey.ER_SCHEME_REQUIRED, null)); // "Scheme is required!");
        }
    ...
    private void initializeScheme(String p_uriSpec) throws MalformedURIException {
        ...
        if (scheme.length() == 0) {
            throw new MalformedURIException(
                    Utils.messages.createMessage(
                            MsgKey.ER_NO_SCHEME_INURI, null)); // "No scheme found in URI.");
        } else {
            setScheme(scheme);
        }
    }
    ...
    public void setPort(int p_port) throws MalformedURIException {
        ...
        if (p_port >= 0 && p_port <= 65535) {
            ...
            throw new MalformedURIException(
                    Utils.messages.createMessage(
                            MsgKey.ER_INVALID_PORT, null)); // "Invalid port number!");
        }
     ...
     *
     * @param p_char the character to check
     * @return true if the char is between '0' and '9', 'a' and 'f' or 'A' and 'F', false otherwise
     */
