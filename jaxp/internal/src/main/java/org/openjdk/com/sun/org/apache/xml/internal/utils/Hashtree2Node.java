...
import org.openjdk.com.sun.org.apache.xalan.internal.lib.Extensions;
 ...
 *
 * <p>Please maintain JDK 1.1.x compatibility; no Collections!
 *
 * @see org.openjdk.com.sun.org.apache.xalan.internal.xslt.EnvironmentCheck
 * @see Extensions
...
public abstract class Hashtree2Node {
     ...
     *
     * <p>The hash may have either Hashtables as values (in which case we recurse) or other values,
     * in which case we print them as &lt;item> elements, with a 'key' attribute with the value of
     * the key, and the element contents as the value.
     *
     * <p>If args are null we simply return without doing anything. If we encounter an error, we
     * will attempt to add an 'ERROR' Element with exception info; if that doesn't work we simply
