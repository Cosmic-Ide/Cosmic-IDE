 ...
 *
 * <p>This implementation is suitable for various use cases, and provides some basic configuration
 * API's as well to control when we re-throw errors, etc.
 *
...
public class ListingErrorHandler implements ErrorHandler, ErrorListener {
        ...
        if (null == pw)
            throw new NullPointerException(
                    XMLMessages.createXMLMessage(
                            XMLErrorResources.ER_ERRORHANDLER_CREATED_WITH_NULL_PRINTWRITER, null));
     ...
     * @exception org.xml.sax.SAXException Any SAX exception, possibly wrapping another exception;
     *     only if setThrowOnErroris true.
     * @see org.xml.sax.SAXParseException
     */
     ...
     * @param exception The error information encapsulated in a SAX parse exception.
     * @exception org.xml.sax.SAXException Any SAX exception, possibly wrapping another exception;
     *     only if setThrowOnFatalError is true.
     * @see org.xml.sax.SAXParseException
     */
     ...
     * conditions that are not errors or fatal errors. The default behaviour is to take no action.
     *
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException only if setThrowOnWarning is
     *     true.
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException only if setThrowOnError is true.
     * @see org.openjdk.javax.xml.transform.TransformerException
     */
     ...
     * <p>The transformer must continue to try and provide normal transformation after invoking this
     * method. It should still be possible for the application to process the document through to
     * the end if no other errors are encountered, but there is no guarantee that the output will be
     * useable.
     *
     * @param exception The error information encapsulated in a transformer exception.
     * @throws org.openjdk.javax.xml.transform.TransformerException only if setThrowOnError is true.
     ...
     *
     * <p>Cribbed from DefaultErrorHandler.printLocation()
     *
    ...
    /**
     * Return the specific source line that caused the exception, if possible to load it; allow
     ...
     *
     * <p>This allows per-instance configuration of ListingErrorHandlers. You can ask us to either
     * throw an exception when we're called for various warning / error / fatalErrors, or simply log
     * them and continue.
     *
     ...
     * them and continue.
     *
     * <p>Note that the behavior of many parsers/transformers after an error is not necessarily
     * defined!
     *
     ...
     * them and continue.
     *
     * <p>Note that the behavior of many parsers/transformers after a fatalError is not necessarily
     * defined, most products will probably barf if you continue.
     *
