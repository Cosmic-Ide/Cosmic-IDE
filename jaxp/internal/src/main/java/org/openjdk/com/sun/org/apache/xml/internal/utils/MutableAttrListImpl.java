...
public class MutableAttrListImpl extends AttributesImpl implements Serializable {
     ...
     *
     * <p>This constructor is especially useful inside a start element event.
     *
    ...
    public void addAttribute(
        ...
        // System.out.println("MutableAttrListImpl#addAttribute: "+uri+":"+localName+", "+index+",
        // "+qName+", "+this);
    ...
    public void addAttributes(Attributes atts) {
        ...
        for (int i = 0; i < nAtts; i++) {
            ...
            int index = this.getIndex(uri, localName);
            // System.out.println("MutableAttrListImpl#addAttributes: "+uri+":"+localName+",
            // "+index+", "+atts.getQName(i)+", "+this);
            if (index >= 0)
