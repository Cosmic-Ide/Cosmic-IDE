...
/**
 * This class holds information about the namespace info of a node. It is used to optimize namespace
 * lookup in a generic DOM.
 *
 * @xsl.usage internal
 */
public class NSInfo {
     ...
     * @param hasProcessedNS Flag indicating whether namespaces have been processed for this node
     * @param hasXMLNSAttrs Flag indicating whether this node has XMLNS attributes.
     * @param ancestorHasXMLNSAttrs Flag indicating whether one of this node's ancestor has XMLNS
     *     attributes.
     */
