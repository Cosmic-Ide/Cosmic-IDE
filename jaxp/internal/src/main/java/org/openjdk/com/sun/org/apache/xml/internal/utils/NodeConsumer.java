...
/**
 * The tree walker will test for this interface, and call setOriginatingNode before calling the SAX
 * event. For creating DOM backpointers for things that are normally created via SAX events.
 */
