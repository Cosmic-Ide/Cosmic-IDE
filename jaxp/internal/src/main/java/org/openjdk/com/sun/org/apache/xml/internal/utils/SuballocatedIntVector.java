...
public class SuballocatedIntVector {
    ...
    /**
     * Construct a IntVector, using the given block size and number of blocks. For efficiency, we
     * will round the requested size off to a power of two.
     *
    ...
    /**
     * Set the length of the list. This will only work to truncate the list, and even then it has
     * not been heavily tested and may not be trustworthy.
     *
     * @return length of the list
     */
