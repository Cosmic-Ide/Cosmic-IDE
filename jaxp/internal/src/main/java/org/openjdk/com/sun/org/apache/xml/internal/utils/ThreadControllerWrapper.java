...
/**
 * A utility class that wraps the ThreadController, which is used by IncrementalSAXSource for the
 * incremental building of DTM.
 */
public class ThreadControllerWrapper {
    ...
    /**
     * Thread controller utility class for incremental SAX source. Must be overriden with a derived
     * class to support thread pooling.
     *
     * <p>All thread-related stuff is in this class.
     */
    public static class ThreadController {
         ...
         *
         * <p>The return value is used only to wait for completion
         *
         * <p>NEEDSDOC @param task
         *
         * @param priority if >0 the task will run with the given priority ( doesn't seem to be used
         *     in xalan, since it's allways the default )
         ...
         *
         * <p>NEEDSDOC @param worker NEEDSDOC @param task
         *
