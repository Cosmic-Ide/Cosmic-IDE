...
/**
 * A digital search trie for 7-bit ASCII text The API is a subset of java.util.Hashtable The key
 * must be a 7-bit ASCII string The value may be any Java Object
 *
 * @xsl.usage internal
 */
public class Trie {
