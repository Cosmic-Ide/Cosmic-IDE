...
/**
 * <meta name="usage" content="internal"/> To be subclassed by classes that wish to fake being
 * nodes.
 */
public class UnImplNode implements Node, Element, NodeList, Document {
    ...
    public void error(String msg, Object[] args) {
        ...
        throw new RuntimeException(
                XMLMessages.createXMLMessage(msg, args)); // "UnImplNode error: "+msg);
    }
    ...
    public NodeList getElementsByTagName(String name) {
        ...
        error(
                XMLErrorResources
                        .ER_FUNCTION_NOT_SUPPORTED); // "getElementsByTagName not supported!");
    ...
    public Attr removeAttributeNode(Attr oldAttr) throws DOMException {
        ...
        error(
                XMLErrorResources
                        .ER_FUNCTION_NOT_SUPPORTED); // "removeAttributeNode not supported!");
    ...
    public NodeList getElementsByTagNameNS(String namespaceURI, String localName) {
        ...
        error(
                XMLErrorResources
                        .ER_FUNCTION_NOT_SUPPORTED); // "getElementsByTagNameNS not supported!");
     ...
     *     is the string "2.0". If the version is not specified, supporting any version of the
     ...
     *     on <code>Attr</code> , <code>EntityReference</code>, and <code>Notation</code> nodes.
     * @return null
     * @throws DOMException
     */
    ...
    /**
     * DOM Level 3 WD - Experimental. An attribute specifying the actual encoding of this document.
    ...
    /**
     * DOM Level 3 WD - Experimental. Returns whether this text node contains whitespace in element
