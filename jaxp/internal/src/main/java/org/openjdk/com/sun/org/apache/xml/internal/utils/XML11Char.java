 ...
 *
 * <p>This class defines the basic properties of characters in XML 1.1. The data in this class can
 * be used to verify that a character is a valid XML 1.1 character or if the character is a space,
 * name start, or name character.
 *
 * <p>A series of convenience methods are supplied to ease the burden of the developer. Using the
 * character as an index into the <code>XML11CHARS</code> array and applying the appropriate mask
 * flag (e.g. <code>MASK_VALID</code>), yields the same results as calling the convenience methods.
 * There is one exception: check the comments for the <code>isValid</code> method for details.
 */
public class XML11Char {
     ...
     *
     * <p>If the program chooses to apply the mask directly to the <code>XML11CHARS</code> array,
     * then they are responsible for checking the surrogate character range.
     *
     * @param c The character to check.
     */
     ...
     * reference. That is, this method will return false for the same set as isXML11Valid, except it
     * also reports false for "control characters".
     *
     * @param c The character to check.
     */
    public static boolean isXML11ValidLiteral(int c) {
        return ((c < 0x10000
                        && ((XML11CHARS[c] & MASK_XML11_VALID) != 0
                                && (XML11CHARS[c] & MASK_XML11_CONTROL) == 0))
                || (0x10000 <= c && c <= 0x10FFFF));
    } // isXML11ValidLiteral(int):boolean

    /**
     * Returns true if the specified character can be considered content in an external parsed
     * entity.
     *
     * @param c The character to check.
     */
    ...
    /**
     * Returns true if the specified character can be considered content in an internal parsed
     * entity.
     *
     * @param c The character to check.
     */
     ...
     * production [4] in the XML 1.1 specification.
     *
     * @param c The character to check.
     */
     ...
     * [4a] in the XML 1.1 specification.
     *
     * @param c The character to check.
     */
     ...
     * production [4] in Namespaces in XML 1.1 recommendation.
     *
     * @param c The character to check.
     */
     ...
     * [5] in Namespaces in XML 1.1 recommendation.
     *
     * @param c The character to check.
     */
    ...
    /**
     * Returns whether the given character is a valid high surrogate for a name character. This
     * includes all high surrogates for characters [0x10000-0xEFFFF]. In other words everything
     * excluding planes 15 and 16.
     *
     * @param c The character to check.
     */
