 ...
 * <code>com.sun.org.apache.xml.internal.utils.FastStringBuffer</code>s, or other character data. By
 * using XMLString, character copies can be reduced in the XML pipeline.
 */
public interface XMLString {

    /**
     * Directly call the characters method on the passed ContentHandler for the string-value.
     * Multiple calls to the ContentHandler's characters methods may well occur for a single call to
     * this method.
     *
    ...
    /**
     * Conditionally trim all leading and trailing whitespace in the specified String. All strings
     * of white space are replaced by a single space character (#x20), except spaces after
     * punctuation which receive double spaces if doublePunctuationSpaces is true. This function may
     * be useful to a formatter, but to get first class results, the formatter should probably do
     * it's own white space handling based on the semantics of the formatting object.
     *
     ...
     */
    public XMLString fixWhiteSpace(
     ...
     * the argument is not <code>null</code> and is an <code>XMLString</code> object that represents
     ...
     *
     * @param anotherString the object to compare this <code>String</code> against.
     * @return <code>true</code> if the <code>String</code>s are equal; <code>false</code>
     *     otherwise.
     * @see java.lang.String#compareTo(java.lang.String)
     * @see java.lang.String#equalsIgnoreCase(java.lang.String)
     */
     ...
     * considerations. Two strings are considered equal ignoring case if they are of the same
     * length, and corresponding characters in the two strings are equal ignoring case.
     *
    ...
    /**
     * Compares two strings lexicographically, ignoring case considerations. This method returns an
     * integer whose sign is that of <code>this.toUpperCase().toLowerCase().compareTo(
     * str.toUpperCase().toLowerCase())</code>.
     *
     * <p>Note that this method does <em>not</em> take locale into account, and will result in an
     ...
     * @return a negative integer, zero, or a positive integer as the the specified String is
     ...
     *     of the substring of this object starting at index <code>toffset</code>; <code>false
     *     </code> otherwise. The result is <code>false</code> if <code>toffset</code> is negative
     *     or greater than the length of this <code>String</code> object; otherwise the result is
     ...
     * @param prefix the prefix.
     * @return <code>true</code> if the character sequence represented by the argument is a prefix
     *     of the character sequence represented by this string; <code>false</code> otherwise. Note
     ...
     *     of the character sequence represented by this object; <code>false</code> otherwise. Note
    ...
    /**
     * Returns a hashcode for this string. The hashcode for a <code>String</code> object is computed
     * as
     *
     * <blockquote>
     *
     ...
     * </blockquote>
     *
     * using <code>int</code> arithmetic, where <code>s[i]</code> is the <i>i</i>th character of the
     * string, <code>n</code> is the length of the string, and <code>^</code> indicates
     ...
     * <code>String</code> object, then the index of the first such occurrence is returned -- that
     * is, the smallest value <i>k</i> such that:
     *
     * <blockquote>
     *
     * <pre>
     ...
     * </blockquote>
     *
     * is <code>true</code>. If no such character occurs in this string, then <code>-1</code> is
     * returned.
     *
     ...
     *
     * <p>If a character with value <code>ch</code> occurs in the character sequence represented by
     * this <code>String</code> object at an index no smaller than <code>fromIndex</code>, then the
     * index of the first such occurrence is returned--that is, the smallest value <i>k</i> such
     * that:
     *
     * <blockquote>
     *
     ...
     * </blockquote>
     *
     * is true. If no such character occurs in this string at or after position <code>fromIndex
     * </code>, then <code>-1</code> is returned.
     *
     * <p>There is no restriction on the value of <code>fromIndex</code>. If it is negative, it has
     * the same effect as if it were zero: this entire string may be searched. If it is greater than
     * the length of this string, it has the same effect as if it were equal to the length of this
     * string: <code>-1</code> is returned.
     *
     * @param ch a character.
     * @param fromIndex the index to start the search from.
     * @return the index of the first occurrence of the character in the character sequence
     *     represented by this object that is greater than or equal to <code>fromIndex</code>, or
     *     <code>-1</code> if the character does not occur.
     */
    public abstract int indexOf(int ch, int fromIndex);

    /**
     * Returns the index within this string of the last occurrence of the specified character. That
     * is, the index returned is the largest value <i>k</i> such that:
     *
     * <blockquote>
     *
     * <pre>
     ...
     *     entire string may be searched. If it is negative, it has the same effect as if it were
     *     -1: -1 is returned.
     * @return the index of the last occurrence of the character in the character sequence
     ...
     *     the first character of the first such substring is returned; if it does not occur as a
     ...
     * starting at the specified index. The integer returned is the smallest value <i>k</i> such
     * that:
     *
     * <blockquote>
     *
     ...
     *     no smaller than <code>fromIndex</code>, then the index of the first character of the
     *     first such substring is returned. If it does not occur as a substring starting at <code>
     *     fromIndex</code> or beyond, <code>-1</code> is returned.
     * @exception java.lang.NullPointerException if <code>str</code> is <code>null</code>
     */
     ...
     * The rightmost empty string "" is considered to occur at the index value <code>this.length()
     * </code>. The returned index is the largest value <i>k</i> such that
     *
     * <blockquote>
     *
     * <pre>
     ...
     *     then the index of the first character of the last such substring is returned. If it does
     *     not occur as a substring, <code>-1</code> is returned.
     * @exception java.lang.NullPointerException if <code>str</code> is <code>null</code>.
     */
     ...
     * @param str the substring to search for.
     * @param fromIndex the index to start the search from. There is no restriction on the value of
     *     fromIndex. If it is greater than the length of this string, it has the same effect as if
     *     it were equal to the length of this string: this entire string may be searched. If it is
     *     negative, it has the same effect as if it were -1: -1 is returned.
     * @return If the string argument occurs one or more times as a substring within this object at
     *     a starting index no greater than <code>fromIndex</code>, then the index of the first
     *     character of the last such substring is returned. If it does not occur as a substring
     *     starting at <code>fromIndex</code> or earlier, <code>-1</code> is returned.
     * @exception java.lang.NullPointerException if <code>str</code> is <code>null</code>.
     */
     ...
     * specified <code>beginIndex</code> and extends to the character at index <code>endIndex - 1
     ...
     *
     * @param str the <code>String</code> that is concatenated to the end of this <code>String
     *     </code>.
    ...
    /**
     * Converts all of the characters in this <code>String</code> to lower case using the rules of
     * the default locale, which is returned by <code>Locale.getDefault</code>.
     *
     * <p>
     *
     * @return the string, converted to lowercase.
     ...
     * the default locale, which is returned by <code>Locale.getDefault</code>.
     *
     * <p>If no character in this string has a different uppercase version, based on calling the
     * <code>toUpperCase</code> method defined by <code>Character</code>, then the original string
     * is returned.
     *
     * <p>Otherwise, this method creates a new <code>String</code> object representing a character
     * sequence identical in length to the character sequence represented by this <code>String
     * </code> object and with every character equal to the result of applying the method <code>
     * Character.toUpperCase</code> to the corresponding character of this <code>String</code>
     * object.
     *
     * <p>Examples:
     *
     ...
     *
     * <p>If this <code>String</code> object represents an empty character sequence, or the first
     * and last characters of character sequence represented by this <code>String</code> object both
     * have codes greater than <code>'&#92;u0020'</code> (the space character), then a reference to
     * this <code>String</code> object is returned.
     *
     * <p>Otherwise, if there is no character with a code greater than <code>'&#92;u0020'</code> in
     * the string, then a new <code>String</code> object representing an empty string is created and
     * returned.
     *
     * <p>Otherwise, let <i>k</i> be the index of the first character in the string whose code is
     ...
     * at index <i>k</i> and ends with the character at index <i>m</i>-that is, the result of <code>
     * this.substring(<i>k</i>,&nbsp;<i>m</i>+1)</code>.
     *
     * <p>This method may be used to trim {@link Character#isSpace(char) whitespace} from the
     ...
     *
     * @return A double value representation of the string, or return Double.NaN if the string can
     *     not be converted.
     */
