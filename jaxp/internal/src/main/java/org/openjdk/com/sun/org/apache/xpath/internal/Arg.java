...
public class Arg {
    ...
    /**
     * Have the object release it's resources. Call only when the variable or argument is going out
     * of scope.
     */
    public void detach() {
        if (null != m_val) {
    ...
    /**
     * True if this variable is currently visible. To be visible, a variable needs to come either
     * from xsl:variable or be a "received" parameter, ie one for which an xsl:param has been
     * encountered. Set at the time the object is constructed and updated as needed.
     */
