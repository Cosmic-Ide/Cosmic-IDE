 ...
 *
 * <p>This has been changed from the previous incarnations of this class to be fairly low level.
 *
 * @xsl.usage internal
 */
public class VariableStack implements Cloneable {
    ...
    /**
     * The stack of frame positions. I call 'em links because of distant <a
     * href="http://math.millikin.edu/mprogers/Courses/currentCourses/CS481-ComputerArchitecture/cs481.Motorola68000.html">
    ...
    /**
     * Get the position from where the search should start, which is either the searchStart
     * property, or the top of the stack if that value is -1.
     *
    ...
    /**
     * Allocates memory (called a stackframe) on the stack; used to store local variables and
     * parameter arguments.
     *
     * <p>I use the link/unlink concept because of distant <a
     * href="http://math.millikin.edu/mprogers/Courses/currentCourses/CS481-ComputerArchitecture/cs481.Motorola68000.html">
     * Motorola 68000 assembler</a> memories.
     *
     * @param size The size of the stack frame allocation. This ammount should normally be the
     *     maximum number of variables that you can have allocated at one time in the new stack
     *     frame.
     * @return The bottom of the stack frame, from where local variable addressing should start
     *     from.
     */
     ...
     *
     * @param index Local variable index relative to the current stack frame bottom. NEEDSDOC @param
     *     stackFrame
     * @param val The value of the variable that is being set.
     */
    ...
    /**
     * Use this to clear the variables in a section of the stack. This is used to clear the
     * parameter section of the stack, so that default param values can tell if they've already been
     * set. It is important to note that this function has a 1K limitation.
     *
