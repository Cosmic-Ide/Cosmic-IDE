...
import org.openjdk.com.sun.org.apache.xml.internal.utils.SAXSourceLocator;
...
import org.openjdk.com.sun.org.apache.xpath.internal.compiler.XPathParser;
...
public class XPath implements Serializable, ExpressionOwner {
    ...
    public XPath(
        ...
        initFunctionTable();
        if (null == errorListener) errorListener = new DefaultErrorHandler();
     ...
     * @throws TransformerException thrown if the error condition is severe enough to halt
     *     processing.
     * @throws org.openjdk.javax.xml.transform.TransformerException
    ...
    public void warn(XPathContext xctxt, int sourceNode, String msg, Object[] args)
        ...
        if (null != ehandler) {
            ...
            ehandler.warning(
                    new TransformerException(fmsg, (SAXSourceLocator) xctxt.getSAXLocator()));
        }
    }
