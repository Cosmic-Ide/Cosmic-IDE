...
import org.openjdk.com.sun.org.apache.xpath.internal.axes.AxesWalker;
import org.openjdk.com.sun.org.apache.xpath.internal.axes.LocPathIterator;
import org.openjdk.com.sun.org.apache.xpath.internal.axes.UnionPathIterator;
...
import org.openjdk.com.sun.org.apache.xpath.internal.functions.WrongNumberArgsException;
...
import org.openjdk.com.sun.org.apache.xpath.internal.operations.And;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Bool;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Div;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Equals;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Gt;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Gte;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Lt;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Lte;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Minus;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Mod;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Mult;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Neg;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.NotEquals;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Number;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Operation;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Or;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Plus;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.String;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.UnaryOperation;
import org.openjdk.com.sun.org.apache.xpath.internal.operations.Variable;
import org.openjdk.com.sun.org.apache.xpath.internal.patterns.FunctionPattern;
import org.openjdk.com.sun.org.apache.xpath.internal.patterns.NodeTest;
import org.openjdk.com.sun.org.apache.xpath.internal.patterns.StepPattern;
import org.openjdk.com.sun.org.apache.xpath.internal.patterns.UnionPattern;
...
public class Compiler extends OpMap {
     ...
     *     sent to System err.
     * @param locator The location object where the expression lives, which may be null, but which,
     *     if not null, must be valid over the long haul, in other words, it will not be cloned.
    ...
    /**
     * Compile a location path. The LocPathIterator itself may create {@link AxesWalker} children.
     *
     * @param opPos The current position in the m_opMap array.
     * @return reference to {@link LocPathIterator} instance.
     * @throws TransformerException if a error occurs creating the Expression.
    ...
    /**
     * Get a {@link org.w3c.dom.traversal.NodeFilter} bit set that tells what to show for a given
     * node test.
     *
     ...
     *
     * @param opPos The position of the first predicate the m_opMap array.
     * @param predicates An empty pre-determined array of {@link Expression}s, that will be filled
     *     in.
     * @throws TransformerException
     */
    ...
    Expression compileFunction(int opPos) throws TransformerException {
        ...
        if (-1 != funcID) {
            ...
            /**
             * It is a trick for function-available. Since the function table is an instance field,
             * insert this table at compilation time for later usage
             */
    ...
    private Expression compileExtension(int opPos) throws TransformerException {
        ...
        Function extension =
                new FuncExtFunction(ns, funcName, java.lang.String.valueOf(getNextMethodId()));
    ...
    public void warn(String msg, Object[] args) throws TransformerException {
        ...
        java.lang.String fmsg =
                "empty messg"; // XSLMessages.createXPATHWarning(msg.toString(), args).toString();
    ...
    public void error(String msg, Object[] args) throws TransformerException {
        ...
        java.lang.String fmsg =
                "todo line 1221"; // XSLMessages.createXPATHMessage(msg, args).toString();
    ...
    /**
     * The error listener where errors will be sent. If this is null, errors and warnings will be
     * sent to System.err. May be null.
     */
