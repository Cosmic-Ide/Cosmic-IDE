...
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncBoolean;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncCeiling;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncConcat;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncContains;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncCount;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncCurrent;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncDoclocation;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncExtElementAvailable;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncExtFunctionAvailable;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncFalse;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncFloor;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncGenerateId;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncId;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncLang;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncLast;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncLocalPart;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncNamespace;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncNormalizeSpace;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncNot;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncNumber;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncPosition;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncQname;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncRound;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncStartsWith;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncString;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncStringLength;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncSubstring;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncSubstringAfter;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncSubstringBefore;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncSum;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncSystemProperty;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncTranslate;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncTrue;
import org.openjdk.com.sun.org.apache.xpath.internal.functions.FuncUnparsedEntityURI;
...
public class FunctionTable {
    ...
    static {
        ...
        m_functions[FUNC_LOCAL_PART] = FuncLocalPart.class;
        m_functions[FUNC_NAMESPACE] = FuncNamespace.class;
        m_functions[FUNC_QNAME] = FuncQname.class;
        m_functions[FUNC_GENERATE_ID] = FuncGenerateId.class;
        ...
        m_functions[FUNC_STARTS_WITH] = FuncStartsWith.class;
        m_functions[FUNC_CONTAINS] = FuncContains.class;
        m_functions[FUNC_SUBSTRING_BEFORE] = FuncSubstringBefore.class;
        m_functions[FUNC_SUBSTRING_AFTER] = FuncSubstringAfter.class;
        m_functions[FUNC_NORMALIZE_SPACE] = FuncNormalizeSpace.class;
        m_functions[FUNC_TRANSLATE] = FuncTranslate.class;
        m_functions[FUNC_CONCAT] = FuncConcat.class;
        m_functions[FUNC_SYSTEM_PROPERTY] = FuncSystemProperty.class;
        m_functions[FUNC_EXT_FUNCTION_AVAILABLE] = FuncExtFunctionAvailable.class;
        m_functions[FUNC_EXT_ELEM_AVAILABLE] = FuncExtElementAvailable.class;
        m_functions[FUNC_SUBSTRING] = FuncSubstring.class;
        m_functions[FUNC_STRING_LENGTH] = FuncStringLength.class;
        m_functions[FUNC_DOCLOCATION] = FuncDoclocation.class;
        m_functions[FUNC_UNPARSED_ENTITY_URI] = FuncUnparsedEntityURI.class;
    }
    ...
    static {
        ...
        m_functionID.put(
                Keywords.FUNC_LOCAL_PART_STRING, new Integer(FunctionTable.FUNC_LOCAL_PART));
        ...
        m_functionID.put(
                Keywords.FUNC_GENERATE_ID_STRING, new Integer(FunctionTable.FUNC_GENERATE_ID));
        ...
        m_functionID.put(
                Keywords.FUNC_STARTS_WITH_STRING, new Integer(FunctionTable.FUNC_STARTS_WITH));
        ...
        m_functionID.put(
                Keywords.FUNC_SUBSTRING_AFTER_STRING,
                new Integer(FunctionTable.FUNC_SUBSTRING_AFTER));
        m_functionID.put(
                Keywords.FUNC_NORMALIZE_SPACE_STRING,
        ...
        m_functionID.put(
                Keywords.FUNC_SYSTEM_PROPERTY_STRING,
                new Integer(FunctionTable.FUNC_SYSTEM_PROPERTY));
        m_functionID.put(
                Keywords.FUNC_EXT_FUNCTION_AVAILABLE_STRING,
                new Integer(FunctionTable.FUNC_EXT_FUNCTION_AVAILABLE));
        m_functionID.put(
                Keywords.FUNC_EXT_ELEM_AVAILABLE_STRING,
        ...
        m_functionID.put(
                Keywords.FUNC_UNPARSED_ENTITY_URI_STRING,
                new Integer(FunctionTable.FUNC_UNPARSED_ENTITY_URI));
        m_functionID.put(
                Keywords.FUNC_DOCLOCATION_STRING, new Integer(FunctionTable.FUNC_DOCLOCATION));
    }
     ...
     *     {@link FunctionTable}, but may be a value installed by an external module.
     ...
     */
    Function getFunction(int which) throws org.openjdk.javax.xml.transform.TransformerException {
        try {
