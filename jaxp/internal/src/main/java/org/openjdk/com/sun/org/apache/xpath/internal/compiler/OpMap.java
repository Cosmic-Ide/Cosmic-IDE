...
import org.openjdk.com.sun.org.apache.xml.internal.utils.ObjectVector;
...
public class OpMap {
     ...
     * m_tokenQueue. The idea is that the queue can be marked and a sequence of tokens can be
     * reused.
     */
     ...
     * indexes into the m_tokenQueue. I use an array instead of a full parse tree in order to cut
     * down on the number of objects created.
     */
    ...
    /**
     * Given an operation position, return the end position, i.e. the beginning of the next
     * operation.
     *
    ...
    public void error(String msg, Object[] args)
        ...
        throw new org.openjdk.javax.xml.transform.TransformerException(fmsg);
    }
