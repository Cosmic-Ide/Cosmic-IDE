...
import org.openjdk.com.sun.org.apache.xml.internal.utils.PrefixResolver;
import org.openjdk.com.sun.org.apache.xpath.internal.XPathProcessorException;
import org.openjdk.com.sun.org.apache.xpath.internal.domapi.XPathStylesheetDOM3Exception;
...
public class XPathParser {
    ...
    /**
     * The first char in m_token, the theory being that this is an optimization because we won't
     * have to do charAt(0) as often.
     */
    ...
    public XPathParser(
            ...
            org.openjdk.javax.xml.transform.SourceLocator sourceLocator) {
    ...
    /**
     * Given an string, init an XPath object for selections, in order that a parse doesn't have to
     * be done each time the expression is evaluated.
     *
     * @param compiler The compiler object.
     * @param expression A string conforming to the XPath grammar.
     * @param namespaceContext An object that is able to resolve prefixes in the XPath to
     *     namespaces.
    ...
    org.openjdk.javax.xml.transform.SourceLocator m_sourceLocator;
     ...
     * @param n number of tokens to look behind. Must be greater than 1. Note that the look behind
     *     terminates at either the beginning of the string or on a '|' character. Because of this,
     *     this method should only be used for pattern matching.
     * @return true if the token behind the current token matches the character argument.
     */
     ...
     *     XPATHErrorResources}, which is a key for a format string.
     ...
     *
     * <p>This method is exactly like error(String, Object[]); except that the underlying
     * TransformerException is XpathStylesheetDOM3Exception (which extends TransformerException).
     *
     * <p>So older XPath code in Xalan is not affected by this. To older XPath code the behavior of
     * whether error() or errorForDOM3() is called because it is always catching
     * TransformerException objects and is oblivious to the new subclass of
     * XPathStylesheetDOM3Exception. Older XPath code runs as before.
     *
     * <p>However, newer DOM3 XPath code upon catching a TransformerException can can check if the
     * exception is an instance of XPathStylesheetDOM3Exception and take appropriate action.
     *
     * @param msg An error msgkey that corresponds to one of the constants found in {@link
     *     XPATHErrorResources}, which is a key for a format string.
     * @param args An array of arguments represented in the format string, which may be null.
    ...
    /**
     * Insert room for operation. This will NOT set the length value of the operation, but will
     * update the length value for the total expression.
     *
    ...
    /**
     * Insert room for operation. This WILL set the length value of the operation, and will update
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void Expr() throws org.openjdk.javax.xml.transform.TransformerException {
        OrExpr();
    }
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void OrExpr() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void AndExpr() throws org.openjdk.javax.xml.transform.TransformerException {
    ...
    /**
     * This has to handle construction of the operations so that they are evaluated in pre-fix
     * order. So, for 9+7-6, instead of |+|9|-|7|6|, this needs to be evaluated as |-|+|9|7|6|.
     *
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void UnaryExpr() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void StringExpr() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void BooleanExpr() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void NumberExpr() throws org.openjdk.javax.xml.transform.TransformerException {
    ...
    /**
     * The context of the right hand side expressions is the context of the left hand side
     * expression. The results of the right hand side expressions are node sets. The result of the
     * left hand side UnionExpr is the union of the results of the right hand side expressions.
     *
     * <p>UnionExpr ::= PathExpr | UnionExpr '|' PathExpr
     *
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void UnionExpr() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void PathExpr() throws org.openjdk.javax.xml.transform.TransformerException {
        ...
        if (filterExprMatch != FILTER_MATCH_FAILED) {
            ...
            if (locationPathStarted) {
                ...
                m_ops.setOp(OpMap.MAPINDEX_LENGTH, m_ops.getOp(OpMap.MAPINDEX_LENGTH) + 1);
                m_ops.setOp(
                        opPos + OpMap.MAPINDEX_LENGTH, m_ops.getOp(OpMap.MAPINDEX_LENGTH) - opPos);
            }
        } else {
            LocationPath();
        }
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected int FilterExpr() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected boolean PrimaryExpr() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void Argument() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected boolean FunctionCall() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void LocationPath() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected boolean Step() throws org.openjdk.javax.xml.transform.TransformerException {
        int opPos = m_ops.getOp(OpMap.MAPINDEX_LENGTH);
        ...
        if (doubleSlash) {
            ...
            // Tell how long the step is without the predicate
            m_ops.setOp(
                    opPos + OpMap.MAPINDEX_LENGTH + 1, m_ops.getOp(OpMap.MAPINDEX_LENGTH) - opPos);
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void Basis() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected int AxisName() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void Predicate() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void PredicateExpr() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void QName() throws org.openjdk.javax.xml.transform.TransformerException {
        // Namespace
        if (lookahead(':', 1)) {
            m_ops.setOp(m_ops.getOp(OpMap.MAPINDEX_LENGTH), m_queueMark - 1);
            m_ops.setOp(OpMap.MAPINDEX_LENGTH, m_ops.getOp(OpMap.MAPINDEX_LENGTH) + 1);
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void Literal() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void Number() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void Pattern() throws org.openjdk.javax.xml.transform.TransformerException {
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void IdKeyPattern() throws org.openjdk.javax.xml.transform.TransformerException {
        FunctionCall();
    }
     ...
     *
     * @param isLeadingSlashPermitted a boolean indicating whether a slash can appear at the start
     *     of this step
