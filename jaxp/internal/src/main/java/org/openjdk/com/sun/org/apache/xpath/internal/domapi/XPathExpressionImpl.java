...
/**
 * The class provides an implementation of XPathExpression according to the DOM L3 XPath
 ...
 *
 * <p>The <code>XPathExpression</code> interface represents a parsed and resolved XPath expression.
 *
...
class XPathExpressionImpl implements XPathExpression {
    ...
    /**
     * This method provides an implementation XPathResult.evaluate according to the DOM L3 XPath
     * Specification, Working Group Note 26 February 2004.
     *
     * <p>See also the <a href='http://www.w3.org/TR/2004/NOTE-DOM-Level-3-XPath-20040226'>Document
     * Object Model (DOM) Level 3 XPath Specification</a>.
     *
     * <p>Evaluates this XPath expression and returns a result.
     *
     ...
     *     return the specified type relying on XPath conversions and fail if the desired coercion
     *     is not possible. This must be one of the type codes of <code>XPathResult</code>.
     ...
     * @exception XPathException TYPE_ERR: Raised if the result cannot be converted to return the
     *     specified type.
     * @exception DOMException WRONG_DOCUMENT_ERR: The Node is from a document that is not supported
     *     by the XPathEvaluator that created this <code>XPathExpression</code>. <br>
    ...
    public Object evaluate(Node contextNode, short type, Object result)
        ...
        if (!XPathResultImpl.isValidType(type)) {
            ...
            throw new XPathException(
                    XPathException.TYPE_ERR, fmsg); // Invalid XPath type argument: {0}
        }
        ...
        try {
            ...
            throw new XPathException(
                    XPathException.INVALID_EXPRESSION_ERR, te.getMessageAndLocation());
        }
