...
public class FuncSystemProperty extends FunctionOneArg {
    ...
    static final String XSLT_PROPERTIES =
            "org/openjdk/com/sun/org/apache/xalan/internal/res/XSLTInfo.properties";
     ...
     *
     * @param file The string name of the property file. The name should already be fully qualified
     *     as path/filename
    ...
    public void loadPropertyFile(String file, Properties target) {
        try {
            ...
            InputStream is =
                    SecuritySupport.getResourceAsStream(ObjectFactory.findClassLoader(), file);
