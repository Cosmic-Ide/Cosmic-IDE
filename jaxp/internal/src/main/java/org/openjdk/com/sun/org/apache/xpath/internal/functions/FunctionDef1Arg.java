...
public class FunctionDef1Arg extends FunctionOneArg {
    ...
    /**
     * Execute the first argument expression that is expected to return a nodeset. If the argument
     * is null, then return the current context node.
     *
     ...
     *
     * @param xctxt Runtime XPath context.
     * @return The string value of the first argument, or the string value of the current context
     ...
     *
     * @param xctxt Runtime XPath context.
     * @return The number value of the first argument, or the number value of the current context
     *     node if the first argument is null.
     * @throws org.openjdk.javax.xml.transform.TransformerException if an error occurs while
     *     executing the argument expression.
     */
    ...
    protected void reportWrongNumberArgs() throws WrongNumberArgsException {
        throw new WrongNumberArgsException(
                XSLMessages.createXPATHMessage(
                        XPATHErrorResources.ER_ZERO_OR_ONE, null)); // "0 or 1");
    }
