...
public class XPathExpressionImpl implements org.openjdk.javax.xml.xpath.XPathExpression {
    ...
    private XObject eval(Object contextItem)
        ...
        if (contextNode == null) xobj = xpath.execute(xpathSupport, DTM.NULL, prefixResolver);
        else xobj = xpath.execute(xpathSupport, contextNode, prefixResolver);
     ...
     * </code> of {@link XPathConstants#STRING}.
     *
     * <p>See "Evaluation of XPath Expressions" section of JAXP 1.3 spec for context item
     * evaluation, variable, function and QName resolution and return type conversion.
     *
