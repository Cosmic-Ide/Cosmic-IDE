...
import org.openjdk.com.sun.org.apache.xpath.internal.*;
...
import org.openjdk.com.sun.org.apache.xpath.internal.XPathFactory;
 ...
 * org.openjdk.javax.xml.xpath.XPath interface. This provide simple access to the results of an
 * XPath expression.
 *
...
public class XPathImpl implements org.openjdk.javax.xml.xpath.XPath {
    ...
    XPathImpl(
            XPathVariableResolver vr,
            XPathFunctionResolver fr,
            boolean featureSecureProcessing,
            boolean useServiceMechanism,
     ...
     * the specified type.
     *
     * <p>See "Evaluation of XPath Expressions" section of JAXP 1.3 spec for context item
     * evaluation, variable, function and <code>QName</code> resolution and return type conversion.
     *
     * <p>If <code>returnType</code> is not one of the types defined in {@link XPathConstants} (
     * {@link XPathConstants#NUMBER NUMBER}, {@link XPathConstants#STRING STRING}, {@link
     * XPathConstants#BOOLEAN BOOLEAN}, {@link XPathConstants#NODE NODE} or {@link
     * XPathConstants#NODESET NODESET}) then an <code>IllegalArgumentException</code> is thrown.
     *
    ...
    public Object evaluate(String expression, Object item, QName returnType)
        ...
        if (returnType == null) {
            String fmsg =
                    XSLMessages.createXPATHMessage(
                            XPATHErrorResources.ER_ARG_CANNOT_BE_NULL, new Object[] {"returnType"});
            throw new NullPointerException(fmsg);
        }
     ...
     * a <code>returnType</code> of {@link XPathConstants#STRING}.
     *
     * <p>See "Evaluation of XPath Expressions" of JAXP 1.3 spec for context item evaluation,
     ...
     * the {@link XPathFunctionResolver}. An {@link XPathExpressionException} will be thrown if the
     * <code>XPathFunction</code> cannot be resovled with the <code>XPathFunctionResolver</code>.
     *
    ...
    public XPathExpression compile(String expression) throws XPathExpressionException {
        ...
        try {
            ...
            XPathExpressionImpl ximpl =
                    new XPathExpressionImpl(
                            xpath,
                            prefixResolver,
                            functionResolver,
                            variableResolver,
     ...
     *
     * <p>If <code>returnType</code> is not one of the types defined in {@link XPathConstants}, then
    ...
    public Object evaluate(String expression, InputSource source, QName returnType)
        ...
        if (source == null) {
            String fmsg =
                    XSLMessages.createXPATHMessage(
                            XPATHErrorResources.ER_ARG_CANNOT_BE_NULL, new Object[] {"source"});
            throw new NullPointerException(fmsg);
        }
        if (expression == null) {
            String fmsg =
     ...
     * XPathFunctionResolver}, {@link XPathVariableResolver} or {@link NamespaceContext} <code>
     * Object</code>s, e.g. {@link Object#equals(Object obj)}. It is guaranteed to have a
     * functionally equal <code>XPathFunctionResolver</code>, <code>XPathVariableResolver</code> and
