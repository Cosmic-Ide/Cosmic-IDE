...
import org.openjdk.com.sun.org.apache.xpath.internal.XPathException;
...
public class XObject extends Expression implements Serializable, Cloneable {
    ...
    /**
     * Specify if it's OK for detach to release the iterator for reuse. This function should be
     * called with a value of false for objects that are stored in variables. Calling this with a
     * value of false on a XNodeSet will cause the nodeset to be cached.
     *
    ...
    /**
     * Create the right XObject based on the type of the object passed. This function can not make
     * an XObject that exposes DOM Nodes, NodeLists, and NodeIterators to the XSLT stylesheet as
     * node-sets.
     *
    ...
    /**
     * Create the right XObject based on the type of the object passed. This function
     * <emph>can</emph> make an XObject that exposes DOM Nodes, NodeLists, and NodeIterators to the
     * XSLT stylesheet as node-sets.
     *
     * @param val The java object which this object will wrap.
    ...
    public double num() throws org.openjdk.javax.xml.transform.TransformerException {
        ...
        error(
                ...
                new Object[] {
                    getTypeString()
                }); // "Can not convert "+getTypeString()+" to a number");
     ...
     * iterator.
     *
     * @return numeric value of the string conversion from the next node in the NodeSetDTM, or NAN
    ...
    public DTMIterator iter() throws org.openjdk.javax.xml.transform.TransformerException {
        ...
        error(
                ...
                new Object[] {
                    getTypeString()
                }); // "Can not convert "+getTypeString()+" to a NodeList!");
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    public NodeSetDTM mutableNodeset() throws org.openjdk.javax.xml.transform.TransformerException {

        error(
                XPATHErrorResources.ER_CANT_CONVERT_TO_MUTABLENODELIST,
                new Object[] {
                    getTypeString()
                }); // "Can not convert "+getTypeString()+" to a NodeSetDTM!");
     ...
     * @throws org.openjdk.javax.xml.transform.TransformerException
     */
    protected void error(String msg) throws org.openjdk.javax.xml.transform.TransformerException {
        error(msg, null);
    }
