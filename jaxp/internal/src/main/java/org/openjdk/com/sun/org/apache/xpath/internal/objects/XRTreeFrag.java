...
import org.openjdk.com.sun.org.apache.xalan.internal.lib.ExsltCommon;
...
import org.openjdk.com.sun.org.apache.xml.internal.dtm.ref.DTMNodeList;
...
public class XRTreeFrag extends XObject implements Cloneable {
    ...
    /**
     * Cast result object to a boolean. This always returns true for a RTreeFrag because it is
     * treated like a node-set with a single root node.
     *
     * @return true
     */
    public boolean bool() {
     ...
     * EXSLT object-type function in {@link ExsltCommon}.
     *
    ...
    public NodeList convertToNodeset() {
        ...
        else return new DTMNodeList(asNodeIterator());
    }
    ...
    public boolean equals(XObject obj2) {
        ...
        try {
            if (CLASS_NODESET == obj2.getType()) {

                // In order to handle the 'all' semantics of
                // nodeset comparisons, we always call the
                // nodeset function.
                return obj2.equals(this);
            } else if (CLASS_BOOLEAN == obj2.getType()) {
                return bool() == obj2.bool();
            } else if (CLASS_NUMBER == obj2.getType()) {
                return num() == obj2.num();
            } else if (CLASS_NODESET == obj2.getType()) {
                return xstr().equals(obj2.xstr());
            } else if (CLASS_STRING == obj2.getType()) {
                return xstr().equals(obj2.xstr());
            } else if (CLASS_RTREEFRAG == obj2.getType()) {
