...
public class XStringForFSB extends XString {
    ...
    private XStringForFSB(String val) {
        ...
        throw new IllegalArgumentException(
                XSLMessages.createXPATHMessage(
                        ...
                        null)); // "XStringForFSB can not take a string for an argument!");
    }
    ...
    /**
     * Since this object is incomplete without the length and the offset, we have to convert to a
    ...
    public void getChars(int srcBegin, int srcEnd, char dst[], int dstBegin) {
        ...
        if (n > (dst.length - dstBegin)) n = (dst.length - dstBegin);
    ...
    public boolean equals(Object obj2) {
        ...
        if (obj2 instanceof XNumber) return obj2.equals(this);

        // In order to handle the 'all' semantics of
        // nodeset comparisons, we always call the
        // nodeset function.
        else if (obj2 instanceof XNodeSet) return obj2.equals(this);
        else if (obj2 instanceof XStringForFSB) return equals((XMLString) obj2);
        else return equals(obj2.toString());
    }
     ...
     *
     * <p>%OPT% CHECK PERFORMANCE against generating a Java String and converting it to double. The
     * advantage of running in native machine code -- perhaps even microcode, on some systems -- may
     * more than make up for the cost of allocating and discarding the additional object. We need to
     * benchmark this.
     *
     * <p>%OPT% More importantly, we need to decide whether we _care_ about the performance of this
     * operation. Does XString.toDouble constitute any measurable percentage of our typical runtime?
     * I suspect not!
     *
    ...
    public double toDouble() {
        ...
        for (i = 0; i < m_length; i++)
            if (!XMLCharacterRecognizer.isWhiteSpace(valueString.charAt(i))) break;
