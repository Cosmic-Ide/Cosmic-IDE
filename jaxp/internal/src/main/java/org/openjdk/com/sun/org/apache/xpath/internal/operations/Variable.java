...
import org.openjdk.com.sun.org.apache.xpath.internal.axes.PathComponent;
...
public class Variable extends Expression implements PathComponent {
    ...
    /**
     * The index of the variable, which is either an absolute index to a global, or, if higher than
     * the globals area, must be adjusted by adding the offset to the current stack frame.
     */
    ...
    /**
     * Dereference the variable, and return the reference value. Note that lazy evaluation will
     * occur. If a variable within scope is not found, a warning will be sent to the error listener,
     * and an empty nodeset will be returned.
     *
    ...
    public XObject execute(XPathContext xctxt, boolean destructiveOK)
        ...
        if (null == result) {
            ...
            //            new Object[]{ m_qname.getLocalPart() });  //"Could not get variable named
            // "+varName);
        ...
        //      }
        //      throw new
        // org.openjdk.javax.xml.transform.TransformerException(XSLMessages.createXPATHMessage(XPATHErrorResources.ER_VAR_NOT_RESOLVABLE, new Object[]{m_qname.toString()})); //"Variable not resolvable: "+m_qname);
        //    }
    }
    ...
    */
    ...
    public boolean deepEquals(Expression expr) {
        ...
        if (!m_qname.equals(((Variable) expr).m_qname)) return false;
