...
import org.openjdk.com.sun.xml.internal.stream.events.XMLEventAllocatorImpl;
...
public class XMLEventReaderImpl implements org.openjdk.javax.xml.stream.XMLEventReader {
    ...
    public XMLEvent nextTag() throws XMLStreamException {
        ...
        if (fPeekedEvent != null) {
            ...
            // we have to have the while loop because there can be many PI or comment event in
            // sucession
    ...
    public XMLEvent peek() throws XMLStreamException {
        ...
        if (hasNext()) {
            ...
            // Can it be an application knows that there is particularly very large 'comment'
            // section
