...
package org.openjdk.com.sun.xml.internal.stream.dtd;
...
import org.openjdk.com.sun.xml.internal.stream.dtd.nonvalidating.XMLAttributeDecl;
import org.openjdk.com.sun.xml.internal.stream.dtd.nonvalidating.XMLElementDecl;
import org.openjdk.com.sun.xml.internal.stream.dtd.nonvalidating.XMLSimpleType;
...
public class DTDGrammarUtil {
    ...
    public DTDGrammarUtil(
            DTDGrammar grammar, SymbolTable symbolTable, NamespaceContext namespaceContext) {
        fDTDGrammar = grammar;
        fSymbolTable = symbolTable;
        ...
        while (attlistIndex != -1) {
            ...
            if (!cdata || required || attValue != null) {
                ...
                if (fNamespaceContext != null
                        && attRawName.startsWith(XMLConstants.XMLNS_ATTRIBUTE)) {
                    String prefix = "";
