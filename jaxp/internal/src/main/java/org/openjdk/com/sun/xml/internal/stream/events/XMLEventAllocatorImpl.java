...
public class XMLEventAllocatorImpl implements XMLEventAllocator {
    ...
    public org.openjdk.javax.xml.stream.events.XMLEvent allocate(
            org.openjdk.javax.xml.stream.XMLStreamReader xMLStreamReader)
            throws org.openjdk.javax.xml.stream.XMLStreamException {
        if (xMLStreamReader == null) throw new XMLStreamException("Reader cannot be null");
    ...
    public void allocate(
            org.openjdk.javax.xml.stream.XMLStreamReader xMLStreamReader,
            org.openjdk.javax.xml.stream.util.XMLEventConsumer xMLEventConsumer)
            throws org.openjdk.javax.xml.stream.XMLStreamException {
        XMLEvent currentEvent = getXMLEvent(xMLStreamReader);
        if (currentEvent != null) xMLEventConsumer.add(currentEvent);
            ...
            case XMLEvent.START_ELEMENT:
                {
                    ...
                    // we might have different XMLStreamReader so check every time for the namespace
                    // aware property
                    // we should be setting namespace related values only when isNamespaceAware is
                    // 'true'
            ...
            case XMLEvent.DTD:
                {
                    ...
                    List notations =
                            (List) streamReader.getProperty(PropertyManager.STAX_NOTATIONS);
