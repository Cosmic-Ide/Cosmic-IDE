...
/**
 * This class is used to write a stream of chars as a stream of bytes using the UTF8 encoding. It
 * assumes that the underlying output stream is buffered or does not need additional buffering.
 *
 * <p>It is more efficient than using a <code>java.io.OutputStreamWriter</code> because it does not
 * need to be wrapped in a <code>java.io.BufferedWriter</code>. Creating multiple instances of
 * <code>java.io.BufferedWriter</code> has been shown to be very expensive in JAX-WS.
 *
...
public final class UTF8OutputStreamWriter extends Writer {
    ...
    /**
     * Java represents chars that are not in the Basic Multilingual Plane (BMP) in UTF-16. This int
     * stores the first code unit for a code point encoded in two UTF-16 code units.
     */
    ...
    public void write(int c) throws IOException {
        ...
        if (lastUTF16CodePoint != 0) {
            final int uc = (((lastUTF16CodePoint & 0x3ff) << 10) | (c & 0x3ff)) + 0x10000;
    ...
    public void close() throws IOException {
        if (lastUTF16CodePoint != 0) {
            throw new IllegalStateException(
                    "Attempting to close a UTF8OutputStreamWriter"
