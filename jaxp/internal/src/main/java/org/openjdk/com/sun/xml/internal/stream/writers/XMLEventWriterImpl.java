...
public class XMLEventWriterImpl implements XMLEventWriter {
     ...
     */
    public void add(org.openjdk.javax.xml.stream.XMLEventReader xMLEventReader)
     ...
     * @throws XMLStreamException
     */
    public void add(org.openjdk.javax.xml.stream.events.XMLEvent xMLEvent)
            throws org.openjdk.javax.xml.stream.XMLStreamException {
        ...
        switch (type) {
            ...
            case XMLEvent.START_ELEMENT:
                {
                    ...
                    fStreamWriter.writeStartElement(
                    ...
                    // This Iterator does not contain
                    // previously declared namespaces unless they appear on the current
                    // START_ELEMENT. Therefore
                    // this list may contain redeclared namespaces and duplicate namespace
                    // declarations. Use the
                    // getNamespaceContext() method to get the current context of namespace
                    // declarations.

                    // so we should be using getNamespaces() to write namespace declarations for
                    // this START_ELEMENT
                    Iterator iterator = startElement.getNamespaces();
                    while (iterator.hasNext()) {
                        Namespace namespace = (Namespace) iterator.next();
                        fStreamWriter.writeNamespace(
                                namespace.getPrefix(), namespace.getNamespaceURI());
                    }
            ...
            case XMLEvent.PROCESSING_INSTRUCTION:
                {
                    ...
                    fStreamWriter.writeProcessingInstruction(
            ...
            case XMLEvent.ENTITY_REFERENCE:
                {
                    ...
                    if (DEBUG)
                        System.out.println(
                                "Adding Entity Reference = " + entityReference.toString());
            ...
            case XMLEvent.END_ELEMENT:
                {
                    // we dont need to typecast it.. just call writeEndElement() and fStreamWriter
            ...
            case XMLEvent.END_DOCUMENT:
                {
                    // we dont need to typecast just call writeEndDocument() and fStreamWriter will
                    // take care rest.
    ...
    public void setNamespaceContext(
            org.openjdk.javax.xml.namespace.NamespaceContext namespaceContext)
            throws org.openjdk.javax.xml.stream.XMLStreamException {
