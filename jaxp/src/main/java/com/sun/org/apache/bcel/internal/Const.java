 ...
 *
 * @since 6.0 (intended to replace the Constants interface) @LastModified: May 2021
 */
public final class Const {
     ...
     */
    @Deprecated public static final short MAJOR_1_9 = MAJOR_9;

    /**
     * @deprecated Use {@link #MINOR_9} instead
     */
    @Deprecated public static final short MINOR_1_9 = MINOR_9;
     ...
     *     Flag definitions for Classes in the Java Virtual Machine Specification (Java SE 9
     *     Edition).</a>
     * @see <a href="https://docs.oracle.com/javase/specs/jvms/se9/html/jvms-4.html#jvms-4.5">Flag
     *     definitions for Fields in the Java Virtual Machine Specification (Java SE 9 Edition).</a>
     * @see <a href="https://docs.oracle.com/javase/specs/jvms/se9/html/jvms-4.html#jvms-4.6">Flag
     *     definitions for Methods in the Java Virtual Machine Specification (Java SE 9
     *     Edition).</a>
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se9/html/jvms-4.html#jvms-4.7.6-300-D.1-D.1">
     *     Flag definitions for Inner Classes in the Java Virtual Machine Specification (Java SE 9
     *     Edition).</a>
     */
    ...
    /**
     * One of the access flags for fields, methods, classes, MethodParameter attribute, or Module
     * attribute.
     *
     * @see #ACC_PUBLIC
     */
     ...
     */
    @Deprecated public static final short MAX_ACC_FLAG = ACC_ENUM;
    ...
    // 'synchronized' is for methods, might be 'open' (if Module), 'super' (if class), or
     ...
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.4.7">The
     *     Constant Pool in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.4.4">The
     *     Constant Pool in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.4.5">The
     *     Constant Pool in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.4.1">The
     *     Constant Pool in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.4.2">The
     *     Constant Pool in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.4.3">The
     *     Constant Pool in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.4.6">The
     *     Constant Pool in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.4.8">The
     *     Constant Pool in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.4.9">The
     *     Constant Pool in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jvms/se9/html/jvms-4.html#jvms-4.4.11">The
     *     Constant Pool in The Java Virtual Machine Specification</a>
     * @since 6.1
     */
     ...
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jvms/se9/html/jvms-4.html#jvms-4.4.12">The
     *     Constant Pool in The Java Virtual Machine Specification</a>
     * @since 6.1
     */
    ...
    /**
     * The name of the static initializer, also called &quot;class initialization method&quot; or
     * &quot;interface initialization method&quot;. This is &quot;&lt;clinit&gt;&quot;.
     */
    public static final String STATIC_INITIALIZER_NAME = "<clinit>";

    /**
     * The name of every constructor method in a class, also called &quot;instance initialization
     * method&quot;. This is &quot;&lt;init&gt;&quot;.
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.11-100-A">The
     *     Java Virtual Machine Specification, Java SE 8 Edition, page 330, chapter 4.11.</a>
     */
    public static final int MAX_CP_ENTRIES = 65535;

    /**
     * Maximum code size (plus one; the code size must be LESS than this) One of the limitations of
     * the Java Virtual Machine. Note vmspec2 page 152 ("Limitations") says: "The amount of code per
     * non-native, non-abstract method is limited to 65536 bytes by the sizes of the indices in the
     * exception_table of the Code attribute (4.7.3), in the LineNumberTable attribute (4.7.8), and
     * in the LocalVariableTable attribute (4.7.9)." However this should be taken as an upper limit
     * rather than the defined maximum. On page 134 (4.8.1 Static Constants) of the same spec, it
     * says: "The value of the code_length item must be less than 65536." The entry in the
     * Limitations section has been removed from later versions of the spec; it is not present in
     * the Java SE 8 edition.
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.7.3-300-E">
     *     The Java Virtual Machine Specification, Java SE 8 Edition, page 104, chapter 4.7.</a>
     */
    public static final int MAX_CODE_SIZE = 65536; // bytes

    /**
     * The maximum number of dimensions in an array ({@value}). One of the limitations of the Java
     * Virtual Machine.
     *
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.aconst_null">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.iconst_i">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.lconst_l">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.fconst_f">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.dconst_d">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.bipush">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.sipush">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.ldc2_w">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.iload_n">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.lload_n">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.fload_n">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.dload_n">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.aload_n">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.iaload">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.laload">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.faload">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.daload">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.aaload">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.baload">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.caload">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.saload">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.istore">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.lstore">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.fstore">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.dstore">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.astore">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.istore_n">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.lstore_n">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.fstore_n">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.dstore_n">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.astore_n">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.iastore">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.lastore">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.fastore">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.dastore">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.aastore">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.bastore">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.castore">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.sastore">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.dup_x1">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.dup_x2">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.dup2_x1">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.dup2_x2">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     * Java VM opcode.
     *
     * @see <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5">Opcode
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.if_icmp_cond">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.if_acmp_cond">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.tableswitch">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.lookupswitch">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.ireturn">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.lreturn">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.freturn">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.dreturn">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.areturn">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.return">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.getstatic">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.putstatic">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.getfield">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.putfield">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.invokevirtual">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.invokespecial">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.invokestatic">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.invokeinterface">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.newarray">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.anewarray">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.arraylength">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.athrow">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.checkcast">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.instanceof">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.monitorenter">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.monitorexit">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.multianewarray">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.ifnull">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.ifnonnull">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5.goto_w">
     *     Opcode definitions in The Java Virtual Machine Specification</a>
     */
     ...
     *     Why the _quick opcodes were removed from the second version of the Java Virtual Machine
     *     Specification.</a>
     */
    ...
    /**
     * BCEL virtual instruction for pushing an arbitrary data type onto the stack. Will be converted
     * to the appropriate JVM opcode when the class is dumped.
     */
    public static final short PUSH = 4711;

    /**
     * BCEL virtual instruction for either LOOKUPSWITCH or TABLESWITCH. Will be converted to the
     * appropriate JVM opcode when the class is dumped.
     */
     ...
     *
     * @see <a
     *     href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.9.1-120-P">
    ...
    /**
     * The primitive class names corresponding to the T_XX constants, e.g., CLASS_TYPE_NAMES[T_INT]
     * = "java.lang.Integer"
     */
    ...
    /**
     * The signature characters corresponding to primitive types, e.g., SHORT_TYPE_NAMES[T_INT] =
     * "I"
     */
    ...
    private static final short[] NO_OF_OPERANDS = {
        ...
        2 /*jsr*/,
        1 /*ret*/,
        UNPREDICTABLE /*tableswitch*/,
        UNPREDICTABLE /*lookupswitch*/,
        0 /*ireturn*/,
        0 /*lreturn*/,
        0 /*freturn*/,
        0 /*dreturn*/,
    ...
    /**
     * How the byte code operands are to be interpreted for each opcode. Indexed by opcode.
     * TYPE_OF_OPERANDS[ILOAD] = an array of shorts describing the data types for the instruction.
     */
    private static final short[][] TYPE_OF_OPERANDS = {
        ...
        {T_SHORT} /*getfield*/,
        {T_SHORT} /*putfield*/,
        {T_SHORT} /*invokevirtual*/,
        {T_SHORT} /*invokespecial*/,
        {T_SHORT} /*invokestatic*/,
        {T_SHORT, T_BYTE, T_BYTE} /*invokeinterface*/,
        {T_SHORT, T_BYTE, T_BYTE} /*invokedynamic*/,
        {T_SHORT} /*new*/,
        {T_BYTE} /*newarray*/,
        {T_SHORT} /*anewarray*/,
        {} /*arraylength*/,
    ...
    /**
     * Number of words consumed on operand stack by instructions. Indexed by opcode.
     * CONSUME_STACK[FALOAD] = number of words consumed from the stack by a faload instruction.
     */
    ...
    /**
     * Number of words produced onto operand stack by instructions. Indexed by opcode.
     * CONSUME_STACK[DALOAD] = number of words consumed from the stack by a daload instruction.
     */
    private static final int[] PRODUCE_STACK = {
        ...
        0 /*areturn*/,
        0 /*return*/,
        UNPREDICTABLE /*getstatic*/,
        0 /*putstatic*/,
        UNPREDICTABLE /*getfield*/,
        0 /*putfield*/,
        UNPREDICTABLE /*invokevirtual*/,
        UNPREDICTABLE /*invokespecial*/,
        UNPREDICTABLE /*invokestatic*/,
     ...
     *
     * <p>For those types which can specify a range, the constant names the lowest value.
     */
