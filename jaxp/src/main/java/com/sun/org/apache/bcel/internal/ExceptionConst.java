 ...
 * Exception constants.
 *
 * @since 6.0 (intended to replace the InstructionConstant interface) @LastModified: May 2021
 */
public final class ExceptionConst {
    ...
    /**
     * Pre-defined exception arrays according to chapters 5.1-5.4 of the Java Virtual Machine
     * Specification
     */
    ...
    private static final Class<?>[] EXCS_INTERFACE_METHOD_RESOLUTION =
            new Class<?>[0]; // Chapter 5.3 (as below)
    ...
    /**
     * Enum corresponding to the various Exception Class arrays, used by {@link
    ...
    private static Class<?>[] mergeExceptions(
            final Class<?>[] input, final Class<?>... extraClasses) {
    ...
    /**
     * Creates a copy of the specified Exception Class array combined with any additional Exception
     * classes.
     *
