 ...
 * @see SyntheticRepository @LastModified: Jan 2020
 */
public abstract class Repository {
    ...
    /**
     * Lookups class somewhere found on your CLASSPATH, or whereever the repository instance looks
     * for it.
     *
     ...
     * @throws ClassNotFoundException if any of the class's superclasses or superinterfaces can't be
     *     found
     */
     ...
     * @throws ClassNotFoundException if the named class can't be found, or if any of its
    ...
    /**
     * @return true, if clazz is an implementation of interface inter
     * @throws ClassNotFoundException if clazz, inter, or any superclasses or superinterfaces of
    ...
    /**
     * @return true, if clazz is an implementation of interface inter
     * @throws ClassNotFoundException if inter or any superclasses or superinterfaces of clazz can't
     *     be found
     */
    ...
    /**
     * @return true, if clazz is an implementation of interface inter
     * @throws ClassNotFoundException if clazz or any superclasses or superinterfaces of clazz can't
     *     be found
     */
