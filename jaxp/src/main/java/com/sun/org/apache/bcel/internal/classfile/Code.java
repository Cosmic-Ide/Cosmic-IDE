 ...
 * <em>Attribute.readAttribute()</em> method. A <em>Code</em> attribute contains informations about
 * operand stack, local variables, byte code and the exceptions handled within this method.
 *
 * <p>This attribute has attributes itself, namely <em>LineNumberTable</em> which is used for
 * debugging purposes and <em>LocalVariableTable</em> which contains information about the local
 * variables.
 *
 * @see Attribute
 * @see CodeException
...
public final class Code extends Attribute {
    ...
    private int
            maxStack; // Maximum size of stack used by this method  // TODO this could be made final
                      // (setter is not used)
    private int
            maxLocals; // Number of local variables  // TODO this could be made final (setter is not
                       // used)
     ...
     * copy). Use copy() for a physical copy.
     */
    ...
    /**
     * @return the internal length of this code attribute (minus the first 6 bytes) and excluding
     *     all its attributes
     */
    ...
    /**
     * @return the full size of this code attribute, minus its first 6 bytes, including the size of
     *     all its contained attributes
     */
