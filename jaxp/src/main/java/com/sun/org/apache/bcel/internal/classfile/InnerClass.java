...
public final class InnerClass implements Cloneable, Node {
    ...
    public String toString(final ConstantPool constantPool) {
        ...
        String inner_class_name =
                constantPool.getConstantString(innerClassIndex, Const.CONSTANT_Class);
        ...
        if (innerNameIndex != 0) {
            inner_name =
                    ((ConstantUtf8) constantPool.getConstant(innerNameIndex, Const.CONSTANT_Utf8))
                            .getBytes();
        } else {
