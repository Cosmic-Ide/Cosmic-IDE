...
/**
 * This class is derived from <em>Attribute</em> and indicates the main class of a module. There may
 * be at most one ModuleMainClass attribute in a ClassFile structure.
 *
 * @see Attribute
 */
public final class ModuleMainClass extends Attribute {
    ...
    public String toString() {
        ...
        final String class_name =
                super.getConstantPool().getConstantString(mainClassIndex, Const.CONSTANT_Class);
