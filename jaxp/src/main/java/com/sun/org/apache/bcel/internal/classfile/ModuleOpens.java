...
/**
 * This class represents an entry in the opens table of the Module attribute. Each entry describes a
 * package which the parent module opens.
 *
 * @see Module
 * @since 6.4.0
 */
public final class ModuleOpens implements Cloneable, Node {
    ...
    public String toString(final ConstantPool constant_pool) {
        ...
        final String package_name =
                constant_pool.constantToString(opensIndex, Const.CONSTANT_Package);
