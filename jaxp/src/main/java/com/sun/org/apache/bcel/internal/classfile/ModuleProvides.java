...
/**
 * This class represents an entry in the provides table of the Module attribute. Each entry
 * describes a service implementation that the parent module provides.
 *
 * @see Module
 * @since 6.4.0
 */
public final class ModuleProvides implements Cloneable, Node {
    ...
    public String toString(final ConstantPool constant_pool) {
        ...
        final String interface_name =
                constant_pool.constantToString(providesIndex, Const.CONSTANT_Class);
