...
/**
 * This class represents an entry in the requires table of the Module attribute. Each entry
 * describes a module on which the parent module depends.
 *
 * @see Module
 * @since 6.4.0
 */
public final class ModuleRequires implements Cloneable, Node {
    ...
    public String toString() {
        return "requires("
                + requiresIndex
                + ", "
                + String.format("%04x", requiresFlags)
                + ", "
    ...
    public String toString(final ConstantPool constant_pool) {
        ...
        final String module_name =
                constant_pool.constantToString(requiresIndex, Const.CONSTANT_Module);
        ...
        final String version =
                requiresVersionIndex == 0
                        ...
                        : constant_pool.getConstantString(
                                requiresVersionIndex, Const.CONSTANT_Utf8);
