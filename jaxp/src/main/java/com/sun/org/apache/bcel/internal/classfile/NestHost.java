...
/**
 * This class is derived from <em>Attribute</em> and records the nest host of the nest to which the
 * current class or interface claims to belong. There may be at most one NestHost attribute in a
 * ClassFile structure.
 *
 * @see Attribute
 */
public final class NestHost extends Attribute {
    ...
    /**
     * Initializes from another object. Note that both objects use the same references (shallow
    ...
    public String toString() {
        ...
        final String class_name =
                super.getConstantPool().getConstantString(hostClassIndex, Const.CONSTANT_Class);
