...
public class ParameterAnnotationEntry implements Node {
     ...
     * @throws IOException
     */
    ParameterAnnotationEntry(final DataInput input, final ConstantPool constant_pool)
            throws IOException {
    ...
    public static ParameterAnnotationEntry[] createParameterAnnotationEntries(
        ...
        for (final Attribute attribute : attrs) {
            if (attribute instanceof ParameterAnnotations) {
                ...
                Collections.addAll(
                        accumulatedAnnotations, runtimeAnnotations.getParameterAnnotationEntries());
            }
        }
        return accumulatedAnnotations.toArray(
                new ParameterAnnotationEntry[accumulatedAnnotations.size()]);
    }
}
