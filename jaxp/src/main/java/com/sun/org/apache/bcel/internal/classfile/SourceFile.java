...
public final class SourceFile extends Attribute {
     ...
     * @param sourceFileIndex Index in constant pool to CONSTANT_Utf8. This string will be
    ...
    public String getSourceFileName() {
        final ConstantUtf8 c =
                (ConstantUtf8)
                        super.getConstantPool().getConstant(sourceFileIndex, Const.CONSTANT_Utf8);
        return c.getBytes();
    }
