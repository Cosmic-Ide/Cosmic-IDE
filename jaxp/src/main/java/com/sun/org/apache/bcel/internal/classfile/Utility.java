...
/**
 * Utility functions that do not really belong to any class in particular. @LastModified: June 2021
 */
...
public abstract class Utility {
     ...
     * Convert bit field of flags into string such as `static final'.
     *
     * <p>Special case: Classes compiled with new compilers and with the `ACC_SUPER' flag would be
     * said to be "synchronized". This is because SUN used the same value for the flags `ACC_SUPER'
     * and `ACC_SYNCHRONIZED'.
     *
     * @param access_flags Access flags
    ...
    /**
     * Disassemble a byte array of JVM byte codes starting from code line `index' and return the
     * disassembled string representation. Decode only `num' opcodes (including their operands), use
     * -1 if you want to decompile everything.
     *
    ...
    public static String codeToString(
        ...
        final StringBuilder buf =
                new StringBuilder(
                        code.length * 20); // Should be sufficient // CHECKSTYLE IGNORE MagicNumber
    ...
    public static String codeToString(
        ...
        switch (opcode) {
            ...
            case Const.PUTSTATIC:
                ...
                buf.append("\t\t")
                        .append(constant_pool.constantToString(index, Const.CONSTANT_Fieldref))
            ...
            case Const.INSTANCEOF:
                index = bytes.readUnsignedShort();
                buf.append("\t<")
                        .append(constant_pool.constantToString(index, Const.CONSTANT_Class))
                        .append(">")
                        .append(verbose ? " (" + index + ")" : "");
                break;
            ...
            case Const.INVOKESTATIC:
                ...
                buf.append("\t")
                        .append(constant_pool.constantToString(index, c.getTag()))
                        .append(verbose ? " (" + index + ")" : "");
                break;
            case Const.INVOKEVIRTUAL:
                index = bytes.readUnsignedShort();
                buf.append("\t")
                        .append(constant_pool.constantToString(index, Const.CONSTANT_Methodref))
                        .append(verbose ? " (" + index + ")" : "");
                break;
            ...
            case Const.INVOKEDYNAMIC:
                index = bytes.readUnsignedShort();
                buf.append("\t")
                        .append(constant_pool.constantToString(index, Const.CONSTANT_InvokeDynamic))
                        .append(verbose ? " (" + index + ")\t" : "")
    ...
    /**
     * Shorten long class names, <em>java/lang/String</em> becomes <em>java.lang.String</em>, e.g..
     * If <em>chopit</em> is <em>true</em> the prefix <em>java.lang</em> is also removed.
     *
     * @param str The long class name
    ...
    /**
     * Shorten long class name <em>str</em>, i.e., chop off the <em>prefix</em>, if the class name
     * starts with this string and the flag <em>chopit</em> is true. Slashes <em>/</em> are
     * converted to dots <em>.</em>.
     *
     * @param str The long class name
    ...
    /**
     * Converts string containing the method return and argument types to a byte code method
     * signature.
     *
     ...
     * @throws ClassFormatException
     */
    public static String[] methodSignatureArgumentTypes(
            final String signature, final boolean chopit) throws ClassFormatException {
     ...
     * @throws ClassFormatException
     */
    public static String methodSignatureReturnType(final String signature, final boolean chopit)
            throws ClassFormatException {
        int index;
        String type;
        try {
    ...
    public static String methodSignatureToString(
            final String signature, final String name, final String access) {
     ...
     */
    public static String methodSignatureToString(
            final String signature, final String name, final String access, final boolean chopit) {
        return methodSignatureToString(signature, name, access, chopit, null);
    }

    /**
     * This method converts a method signature string into a Java type declaration like `void
     * main(String[])' and throws a `ClassFormatException' when the parsed type is invalid.
     *
     * @param signature Method signature
     ...
     * WARNING:
     *
     * <p>There is some nomenclature confusion through much of the BCEL code base with respect to
     * the terms Descriptor and Signature. For the offical definitions see:
     *
     ...
     *     <p>In brief, a descriptor is a string representing the type of a field or method.
     ...
     *     constructor, method or field whose declaration uses type variables or parameterized
     *     types.
     *     <p>To parse a descriptor, call typeSignatureToString. To parse a signature, call
     *     signatureToString.
     *     <p>Note that if the signature string is a single, non-generic item, the call to
     *     signatureToString reduces to a call to typeSignatureToString. Also note, that if you only
     *     wish to parse the first item in a longer signature string, you should call
     *     typeSignatureToString directly.
     */

    /**
     * Converts a signature to a string with all class names compacted. Class, Method and Type
     * signatures are supported. Enum and Interface signatures are not supported.
     *
    ...
    /**
     * Converts a signature to a string. Class, Method and Type signatures are supported. Enum and
     * Interface signatures are not supported.
     *
     * @param signature signature to convert
     * @param chopit flag that determines whether chopping is executed or not
     * @return String containg human readable signature
    ...
    private static String typeSignaturesToString(
            final String signature, final boolean chopit, final char term) {
    ...
    /**
     * This method converts a type signature string into a Java type declaration such as `String[]'
     * and throws a `ClassFormatException' when the parsed type is invalid.
     *
     ...
     * @since 6.4.0
     */
    public static String typeSignatureToString(final String signature, final boolean chopit)
            throws ClassFormatException {
        // corrected concurrent private static field acess
                    ...
                    { // TypeVariableSignature
                        ...
                        if (index < 0) {
                            throw new ClassFormatException(
                                    "Invalid type variable signature: " + signature);
                        }
                        // corrected concurrent private static field acess
                ...
                case 'L':
                    { // Full class name
                        ...
                        if (fromIndex < bracketIndex) {
                            ...
                            wrap(
                                    consumed_chars,
                                    fromIndex + 1); // "Lblabla;" `L' and `;' are removed
                        ...
                        final StringBuilder type =
                                new StringBuilder(
                                                compactClassName(
                                                        signature.substring(1, bracketIndex),
                                                        chopit))
                                        .append("<");
                        ...
                        if (signature.charAt(consumed_chars) == '*') {
                            ...
                            type.append(
                                    typeSignatureToString(
                                            signature.substring(consumed_chars), chopit));
                            // update our consumed count by the number of characters the for type
                            // argument
                        ...
                        while (signature.charAt(consumed_chars) != '>') {
                            ...
                            if (signature.charAt(consumed_chars) == '*') {
                                ...
                                type.append(
                                        typeSignatureToString(
                                                signature.substring(consumed_chars), chopit));
                                // update our consumed count by the number of characters the for
                                // type argument
                                consumed_chars = unwrap(Utility.consumed_chars) + consumed_chars;
                                wrap(Utility.consumed_chars, consumed_chars);
                            }
                        ...
                        if (signature.charAt(consumed_chars) == '.') {
                            ...
                            type.append(
                                    typeSignatureToString(
                                            "L" + signature.substring(consumed_chars + 1), chopit));
                            // update our consumed count by the number of characters the for type
                            // argument
    ...
    /**
     * Parse Java type such as "char", or "java.lang.String[]" and return the signature in byte code
     * format, e.g. "C" or "[Ljava/lang/String;" respectively.
     *
    ...
    /**
     * Return a string for an integer justified left or right and filled up with `fill' characters
     * if necessary.
     *
    ...
    public static String format(
            final int i, final int length, final boolean left_justify, final char fill) {
    ...
    public static String fillup(
            final String str, final int length, final boolean left_justify, final char fill) {
    ...
    /**
     * Encode byte array it into Java identifier string, i.e., a string that only contains the
     * following characters: (a, ... z, A, ... Z, 0, ... 9, _, $). The encoding algorithm itself is
     * not too clever: if the current byte's ASCII value already is a valid Java identifier part,
     * leave it as it is. Otherwise it writes the escape character($) followed by:
     *
     * <ul>
     *   <li>the ASCII value as a hexadecimal string, if the value is not in the range 200..247
     *   <li>a Java identifier char not used in a lowercase hexadecimal string, if the value is in
     *       the range 200..247
     * </ul>
     *
    ...
    /**
     * Decode characters into bytes. Used by <a href="Utility.html#decode(java.lang.String,
     * boolean)">decode()</a>
     */
