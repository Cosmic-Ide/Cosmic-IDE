...
public class ArrayElementValueGen extends ElementValueGen {
    ...
    public ArrayElementValueGen(
            final int type, final ElementValue[] datums, final ConstantPoolGen cpool) {
        super(type, cpool);
        if (type != ARRAY) {
    ...
    public ElementValue getElementValue() {
        ...
        return new ArrayElementValue(
                super.getElementValueType(), immutableData, getConstantPool().getConstantPool());
    }
