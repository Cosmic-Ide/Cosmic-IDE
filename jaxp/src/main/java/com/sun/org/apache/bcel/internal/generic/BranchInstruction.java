 ...
 *
 * @see InstructionList @LastModified: July 2020
 */
public abstract class BranchInstruction extends Instruction implements InstructionTargeter {
    ...
    static void notifyTarget(
            final InstructionHandle old_ih,
            final InstructionHandle new_ih,
    ...
    /**
     * Updates the opcode. Before changing the opcode, reset the target so that the old instruction
     * is removed from the HashSet and the new one then added.
     *
