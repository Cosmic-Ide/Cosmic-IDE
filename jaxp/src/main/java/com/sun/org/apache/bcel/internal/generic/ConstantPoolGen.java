 ...
 *
 * @see Constant @LastModified: May 2022
 */
public class ConstantPoolGen {
        ...
        for (int i = 1; i < index; i++) {
            ...
            if (c instanceof ConstantString) {
                ...
                if (c instanceof ConstantInvokeDynamic) {
                    class_name =
                            Integer.toString(
                                    ((ConstantInvokeDynamic) m).getBootstrapMethodAttrIndex());
    ...
    public int lookupMethodref(
            final String class_name, final String method_name, final String signature) {
        final Index index =
                cpTable.get(
     ...
     * @return index on success, -1 otherwise
     */
    public int lookupInterfaceMethodref(
            final String class_name, final String method_name, final String signature) {
        final Index index =
                cpTable.get(
     ...
     * @return index on success, -1 otherwise
     */
    public int lookupFieldref(
            final String class_name, final String field_name, final String signature) {
        final Index index =
                cpTable.get(class_name + FIELDREF_DELIM + field_name + FIELDREF_DELIM + signature);
        return (index != null) ? index.index : -1;
    }
