...
public class ElementValuePairGen {
    ...
    public ElementValuePairGen(
            final ElementValuePair nvp,
    ...
    protected ElementValuePairGen(
            final int idx, final ElementValueGen value, final ConstantPoolGen cpool) {
        this.nameIdx = idx;
        this.value = value;
        this.constantPoolGen = cpool;
    }
    ...
    public ElementValuePairGen(
            final String name, final ElementValueGen value, final ConstantPoolGen cpool) {
