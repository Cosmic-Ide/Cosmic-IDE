...
public class EnumElementValueGen extends ElementValueGen {
    ...
    /**
     * This ctor assumes the constant pool already contains the right type and value - as indicated
     * by typeIdx and valueIdx. This ctor is used for deserialization
     */
    protected EnumElementValueGen(
            final int typeIdx, final int valueIdx, final ConstantPoolGen cpool) {
    ...
    public ElementValue getElementValue() {
        System.err.println(
                "Duplicating value: " + getEnumTypeString() + ":" + getEnumValueString());
    ...
    public EnumElementValueGen(
            final ObjectType t, final String value, final ConstantPoolGen cpool) {
        super(ElementValueGen.ENUM_CONSTANT, cpool);
