 ...
 * type).
 *
 * @see Field @LastModified: May 2021
 */
public class FieldGen extends FieldGenOrMethodGen {
    ...
    public Field getField() {
        ...
        if (value != null) {
            ...
            addAttribute(
                    new ConstantValue(
                            super.getConstantPool().addUtf8("ConstantValue"),
                            2,
                            index,
    ...
    /**
     * Return value as defined by given BCELComparator strategy. By default two FieldGen objects are
