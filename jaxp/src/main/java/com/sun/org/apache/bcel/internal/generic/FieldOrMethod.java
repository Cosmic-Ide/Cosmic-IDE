...
public abstract class FieldOrMethod extends CPInstruction implements LoadClass {
     ...
     * @deprecated If the instruction references an array class, this method will return
     *     "java.lang.Object". For code generated by Java 1.5, this answer is sometimes wrong (e.g.,
     *     if the "clone()" method is called on an array). A better idea is to use the {@link
     *     #getReferenceType(ConstantPoolGen)} method, which correctly distinguishes between class
     ...
     * @deprecated If the instruction references an array class, the ObjectType returned will be
     *     invalid. Use getReferenceType() instead.
     */
    @Deprecated
    ...
    /**
     * Gets the reference type representing the class, interface, or array class referenced by the
     * instruction.
     *
     * @param cpg the ConstantPoolGen used to create the instruction
     * @return an ObjectType (if the referenced class type is a class or interface), or an ArrayType
     *     (if the referenced class type is an array class)
     */
