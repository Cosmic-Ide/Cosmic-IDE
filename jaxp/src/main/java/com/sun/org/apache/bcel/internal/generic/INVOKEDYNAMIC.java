...
/**
 * Class for INVOKEDYNAMIC. Not an instance of InvokeInstruction, since that class expects to be
 * able to get the class of the method. Ignores the bootstrap mechanism entirely.
 *
 * @see <a
...
public class INVOKEDYNAMIC extends InvokeInstruction {
    ...
    public String getClassName(final ConstantPoolGen cpg) {
        ...
        final ConstantInvokeDynamic cid =
    ...
    /**
     * Since InvokeDynamic doesn't refer to a reference type, just return java.lang.Object, as that
     * is the only type we can say for sure the reference will be.
     *
