...
/** Abstract super class for all Java byte codes. @LastModified: July 2020 */
public abstract class Instruction implements Cloneable {
    ...
    /**
     * Use with caution, since `BranchInstruction's have a `target' reference which is not copied
     * correctly (only basic types are). This also applies for `Select' instructions with their
     ...
     *
     * <p>If the Instruction is defined in {@link InstructionConst}, then the singleton instance is
     * returned.
     *
    ...
    /**
     * This method also gives right results for instructions whose effect on the stack depends on
     * the constant pool entry they reference.
     *
     * @return Number of words consumed from stack by this instruction, or Constants.UNPREDICTABLE,
     *     if this can not be computed statically
     */
     ...
     * the constant pool entry they reference.
     *
     * @return Number of words produced onto stack by this instruction, or Constants.UNPREDICTABLE,
     *     if this can not be computed statically
     */
     ...
     * @deprecated (6.0) use the built in comparator, or wrap this class in another object that
