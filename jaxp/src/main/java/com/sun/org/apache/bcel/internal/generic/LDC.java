...
public class LDC extends CPInstruction implements PushInstruction, ExceptionThrower {
    ...
    protected final void setSize() {
        if (super.getIndex()
                <= com.sun.org.apache.bcel.internal.Const.MAX_BYTE) { // Fits in one byte?
    ...
    public Object getValue(final ConstantPoolGen cpg) {
        com.sun.org.apache.bcel.internal.classfile.Constant c =
                cpg.getConstantPool().getConstant(super.getIndex());
        switch (c.getTag()) {
            case com.sun.org.apache.bcel.internal.Const.CONSTANT_String:
                final int i =
                        ((com.sun.org.apache.bcel.internal.classfile.ConstantString) c)
                                .getStringIndex();
            ...
            case com.sun.org.apache.bcel.internal.Const.CONSTANT_Class:
                final int nameIndex =
                        ((com.sun.org.apache.bcel.internal.classfile.ConstantClass) c)
                                .getNameIndex();
                c = cpg.getConstantPool().getConstant(nameIndex);
                return new ObjectType(
                        ((com.sun.org.apache.bcel.internal.classfile.ConstantUtf8) c).getBytes());
            default: // Never reached
                throw new IllegalArgumentException(
                        "Unknown or invalid constant type at " + super.getIndex());
        }
    }
