...
/** Abstract super class for instructions dealing with local variables. @LastModified: May 2021 */
public abstract class LocalVariableInstruction extends Instruction
    ...
    /**
     * Empty constructor needed for Instruction.readInstruction. Not to be used otherwise. tag and
     * length are defined in readInstruction and initFromFile, respectively.
     */
    ...
    /**
     * Returns the type associated with the instruction - in case of ALOAD or ASTORE Type.OBJECT is
     * returned. This is just a bit incorrect, because ALOAD and ASTORE may work on every
     * ReferenceType (including Type.NULL) and ASTORE may even work on a ReturnaddressType .
     *
