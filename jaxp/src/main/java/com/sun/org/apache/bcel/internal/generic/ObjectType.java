...
public class ObjectType extends ReferenceType {
     ...
     *
     * @deprecated (since 6.0) this method returns an inaccurate result if the class or interface
     *     referenced cannot be found: use referencesClassExact() instead
     */
    @Deprecated
     ...
     *
     * @deprecated (since 6.0) this method returns an inaccurate result if the class or interface
     *     referenced cannot be found: use referencesInterfaceExact() instead
     */
    @Deprecated
     ...
     * @throws ClassNotFoundException if the class or interface referenced by this type can't be
     *     found
     */
