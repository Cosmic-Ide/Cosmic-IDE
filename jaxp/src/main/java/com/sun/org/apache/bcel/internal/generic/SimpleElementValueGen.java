...
public class SimpleElementValueGen extends ElementValueGen {
    ...
    /**
     * Protected ctor used for deserialization, doesn't *put* an entry in the constant pool, assumes
     * the one at the supplied index is correct.
     */
    ...
    /**
     * The boolean controls whether we copy info from the 'old' constant pool to the 'new'. You need
     * to use this ctor if the annotation is being copied from one file to another.
     */
    public SimpleElementValueGen(
            final SimpleElementValue value,
            ...
            switch (value.getElementValueType()) {
                ...
                default:
                    throw new IllegalArgumentException(
                            "SimpleElementValueGen class does not know how to copy this type "
