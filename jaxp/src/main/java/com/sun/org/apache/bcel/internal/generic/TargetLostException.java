...
/**
 * Thrown by InstructionList.remove() when one or multiple disposed instructions are still being
 * referenced by an InstructionTargeter object. I.e. the InstructionTargeter has to be notified that
