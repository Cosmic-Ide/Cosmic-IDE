    ...
    void writeAttribute(final Attribute attribute, final String anchor, final int method_number) {
        ...
        switch (tag) {
            ...
            case Const.ATTR_LINE_NUMBER_TABLE:
                final LineNumber[] line_numbers =
                        ((LineNumberTable) attribute).getLineNumberTable();
            ...
            case Const.ATTR_LOCAL_VARIABLE_TABLE:
                ...
                for (final LocalVariable var : vars) {
                    ...
                    String signature =
                            ((ConstantUtf8) constant_pool.getConstant(index, Const.CONSTANT_Utf8))
                                    .getBytes();
