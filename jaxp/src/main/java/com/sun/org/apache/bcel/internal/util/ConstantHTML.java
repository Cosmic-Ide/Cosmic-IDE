    ...
    private void writeConstant(final int index) {
        ...
        switch (tag) {
            ...
            case Const.CONSTANT_Methodref:
                ...
                if (tag == Const.CONSTANT_Methodref) {
                    final ConstantMethodref c =
                            (ConstantMethodref)
                                    constantPool.getConstant(index, Const.CONSTANT_Methodref);
                    class_index = c.getClassIndex();
                    name_index = c.getNameAndTypeIndex();
                } else {
                    final ConstantInterfaceMethodref c1 =
                ...
                final String method_name =
                        constantPool.constantToString(name_index, Const.CONSTANT_NameAndType);
                final String html_method_name = Class2HTML.toHTML(method_name);
                // Partially compacted class name, i.e., / -> .
                final String method_class =
                        constantPool.constantToString(class_index, Const.CONSTANT_Class);
                ...
                final ConstantNameAndType c2 =
                        (ConstantNameAndType)
                                constantPool.getConstant(name_index, Const.CONSTANT_NameAndType);
            ...
            case Const.CONSTANT_Class:
                final ConstantClass c4 =
                        (ConstantClass) constantPool.getConstant(index, Const.CONSTANT_Class);
            ...
            case Const.CONSTANT_String:
                final ConstantString c5 =
                        (ConstantString) constantPool.getConstant(index, Const.CONSTANT_String);
