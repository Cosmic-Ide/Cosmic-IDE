 ...
 * equivalents.
 *
 * <p>This class internally uses the java.util.regex package to search for regular expressions.
 *
 ...
 * @see InstructionList @LastModified: May 2021
 */
public class InstructionFinder {
     ...
     */
    public final Iterator<InstructionHandle[]> search(
            final String pattern, final InstructionHandle from, final CodeConstraint constraint) {
     ...
     */
    public final Iterator<InstructionHandle[]> search(
            final String pattern, final InstructionHandle from) {
     ...
     */
    public final Iterator<InstructionHandle[]> search(
            final String pattern, final CodeConstraint constraint) {
    ...
    static {
        ...
        map.put(
                ...
                new String(
                        new char[] {
                            '(', makeChar(Const.LCONST_0), '|', makeChar(Const.LCONST_1), ')'
                        }));
        map.put(
                "dconst",
                new String(
                        new char[] {
                            '(', makeChar(Const.DCONST_0), '|', makeChar(Const.DCONST_1), ')'
                        }));
        map.put(
                "fconst",
                new String(
                        new char[] {
                            '(',
                            makeChar(Const.FCONST_0),
                            '|',
                            makeChar(Const.FCONST_1),
                            '|',
                            makeChar(Const.FCONST_2),
                            ')'
                        }));
