 ...
 * ClassLoader. Classes are loaded from the file systems using the paths specified in the given
 * class path. By default, this is the value returned by ClassPath.getClassPath(). <br>
 * This repository uses a factory design, allowing it to maintain a collection of different
 * classpaths, and as such It is designed to be used as a singleton per classpath.
 *
 * @see com.sun.org.apache.bcel.internal.Repository @LastModified: May 2021
 */
public class SyntheticRepository implements Repository {
    ...
    /**
     * Finds a JavaClass object by name. If it is already in this Repository, the Repository version
     * is returned.
     *
    ...
    public JavaClass loadClass(String className) throws ClassNotFoundException {
        ...
        throw new ClassNotFoundException(
                "Exception while looking for class " + className + ": " + e, e);
    }

    /**
     * Find the JavaClass object for a runtime Class object. If a class with the same name is
     * already in this Repository, the Repository version is returned. Otherwise,
     * getResourceAsStream() is called on the Class object to find the class's representation. If
     * the representation is found, it is added to the Repository.
     *
     * @see Class
     * @param clazz the runtime Class object
     * @return JavaClass object for given runtime class
     * @throws ClassNotFoundException if the class is not in the Repository, and its representation
     *     could not be found
     */
    @Override
