 ...
 * @author Morten Jorgensen @LastModified: June 2021
 */
final class SymbolTable {
    ...
    /**
     * Add a primitive operator or function to the symbol table. To avoid name clashes with
     * user-defined names, the prefix <tt>PrimopPrefix</tt> is prepended.
     */
    ...
    /**
     * Lookup a primitive operator or function in the symbol table by prepending the prefix
     * <tt>PrimopPrefix</tt>.
     */
    ...
    /**
     * This is used for xsl:attribute elements that have a "namespace" attribute that is currently
     * not defined using xmlns:
     */
    ...
    /**
     * Register a namespace URI so that it will not be declared in the output unless it is actually
    ...
    public void excludeURI(String uri) {
        ...
        if (refcnt == null) refcnt = 1;
        else refcnt = refcnt + 1;
    ...
    public void unExcludeNamespaces(String prefixes) {
        ...
        if (prefixes != null) {
            ...
            while (tokens.hasMoreTokens()) {
                ...
                Integer refcnt = _excludedURI.get(uri);
                if (refcnt != null) _excludedURI.put(uri, refcnt - 1);
            }
        }
    }
    /**
     * Exclusion of namespaces by a stylesheet does not extend to any stylesheet imported or
     * included by the stylesheet. Upon entering the context of a new stylesheet, a call to this
     * method is needed to clear the current set of excluded namespaces temporarily. Every call to
     * this method requires a corresponding call to {@link #popExcludedNamespacesContext()}.
     */
    ...
    /**
     * Exclusion of namespaces by a stylesheet does not extend to any stylesheet imported or
     * included by the stylesheet. Upon exiting the context of a stylesheet, a call to this method
     * is needed to restore the set of excluded namespaces that was in effect prior to entering the
     * context of the current stylesheet.
     */
