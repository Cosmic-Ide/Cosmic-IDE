...
class XPathLexer implements com.sun.java_cup.internal.runtime.Scanner {
    ...
    /**
     * If symbol is not followed by '::' or '(', then treat it as a name instead of an axis or
     * function (Jira-1912).
     */
    ...
    /**
     * If symbol is first token or if it follows any of the operators listed in
     * http://www.w3.org/TR/xpath#exprlex then treat as a name instead of a keyword (Jira-1912).
     * Look two tokens behind to desambiguate expressions like "* and *" or "and * and".
     */
                ...
                if (YY_NO_STATE == yy_last_accept_state) {
                    ...
                    switch (yy_last_accept_state) {
                        ...
                        case 32:
                            {
                                return newSymbol(
                                        sym.Literal, yytext().substring(1, yytext().length() - 1));
                            }
                        case -33:
                            break;
                        case 33:
