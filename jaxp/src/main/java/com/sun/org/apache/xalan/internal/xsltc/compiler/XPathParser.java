...
/**
 * CUP v0.11b generated parser. This class was generated by CUP v0.11b on Nov 12,
 * 2019. @LastModified: July 2022
 */
public class XPathParser extends lr_parser {
    ...
    public Symbol do_action(int act_num, lr_parser parser, Stack<Symbol> stack, int top)
        ...
        try {
            ...
            if (isOverLimit()) {
                ...
                if (grpLimit > 0 && grpCount > grpLimit) {
                    ...
                    params =
                            new Object[] {
                                grpCount, grpLimit, _xmlSM.getStateLiteral(Limit.XPATH_GROUP_LIMIT)
                            };
                } else if (opLimit > 0 && opCount > opLimit) {
                    errCode = ErrorMsg.XPATH_OPERATOR_LIMIT;
                    params =
                            new Object[] {
                                opCount, opLimit, _xmlSM.getStateLiteral(Limit.XPATH_OP_LIMIT)
                            };
                ...
                if (errCode != null) {
                    _parser.reportError(Constants.FATAL, new ErrorMsg(errCode, lineNumber, params));
...
class parser_actions {
    ...
    public final Symbol parser_do_action(
            int parser_act_num, lr_parser parser_parser, Stack<Symbol> parser_stack, int parser_top)
            throws java.lang.Exception {
            ...
            case 0: // $START ::= TopLevel EOF
                {
                    SyntaxTreeNode start_val =
                            (SyntaxTreeNode) (parser_stack.get(parser_top - 1)).value;
                    parser_result =
                            new Symbol(
                                    0,
                                    (parser_stack.get(parser_top - 1)).left,
                                    (parser_stack.get(parser_top - 0)).right,
                                    start_val);
                }
                /* ACCEPT */
            ...
            case 3: // Pattern ::= LocationPathPattern
                {
                    ...
                    parser_result =
                            new Symbol(
                                    28,
                                    (parser_stack.get(parser_top - 0)).left,
                                    (parser_stack.get(parser_top - 0)).right,
                                    lpp);
                }
                return parser_result;
            ...
            case 4: // Pattern ::= LocationPathPattern VBAR Pattern
                {
                    ...
                    parser_result =
                            new Symbol(
                                    28,
                                    (parser_stack.get(parser_top - 2)).left,
                                    (parser_stack.get(parser_top - 0)).right,
                                    result);
                }
                return parser_result;
            ...
            case 6: // LocationPathPattern ::= SLASH RelativePathPattern
                {
                    RelativePathPattern rpp =
                            (RelativePathPattern) (parser_stack.get(parser_top - 0)).value;
            ...
            case 12: // IdKeyPattern ::= ID LPAREN Literal RPAREN
                {
                    ...
                    parser_result =
                            new Symbol(
                                    27,
                                    (parser_stack.get(parser_top - 3)).left,
                                    (parser_stack.get(parser_top - 0)).right,
                                    result);
                }
                return parser_result;
            ...
            case 13: // IdKeyPattern ::= KEY LPAREN Literal COMMA Literal RPAREN
                {
                    ...
                    parser_result =
                            new Symbol(
                                    27,
                                    (parser_stack.get(parser_top - 5)).left,
                                    (parser_stack.get(parser_top - 0)).right,
                                    result);
                }
                return parser_result;
            ...
            case 19: // StepPattern ::= NodeTestPattern Predicates
                {
                    ...
                    List<Predicate> pp =
                            (ArrayList<Predicate>) (parser_stack.get(parser_top - 0)).value;
            ...
            case 37: // Predicates ::= Predicate Predicates
                {
                    ...
                    @SuppressWarnings("unchecked")
                    List<Expression> pp =
                            (ArrayList<Expression>) (parser_stack.get(parser_top - 0)).value;
                    pp.add(0, p);
                    parser_result =
                            new Symbol(
                                    35,
            ...
            case 109: // FunctionCall ::= FunctionName LPAREN NonemptyArgumentList RPAREN
                {
                    ...
                    List<Expression> argl =
                            (ArrayList<Expression>) (parser_stack.get(parser_top - 1)).value;
