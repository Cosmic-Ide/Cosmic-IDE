...
public class ErrorMessages_de extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            {ErrorMsg.MULTIPLE_STYLESHEET_ERR, "Mehrere Stylesheets in derselben Datei definiert."},
             ...
             */
            {ErrorMsg.TEMPLATE_UNDEF_ERR, "Vorlage \"{0}\" nicht in diesem Stylesheet definiert."},
             ...
             */
            {ErrorMsg.VARIABLE_UNDEF_ERR, "Variable oder Parameter \"{0}\" ist nicht definiert."},
             ...
             */
            {ErrorMsg.CLASS_NOT_FOUND_ERR, "Klasse \"{0}\" kann nicht gefunden werden."},
             ...
             * is missing.
             */
            {ErrorMsg.FILE_NOT_FOUND_ERR, "Datei oder URI \"{0}\" nicht gefunden."},

            /*
             * Note to translators:  This message is displayed when the URI
             * mentioned in the substitution text is not well-formed syntactically.
             */
            {ErrorMsg.INVALID_URI_ERR, "Ung\u00FCltiger URI \"{0}\"."},
             ...
             */
            {
                ...
                "JAXP08090001: CatalogResolver ist mit dem Katalog \"{0}\" aktiviert, eine"
                    + " CatalogException wird jedoch zur\u00FCckgegeben."
            },
             ...
             */
            {ErrorMsg.FILE_ACCESS_ERR, "Datei oder URI \"{0}\" kann nicht ge\u00F6ffnet werden."},

            /*
             * Note to translators: <xsl:stylesheet> and <xsl:transform> are
             * keywords that should not be translated.
             */
            {ErrorMsg.MISSING_ROOT_ERR, "<xsl:stylesheet>- oder <xsl:transform>-Element erwartet."},
             ...
             */
            {ErrorMsg.NAMESPACE_UNDEF_ERR, "Namespace-Pr\u00E4fix \"{0}\" ist nicht deklariert."},
             ...
             * the expression.
             */
            {ErrorMsg.XPATH_PARSER_ERR, "Fehler beim Parsen von XPath-Ausdruck \"{0}\"."},
             ...
             */
            {ErrorMsg.REQUIRED_ATTR_ERR, "Erforderliches Attribut \"{0}\" fehlt."},
             ...
             */
            {ErrorMsg.ILLEGAL_CHAR_ERR, "Ung\u00FCltiges Zeichen \"{0}\" in XPath-Ausdruck."},
             ...
             */
            {ErrorMsg.STRAY_ATTRIBUTE_ERR, "Attribut \"{0}\" au\u00DFerhalb des Elements."},
             ...
             * text.
             */
            {ErrorMsg.ILLEGAL_ATTRIBUTE_ERR, "Ung\u00FCltiges Attribut \"{0}\"."},
             ...
             */
            {
                ...
                "Die untergeordneten Elemente des xsl:import-Elements m\u00FCssen vor allen anderen"
                    + " untergeordneten Elementen eines xsl:stylesheet-Elements stehen,"
                    + " einschlie\u00DFlich eventueller untergeordneter Elemente des"
             ...
             */
            {ErrorMsg.SYMBOLS_REDEF_ERR, "Dezimalformatierung \"{0}\" ist bereits definiert."},
             ...
             */
            {ErrorMsg.CIRCULAR_VARIABLE_ERR, "Zyklische Variablen-/Parameterreferenz in \"{0}\"."},

            /*
             * Note to translators:  The operator in an expresion with two operands was
             * not recognized.
             */
            {ErrorMsg.ILLEGAL_BINARY_OP_ERR, "Unbekannter Operator f\u00FCr Bin\u00E4rausdruck."},

            /*
             * Note to translators:  This message is produced if a reference to a
             * function has too many or too few arguments.
             */
            {ErrorMsg.ILLEGAL_ARG_ERR, "Ung\u00FCltige Argumente f\u00FCr Funktionsaufruf."},
             ...
             * in the stylesheet.
             */
            {ErrorMsg.STRAY_WHEN_ERR, "<xsl:when> kann nur in <xsl:choose> verwendet werden."},
             ...
             */
            {ErrorMsg.ILLEGAL_CHILD_ERR, "Ung\u00FCltiges untergeordnetes Element."},
             ...
             * the name.
             */
            {ErrorMsg.ILLEGAL_ELEM_NAME_ERR, "Elemente d\u00FCrfen nicht den Namen \"{0}\" haben"},
             ...
             * contains the name.
             */
            {ErrorMsg.ILLEGAL_ATTR_NAME_ERR, "Attribute d\u00FCrfen nicht den Namen \"{0}\" haben"},
             ...
             */
            {ErrorMsg.SAX_PARSER_CONFIG_ERR, "JAXP-Parser nicht korrekt konfiguriert"},

            /*
             * Note to translators:  The substitution text names the internal error
             * encountered.
             */
            {ErrorMsg.INTERNAL_ERR, "Nicht behebbarer interner XSLTC-Fehler: \"{0}\""},
             ...
             */
            {ErrorMsg.UNSUPPORTED_XSL_ERR, "Nicht unterst\u00FCtztes XSL-Element \"{0}\"."},
             ...
             */
            {ErrorMsg.UNSUPPORTED_EXT_ERR, "Unbekannte XSLTC-Erweiterung \"{0}\"."},
             ...
             */
            {ErrorMsg.NOT_IMPLEMENTED_ERR, "Nicht implementiert: \"{0}\"."},
             ...
             */
            {ErrorMsg.ELEMENT_PARSE_ERR, "Element \"{0}\" konnte nicht geparst werden"},
             ...
             */
            {ErrorMsg.OUTPUT_VERSION_ERR, "Ausgabe-XML-Dokumentversion muss 1.0 sein"},

            /*
             * Note to translators:  The operator in a comparison operation was
             * not recognized.
             */
            {ErrorMsg.ILLEGAL_RELAT_OP_ERR, "Unbekannter Operator f\u00FCr Vergleichsausdruck"},
             ...
             */
            {ErrorMsg.TRANSLET_CLASS_ERR, "Translet-Klasse \"{0}\" konnte nicht geladen werden."},
            {
             ...
             */
            {ErrorMsg.JAXP_COMPILE_ERR, "Stylesheet konnte nicht kompiliert werden"},
             ...
             */
            {ErrorMsg.JAXP_INVALID_ATTR_ERR, "TransformerFactory erkennt Attribut \"{0}\" nicht."},
            {
             ...
             */
            {ErrorMsg.SAX2DOM_ADAPTER_ERR, "SAX2DOM-Adapter \"{0}\" konnte nicht erstellt werden."},
            ...
            {ErrorMsg.ER_RESULT_NULL, "Ergebnis darf nicht null sein"},
             ...
             */
            {
                ...
                "SYNOPSIS\n"
                    ...
                    + "                  Translet zu. Standardm\u00E4\u00DFig wird der"
                    + " Translet-Name\n"
                    + "                  vom <Stylesheet>-Namen abgeleitet. Diese Option\n"
                    + "                  wird ignoriert, wenn mehrere Stylesheets kompiliert"
                    + " werden.\n"
                    ...
                    + "   -p <package>   gibt ein Packagenamenspr\u00E4fix f\u00FCr alle"
                    + " generierten\n"
                    + "                  Translet-Klassen an.\n"
                    + "   -n             aktiviert das Vorlagen-Inlining (Standardverhalten"
                    + " durchschnittlich\n"
                    + "                  besser).\n"
                    + "   -x             schaltet die zus\u00E4tzliche Debugging-Meldungsausgabe"
                    + " ein\n"
                    + "   -u             interpretiert <Stylesheet>-Argumente als URLs\n"
                    + "   -i             erzwingt, dass der Compiler das Stylesheet aus stdin"
                    + " liest\n"
             ...
             */
            {
                ...
                "SYNOPSIS \n"
                    ...
                    + " \n"
                    + "   das als <Dokument> angegeben wird. Die Translet-<Klasse> befindet sich"
                    + " entweder im\n"
                    + "   CLASSPATH des Benutzers oder in der optional angegebenen <JAR-Datei>.\n"
                    + "OPTIONS\n"
                    + "   -j <JAR-Datei>    gibt eine JAR-Datei an, aus der das Translet geladen"
                    + " werden soll\n"
                    + "   -x              schaltet die zus\u00E4tzliche Debugging-Meldungsausgabe"
                    + " ein\n"
                    + "   -n <Iterationen> f\u00FChrt die Transformation so oft aus, wie in"
                    + " <Iterationen> angegeben und\n"
             ...
             */
            {ErrorMsg.SYNTAX_ERR, "Syntaxfehler in \"{0}\"."},
             ...
             */
            {ErrorMsg.TYPE_CHECK_ERR, "Fehler beim Pr\u00FCfen des Typs des Ausdrucks \"{0}\"."},
             ...
             * Note to translators:  The substitution text is the name of a class.
             */
            {ErrorMsg.TRANSFORM_WITH_TRANSLET_STR, "Transformation mit Translet \"{0}\" "},
             ...
             */
            {
                ...
                "Der Name \"{0}\" konnte nicht als Name der Translet-Klasse verwendet werden, da er"
                    + " Zeichen enth\u00E4lt, die nicht im Namen einer Java-Klasse zul\u00E4ssig"
                    + " sind. Der Name \"{1}\" wurde stattdessen verwendet."
            },
             ...
             * this message.
             */
            {ErrorMsg.COMPILER_ERROR_KEY, "Compiler-Fehler:"},
             ...
             */
            {ErrorMsg.COMPILER_WARNING_KEY, "Compiler-Warnungen:"},
             ...
             */
            {ErrorMsg.RUNTIME_ERROR_KEY, "Translet-Fehler:"},
             ...
             */
            {
                ...
                "Interner XSLTC-Fehler: Eine Anweisung, die Teil eines Bytecodeblocks war, f\u00FCr"
                    + " den ein Outline erstellt wurde, wird nach wie vor in der Originalmethode"
                    + " referenziert."
            },
             ...
             */
            {
                ...
                "Interner XSLTC-Fehler: Eine Methode im Translet \u00FCberschreitet die Java"
                    + " Virtual Machine-L\u00E4ngeneinschr\u00E4nkung einer Methode von 64 KB."
                    + " Ursache hierf\u00FCr sind in der Regel sehr gro\u00DFe Vorlagen in einem"
                    + " Stylesheet. Versuchen Sie, das Stylesheet mit kleineren Vorlagen"
                    + " umzustrukturieren."
            },
            {
                ErrorMsg.DESERIALIZE_TRANSLET_ERR,
                "Wenn die Java-Sicherheit aktiviert ist, ist die Unterst\u00FCtzung f\u00FCr das"
                    + " Deserialisieren von TemplatesImpl deaktiviert. Dies kann durch Setzen der"
                    + " Systemeigenschaft jdk.xml.enableTemplatesImplDeserialization auf \"True\""
