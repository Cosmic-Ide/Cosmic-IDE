...
public class ErrorMessages_es extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
             ...
             */
            {ErrorMsg.CLASS_NOT_FOUND_ERR, "No se ha encontrado la clase ''{0}''."},
             ...
             * is missing.
             */
            {ErrorMsg.FILE_NOT_FOUND_ERR, "No se ha encontrado el archivo o URI ''{0}''."},

            /*
             * Note to translators:  This message is displayed when the URI
             * mentioned in the substitution text is not well-formed syntactically.
             */
            {ErrorMsg.INVALID_URI_ERR, "URI ''{0}'' no v\u00E1lido."},
             ...
             */
            {
                ...
                "JAXP08090001: CatalogResolver est\u00E1 activado con el cat\u00E1logo \"{0}\","
                    + " pero se ha devuelto una excepci\u00F3n CatalogException."
            },
             ...
             */
            {ErrorMsg.FILE_ACCESS_ERR, "No se puede abrir el archivo o URI ''{0}''."},
             ...
             */
            {ErrorMsg.NEED_LITERAL_ERR, "El argumento en ''{0}'' debe ser una cadena literal."},
             ...
             * the expression.
             */
            {ErrorMsg.XPATH_PARSER_ERR, "Error al analizar la expresi\u00F3n XPath ''{0}''."},
             ...
             */
            {ErrorMsg.REQUIRED_ATTR_ERR, "Falta el atributo ''{0}'' necesario."},
             ...
             */
            {ErrorMsg.STRAY_ATTRIBUTE_ERR, "El atributo ''{0}'' est\u00E1 fuera del elemento."},
             ...
             * text.
             */
            {ErrorMsg.ILLEGAL_ATTRIBUTE_ERR, "Atributo ''{0}'' no permitido."},
             ...
             */
            {
                ...
                "Los secundarios del elemento xsl:import deben preceder al resto de secundarios de"
                    + " elementos de un elemento xsl:stylesheet, incluidos los secundarios de"
             ...
             */
            {
                ...
                "Los fragmentos del \u00E1rbol de resultados no se pueden ordenar (los elementos"
                    + " <xsl:sort> se ignoran). Debe ordenar los nodos al crear el \u00E1rbol de"
                    + " resultados."
            },
             ...
             */
            {ErrorMsg.SYMBOLS_REDEF_ERR, "Ya se ha definido el formato decimal ''{0}''."},
             ...
             */
            {ErrorMsg.ILLEGAL_ARG_ERR, "Argumentos no permitidos para la llamada de funci\u00F3n."},
             ...
             * in the stylesheet.
             */
            {ErrorMsg.STRAY_WHEN_ERR, "<xsl:when> s\u00F3lo se puede utilizar en <xsl:choose>."},
             ...
             */
            {ErrorMsg.UNNAMED_ATTRIBSET_ERR, "Falta el atributo 'name' en <xsl:attribute-set>"},

            /*
             * Note to translators:  An element in the stylesheet contained an
             * element of a type that it was not permitted to contain.
             */
            {ErrorMsg.ILLEGAL_CHILD_ERR, "Elemento secundario no permitido."},
             ...
             * the name.
             */
            {ErrorMsg.ILLEGAL_ELEM_NAME_ERR, "No se puede llamar ''{0}'' a un elemento"},
             ...
             * contains the name.
             */
            {ErrorMsg.ILLEGAL_ATTR_NAME_ERR, "No se puede llamar ''{0}'' a un atributo"},
             ...
             * encountered.
             */
            {ErrorMsg.INTERNAL_ERR, "Error interno de XSLTC irrecuperable: ''{0}''"},
             ...
             */
            {ErrorMsg.UNSUPPORTED_XSL_ERR, "Elemento ''{0}'' de XSL no soportado."},
             ...
             */
            {ErrorMsg.UNSUPPORTED_EXT_ERR, "Extensi\u00F3n ''{0}'' de XSLTC no reconocida."},
             ...
             */
            {
                ...
                "No se ha podido leer el destino de hoja de estilos ''{0}'', porque no se permite"
                    + " el acceso ''{1}'' debido a una restricci\u00F3n definida por la propiedad"
             ...
             */
            {ErrorMsg.NOT_IMPLEMENTED_ERR, "No implantado: ''{0}''."},
             ...
             */
            {ErrorMsg.ELEMENT_PARSE_ERR, "No se ha podido analizar el elemento ''{0}''"},
             ...
             */
            {ErrorMsg.TRANSLET_CLASS_ERR, "No se ha podido cargar la clase de translet ''{0}''."},
            {
             ...
             */
            {ErrorMsg.JAXP_COMPILE_ERR, "No se ha podido compilar la hoja de estilo"},
             ...
             */
            {ErrorMsg.JAXP_INVALID_ATTR_ERR, "TransformerFactory no reconoce el atributo ''{0}''."},
            {
             ...
             */
            {ErrorMsg.JAXP_SET_RESULT_ERR, "setResult() debe llamarse antes de startDocument()."},
             ...
             * met.
             */
            {ErrorMsg.JAXP_NO_TRANSLET_ERR, "Transformer no tiene un objeto translet encapsulado."},
             ...
             */
            {ErrorMsg.SAX2DOM_ADAPTER_ERR, "No se ha podido crear el adaptador SAX2DOM: ''{0}''."},
             ...
             */
            {
                ...
                "SINOPSIS\n"
                    ...
                    + "   -j <archivo jar>   empaqueta las clases de translet en un archivo jar"
                    + " del\n"
                    + "                  nombre especificado como <archivo jar>\n"
                    + "   -p <paquete>   especifica un prefijo de nombre de paquete para todas las"
                    + " clases de translet n\n"
                    + "                  generadas.\n"
                    + "   -n             permite poner en l\u00EDnea la plantilla (comportamiento"
                    + " por defecto mejor\n"
                    + "                  sobre la media).\n"
             ...
             */
            {
                ...
                "SYNOPSIS \n"
                    ...
                    + "   la CLASSPATH del usuario o en el <archivo jar> especificado"
                    + " opcionalmente.\n"
                    + "OPCIONES\n"
                    + "   -j <archivo jar>    especifica un archivo jar desde el que cargar el"
                    + " translet\n"
                    + "   -x              activa la salida del mensaje de depuraci\u00F3n"
                    + " adicional\n"
                    + "   -n <iteraciones> ejecuta el n\u00FAmero de <iteraciones> de una"
                    + " transformaci\u00F3n y\n"
                    + "                   muestra la informaci\u00F3n de la creaci\u00F3n de"
                    + " perfil\n"
             ...
             */
            {ErrorMsg.SYNTAX_ERR, "Error de sintaxis en ''{0}''."},
             ...
             * class.
             */
            {ErrorMsg.CONSTRUCTOR_NOT_FOUND, "No se ha encontrado el constructor externo ''{0}''."},
             ...
             */
            {ErrorMsg.TYPE_CHECK_ERR, "Error al comprobar el tipo de la expresi\u00F3n ''{0}''."},
             ...
             */
            {
                ...
                "El nombre ''{0}'' no se ha podido utilizar como el nombre de la clase de translet"
                    + " porque contiene caracteres que no est\u00E1n permitidos en el nombre de la"
                    + " clase Java. Se ha utilizado el nombre ''{1}'' en su lugar."
            },
             ...
             * this message.
             */
            {ErrorMsg.COMPILER_ERROR_KEY, "Errores del compilador:"},
             ...
             */
            {ErrorMsg.COMPILER_WARNING_KEY, "Advertencias del compilador:"},
             ...
             */
            {ErrorMsg.RUNTIME_ERROR_KEY, "Errores del translet:"},
             ...
             */
            {
                ...
                "Error interno de XSLTC: un m\u00E9todo en el translet excede la limitaci\u00F3n de"
                    + " Java Virtual Machine de longitud de un m\u00E9todo de 64 kilobytes."
                    + " Normalmente, esto lo causan plantillas en una hoja de estilos demasiado"
                    + " grandes. Pruebe a reestructurar la hoja de estilos para utilizar plantillas"
                    + " m\u00E1s peque\u00F1as."
            },
            {
                ErrorMsg.DESERIALIZE_TRANSLET_ERR,
                "Cuando la seguridad de Java est\u00E1 activada, el soporte para anular la"
                    + " serializaci\u00F3n de TemplatesImpl est\u00E1 desactivado. Esto se puede"
                    + " sustituir definiendo la propiedad del sistema"
                    + " jdk.xml.enableTemplatesImplDeserialization en true."
            }
        };
    }
}
