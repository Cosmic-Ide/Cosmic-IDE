...
public class ErrorMessages_fr extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
             ...
             */
            {ErrorMsg.INVALID_URI_ERR, "URI ''{0}'' non valide."},
             ...
             */
            {
                ...
                "JAXP08090001 : le CatalogResolver est activ\u00E9 avec le catalogue \"{0}\", mais"
                    + " une exception CatalogException est renvoy\u00E9e."
            },
             ...
             */
            {
                ...
                "Les enfants d'\u00E9l\u00E9ment xsl:import doivent pr\u00E9c\u00E9der tous les"
                    + " autres enfants d'\u00E9l\u00E9ment d'un \u00E9l\u00E9ment xsl:stylesheet, y"
                    + " compris tout enfant d'\u00E9l\u00E9ment xsl:include."
            },
             ...
             */
            {
                ...
                "Les fragments de l'arborescence de r\u00E9sultats ne peuvent pas \u00EAtre"
                    + " tri\u00E9s (les \u00E9l\u00E9ments <xsl:sort> ne sont pas pris en compte)."
                    + " Vous devez trier les noeuds lorsque vous cr\u00E9ez l'arborescence de"
                    + " r\u00E9sultats."
            },
             ...
             */
            {
                ...
                "Impossible de lire la cible de feuille de style ''{0}'' car l''acc\u00E8s \u00E0"
                    + " ''{1}'' n''est pas autoris\u00E9 en raison d''une restriction d\u00E9finie"
                    + " par la propri\u00E9t\u00E9 accessExternalStylesheet."
            },
             ...
             */
            {
                ...
                "SYNTAXE\n"
                    ...
                    + "                  translet g\u00E9n\u00E9r\u00E9. Par d\u00E9faut, le nom du"
                    + " translet est\n"
                    + "                  d\u00E9riv\u00E9 du nom <stylesheet>. Cette option\n"
                    + "                  n'est pas prise en compte lors de la compilation de"
                    + " plusieurs feuilles de style.\n"
                    + "   -d <directory> indique un r\u00E9pertoire de destination pour le"
                    + " translet\n"
                    + "   -j <jarfile>   package les classes de translet dans un fichier JAR"
                    + " portant le\n"
                    + "                  nom sp\u00E9cifi\u00E9 comme <jarfile>\n"
                    + "   -p <package>   indique un pr\u00E9fixe de nom de package pour toutes"
                    + " les\n"
                    + "                  classes de translet g\u00E9n\u00E9r\u00E9es.\n"
                    + "   -n             active le mode INLINE du mod\u00E8le (comportement par"
                    + " d\u00E9faut am\u00E9lior\u00E9\n"
                    + "                  en moyenne).\n"
                    + "   -x             active la sortie de messages de d\u00E9bogage"
                    + " suppl\u00E9mentaires\n"
                    + "   -u             interpr\u00E8te les arguments <stylesheet> comme des URL\n"
                    + "   -i             force le compilateur \u00E0 lire la feuille de style"
                    + " \u00E0 partir de STDIN\n"
             ...
             */
            {
                ...
                "SYNTAXE \n"
                    ...
                    + "   la variable d'environnement CLASSPATH de l'utilisateur, soit dans un"
                    + " fichier <jarfile> indiqu\u00E9 en option.\n"
                    + "OPTIONS\n"
                    + "   -j <jarfile>    indique un fichier JAR \u00E0 partir duquel charger le"
                    + " translet\n"
                    + "   -x              active la sortie de messages de d\u00E9bogage"
                    + " suppl\u00E9mentaires\n"
             ...
             */
            {ErrorMsg.SYNTAX_ERR, "Erreur de syntaxe dans ''{0}''."},
             ...
             */
            {
                ...
                "Impossible d''utiliser le nom ''{0}'' comme nom de classe de translet car il"
                    + " contient des caract\u00E8res non autoris\u00E9s dans le nom de la classe"
                    + " Java. Le nom ''{1}'' a \u00E9t\u00E9 utilis\u00E9 \u00E0 la place."
            },
             ...
             * this message.
             */
            {ErrorMsg.COMPILER_ERROR_KEY, "Erreurs de compilateur :"},
             ...
             */
            {ErrorMsg.RUNTIME_ERROR_KEY, "Erreurs de translet :"},
             ...
             */
            {
                ...
                "L''attribut \"method\" d''un \u00E9l\u00E9ment <xsl:output> avait la valeur"
                    + " ''{0}''. La valeur doit \u00EAtre l''une des suivantes : ''xml'', ''html'',"
                    + " ''text'' ou qname-but-not-ncname"
            },
            {
             ...
             */
            {
                ...
                "Erreur XSLTC interne : une instruction ayant fait partie d'un bloc de code"
                    + " ex\u00E9cutable d\u00E9limit\u00E9 est toujours r\u00E9f\u00E9renc\u00E9e"
             ...
             */
            {
                ...
                "Erreur XSLTC interne : une m\u00E9thode dans le translet d\u00E9passe la limite de"
                    + " la JVM concernant la longueur d'une m\u00E9thode de 64 kilo-octets. En"
                    + " g\u00E9n\u00E9ral, ceci est d\u00FB \u00E0 de tr\u00E8s grands mod\u00E8les"
                    + " dans une feuille de style. Essayez de restructurer la feuille de style pour"
                    + " utiliser des mod\u00E8les plus petits."
            },
            {
                ErrorMsg.DESERIALIZE_TRANSLET_ERR,
                "Lorsque la s\u00E9curit\u00E9 Java est activ\u00E9e, la prise en charge de la"
                    + " d\u00E9s\u00E9rialisation de TemplatesImpl est d\u00E9sactiv\u00E9e. La"
                    + " d\u00E9finition de la propri\u00E9t\u00E9 syst\u00E8me"
                    + " jdk.xml.enableTemplatesImplDeserialization sur True permet de remplacer ce"
                    + " param\u00E8tre."
            }
        };
    }
