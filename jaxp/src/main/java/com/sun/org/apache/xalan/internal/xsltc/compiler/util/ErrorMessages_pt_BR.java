...
public class ErrorMessages_pt_BR extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
             ...
             */
            {ErrorMsg.VARIABLE_UNDEF_ERR, "Vari\u00E1vel ou par\u00E2metro ''{0}'' indefinido."},
             ...
             * is missing.
             */
            {ErrorMsg.FILE_NOT_FOUND_ERR, "Arquivo ou URI ''{0}'' n\u00E3o encontrado."},

            /*
             * Note to translators:  This message is displayed when the URI
             * mentioned in the substitution text is not well-formed syntactically.
             */
            {ErrorMsg.INVALID_URI_ERR, "URI inv\u00E1lido ''{0}''."},
             ...
             */
            {
                ...
                "JAXP08090001: O CatalogResolver foi ativado com o cat\u00E1logo \"{0}\", mas uma"
                    + " CatalogException foi retornada."
            },
             ...
             */
            {ErrorMsg.MISSING_ROOT_ERR, "elemento <xsl:stylesheet> ou <xsl:transform> esperado."},
             ...
             */
            {ErrorMsg.NEED_LITERAL_ERR, "O argumento para \"{0}'' deve ser uma string literal."},
             ...
             * the expression.
             */
            {ErrorMsg.XPATH_PARSER_ERR, "Erro durante o parsing da express\u00E3o XPath ''{0}''."},
             ...
             */
            {ErrorMsg.ILLEGAL_CHAR_ERR, "Caractere inv\u00E1lido ''{0}'' na express\u00E3o XPath."},
             ...
             */
            {ErrorMsg.STRAY_ATTRIBUTE_ERR, "Atributo ''{0}'' fora do elemento."},
             ...
             * text.
             */
            {ErrorMsg.ILLEGAL_ATTRIBUTE_ERR, "Atributo ''{0}'' inv\u00E1lido."},
             ...
             */
            {
                ...
                "Os filhos do elemento xsl:import devem preceder todos os outros filhos de um"
                    + " elemento xsl:stylesheet, inclusive quaisquer filhos do elemento"
                    + " xsl:include."
            },
             ...
             * in the stylesheet.
             */
            {ErrorMsg.STRAY_WHEN_ERR, "<xsl:when> s\u00F3 pode ser usado em <xsl:choose>."},
             ...
             */
            {ErrorMsg.ILLEGAL_CHILD_ERR, "Elemento filho inv\u00E1lido."},
             ...
             * the name.
             */
            {ErrorMsg.ILLEGAL_ELEM_NAME_ERR, "Voc\u00EA n\u00E3o pode chamar um elemento ''{0}''"},
             ...
             * contains the name.
             */
            {ErrorMsg.ILLEGAL_ATTR_NAME_ERR, "Voc\u00EA n\u00E3o pode chamar um atributo ''{0}''"},
             ...
             */
            {ErrorMsg.SAX_PARSER_CONFIG_ERR, "Parser de JAXP n\u00E3o configurado corretamente"},

            /*
             * Note to translators:  The substitution text names the internal error
             * encountered.
             */
            {ErrorMsg.INTERNAL_ERR, "Erro interno-XSLTC irrecuper\u00E1vel: ''{0}''"},
             ...
             */
            {ErrorMsg.UNSUPPORTED_XSL_ERR, "Elemento XSL n\u00E3o suportado ''{0}''."},
             ...
             */
            {ErrorMsg.UNSUPPORTED_EXT_ERR, "Extens\u00E3o de XSLTC n\u00E3o reconhecida ''{0}''."},
             ...
             */
            {ErrorMsg.NOT_IMPLEMENTED_ERR, "N\u00E3o implementado: ''{0}''."},
             ...
             */
            {ErrorMsg.JAXP_COMPILE_ERR, "N\u00E3o foi poss\u00EDvel compilar a folha de estilos"},
             ...
             */
            {ErrorMsg.XSLTC_SOURCE_ERR, "XSLTCSource.build() chamado sem o systemId ser definido."},
            {ErrorMsg.ER_RESULT_NULL, "O resultado n\u00E3o deve ser nulo"},
             ...
             */
            {
                ...
                "SINOPSE\n"
                    ...
                    + "                  origina-se do nome <folha de estilos>.  Esta"
                    + " op\u00E7\u00E3o\n"
                    + "                  \u00E9 ignorada caso sejam compiladas v\u00E1rias folhas"
                    + " de estilos.\n"
                    + "   -d <diret\u00F3rio> especifica um diret\u00F3rio de destino para"
                    + " translet\n"
                    + "   -j <arquivo jar>   empacota as classes translet em um arquivo jar do\n"
                    + "                  nome especificado como <arquivo jar>\n"
                    + "   -p <pacote>   especifica um prefixo de nome do pacote para todas as"
                    + " classes\n"
                    + "                  translet geradas.\n"
                    + "   -n             permite a inclus\u00E3o do modelo na linha (comportamento"
                    + " padr\u00E3o melhor\n"
                    + "                  em m\u00E9dia).\n"
                    + "   -x             ativa a sa\u00EDda de mensagens de depura\u00E7\u00E3o"
                    + " adicionais\n"
             ...
             */
            {
                ...
                "SINOPSE \n"
                    ...
                    + "   CLASSPATH do usu\u00E1rio ou no <arquivo jar> opcionalmente"
                    + " especificado.\n"
                    + "OP\u00C7\u00D5ES\n"
                    + "   -j <arquivo jar>    especifica um arquivo jar com base no qual ser\u00E1"
                    + " carregado o translet\n"
                    + "   -x              ativa a sa\u00EDda de mensagens de depura\u00E7\u00E3o"
                    + " adicionais\n"
                    + "   -n <itera\u00E7\u00F5es> executa a transforma\u00E7\u00E3o"
                    + " <itera\u00E7\u00F5es> vezes e\n"
                    + "                   exibe as informa\u00E7\u00F5es de perfis\n"
                    + "   -u <url_documento> especifica o documento XML de entrada na forma de"
                    + " URL\n"
            },
             ...
             */
            {ErrorMsg.SYNTAX_ERR, "Erro de sintaxe em ''{0}''."},
             ...
             */
            {ErrorMsg.TYPE_CHECK_ERR, "Erro ao verificar o tipo de express\u00E3o ''{0}''."},
             ...
             * Note to translators:  The substitution text is the name of a class.
             */
            {ErrorMsg.TRANSFORM_WITH_TRANSLET_STR, "Transformar usando translet ''{0}'' "},
             ...
             */
            {
                ...
                "N\u00E3o foi poss\u00EDvel usar o nome ''{0}'' como o nome da classe translet,"
                    + " pois ele cont\u00E9m caracteres que n\u00E3o s\u00E3o permitidos no nome da"
                    + " classe Java. O nome ''{1}'' foi usado."
            },
             ...
             * this message.
             */
            {ErrorMsg.COMPILER_ERROR_KEY, "Erros do compilador:"},
             ...
             */
            {ErrorMsg.COMPILER_WARNING_KEY, "Advert\u00EAncias do compilador:"},
             ...
             */
            {ErrorMsg.RUNTIME_ERROR_KEY, "Erros de translet:"},
             ...
             */
            {
                ...
                "O atributo method de um elemento <xsl:output> tinha o valor ''{0}''. O valor deve"
                    + " ser um dos seguintes: ''xml'', ''html'', ''text'', ou qname, mas n\u00E3o"
                    + " ncname"
            },
            {
             ...
             */
            {
                ...
                "Erro interno de XSLTC: um m\u00E9todo no translet excede a limita\u00E7\u00E3o da"
                    + " M\u00E1quina Virtual Java quanto ao tamanho de um m\u00E9todo de de 64"
                    + " kilobytes. Em geral, essa situa\u00E7\u00E3o \u00E9 causada por modelos de"
                    + " uma folha de estilos que s\u00E3o muito grandes. Tente reestruturar sua"
                    + " folha de estilos de forma a usar modelos menores."
            },
            {
                ErrorMsg.DESERIALIZE_TRANSLET_ERR,
                "Quando a seguran\u00E7a do Java est\u00E1 ativada, o suporte para desserializar"
                    + " TemplatesImpl fica desativado. Essa situa\u00E7\u00E3o pode ser corrigida"
                    + " definindo a propriedade do sistema"
                    + " jdk.xml.enableTemplatesImplDeserialization como true."
            }
        };
    }
}
