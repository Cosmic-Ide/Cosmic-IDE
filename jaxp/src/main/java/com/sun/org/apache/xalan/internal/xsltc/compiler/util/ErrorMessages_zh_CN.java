...
public class ErrorMessages_zh_CN extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
             ...
             * is missing.
             */
            {ErrorMsg.FILE_NOT_FOUND_ERR, "\u627E\u4E0D\u5230\u6587\u4EF6\u6216 URI ''{0}''\u3002"},

            /*
             * Note to translators:  This message is displayed when the URI
             * mentioned in the substitution text is not well-formed syntactically.
             */
            {ErrorMsg.INVALID_URI_ERR, "URI ''{0}'' \u65E0\u6548\u3002"},
             ...
             */
            {
                ...
                "JAXP08090001: \u5DF2\u5BF9\u76EE\u5F55 \"{0}\" \u542F\u7528 CatalogResolver,"
                    + " \u4F46\u8FD4\u56DE\u4E86 CatalogException\u3002"
            },
             ...
             */
            {ErrorMsg.REQUIRED_ATTR_ERR, "\u7F3A\u5C11\u6240\u9700\u5C5E\u6027 ''{0}''\u3002"},
             ...
             */
            {
                ...
                "xsl:import \u5143\u7D20\u5B50\u7EA7\u5FC5\u987B\u4F4D\u4E8E xsl:stylesheet"
                    + " \u5143\u7D20\u7684\u6240\u6709\u5176\u4ED6\u5143\u7D20\u5B50\u7EA7"
                    + " (\u5305\u62EC\u4EFB\u4F55 xsl:include \u5143\u7D20\u5B50\u7EA7)"
                    + " \u4E4B\u524D\u3002"
            },
             ...
             */
            {ErrorMsg.XSL_VERSION_ERR, "XSLTC \u4E0D\u652F\u6301 XSL \u7248\u672C ''{0}''\u3002"},
             ...
             */
            {ErrorMsg.TRANSLET_CLASS_ERR, "\u65E0\u6CD5\u52A0\u8F7D translet \u7C7B ''{0}''\u3002"},
            {
             ...
             */
            {
                ...
                "\u63D0\u8981\n"
                    ...
                    + "                  \u540D\u79F0"
                    + " <\u8F93\u51FA>\u3002\u9ED8\u8BA4\u60C5\u51B5\u4E0B, translet \u540D\u79F0\n"
                    + "                  \u6D3E\u751F\u81EA <\u6837\u5F0F\u8868>"
                    + " \u540D\u79F0\u3002\u5982\u679C\u8981\u7F16\u8BD1\u591A\u4E2A\u6837\u5F0F\u8868,"
                    + " \n"
                    + "                  \u5219\u5FFD\u7565\u6B64\u9009\u9879\u3002\n"
                    + "   -d <\u76EE\u5F55> \u6307\u5B9A translet \u7684\u76EE\u6807\u76EE\u5F55\n"
                    + "   -j <jarfile>   \u5C06 translet \u7C7B\u6253\u5305\u5230\u5177\u6709"
                    + " <jarfile>\n"
                    + "                  \u6307\u5B9A\u7684\u540D\u79F0\u7684 jar"
                    + " \u6587\u4EF6\u4E2D\n"
                    + "   -p <\u7A0B\u5E8F\u5305>   \u4E3A\u751F\u6210\u7684\u6240\u6709 translet"
                    + " \u7C7B\n"
                    + "                 "
                    + " \u6307\u5B9A\u7A0B\u5E8F\u5305\u540D\u79F0\u524D\u7F00\u3002\n"
                    + "   -n             \u542F\u7528\u6A21\u677F\u5185\u5D4C"
             ...
             */
            {
                ...
                "\u63D0\u8981\n"
                    ...
                    + "      <\u7C7B> [<param1>=<value1> ...]\n\n"
                    + "   \u4F7F\u7528 translet <\u7C7B> \u8F6C\u6362\n"
                    + "   <\u6587\u6863> \u6307\u5B9A\u7684 XML \u6587\u6863\u3002translet <\u7C7B>"
                    + " \u4F4D\u4E8E\n"
                    + "   \u7528\u6237\u7684 CLASSPATH \u6216\u9009\u62E9\u6027\u6307\u5B9A\u7684"
                    + " <jarfile> \u4E2D\u3002\n"
                    + "\u9009\u9879\n"
                    + "   -j <jarfile>    \u6307\u5B9A\u8981\u4ECE\u4E2D\u52A0\u8F7D translet"
                    + " \u7684 jarfile\n"
                    + "   -x             "
                    + " \u542F\u7528\u5176\u4ED6\u8C03\u8BD5\u6D88\u606F\u8F93\u51FA\n"
                    + "   -n <\u8FED\u4EE3\u6570> \u8FD0\u884C <\u8FED\u4EE3\u6570>"
             ...
             */
            {ErrorMsg.RUNTIME_ERROR_KEY, "Translet \u9519\u8BEF:"},
             ...
             */
            {
                ...
                "\u5185\u90E8 XSLTC \u9519\u8BEF: OutlineableChunkStart \u548C OutlineableChunkEnd"
                    + " \u6807\u8BB0\u5FC5\u987B\u914D\u5BF9\u5E76\u4E14\u6B63\u786E\u5D4C\u5957\u3002"
            },
             ...
             */
            {
                ...
                "\u5185\u90E8 XSLTC \u9519\u8BEF: translet"
                    + " \u4E2D\u7684\u65B9\u6CD5\u8D85\u8FC7\u4E86 Java"
                    + " \u865A\u62DF\u673A\u7684\u65B9\u6CD5\u957F\u5EA6\u9650\u5236 64"
                    + " KB\u3002\u8FD9\u901A\u5E38\u662F\u7531\u4E8E\u6837\u5F0F\u8868\u4E2D\u7684\u6A21\u677F\u975E\u5E38\u5927\u9020\u6210\u7684\u3002\u8BF7\u5C1D\u8BD5\u4F7F\u7528\u8F83\u5C0F\u7684\u6A21\u677F\u91CD\u65B0\u6784\u5EFA\u6837\u5F0F\u8868\u3002"
            },
            {
                ErrorMsg.DESERIALIZE_TRANSLET_ERR,
                "\u542F\u7528\u4E86 Java \u5B89\u5168\u65F6,"
                    + " \u5C06\u7981\u7528\u5BF9\u53CD\u5E8F\u5217\u5316 TemplatesImpl"
                    + " \u7684\u652F\u6301\u3002\u53EF\u4EE5\u901A\u8FC7\u5C06"
