...
/** Base class for sort records containing application specific sort keys @LastModified: May 2019 */
public abstract class NodeSortRecord {
     ...
     *     to it.
     */
    @Deprecated private static final Collator DEFAULT_COLLATOR = Collator.getInstance();
     ...
     *     to it.
     */
    @Deprecated protected Collator _collator = DEFAULT_COLLATOR;
     ...
     *     to it.
     */
    @Deprecated protected Locale _locale;
