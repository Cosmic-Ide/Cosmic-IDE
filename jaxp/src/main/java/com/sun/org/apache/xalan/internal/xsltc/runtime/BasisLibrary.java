 ...
 * two arguments. @LastModified: Sep 2017
 */
public final class BasisLibrary {
     ...
     * from the 'formatSymbols' map in AbstractTranslet.
     */
    ...
    /**
     * These functions are used in the execution of xsl:element to generate and reset namespace
     * prefix index local to current transformation process
     */
    ...
    /**
     * Utility method to calculate string-length as a number of code points, to avoid possible
     * errors with string that contains complementary characters
     */
