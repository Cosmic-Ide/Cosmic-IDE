...
/**
 * @author Santiago Pericas-Geertsen @LastModified: Aug 2019
 */
public class TransletOutputHandlerFactory {
    ...
    public static TransletOutputHandlerFactory newInstance(
            boolean overrideDefaultParser, ErrorListener errListener) {
        return new TransletOutputHandlerFactory(overrideDefaultParser, errListener);
    }

    public TransletOutputHandlerFactory(boolean overrideDefaultParser, ErrorListener errListener) {
