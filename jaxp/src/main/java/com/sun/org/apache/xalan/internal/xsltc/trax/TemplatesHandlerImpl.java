...
public class TemplatesHandlerImpl implements ContentHandler, TemplatesHandler, SourceLoader {
    ...
    protected TemplatesHandlerImpl(
            int indentNumber, TransformerFactoryImpl tfactory, boolean hasUserErrListener) {
    ...
    /**
     * Implements javax.xml.transform.sax.TemplatesHandler.getSystemId() Get the base ID (URI or
    ...
    /**
     * Implements javax.xml.transform.sax.TemplatesHandler.setSystemId() Get the base ID (URI or
     * system ID) from where relative URLs will be resolved.
     *
    ...
    /**
     * Implements javax.xml.transform.sax.TemplatesHandler.getTemplates() When a TemplatesHandler
     * object is used as a ContentHandler or DocumentHandler for the parsing of transformation
     * instructions, it creates a Templates object, which the caller can get once the SAX events
     * have been completed.
     *
