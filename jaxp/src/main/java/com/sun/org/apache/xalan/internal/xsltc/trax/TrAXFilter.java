...
public class TrAXFilter extends XMLFilterImpl {
    ...
    private void createParent() throws SAXException {
        XMLReader parent =
                JdkXmlUtils.getXMLReader(_overrideDefaultParser, _transformer.isSecureProcessing());
    ...
    public void parse(InputSource input) throws SAXException, IOException {
        ...
        try {
            if (getParent() == null) {
                try {
                    managedReader =
                            XMLReaderManager.getInstance(_overrideDefaultParser).getXMLReader();
            ...
            if (managedReader != null) {
                XMLReaderManager.getInstance(_overrideDefaultParser)
