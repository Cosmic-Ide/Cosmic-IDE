...
public class TransformerHandlerImpl implements TransformerHandler, DeclHandler {
    ...
    /**
     * Implements javax.xml.transform.sax.TransformerHandler.getSystemId() Get the base ID (URI or
     * system ID) from where relative URLs will be resolved.
     *
    ...
    /**
     * Implements javax.xml.transform.sax.TransformerHandler.setSystemId() Get the base ID (URI or
     * system ID) from where relative URLs will be resolved.
     *
    ...
    /**
     * Implements javax.xml.transform.sax.TransformerHandler.getTransformer() Get the Transformer
     * associated with this handler, which is needed in order to set parameters and output
     * properties.
     *
