...
/**
 * Supply one the right implementation, based upon requested features. Each implemented <code>
 * DOMImplementationSource</code> object is listed in the binding-specific list of available sources
 * so that its <code>DOMImplementation</code> objects are made available.
 *
 * <p>See also the <a
 * href='http://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407/core.html#DOMImplementationSource'>
