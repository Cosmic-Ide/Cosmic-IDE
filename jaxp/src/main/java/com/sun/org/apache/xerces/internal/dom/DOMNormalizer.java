 ...
 * @author Neeraj Bajaj, Sun Microsystems, inc. @LastModified: Apr 2019
 */
public class DOMNormalizer implements XMLDocumentHandler {
    ...
    protected void normalizeDocument(CoreDocumentImpl document, DOMConfigurationImpl config) {
        ...
        if ((fConfiguration.features & DOMConfigurationImpl.VALIDATE) != 0) {
            ...
            if (schemaLang != null && schemaLang.equals(Constants.NS_XMLSCHEMA)) {
                ...
                fValidationHandler =
                        CoreDOMImplementationImpl.singleton.getValidator(schemaType, xmlVersion);
        ...
        if (fValidationHandler != null) {
            ...
            fValidationHandler.startDocument(
                    ...
                    fNamespaceContext,
                    null);
            fValidationHandler.xmlDecl(
                    fDocument.getXmlVersion(),
                    fDocument.getXmlEncoding(),
                    fDocument.getXmlStandalone() ? "yes" : "no",
                    null);
        }
        try {
            ...
            if (fValidationHandler != null) {
                ...
                CoreDOMImplementationImpl.singleton.releaseValidator(
                        schemaType, xmlVersion, fValidationHandler);
                fValidationHandler = null;
            }
                    ...
                    if ((fConfiguration.features & DOMConfigurationImpl.NAMESPACES) != 0) {
                        ...
                        if ((fConfiguration.features & DOMConfigurationImpl.NSDECL) == 0) {
                            ...
                            if (attributes == null) {
                                attributes =
                                        (elem.hasAttributes())
                                                ? (AttributeMap) elem.getAttributes()
                                                : null;
                            }
                            if (attributes != null) {
            ...
            case Node.PROCESSING_INSTRUCTION_NODE:
                {
                    ...
                    if (fValidationHandler != null) {
                        ...
                        fValidationHandler.processingInstruction(
                                ((ProcessingInstruction) node).getTarget(), EMPTY_STRING, null);
                    }
    ...
    private void processDTD(String xmlVersion, String schemaLocation) {
        ...
        try {
            ...
            loader.loadGrammarWithContext(
                    (XMLDTDValidator) fValidationHandler,
                    rootName,
                    publicId,
                    systemId,
                    baseSystemId,
                    ...
                    if (fDocument.errorChecking && value.equals(NamespaceContext.XMLNS_URI)) {
                        ...
                        if (prefix == XMLSymbols.PREFIX_XMLNS) { // xmlns:prefix
                            ...
                            fNamespaceContext.declarePrefix(
                                    XMLSymbols.EMPTY_STRING, value.length() != 0 ? value : null);
                            // removeDefault (attr, attributes);
                            continue;
                        }
    ...
    public static final void reportDOMError(
        ...
        if (errorHandler != null) {
            ...
            if (!errorHandler.handleError(error)) throw new AbortException();
        }
        if (severity == DOMError.SEVERITY_FATAL_ERROR) throw new AbortException();
    }
    ...
    protected final class XMLAttributesProxy implements XMLAttributes {
         ...
         *
         * @see com.sun.org.apache.xerces.internal.xni.XMLAttributes#addAttribute(QName, String,
         *     String)
         */
