 ...
 * @since PR-DOM-Level-1-19980818. @LastModified: Nov 2017
 */
public class DocumentImpl extends CoreDocumentImpl
    ...
    protected void removeEventListener(
        ...
        for (int i = nodeListeners.size() - 1; i >= 0; --i) {
            ...
            if (le.useCapture == useCapture && le.listener == listener && le.type.equals(type)) {
                ...
                if (nodeListeners.isEmpty()) setEventListeners(node, null);
    ...
    /**
     * @serialData Serialized fields. Convert Maps to Hashtables and Lists to Vectors for backward
     *     compatibility.
     */
