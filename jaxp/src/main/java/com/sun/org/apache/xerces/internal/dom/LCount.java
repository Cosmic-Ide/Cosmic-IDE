 ...
 * as an entry in a global Map. This should allow us to avoid generating, or discarding, events for
 * which no listeners are registered.
 *
 ...
 */
class LCount {
    static final java.util.Map<String, LCount> lCounts =
