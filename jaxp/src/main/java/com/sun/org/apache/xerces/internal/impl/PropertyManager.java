...
public class PropertyManager {
    ...
    private void initConfigurableReaderProperties() {
        ...
        supportedProps.put(
                Constants.XERCES_FEATURE_PREFIX + Constants.ALLOW_JAVA_ENCODINGS_FEATURE, true);
        ...
        supportedProps.put(
                Constants.ZEPHYR_PROPERTY_PREFIX + Constants.STAX_REPORT_CDATA_EVENT, false);
        supportedProps.put(
    ...
    public Object getProperty(String property) {
        ...
        String propertyValue =
                (fSecurityManager != null) ? fSecurityManager.getLimitAsString(property) : null;
