 ...
 * @author Eric Ye, IBM
 * @author Sunitha Reddy, SUN Microsystems @LastModified: May 2021
 */
public class XMLDocumentFragmentScannerImpl extends XMLScanner
    ...
    private static final Object[] PROPERTY_DEFAULTS = {
        null, null, null, null, null, null, null, null, JdkConstants.CDATA_CHUNK_SIZE_DEFAULT
    };
    ...
    public void reset(XMLComponentManager componentManager) throws XMLConfigurationException {
        ...
        fCreateEntityRefNodes =
                componentManager.getFeature(CREATE_ENTITY_REF_NODES, fCreateEntityRefNodes);
    ...
    public void reset(PropertyManager propertyManager) {
        ...
        Boolean bo =
                (Boolean)
                        propertyManager.getProperty(XMLInputFactory.IS_REPLACING_ENTITY_REFERENCES);
        ...
        fChunkSize =
                JdkXmlUtils.getValue(
                        propertyManager.getProperty(JdkConstants.CDATA_CHUNK_SIZE),
                        JdkConstants.CDATA_CHUNK_SIZE_DEFAULT);
        resetCommon();
    } // reset(XMLComponentManager)
    ...
    protected void scanEntityReference(XMLStringBuffer content) throws IOException, XNIException {
        ...
        if (fCreateEntityRefNodes) {
            ...
            // set the scaner state to content.. parser will automatically revive itself at any
            // point of time.
            // setScannerState(SCANNER_STATE_CONTENT);
            // return true ;
        }
    ...
    String checkAccess(String systemId, String allowedProtocols) throws IOException {
        ...
        String expandedSystemId =
                XMLEntityManager.expandSystemId(systemId, baseSystemId, fStrictURI);
        return SecuritySupport.checkAccess(
                expandedSystemId, allowedProtocols, JdkConstants.ACCESS_EXTERNAL_ALL);
    }
                        ...
                        case SCANNER_STATE_REFERENCE:
                            {
                                ...
                                // Whether it was character reference, entity reference or built-in
                                // entity
                                        ...
                                        if (fNamespaces) {
                                            while (isValidNCName(fEntityScanner.peekChar())) {
                                                fStringBuffer.append(
                                                        (char) fEntityScanner.scanChar(null));
                                            }
                                        } else {
    ...
    /**
     * Since 'TempString' shares the buffer (a char array) with the CurrentEntity, when the cursor
     * position reaches the end, that is, before the buffer is being loaded with new data, the
     * content in the TempString needs to be copied into the ContentBuffer.
     */
