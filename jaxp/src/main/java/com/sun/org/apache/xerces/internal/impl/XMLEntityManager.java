 ...
 * @author Sunitha Reddy SUN Microsystems @LastModified: Aug 2021
 */
public class XMLEntityManager implements XMLComponent, XMLEntityResolver {
    ...
    public void setEntityHandler(
            com.sun.org.apache.xerces.internal.impl.XMLEntityHandler entityHandler) {
            ...
            if (fCatalogFile != null) {
                try {
                    ...
                    if (is != null && !is.isEmpty()) {
                        staxInputSource =
                                new StaxXMLInputSource(new XMLInputSource(is, true), true);
                    }
        ...
        if (staxInputSource == null) {
            ...
            staxInputSource =
                    new StaxXMLInputSource(
                            new XMLInputSource(publicId, literalSystemId, baseSystemId, true),
                            false);
                ...
                */
                ...
                if (is != null && !is.isEmpty()) {
                    ...
                    if (source != null && !source.isEmpty()) {
                        xmlInputSource =
                                new XMLInputSource(
                                        publicId, source.getSystemId(), baseSystemId, true);
                    }
                }
            }
        }
    ...
    public void startEntity(boolean isGE, String entityName, boolean literal)
        ...
        for (int i = size; i >= 0; i--) {
            Entity activeEntity = i == size ? fCurrentEntity : fEntityStack.get(i);
    ...
    public Entity.ScannedEntity getTopLevelEntity() {
        return (Entity.ScannedEntity) (fEntityStack.empty() ? null : fEntityStack.get(0));
    }
     ...
     *     tells whether the order is bigEndian. null if unknown or irrelevant.
    ...
    private static class EncodingInfo {
        ...
        /** UTF-8 * */
        public static final EncodingInfo UTF_8 = new EncodingInfo(STR_UTF8, null, false);

        /** UTF-8, with BOM * */
        public static final EncodingInfo UTF_8_WITH_BOM = new EncodingInfo(STR_UTF8, null, true);
