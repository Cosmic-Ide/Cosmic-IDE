...
public class XMLNSDocumentScannerImpl extends XMLDocumentScannerImpl {
    ...
    public void reset(PropertyManager propertyManager) {
        ...
        fNotAddNSDeclAsAttribute =
                !((Boolean) propertyManager.getProperty(Constants.ADD_NAMESPACE_DECL_AS_ATTRIBUTE))
                        .booleanValue();
    }
    ...
    protected boolean scanStartElement() throws IOException, XNIException {
        ...
        if (fEmptyElement) {
            ...
            if (fDocumentHandler != null) {
                if (DEBUG) System.out.println("emptyElement = " + fElementQName);
            ...
            if (fDocumentHandler != null) {
                ...
                if (DEBUG) System.out.println("startElement = " + fElementQName);
    ...
    protected void scanAttribute(XMLAttributesImpl attributes) throws IOException, XNIException {
        ...
        if (fBindNamespaces) {
            if (isNSDecl) {
                ...
                // is of type xmlns = "..", in this case prefix = "" and localname =
                ...
                // xerces internals (XSAttributeChecker) has dependency on namespace declaration
                // returned
                // as part of XMLAttributes.
                // addition of namespace declaration to the attribute list is controlled by
                // fNotAddNSDeclAsAttribute
                // feature. This is required in Stax where namespace declarations are not considered
                // as attribute
