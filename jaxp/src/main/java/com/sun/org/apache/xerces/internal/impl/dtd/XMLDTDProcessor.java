 ...
 *
 * @xerces.internal
 * @author Neil Graham, IBM @LastModified: Nov 2017
 */
        ...
        if (fValidation) {
                ...
                if (!fTableOfIDAttributeNames.containsKey(elementName)) {
                    ...
                    if (!duplicateAttributeDef) {
                        String previousIDAttributeName =
                                fTableOfIDAttributeNames.get(elementName); // rule a)
                        fErrorReporter.reportError(
                                XMLMessageFormatter.XML_DOMAIN,
            ...
            if (type == XMLSymbols.fNOTATIONSymbol) {
                ...
                if (fTableOfNOTATIONAttributeNames.containsKey(elementName) == false) {
                    ...
                    // if http://apache.org/xml/features/validation/warn-on-duplicate-attdef feature
                    // is set to true,
                    // Application behavior may differ on the basis of error or warning thrown. -
                    // nb.
