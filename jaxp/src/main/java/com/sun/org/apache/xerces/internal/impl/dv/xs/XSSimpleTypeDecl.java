 ...
 * @author Neeraj Bajaj, Sun Microsystems, inc. @LastModified: Nov 2017
 */
public class XSSimpleTypeDecl implements XSSimpleType, TypeInfo {
        ...
        if ((presentFacet & FACET_ENUMERATION) != 0) {
            if ((allowedFacet & FACET_ENUMERATION) == 0) {
                ...
                for (int i = 0; i < size; i++) {
                    if (enumNSDecls != null) ctx.setNSContext(enumNSDecls.get(i));
                    try {
                        ...
                        reportError(
                                ...
                                new Object[] {enumVals.get(i), this.getBaseType().getName()});
                    }
                }
    ...
    private void checkFacets(ValidatedInfo validatedInfo) throws InvalidDatatypeValueException {
        ...
        if (((fFacetsDefined & FACET_ENUMERATION) != 0)) {
            ...
            for (int i = 0; i < enumSize; i++) {
                final short primitiveType2 =
                        convertToPrimitiveKind(fEnumeration[i].actualValueType);
            ...
            if (!present) {
                ...
                appendEnumString(sb);
                throw new InvalidDatatypeValueException(
                        "cvc-enumeration-valid", new Object[] {content, sb.toString()});
            }
        }
        ...
        if ((fFacetsDefined & FACET_PATTERN) != 0) {
            ...
            for (int idx = fPattern.size() - 1; idx >= 0; idx--) {
                ...
                if (!regex.matches(nvalue)) {
                    throw new InvalidDatatypeValueException(
                            "cvc-pattern-valid",
                            new Object[] {content, fPatternStr.get(idx), fTypeName});
                }
            }
        }
    ...
    public StringList getLexicalEnumeration() {
        if (fLexicalEnumeration == null) {
            ...
            for (int i = 0; i < size; i++) strs[i] = fEnumeration[i].normalizedValue;
            ...
            fEnumerationItemTypeList =
                    new AbstractObjectList() {
                        ...
                        public boolean contains(Object item) {
                            ...
                            for (int i = 0; i < fEnumerationSize; i++)
                                if (fEnumeration[i].itemValueTypes == item) return true;
                            return false;
                        }
    ...
    public StringList getLexicalPattern() {
        ...
        if (fLexicalPattern == null) {
            ...
            for (int i = 0; i < size; i++) strs[i] = fPatternStr.get(i);
    ...
    public XSObjectList getFacets() {
        if (fFacets == null && (fFacetsDefined != 0 || fValidationDV == DV_INTEGER)) {
            ...
            if (fValidationDV == DV_INTEGER) {
                facets[count] =
                        new XSFacetImpl(
                                FACET_FRACTIONDIGITS, "0", 0, null, true, fractionDigitsAnnotation);
                count++;
    ...
    public XSObjectList getMultiValueFacets() {
        if (fMultiValueFacets == null
            ...
            if ((fFacetsDefined & FACET_PATTERN) != 0
                ...
                facets[count] =
                        new XSMVFacetImpl(
                                FACET_PATTERN, this.getLexicalPattern(), null, patternAnnotations);
                count++;
            }
            if (fEnumeration != null) {
                facets[count] =
    ...
    private static final class XSMVFacetImpl implements XSMultiValueFacet {
        ...
        public XSMVFacetImpl(
                short kind, StringList svalues, ObjectList avalues, XSObjectList annotations) {
            this.kind = kind;
    ...
    private abstract static class AbstractObjectList extends AbstractList<Object>
