...
public final class Latin1Reader extends Reader {
    ...
    //
    /**
     * Constructs an ISO-8859-1 reader from the specified input stream using the default buffer
     * size.
     *
     ...
     * method.
     *
     * @return The character read, as an integer in the range 0 to 255 (<tt>0x00-0xff</tt>), or -1
