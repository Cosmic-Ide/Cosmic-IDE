...
public class XPath {
    ...
    public String toString() {
        ...
        final String s = l.stream().map(aPath -> aPath.toString()).collect(Collectors.joining("|"));
    ...
    private static final class Tokens {
        ...
        public Tokens(SymbolTable symbolTable) {
            ...
            fTokenNames.put(
                    EXPRTOKEN_AXISNAME_ANCESTOR_OR_SELF, "EXPRTOKEN_AXISNAME_ANCESTOR_OR_SELF");
            ...
            fTokenNames.put(
                    EXPRTOKEN_AXISNAME_DESCENDANT_OR_SELF, "EXPRTOKEN_AXISNAME_DESCENDANT_OR_SELF");
            fTokenNames.put(EXPRTOKEN_AXISNAME_FOLLOWING, "EXPRTOKEN_AXISNAME_FOLLOWING");
            fTokenNames.put(
                    EXPRTOKEN_AXISNAME_FOLLOWING_SIBLING, "EXPRTOKEN_AXISNAME_FOLLOWING_SIBLING");
            ...
            fTokenNames.put(
                    EXPRTOKEN_AXISNAME_PRECEDING_SIBLING, "EXPRTOKEN_AXISNAME_PRECEDING_SIBLING");
