...
/**
 * A regular expression matching engine using Non-deterministic Finite Automaton (NFA). This engine
 * does not conform to the POSIX regular expression.
 *
 * <p><hr width="50%">
 *
 * <h2>How to use</h2>
 ...
 * <h4>Options</h4>
 *
 * <p>You can specify options to <a href="#RegularExpression(java.lang.String, java.lang.String)">
 * <code>RegularExpression(</code><var>regex</var><code>, </code><var>options</var><code>)</code>
 * </a> or <a href="#setPattern(java.lang.String, java.lang.String)"><code>setPattern(</code>
 * <var>regex</var><code>, </code><var>options</var><code>)</code></a>. This <var>options</var>
 * parameter consists of the following characters.
 *
 * <dl>
 ...
 *       'Unicode Regular Expression Guidelines' Revision 4. When "w" and "u" are specified at the
 *       same time, <kbd>\b \B \&lt; \></kbd> are processed for the "w" option.
 *   <dt><a name="COMMA_OPTION"><code>","</code></a>
 *   <dd>The parser treats a comma in a character class as a range separator. <kbd
 *       class="REGEX">[a,b]</kbd> matches <kbd>a</kbd> or <kbd>,</kbd> or <kbd>b</kbd> without this
 *       option. <kbd class="REGEX">[a,b]</kbd> matches <kbd>a</kbd> or <kbd>b</kbd> with this
 *       option.
 *   <dt><a name="X_OPTION"><code>"X"</code></a>
 *   <dd class="REGEX">By this option, the engine confoms to <a
 *       href="http://www.w3.org/TR/2000/WD-xmlschema-2-20000407/#regexs">XML Schema: Regular
 *       Expression</a>. The <code>match()</code> method does not do subsring matching but entire
 *       string matching.
 * </dl>
 *
 * <hr width="50%">
 ...
 *         <dd>LINE FEED (U+000A), CARRIAGE RETURN (U+000D), PARAGRAPH SEPARATOR (U+2029), LINE
 *             SEPARATOR (U+2028)
 *         <dd>This expression matches one code point in Unicode. It can match a pair of surrogates.
 *         <dd>When <a href="#S_OPTION">the "s" option</a> is specified, it matches any character
 *             including the above four characters.
 *         <dt class="REGEX"><Kbd>\e \f \n \r \t</kbd>
 *         <dd>Matches ESCAPE (U+001B), FORM FEED (U+000C), LINE FEED (U+000A), CARRIAGE RETURN
 *             (U+000D), HORIZONTAL TABULATION (U+0009)
 *         <dt class="REGEX"><kbd>\c</kbd><var>C</var>
 *         <dd>Matches a control character. The <var>C</var> must be one of '<kbd>@</kbd>',
 *             '<kbd>A</kbd>'-'<kbd>Z</kbd>', '<kbd>[</kbd>', '<kbd>\u005c</kbd>', '<kbd>]</kbd>',
 *             '<kbd>^</kbd>', '<kbd>_</kbd>'. It matches a control character of which the character
 *             code is less than the character code of the <var>C</var> by 0x0040.
 *         <dd class="REGEX">For example, a <kbd>\cJ</kbd> matches a LINE FEED (U+000A), and a
 *             <kbd>\c[</kbd> matches an ESCAPE (U+001B).
 ...
 *             You can write just 2 digits for <kbd>\u005cx</kbd><var>HH</var>, and variable length
 *             digits for <kbd>\u005cx{</kbd><var>HHHH</var><kbd>}</kbd>.
 *             <!--
 ...
 *         <dd>Matches a character of which code point is <var>HHHHHH</var> (Hexadecimal) in
 *             Unicode.
 ...
 *         <dd class="REGEX">Matches a combining character sequence. It is equivalent to
 *             <kbd>(?:\PM\pM*)</kbd>
 *       </dl>
 *   <li>Character class
 *       <dl>
 ...
 *                   <kbd>\u005cx</kbd><var>HH</var> <kbd>\u005cx{</kbd><var>HHHH</var><kbd>}</kbd>
 *                   <!--kbd>\u005c u</kbd><var>HHHH</var-->
 *                   <kbd>\u005cv</kbd><var>HHHHHH</var>)
 *                   <p>This range matches the character.
 *               <li class="REGEX"><var>C<sub>1</sub></var><kbd>-</kbd><var>C<sub>2</sub></var>
 *                   <p>This range matches a character which has a code point that is >=
 *                   <var>C<sub>1</sub></var>'s code point and &lt;= <var>C<sub>2</sub></var>'s code
 *                   point. + *
 *               <li class="REGEX">A POSIX character class: <Kbd>[:alpha:] [:alnum:] [:ascii:]
 *                   [:cntrl:] [:digit:] [:graph:] [:lower:] [:print:] [:punct:] [:space:] [:upper:]
 *                   [:xdigit:]</kbd>, + * and negative POSIX character classes in Perl like
 *                   <kbd>[:^alpha:]</kbd>
 *                   <p>...
 ...
 *             </ul>
 *             <p class="REGEX">Enumerated ranges are merged (union operation). <kbd>[a-ec-z]</kbd>
 *             is equivalent to <kbd>[a-z]</kbd>
 *         <dt class="REGEX"><kbd>[^</kbd><var>R<sub>1</sub></var><var>R<sub>2</sub></var><var>...</var><var>R<sub>n</sub></var><kbd>]</kbd>
 ...
 *             ... <Kbd>)</kbd> (<var>op</var> is <kbd>-</kbd> or <kbd>+</kbd> or <kbd>&</kbd>.)
 *         <dd>Subtraction or union or intersection for character classes.
 *         <dd class="REGEX">For exmaple, <kbd>(?[A-Z]-[CF])</kbd> is equivalent to
 *             <kbd>[A-BD-EG-Z]</kbd>, and <kbd>(?[0x00-0x7f]-[K]&[\p{Lu}])</kbd> is equivalent to
 *             <kbd>[A-JL-Z]</kbd>.
 *         <dd>The result of this operations is a <u>positive character class</u> even if an
 *             expression includes any negative character classes. You have to take care on this in
 *             case-insensitive matching. For instance, <kbd>(?[^b])</kbd> is equivalent to
 *             <kbd>[\x00-ac-\x{10ffff}]</kbd>, which is equivalent to <kbd>[^b]</kbd> in
 *             case-sensitive matching. But, in case-insensitive matching, <kbd>(?[^b])</kbd>
 *             matches any character because it includes '<kbd>B</kbd>' and '<kbd>B</kbd>' matches
 *             '<kbd>b</kbd>' though <kbd>[^b]</kbd> is processed as <kbd>[^Bb]</kbd>.
 *         <dt class="REGEX"><kbd>[</kbd><var>R<sub>1</sub>R<sub>2</sub>...</var><kbd>-[</kbd><var>R<sub>n</sub>R<sub>n+1</sub>...</var><kbd>]]</kbd>
 *             (with an <a href="#X_OPTION">"X" option</a>)
 *         <dd>Character class subtraction for the XML Schema. You can use this syntax when you
 *             specify an <a href="#X_OPTION">"X" option</a>.
 *         <dt class="REGEX"><kbd>\d</kbd>
 *         <dd class="REGEX">Equivalent to <kbd>[0-9]</kbd>.
 *         <dd>When <a href="#U_OPTION">a "u" option</a> is set, it is equivalent to <span
 *             class="REGEX"><kbd>\p{Nd}</kbd></span>.
 *         <dt class="REGEX"><kbd>\D</kbd>
 *         <dd class="REGEX">Equivalent to <kbd>[^0-9]</kbd>
 *         <dd>When <a href="#U_OPTION">a "u" option</a> is set, it is equivalent to <span
 *             class="REGEX"><kbd>\P{Nd}</kbd></span>.
 ...
 *         <dd>When <a href="#U_OPTION">a "u" option</a> is set, it is equivalent to <span
 *             class="REGEX"><kbd>[\p{Lu}\p{Ll}\p{Lo}\p{Nd}_]</kbd></span>.
 *         <dt class="REGEX"><kbd>\W</kbd>
 *         <dd class="REGEX">Equivalent to <kbd>[^a-zA-Z0-9_]</kbd>
 *         <dd>When <a href="#U_OPTION">a "u" option</a> is set, it is equivalent to <span
 *             class="REGEX"><kbd>[^\p{Lu}\p{Ll}\p{Lo}\p{Nd}_]</kbd></span>.
 ...
 *               <dd><kbd> L, M, N, Z, C, P, S, Lu, Ll, Lt, Lm, Lo, Mn, Me, Mc, Nd, Nl, No, Zs, Zl,
 *                   Zp, Cc, Cf, Cn, Co, Cs, Pd, Ps, Pe, Pc, Po, Sm, Sc, Sk, So, </kbd>
 *               <dd>(Currently the Cn category includes U+10000-U+10FFFF characters)
 *               <dt>Unicode Blocks:
 *               <dd><kbd> Basic Latin, Latin-1 Supplement, Latin Extended-A, Latin Extended-B, IPA
 ...
 *                   Oriya, Tamil, Telugu, Kannada, Malayalam, Thai, Lao, Tibetan, Georgian, Hangul
 *                   Jamo, Latin Extended Additional, Greek Extended, General Punctuation,
 *                   Superscripts and Subscripts, Currency Symbols, Combining Marks for Symbols,
 *                   Letterlike Symbols, Number Forms, Arrows, Mathematical Operators, Miscellaneous
 *                   Technical, Control Pictures, Optical Character Recognition, Enclosed
 *                   Alphanumerics, Box Drawing, Block Elements, Geometric Shapes, Miscellaneous
 *                   Symbols, Dingbats, CJK Symbols and Punctuation, Hiragana, Katakana, Bopomofo,
 *                   Hangul Compatibility Jamo, Kanbun, Enclosed CJK Letters and Months, CJK
 *                   Compatibility, CJK Unified Ideographs, Hangul Syllables, High Surrogates, High
 *                   Private Use Surrogates, Low Surrogates, Private Use, CJK Compatibility
 *                   Ideographs, Alphabetic Presentation Forms, Arabic Presentation Forms-A,
 *                   Combining Half Marks, CJK Compatibility Forms, Small Form Variants, Arabic
 *                   Presentation Forms-B, Specials, Halfwidth and Fullwidth Forms </kbd>
 *               <dt>Others:
 *               <dd><kbd>ALL</kbd> (Equivalent to <kbd>[\u005cu0000-\u005cv10FFFF]</kbd>)
 *               <dd><kbd>ASSGINED</kbd> (<kbd>\p{ASSIGNED}</kbd> is equivalent to
 *                   <kbd>\P{Cn}</kbd>)
 *               <dd><kbd>UNASSGINED</kbd> (<kbd>\p{UNASSIGNED}</kbd> is equivalent to
 *                   <kbd>\p{Cn}</kbd>)
 *             </dl>
 *         <dt class="REGEX"><kbd>\P{</kbd><var>name</var><kbd>}</kbd>
 ...
 *         <dd>Grouping. "<KBD>foo+</KBD>" matches "<KBD>foo</KBD>" or "<KBD>foooo</KBD>". If you
 *             want it matches "<KBD>foofoo</KBD>" or "<KBD>foofoofoo</KBD>", you have to write
 *             "<KBD>(?:foo)+</KBD>".
 *         <dt class="REGEX"><KBD>(</kbd><VAR>X</VAR><kbd>)</KBD>
 *         <dd>Grouping with capturing. It make a group and applications can know where in target
 *             text a group matched with methods of a <code>Match</code> instance after <code>
 *             <a href="#matches(java.lang.String, com.sun.org.apache.xerces.internal.utils.regex.Match)">matches(String,Match)</a>
 *             </code>. The 0th group means whole of this regular expression. The <VAR>N</VAR>th
 *             gorup is the inside of the <VAR>N</VAR>th left parenthesis.
 *             <p>For instance, a regular expression is "<FONT color=blue><KBD> *([^&lt;:]*)
 *             +&lt;([^&gt;]*)&gt; *</KBD></FONT>" and target text is "<FONT color=red><KBD>From:
 *             TAMURA Kent &lt;kent@trl.ibm.co.jp&gt;</KBD></FONT>":
 *             <ul>
 *               <li><code>Match.getCapturedText(0)</code>: "<FONT color=red><KBD> TAMURA Kent
 *                   &lt;kent@trl.ibm.co.jp&gt;</KBD></FONT>"
 *               <li><code>Match.getCapturedText(1)</code>: "<FONT color=red><KBD>TAMURA
 *                   Kent</KBD></FONT>"
 *               <li><code>Match.getCapturedText(2)</code>: "<FONT
 *                   color=red><KBD>kent@trl.ibm.co.jp</KBD></FONT>"
 *             </ul>
 ...
 *         <dd>............................
 *         <dd>The <var>options</var> or the <var>options2</var> consists of 'i' 'm' 's' 'w'. Note
 *             that it can not contain 'u'.
 ...
 *         <dd>Matches the end of the text, or before an EOL character at the end of the text, or
 *             CARRIAGE RETURN + LINE FEED at the end of the text.
 *         <dt class="REGEX"><kbd>\z</kbd>
 *         <dd>Matches the end of the text.
 *         <dt class="REGEX"><kbd>^</kbd>
 *         <dd>Matches the beginning of the text. It is equivalent to <span
 *             class="REGEX"><Kbd>\A</kbd></span>.
 *         <dd>When <a href="#M_OPTION">a "m" option</a> is set, it matches the beginning of the
 *             text, or after one of EOL characters ( LINE FEED (U+000A), CARRIAGE RETURN (U+000D),
 *             LINE SEPARATOR (U+2028), PARAGRAPH SEPARATOR (U+2029).)
 *         <dt class="REGEX"><kbd>$</kbd>
 *         <dd>Matches the end of the text, or before an EOL character at the end of the text, or
 *             CARRIAGE RETURN + LINE FEED at the end of the text.
 *         <dd>When <a href="#M_OPTION">a "m" option</a> is set, it matches the end of the text, or
 *             before an EOL character.
 *         <dt class="REGEX"><kbd>\b</kbd>
 *         <dd>Matches word boundary. (See <a href="#W_OPTION">a "w" option</a>)
 *         <dt class="REGEX"><kbd>\B</kbd>
 *         <dd>Matches non word boundary. (See <a href="#W_OPTION">a "w" option</a>)
 *         <dt class="REGEX"><kbd>\&lt;</kbd>
 *         <dd>Matches the beginning of a word. (See <a href="#W_OPTION">a "w" option</a>)
 *         <dt class="REGEX"><kbd>\&gt;</kbd>
 *         <dd>Matches the end of a word. (See <a href="#W_OPTION">a "w" option</a>)
 *       </dl>
 ...
 *         <dd>Comment. A comment string consists of characters except '<kbd>)</kbd>'. You can not
 *             write comments in character classes and before quantifiers.
 *       </dl>
 * </ul>
 *
 * <hr width="50%">
 ...
 *
 * <ul>
 *   <li><a href="http://www.unicode.org/reports/tr18/">Unicode Technical Standard #18: Unicode
...
public class RegularExpression implements java.io.Serializable {
    ...
    private Op compile(Token tok, Op next, boolean reverse) {
        ...
        switch (tok.type) {
            ...
            case Token.NEGATIVELOOKAHEAD:
                ret =
                        Op.createLook(
                                Op.NEGATIVELOOKAHEAD, next, compile(tok.getChild(0), null, false));
                break;
            ...
            case Token.NEGATIVELOOKBEHIND:
                ret =
                        Op.createLook(
                                Op.NEGATIVELOOKBEHIND, next, compile(tok.getChild(0), null, true));
                break;
            ...
            case Token.CONDITION:
                ...
                Op condition =
                        ctok.condition == null ? null : compile(ctok.condition, null, reverse);
    ...
    /**
     * Checks whether the <var>target</var> text <strong>contains</strong> this pattern in specified
     * range or not.
     *
    ...
    public boolean matches(char[] target, int start, int end, Match match) {
         ...
         */
            ...
            for (matchStart = con.start; matchStart <= limit; matchStart++) {
                ...
                if (0
                        <= (matchEnd =
                                this.match(con, this.operations, matchStart, 1, this.options))) {
                    break;
                }
            }
        }
                    ...
                    case Op.CHAR:
                        {
                            ...
                            if (o1 >= con.limit
                                    || o1 < 0
                                    || !matchChar(
                                            op.getData(), target.charAt(o1), isSetIgnoreCase)) {
                                returned = true;
                                break;
                            }
                            offset += dx;
                    ...
                    case Op.DOT:
                        {
                            ...
                            if (isSet(opts, SINGLE_LINE)) {
                                if (REUtil.isHighSurrogate(target.charAt(o1))
                                        && o1 + dx >= 0
                                        && o1 + dx < con.limit) {
                                    o1 += dx;
                                }
                    ...
                    case Op.BACKREFERENCE:
                        {
                            ...
                            if (dx > 0) {
                                if (!target.regionMatches(
                                        isSetIgnoreCase, offset, con.limit, o2, literallen)) {
                                    returned = true;
                                    break;
                                }
                                offset += literallen;
                    ...
                    case Op.STRING:
                        {
                            ...
                            if (dx > 0) {
                                if (!target.regionMatches(
                                        isSetIgnoreCase, offset, con.limit, literal, literallen)) {
                                    returned = true;
                                    break;
                                }
                                offset += literallen;
                    ...
                    case Op.NEGATIVELOOKBEHIND:
                        {
                            ...
                            dataStack.push(offset);
                            dx =
                                    (op.type == Op.LOOKAHEAD || op.type == Op.NEGATIVELOOKAHEAD)
                                            ? 1
                                            : -1;
                            op = op.getChild();
                        }
        ...
        switch (op.getData()) {
            case '^':
                if (isSet(opts, MULTIPLE_LINES)) {
                    if (!(offset == con.start
                            || offset > con.start
                                    && offset < con.limit
                                    && isEOLChar(target.charAt(offset - 1)))) return false;
                } else {
            ...
            case '$':
                if (isSet(opts, MULTIPLE_LINES)) {
                    ...
                    if (!(offset == con.limit
                            ...
                            || offset + 2 == con.limit
                                    && target.charAt(offset) == CARRIAGE_RETURN
                                    && target.charAt(offset + 1) == LINE_FEED)) return false;
                }
                break;
            ...
            case '<':
                ...
                if (getWordType(target, con.start, con.limit, offset, opts) != WT_LETTER
                        || getPreviousWordType(target, con.start, con.limit, offset, opts)
                                != WT_OTHER) return false;
                break;
    ...
    private static final int getPreviousWordType(
            ExpressionTarget target, int begin, int end, int offset, int opts) {
        int ret = getWordType(target, begin, end, --offset, opts);
        while (ret == WT_IGNORE) ret = getWordType(target, begin, end, --offset, opts);
        return ret;
    }

    private static final int getWordType(
            ExpressionTarget target, int begin, int end, int offset, int opts) {
    ...
    abstract static class ExpressionTarget {
        ...
        abstract boolean regionMatches(
                boolean ignoreCase, int offset, int limit, String part, int partlen);

        abstract boolean regionMatches(
                boolean ignoreCase, int offset, int limit, int offset2, int partlen);
    }
    ...
    static final class StringTarget extends ExpressionTarget {
        ...
        final boolean regionMatches(
                boolean ignoreCase, int offset, int limit, String part, int partlen) {
            if (limit - offset < partlen) {
                return false;
            }
            return (ignoreCase)
                    ? target.regionMatches(true, offset, part, 0, partlen)
        ...
        final boolean regionMatches(
            ...
            return (ignoreCase)
                    ? target.regionMatches(true, offset, target, offset2, partlen)
    ...
    static final class CharArrayTarget extends ExpressionTarget {
        ...
        final boolean regionMatches(
            ...
            return (ignoreCase)
                    ? regionMatchesIgnoreCase(offset, limit, part, partlen)
        ...
        private final boolean regionMatchesIgnoreCase(
                int offset, int limit, String part, int partlen) {
            int i = 0;
            while (partlen-- > 0) {
        ...
        final boolean regionMatches(
            ...
            return (ignoreCase)
                    ? regionMatchesIgnoreCase(offset, limit, offset2, partlen)
        ...
        private final boolean regionMatchesIgnoreCase(
                int offset, int limit, int offset2, int partlen) {
            int i = offset2;
            while (partlen-- > 0) {
                final char ch1 = target[offset++];
    ...
    void prepare() {
        ...
        */
        ...
        if (this.operations != null
            ...
            if (this.operations.type == Op.STRING) this.fixedString = this.operations.getString();
            ...
            this.fixedStringTable =
                    new BMPattern(
                            this.fixedString, 256, isSet(this.fixedStringOptions, IGNORE_CASE));
    ...
    /**
     * An option. If you specify this option, <span
     * class="REGEX"><kbd>(</kbd><var>X</var><kbd>)</kbd></span> captures matched text, and <span
     * class="REGEX"><kbd>(:?</kbd><var>X</var><kbd>)</kbd></span> does not capture.
     *
    ...
    /**
     * An option. This enables to process locale-independent word boundary for <span
     * class="REGEX"><kbd>\b \B \&lt; \></kbd></span>.
     *
     * <p>By default, the engine considers a position between a word character (<span
     * class="REGEX"><Kbd>\w</kbd></span>) and a non word character is a word boundary.
     *
     * <p>By this option, the engine checks word boundaries with the method of 'Unicode Regular
     * Expression Guidelines' Revision 4.
     *
     * @see #RegularExpression(java.lang.String,int)
     * @see #setPattern(java.lang.String,int)
     */
     ...
     * @exception org.apache.xerces.utils.regex.ParseException <VAR>regex</VAR> is not conforming to
     *     the syntax.
     */
    ...
    private void setPattern(String newPattern, int options, Locale locale) throws ParseException {
        ...
        this.options = options;
        RegexParser rp =
                RegularExpression.isSet(this.options, RegularExpression.XMLSCHEMA_MODE)
                        ? new ParserForXMLSchema(locale)
                        : new RegexParser(locale);
    ...
    /**
     * Returns a option string. The order of letters in it may be different from a string specified
    ...
    /**
     * Return the number of regular expression groups. This method returns 1 when the regular
     * expression has no capturing-parenthesis.
     */
