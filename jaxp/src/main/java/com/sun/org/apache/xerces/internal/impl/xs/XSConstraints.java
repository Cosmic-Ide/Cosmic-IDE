...
public class XSConstraints {
    ...
    */
    ...
    private static void gatherChildren(
            int parentType, XSParticleDecl p, List<XSParticleDecl> children) {
    ...
    private static void checkRecurse(
            List<XSParticleDecl> dChildren,
            int min1,
            int max1,
            SubstitutionGroupHandler dSGHandler,
            List<XSParticleDecl> bChildren,
            int min2,
            int max2,
            SubstitutionGroupHandler bSGHandler)
            throws XMLSchemaException {
