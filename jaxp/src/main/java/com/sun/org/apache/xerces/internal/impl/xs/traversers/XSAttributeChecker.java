 ...
 * return compiled value - use symbol table instead of many maps
 *
 * @xerces.internal
                ...
                if (fSchemaHandler.fSecurityManager != null) {
                    ...
                    if (!optimize) {
                        ...
                        int maxOccurNodeLimit =
                                fSchemaHandler.fSecurityManager.getLimit(
                                        XMLSecurityManager.Limit.MAX_OCCUR_NODE_LIMIT);
                        if (max > maxOccurNodeLimit
                                && !fSchemaHandler.fSecurityManager.isNoLimit(maxOccurNodeLimit)) {
                            reportSchemaFatalError(
                                    "MaxOccurLimit", new Object[] {maxOccurNodeLimit}, element);
