 ...
 * @author Neeraj Bajaj, Sun Microsystems Inc. @LastModified: Oct 2017
 */
abstract class XSDAbstractTraverser {
    ...
    XSAnnotationImpl traverseAnnotationDecl(
        ...
        List<String> annotationLocalAttrs =
                (ArrayList<String>) parentAttrs[XSAttributeChecker.ATTIDX_NONSCHEMA];
        ...
        if (annotationLocalAttrs != null && !annotationLocalAttrs.isEmpty()) {
            ...
            StringBuilder contentBuffer =
                    new StringBuilder(contents.length() + localStrBuffer.length());
    ...
    FacetInfo traverseFacets(
        ...
        while (content != null) {
            ...
            if (facet.equals(SchemaSymbols.ELT_ENUMERATION)) {
                ...
                if (hasQName) enumNSDecls.add(nsDecls);
        ...
        if (enumData != null) {
            if (hasLengthFacet) {
                checkEnumerationAndLengthInconsistency(
                        baseValidator, enumData, contextNode, getSchemaTypeName(typeDef));
            }
     ...
     */
    private void checkEnumerationAndMaxLengthInconsistency(
            XSSimpleType baseValidator,
        ...
        if (SchemaSymbols.URI_SCHEMAFORSCHEMA.equals(baseValidator.getNamespace())
            ...
            for (int enumIdx = 0; enumIdx < enumData.size(); enumIdx++) {
                ...
                if (enumVal.length() / 2 > xsFacets.maxLength) {
                    reportSchemaWarning(
                            "FacetsContradict",
                            new Object[] {enumVal, SchemaSymbols.ELT_MAXLENGTH, typeName},
                            contextNode);
                }
            }
     ...
     */
    private void checkEnumerationAndMinLengthInconsistency(
            XSSimpleType baseValidator,
            List<String> enumData,
            Element contextNode,
            String typeName) {
        if (SchemaSymbols.URI_SCHEMAFORSCHEMA.equals(baseValidator.getNamespace())
            ...
            for (int enumIdx = 0; enumIdx < enumData.size(); enumIdx++) {
                ...
                if (enumVal.length() / 2 < xsFacets.minLength) {
                    reportSchemaWarning(
                            "FacetsContradict",
                            new Object[] {enumVal, SchemaSymbols.ELT_MINLENGTH, typeName},
                            contextNode);
                }
            }
        } else if (SchemaSymbols.URI_SCHEMAFORSCHEMA.equals(baseValidator.getNamespace())
     ...
     */
    private void checkEnumerationAndLengthInconsistency(
            XSSimpleType baseValidator,
            List<String> enumData,
            Element contextNode,
            String typeName) {
        if (SchemaSymbols.URI_SCHEMAFORSCHEMA.equals(baseValidator.getNamespace())
            ...
            for (int enumIdx = 0; enumIdx < enumData.size(); enumIdx++) {
                ...
                if (enumVal.length() / 2 != xsFacets.length) {
                    reportSchemaWarning(
                            "FacetsContradict",
                            new Object[] {enumVal, SchemaSymbols.ELT_LENGTH, typeName},
                            contextNode);
                }
            }
        } else if (SchemaSymbols.URI_SCHEMAFORSCHEMA.equals(baseValidator.getNamespace())
