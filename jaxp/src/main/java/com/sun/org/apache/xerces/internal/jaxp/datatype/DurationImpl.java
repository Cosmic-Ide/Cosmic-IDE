 ...
 * @see XMLGregorianCalendar#add(Duration) @LastModified: May 2020
 */
class DurationImpl extends Duration implements Serializable {
    ...
    public int compare(Duration rhs) {
        /**
         * check if any field in the Durations is too large for the operation that uses
         * XMLGregorianCalendar for comparison
         */
    ...
    public boolean isSet(DatatypeConstants.Field field) {
        ...
        if (field == null) {
            String methodName =
                    "javax.xml.datatype.Duration" + "#isSet(DatatypeConstants.Field field)";
            throw new NullPointerException(
    ...
    public Number getField(DatatypeConstants.Field field) {
         ...
         */
        String methodName =
                "javax.xml.datatype.Duration" + "#(getSet(DatatypeConstants.Field field)";
        ...
        do { // repeat until all the sign bits become consistent
            ...
            for (int i = start; i < end; i++) {
                if (s * buf[i].signum() < 0) {
                    ...
                    BigDecimal borrow = buf[i].abs().divide(FACTORS[i - 1], 0, RoundingMode.UP);
                    if (buf[i].signum() > 0) {
    ...
    public void addTo(Calendar calendar) {
        ...
        if (seconds != null) {
            BigDecimal fraction = seconds.subtract(seconds.setScale(0, RoundingMode.DOWN));
     ...
     * @return time value
     *     <p>Diff from Xerces; Use JDK 1.5 feature.
     */
     ...
     *
     * <p>Serialization uses the lexical form returned by toString().
     */
