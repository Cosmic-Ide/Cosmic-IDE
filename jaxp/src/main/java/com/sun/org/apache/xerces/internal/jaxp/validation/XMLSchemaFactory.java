 ...
 *
 * @author Kohsuke Kawaguchi @LastModified: May 2021
 */
public final class XMLSchemaFactory extends SchemaFactory {
    ...
    public XMLSchemaFactory() {
        ...
        fXMLSchemaLoader.setProperty(
                JdkConstants.CDATA_CHUNK_SIZE, JdkConstants.CDATA_CHUNK_SIZE_DEFAULT);
        fXmlFeatures = new JdkXmlFeatures(fSecurityManager.isSecureProcessing());
        fOverrideDefaultParser =
                fXmlFeatures.getFeature(JdkXmlFeatures.XmlFeature.JDK_OVERRIDE_PARSER);
    ...
    public Schema newSchema(XMLGrammarPool pool) throws SAXException {
        ...
        final AbstractXMLSchema schema =
                (fUseGrammarPoolOnly)
    ...
    public Object getProperty(String name)
        ...
        try {
            ...
            return propertyValue != null ? propertyValue : fXMLSchemaLoader.getProperty(name);
        } catch (XMLConfigurationException e) {
            String identifier = e.getIdentifier();
            if (e.getType() == Status.NOT_RECOGNIZED) {
                throw new SAXNotRecognizedException(
    ...
    public void setFeature(String name, boolean value)
        ...
        if ((fXmlFeatures != null)
            ...
            if ((ImplPropMap.OVERRIDEPARSER.is(name)) || name.equals(JdkXmlUtils.USE_CATALOG)) {
    ...
    public void setProperty(String name, Object object)
        ...
        if (name.equals(SECURITY_MANAGER)) {
            ...
            fXMLSchemaLoader.setProperty(
                    JdkConstants.XML_SECURITY_PROPERTY_MANAGER, fSecurityPropertyMgr);
            return;
        } else if (name.equals(XMLGRAMMAR_POOL)) {
            throw new SAXNotSupportedException(
                    SAXMessageFormatter.formatMessage(
