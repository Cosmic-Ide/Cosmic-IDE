 ...
 * @author Elena Litani, IBM @LastModified: July 2021
 */
public class AbstractDOMParser extends AbstractXMLDocumentParser {
    ...
    public void startGeneralEntity(
        ...
        if (DEBUG_EVENTS) {
            ...
            if (DEBUG_BASEURI) {
                System.out.println(
                        "   expandedSystemId( **baseURI): " + identifier == null
                                ? null
                                : identifier.getExpandedSystemId());
                System.out.println(
                        "   baseURI:" + identifier == null ? null : identifier.getBaseSystemId());
            }
        }
        ...
        if (!fDeferNodeExpansion) {
            ...
            int er =
                    fDeferredDocumentImpl.createDeferredEntityReference(
                            name, identifier == null ? null : identifier.getExpandedSystemId());
    ...
    public void startDocument(
        ...
        if (!fDeferNodeExpansion) {
            if (fDocumentClassName.equals(DEFAULT_DOCUMENT_CLASS_NAME)) {
                ...
                try {
                    Class<?> documentClass =
                            ObjectFactory.findProviderClass(fDocumentClassName, true);
            ...
            if (!found) {
                int entityIndex =
                        fDeferredDocumentImpl.createDeferredEntity(
                                name, null, null, null, fBaseURIStack.peek());
