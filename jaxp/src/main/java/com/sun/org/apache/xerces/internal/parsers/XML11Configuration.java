...
public class XML11Configuration extends ParserConfigurationSettings
    ...
    /**
     * Reset the symbol table if it wasn't provided during construction, its not the first time when
     * parse is called after initialization and RESET_SYMBOL_TABLE feature is set to true
     */
