 ...
 *
 * <p>In addition to the features and properties recognized by the parser configuration, this parser
 * recognizes these additional features and properties:
 *
 * <ul>
 *   <li>Properties
 *       <ul>
    ...
    public void parse(XMLInputSource inputSource) throws XNIException, IOException {
        ...
        if (securityPropertyManager == null) {
            ...
            fConfiguration.setProperty(
                    JdkConstants.XML_SECURITY_PROPERTY_MANAGER, securityPropertyManager);
        }
