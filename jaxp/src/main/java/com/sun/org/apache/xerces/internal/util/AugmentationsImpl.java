...
/**
 * This class provides an implementation for Augmentations interface. Augmentations interface
 * defines a map of additional data that could be passed along the document pipeline. The
 * information can contain extra arguments or infoset augmentations, for example PSVI. This
 * additional information is identified by a String key.
 *
 * <p>
 *
...
public class AugmentationsImpl implements Augmentations {
     ...
     * @return the previous value of the specified key in the Augmentations strucutre, or <code>null
