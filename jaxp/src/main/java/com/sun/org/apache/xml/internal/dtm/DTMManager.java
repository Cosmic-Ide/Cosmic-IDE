 ...
 * "com.sun.org.apache.xml.internal.utils.DTMFactory". This property names a concrete subclass of
 * the DTMFactory abstract class. If the property is not defined, a platform default is be used.
 *
...
public abstract class DTMManager {
     ...
     * @throws DTMException if the implementation is not available or cannot be instantiated.
     */
    public static DTMManager newInstance(XMLStringFactory xsf) throws DTMException {
        final DTMManager factoryImpl =
