 ...
 * before the DTM's storage is actually released for reuse. @LastModified: Nov 2017
 */
public class DTMManagerDefault extends DTMManager {
                ...
                try {
                    ...
                    /* || ((null == reader) && incremental) */ ) {
                        ...
                        if (haveXercesParser) {
                            ...
                            try {
                                coParser =
                                        new com.sun.org.apache.xml.internal.dtm.ref
    ...
    public synchronized boolean release(DTM dtm, boolean shouldHardDelete) {
        ...
        if (dtm instanceof DTMDefaultBase) {
            com.sun.org.apache.xml.internal.utils.SuballocatedIntVector ids =
