 ...
 * is constructed via SAX2 ContentHandler events. @LastModified: Oct 2017
 */
public class SAX2DTM extends DTMDefaultBaseIterators
    ...
    protected int getNextNodeIdentity(int identity) {
        ...
        while (identity >= m_size) {
            if (m_incrementalSAXSource == null) return DTM.NULL;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if ((localName == null || localName.isEmpty()) && (uri == null || uri.isEmpty())) {
            localName = qName;
        }
     ...
     * ContentHandler#skippedEntity skippedEntity} event, which is part of the ContentHandler
     * interface.
     *
     * @param name The name of the entity. If it is a parameter entity, the name will begin with
     *     '%'.
     ...
     * ContentHandler#characters characters} event.
     *
     * @throws SAXException The application may raise an exception.
     * @see #endCDATA
     */
