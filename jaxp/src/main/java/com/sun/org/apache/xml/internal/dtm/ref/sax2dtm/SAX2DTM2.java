 ...
 * making changes here! @LastModified: Oct 2017
 */
public class SAX2DTM2 extends SAX2DTM {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if ((uri == null || uri.isEmpty()) && (localName == null || localName.isEmpty())) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attrUri == null || attrUri.isEmpty()) {
                if (attrLocalName == null || attrLocalName.isEmpty()) {
                    ...
                    attrLocalName =
                            (colon > -1) ? attrLocalName.substring(colon + 1) : attrLocalName;
                }
            }
    ...
    public XMLString getStringValue(int nodeHandle) {
        ...
        if (type == DTM.ELEMENT_NODE || type == DTM.DOCUMENT_NODE) {
            ...
            if (m_xstrf != null) return m_xstrf.newstr(m_values.get(dataIndex));
            else return new XMLStringDefault(m_values.get(dataIndex));
        }
    }
    ...
    protected final void copyNS(final int nodeID, SerializationHandler handler, boolean inScope)
        ...
        if (m_namespaceDeclSetElements != null
                ...
                && (m_namespaceDeclSets.get(0)).size() == 1) return;
