 ...
 *     is replaced by {@link
 *     com.sun.org.apache.xml.internal.serializer.dom3.LSSerializerImpl}. @LastModified: Nov 2017
 */
@Deprecated
public abstract class BaseMarkupSerializer
    ...
    /**
     * List holding comments and PIs that come before the root element (even after it), see {@link
     * #serializePreRoot}.
     */
    ...
    public void processingInstructionIO(String target, String code) throws IOException {
        ...
        if (isDocumentState()) {
            if (_preRoot == null) _preRoot = new ArrayList<>();
    ...
    public void startPrefixMapping(String prefix, String uri) throws SAXException {
        if (_prefixes == null) _prefixes = new HashMap<>();
