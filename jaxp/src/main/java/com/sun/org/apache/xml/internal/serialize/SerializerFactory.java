...
public abstract class SerializerFactory {
    ...
    public static final String FactoriesProperty =
            "com.sun.org.apache.xml.internal.serialize.factories";
     ...
     * required so factories can be added from a properties file by knowing only the class name.
     * This method is protected, it is only required by this class but must be implemented in
     * derived classes.
     */
    protected abstract String getSupportedMethod();

    /**
     * Create a new serializer based on the {@link OutputFormat}. If this method is used to create
     * the serializer, the {@link Serializer#setOutputByteStream} or {@link
    ...
    /**
     * Create a new serializer, based on the {@link OutputFormat} and using the output byte stream
     * and the encoding specified in the output format.
     *
