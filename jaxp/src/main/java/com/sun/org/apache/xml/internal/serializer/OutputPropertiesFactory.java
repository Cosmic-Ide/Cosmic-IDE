 ...
 * @see Method
 * @see Serializer @LastModified: May 2021
 */
public final class OutputPropertiesFactory {
    ...
    private static final String[] PROP_TEXT = {
        "method", "media-type", "{http://xml.apache.org/xalan}content-handler"
    };

    private static final String[] PROP_TEXT_VALUE = {
        "text", "text/plain", "com.sun.org.apache.xml.internal.serializer.ToTextStream"
    };
        ...
        switch (method) {
            ...
            case Method.HTML:
                if (null == m_html_properties) {
                    m_html_properties =
                            initProperties(PROP_HTML, PROP_HTML_VALUE, m_xml_properties);
                }
            ...
            case Method.TEXT:
                if (null == m_text_properties) {
                    m_text_properties =
                            initProperties(PROP_TEXT, PROP_TEXT_VALUE, m_xml_properties);
            ...
            case com.sun.org.apache.xml.internal.serializer.Method.UNKNOWN:
                if (null == m_unknown_properties) {
                    m_unknown_properties =
                            initProperties(PROP_UNKNOWN, PROP_UNKNOWN_VALUE, m_xml_properties);
                }
