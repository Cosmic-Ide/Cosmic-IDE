 ...
 * Serialization is achieved by delegating serialization calls to <CODE>
 * org.apache.xml.serializer.ToStream</CODE> or one of its derived classes depending on the
 * serialization method, while walking the DOM in DOM3TreeWalker.
 *
 * @see <a
 *     href="http://www.w3.org/TR/2004/REC-DOM-Level-3-LS-20040407/load-save.html#LS-LSSerializer">org.w3c.dom.ls.LSSerializer</a>
 * @see <a
 *     href="http://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407/core.html#DOMConfiguration">org.w3c.dom.DOMConfiguration</a>
 * @version $Id:
 * @xsl.usage internal @LastModified: Jan 2022
 */
public final class LSSerializerImpl implements DOMConfiguration, LSSerializer {
    ...
    // Parameter element-content-whitespace, true [required] (default) - value - false [optional]
    // NOT SUPPORTED
    ...
    // Parameter infoset, true [required] (default), false has no effect --> True has no effect for
    // the serializer
    ...
    /**
     * Constructor: Creates a LSSerializerImpl object. The underlying XML 1.0 or XML 1.1
     * org.apache.xml.serializer.Serializer object is created and initialized the first time any of
     * the write methods are invoked to serialize the Node. Subsequent write methods on the same
    ...
    /**
     * Initializes the underlying serializer's configuration depending on the default
     * DOMConfiguration parameters. This method must be called before a node is to be serialized.
     *
     * @xsl.usage internal
     */
    public void initializeSerializerProps() {
        ...
        fDOMConfigProperties.setProperty(
                DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_CANONICAL_FORM,
        ...
        fDOMConfigProperties.setProperty(
                DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_CHECK_CHAR_NORMALIZATION,
                DOMConstants.DOM3_DEFAULT_FALSE);
        ...
        fDOMConfigProperties.setProperty(
                DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_DATATYPE_NORMALIZATION,
                DOMConstants.DOM3_DEFAULT_FALSE);

        // element-content-whitespace
        fDOMConfigProperties.setProperty(
                DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_ELEMENT_CONTENT_WHITESPACE,
                DOMConstants.DOM3_DEFAULT_TRUE);
        ...
        if ((fFeatures & INFOSET) != 0) {
            fDOMConfigProperties.setProperty(
                    ...
                    DOMConstants.DOM3_DEFAULT_TRUE);
            fDOMConfigProperties.setProperty(
                    DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_NAMESPACE_DECLARATIONS,
                    DOMConstants.DOM3_DEFAULT_TRUE);
            fDOMConfigProperties.setProperty(
                    DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_COMMENTS,
                    DOMConstants.DOM3_DEFAULT_TRUE);
            ...
            fDOMConfigProperties.setProperty(
                    ...
                    DOMConstants.DOM3_DEFAULT_FALSE);
            fDOMConfigProperties.setProperty(
                    DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_VALIDATE_IF_SCHEMA,
                    DOMConstants.DOM3_DEFAULT_FALSE);
            fDOMConfigProperties.setProperty(
                    DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_DATATYPE_NORMALIZATION,
                    DOMConstants.DOM3_DEFAULT_FALSE);
        ...
        */
        ...
        // validate
        fDOMConfigProperties.setProperty(
                DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_VALIDATE,
                DOMConstants.DOM3_DEFAULT_FALSE);
        ...
        // pretty-print
        fDOMConfigProperties.setProperty(
                DOMConstants.S_XSL_OUTPUT_INDENT, DOMConstants.DOM3_DEFAULT_FALSE);
        fDOMConfigProperties.setProperty(
        ...
        fDOMConfigProperties.setProperty(
                DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_DISCARD_DEFAULT_CONTENT,
                DOMConstants.DOM3_DEFAULT_TRUE);
        ...
        fIsStandalone =
                new JdkProperty<>(ImplPropMap.ISSTANDALONE, Boolean.class, false, State.DEFAULT);
        // the system property is true only if it is "true" and false otherwise
        if (fIsStandalone.getValue()) {
            fFeatures |= IS_STANDALONE;
            fDOMConfigProperties.setProperty(
                    DOMConstants.NS_IS_STANDALONE, DOMConstants.DOM3_EXPLICIT_TRUE);
        } else {
            fDOMConfigProperties.setProperty(
                    DOMConstants.NS_IS_STANDALONE, DOMConstants.DOM3_DEFAULT_FALSE);
        }
    }
    ...
    public boolean canSetParameter(String name, Object value) {
        ...
        } else if (name.equalsIgnoreCase(DOMConstants.DOM_ERROR_HANDLER) && value == null
                || value instanceof DOMErrorHandler) {
            return true;
        }
        return false;
    }
     ...
     * @param name A String containing the DOMConfiguration parameter name whose value is to be
     *     returned.
    ...
    public Object getParameter(String name) throws DOMException {
        ...
        } else if (name.equalsIgnoreCase(DOMConstants.DOM_SCHEMA_LOCATION)
                || name.equalsIgnoreCase(DOMConstants.DOM_SCHEMA_TYPE)) {
            return null;
        } else {
            // Here we have to add the Xalan specific DOM Message Formatter
            String msg =
                    Utils.messages.createMessage(MsgKey.ER_FEATURE_NOT_FOUND, new Object[] {name});
            throw new DOMException(DOMException.NOT_FOUND_ERR, msg);
        }
    }

    /**
     * This method returns a of the parameters supported by this DOMConfiguration object and for
     * which at least one value can be set by the application
     *
     * @see org.w3c.dom.DOMConfiguration#getParameterNames()
     * @return DOMStringList A list of DOMConfiguration parameters recognized by the serializer
     */
    ...
    public void setParameter(String name, Object value) throws DOMException {
        ...
        if (value instanceof Boolean) {
            ...
            if (name.equalsIgnoreCase(DOMConstants.DOM_COMMENTS)) {
                fFeatures = bValue ? fFeatures | COMMENTS : fFeatures & ~COMMENTS;
                // comments
                if (bValue) {
                    fDOMConfigProperties.setProperty(
                            DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_COMMENTS,
                ...
                fFeatures = bValue ? fFeatures | CDATA : fFeatures & ~CDATA;
                // cdata-sections
                if (bValue) {
                    fDOMConfigProperties.setProperty(
                            DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_CDATA_SECTIONS,
                ...
                fFeatures = bValue ? fFeatures | ENTITIES : fFeatures & ~ENTITIES;
                // entities
                if (bValue) {
                    fDOMConfigProperties.setProperty(
                            DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_ENTITIES,
                ...
                fFeatures = bValue ? fFeatures | NAMESPACES : fFeatures & ~NAMESPACES;
                // namespaces
                if (bValue) {
                    fDOMConfigProperties.setProperty(
                            DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_NAMESPACES,
                ...
                fFeatures = bValue ? fFeatures | NAMESPACEDECLS : fFeatures & ~NAMESPACEDECLS;
                // namespace-declarations
                if (bValue) {
                    fDOMConfigProperties.setProperty(
                ...
                fFeatures = bValue ? fFeatures | SPLITCDATA : fFeatures & ~SPLITCDATA;
                // split-cdata-sections
                if (bValue) {
                    fDOMConfigProperties.setProperty(
                            DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_SPLIT_CDATA,
                ...
                fFeatures = bValue ? fFeatures | WELLFORMED : fFeatures & ~WELLFORMED;
                // well-formed
                if (bValue) {
                    fDOMConfigProperties.setProperty(
                            DOMConstants.S_DOM3_PROPERTIES_NS + DOMConstants.DOM_WELLFORMED,
                ...
                fFeatures = bValue ? fFeatures | DISCARDDEFAULT : fFeatures & ~DISCARDDEFAULT;
                // discard-default-content
                if (bValue) {
                    fDOMConfigProperties.setProperty(
                            DOMConstants.S_DOM3_PROPERTIES_NS
                ...
                fFeatures = bValue ? fFeatures | PRETTY_PRINT : fFeatures & ~PRETTY_PRINT;
                if (bValue) {
                    fDOMConfigProperties.setProperty(
                            DOMConstants.S_XSL_OUTPUT_INDENT, DOMConstants.DOM3_EXPLICIT_TRUE);
                    fDOMConfigProperties.setProperty(
                            OutputPropertiesFactory.S_KEY_INDENT_AMOUNT, Integer.toString(4));
                } else {
                    fDOMConfigProperties.setProperty(
                            DOMConstants.S_XSL_OUTPUT_INDENT, DOMConstants.DOM3_EXPLICIT_FALSE);
                }
            } else if (name.equalsIgnoreCase(DOMConstants.DOM_XMLDECL)) {
                fFeatures = bValue ? fFeatures | XMLDECL : fFeatures & ~XMLDECL;
                if (bValue) {
                    fDOMConfigProperties.setProperty(DOMConstants.S_XSL_OUTPUT_OMIT_XML_DECL, "no");
                } else {
                    fDOMConfigProperties.setProperty(
                            DOMConstants.S_XSL_OUTPUT_OMIT_XML_DECL, "yes");
                }
            } else if (ImplPropMap.ISSTANDALONE.is(name)) {
                fIsStandalone.setValue(name, bValue, State.APIPROPERTY);
                fFeatures =
                        fIsStandalone.getValue()
                                ? fFeatures | IS_STANDALONE
                                : fFeatures & ~IS_STANDALONE;
                fDOMConfigProperties.setProperty(
                        DOMConstants.NS_IS_STANDALONE,
                        fIsStandalone.getValue()
                                ? DOMConstants.DOM3_EXPLICIT_TRUE
                                : DOMConstants.DOM3_EXPLICIT_FALSE);
            } else if (name.equalsIgnoreCase(DOMConstants.DOM_ELEMENT_CONTENT_WHITESPACE)) {
                ...
                if (!bValue) {
                    ...
                    String msg =
                            Utils.messages.createMessage(
                                    MsgKey.ER_FEATURE_NOT_SUPPORTED, new Object[] {name});
            ...
            if (value == null || value instanceof DOMErrorHandler) {
                ...
                String msg =
                        Utils.messages.createMessage(
                                MsgKey.ER_TYPE_MISMATCH_ERR, new Object[] {name});
                throw new DOMException(DOMException.TYPE_MISMATCH_ERR, msg);
            }
        } else if (name.equalsIgnoreCase(DOMConstants.DOM_SCHEMA_LOCATION)
                || name.equalsIgnoreCase(DOMConstants.DOM_SCHEMA_TYPE)
                || name.equalsIgnoreCase(DOMConstants.DOM_NORMALIZE_CHARACTERS) && value != null) {
            String msg =
                    Utils.messages.createMessage(
                            MsgKey.ER_FEATURE_NOT_SUPPORTED, new Object[] {name});
            throw new DOMException(DOMException.NOT_SUPPORTED_ERR, msg);
    ...
    /**
     * Returns the End-Of-Line sequence of characters to be used in the XML being serialized. If
     * none is set a default "\n" is returned.
     *
     * @see org.w3c.dom.ls.LSSerializer#getNewLine()
     * @since DOM Level 3
     * @return A String containing the end-of-line character sequence used in serialization.
     */
    ...
    /**
     * Set a LSSerilizerFilter on the LSSerializer. When set, the filter is called before each node
     * is serialized which depending on its implemention determines if the node is to be serialized
     * or not.
     *
    ...
    /**
     * Sets the End-Of-Line sequence of characters to be used in the XML being serialized. Setting
     * this attribute to null will reset its value to the default value i.e. "\n".
     *
    ...
    /**
     * Serializes the specified node to the specified LSOutput and returns true if the Node was
     * successfully serialized.
     *
     * @see org.w3c.dom.ls.LSSerializer#write(org.w3c.dom.Node, org.w3c.dom.ls.LSOutput)
     * @since DOM Level 3
     * @param nodeArg The Node to serialize.
     * @throws org.w3c.dom.ls.LSException SERIALIZE_ERR: Raised if the LSSerializer was unable to
     *     serialize the node.
     */
    public boolean write(Node nodeArg, LSOutput destination) throws LSException {
        ...
        if (destination == null) {
            ...
            if (fDOMErrorHandler != null) {
                fDOMErrorHandler.handleError(
                        new DOMErrorImpl(
                                DOMError.SEVERITY_FATAL_ERROR, msg, MsgKey.ER_NO_OUTPUT_SPECIFIED));
            }
        ...
        if (nodeArg != fVisitedNode) {
            ...
            // Determine the encoding: 1.LSOutput.encoding, 2.Document.inputEncoding,
            ...
            if (fEncoding == null) {
                ...
                fEncoding =
                        fEncoding != null
                                ? fEncoding
                                : getXMLEncoding(nodeArg) == null
                                        ? "UTF-8"
                                        : getXMLEncoding(nodeArg);
            }
            ...
            fDOMConfigProperties.setProperty(
                    DOMConstants.S_XERCES_PROPERTIES_NS + DOMConstants.S_XML_VERSION, xmlVersion);
            ...
            if ((nodeArg.getNodeType() != Node.DOCUMENT_NODE
                    ...
                    && ((fFeatures & XMLDECL) != 0)) {
                fDOMConfigProperties.setProperty(
                        DOMConstants.S_XSL_OUTPUT_OMIT_XML_DECL, DOMConstants.DOM3_DEFAULT_FALSE);
            }
        ...
        try {
            ...
            if (writer == null) {
                ...
                if (outputStream == null) {
                    ...
                    if (uri == null) {
                        String msg =
                                Utils.messages.createMessage(MsgKey.ER_NO_OUTPUT_SPECIFIED, null);
                        if (fDOMErrorHandler != null) {
                            fDOMErrorHandler.handleError(
                                    new DOMErrorImpl(
                                            DOMError.SEVERITY_FATAL_ERROR,
            ...
            throw new LSException(
                    LSException.SERIALIZE_ERR, e != null ? e.getMessage() : "NULL Exception");
        } catch (Exception e) {
            if (fDOMErrorHandler != null) {
                fDOMErrorHandler.handleError(
                        new DOMErrorImpl(DOMError.SEVERITY_FATAL_ERROR, e.getMessage(), null, e));
            }
            e.printStackTrace();
    ...
    /**
     * Serializes the specified node to the specified URI and returns true if the Node was
     * successfully serialized.
     *
    ...
    /**
     * Determines the XML Version of the Document Node to serialize. If the Document Node is not a
     * DOM Level 3 Node, then the default version returned is 1.0.
     *
     * @param nodeArg The Node to serialize
    ...
    /**
     * Determines the XML Encoding of the Document Node to serialize. If the Document Node is not a
     * DOM Level 3 Node, then the default encoding "UTF-8" is returned.
     *
     * @param nodeArg The Node to serialize
    ...
    /**
     * Determines the Input Encoding of the Document Node to serialize. If the Document Node is not
     * a DOM Level 3 Node, then null is returned.
     *
     * @param nodeArg The Node to serialize
