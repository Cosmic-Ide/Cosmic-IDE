 ...
 *
 * <p>A user of this class normally would create a singleton instance of this class, passing the
 * name of the message class on the constructor. For example: <CODE>
 * static Messages x = new Messages("org.package.MyMessages");
 * </CODE> Later the message is typically generated this way if there are no substitution arguments:
 * <CODE>
 * String msg = x.createMessage(org.package.MyMessages.KEY_ONE, null);
 * </CODE> If there are arguments substitutions then something like this: <CODE>
 * String filename = ...;
 * String directory = ...;
 * String msg = x.createMessage(org.package.MyMessages.KEY_TWO,
 *   new Object[] {filename, directory) );
 * </CODE> The constructor of an instance of this class must be given the class name of a class that
 * extends java.util.ListResourceBundle ("org.package.MyMessages" in the example above). The name
 * should not have any language suffix which will be added automatically by this utility class.
 *
 * <p>The message class ("org.package.MyMessages") must define the abstract method getContents()
 * that is declared in its base class, for example: <CODE>
 * public Object[][] getContents() {return contents;}
 * </CODE> It is suggested that the message class expose its message keys like this: <CODE>
 *   public static final String KEY_ONE = "KEY1";
 *   public static final String KEY_TWO = "KEY2";
 *   . . .
 * </CODE> and used through their names (KEY_ONE ...) rather than their values ("KEY1" ...).
 *
 * <p>The field contents (returned by getContents() should be initialized something like this:
 * <CODE>
 ...
 * . . .
 * { KEY_N, "Message N" }  }
 * </CODE> Where that section of code with the KEY to Message mappings (where the message classes
 * 'contents' field is initialized) can have the Message strings translated in an alternate language
 ...
 *
 * @xsl.usage internal @LastModified: Sep 2017
 */
public final class Messages {
     ...
     * Constructor.
     *
     * @param resourceBundle the class name of the ListResourceBundle that the instance of this
     *     class is associated with and will use when creating messages. The class name is without a
     *     language suffix. If the value passed is null then loadResourceBundle(errorResourceClass)
     *     needs to be called explicitly before any messages are created.
     * @xsl.usage internal
     */
            ...
            try {
                ...
                msg =
                        java.text.MessageFormat.format(
                                MsgKey.BAD_MSGKEY, new Object[] {msgKey, m_resourceBundleName});
            } catch (Exception e) {
