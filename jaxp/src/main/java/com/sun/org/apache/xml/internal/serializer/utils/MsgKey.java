...
/**
 * This class is not a public API, It is used internally by serializer and is public, in the Java
 * sense, only because its use crosses package boundaries.
 *
 * <p>This class holds only the message keys used when generating messages.
 */
public class MsgKey {

    /**
     * An internal error with the messages, this is the message to use if the message key can't be
     * found
     */
    public static final String BAD_MSGKEY = "BAD_MSGKEY";

    /**
     * An internal error with the messages, this is the message to use if the message format
     * operation failed.
     */
    ...
    public static final String ER_ELEM_UNBOUND_PREFIX_IN_ENTREF =
            "unbound-prefix-in-entity-reference";
    public static final String ER_ATTR_UNBOUND_PREFIX_IN_ENTREF =
            "unbound-prefix-in-entity-reference";
    ...
    public static final String ER_WF_INVALID_CHARACTER_IN_NODE_NAME =
    ...
    public static final String ER_WF_INVALID_CHARACTER_IN_COMMENT =
            "ER_WF_INVALID_CHARACTER_IN_COMMENT";
    public static final String ER_WF_INVALID_CHARACTER_IN_PI = "ER_WF_INVALID_CHARACTER_IN_PI";
    public static final String ER_WF_INVALID_CHARACTER_IN_CDATA =
