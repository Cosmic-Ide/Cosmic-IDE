        ...
        Object[][] contents =
                new Object[][] {
                    ...
                    },
                    {
                        ...
                        "Warning:  The version of the output document is requested to be ''{0}''. "
                            + " This version of XML is not supported.  The version of the output"
                            + " document will be ''1.0''."
                    },
                    {MsgKey.ER_SCHEME_REQUIRED, "Scheme is required!"},
                     ...
                     */
                    {
                        ...
                        "The Properties object passed to the SerializerFactory does not have a"
                            + " ''{0}'' property."
                    },
                    {
                    ...
                    {MsgKey.ER_FEATURE_NOT_FOUND, "The parameter ''{0}'' is not recognized."},
                    {
                    ...
                    },
                    {
                        ...
                        "The value type for this parameter name is incompatible with the expected"
                            + " value type."
                    },
                    {
                    ...
                    {MsgKey.ER_UNSUPPORTED_ENCODING, "An unsupported encoding is encountered."},
                    {MsgKey.ER_UNABLE_TO_SERIALIZE_NODE, "The node could not be serialized."},
                    {
                    ...
                    },
                    {
                        ...
                        "An instance of the Well-Formedness checker could not be created.  The"
                            + " well-formed parameter was set to true but well-formedness checking"
                    ...
                    },
                    {
                        ...
                        "An invalid XML character (Unicode: 0x{0}) was found in the processing"
                            + " instructiondata."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_CDATA,
                        "An invalid XML character (Unicode: 0x{0}) was found in the contents of the"
                            + " CDATASection."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_TEXT,
                        "An invalid XML character (Unicode: 0x{0}) was found in the node''s"
                    ...
                    },
                    {
                        ...
                        "The value of attribute \"{1}\" associated with an element type \"{0}\""
                    ...
                    },
                    {
                        ...
                        "The external entity reference \"&{0};\" is not permitted in an attribute"
                            + " value."
                    },
                    {
                    ...
                    {MsgKey.ER_NULL_LOCAL_ATTR_NAME, "The local name of attr \"{0}\" is null."},
                    {
                        MsgKey.ER_ELEM_UNBOUND_PREFIX_IN_ENTREF,
                        "The replacement text of the entity node \"{0}\" contains an element node"
                            + " \"{1}\" with an unbound prefix \"{2}\"."
                    },
                    {
                        MsgKey.ER_ATTR_UNBOUND_PREFIX_IN_ENTREF,
                        "The replacement text of the entity node \"{0}\" contains an attribute node"
                            + " \"{1}\" with an unbound prefix \"{2}\"."
                    },
                    {
