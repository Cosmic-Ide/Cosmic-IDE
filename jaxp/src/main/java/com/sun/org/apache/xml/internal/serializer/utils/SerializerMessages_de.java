        ...
        Object[][] contents =
                new Object[][] {
                    ...
                    {MsgKey.ER_OIERROR, "I/O-Fehler"},
                    {
                        ...
                        "Attribut {0} kann nicht nach untergeordneten Knoten oder vor dem Erstellen"
                            + " eines Elements hinzugef\u00FCgt werden. Attribut wird ignoriert."
                    },
                    ...
                    {MsgKey.ER_NO_SCHEME_IN_URI, "Kein Schema gefunden in URI"},
                    {
                    ...
                    {MsgKey.ER_FEATURE_NOT_FOUND, "Parameter \"{0}\" nicht erkannt."},
                    {
                        MsgKey.ER_FEATURE_NOT_SUPPORTED,
                        "Parameter \"{0}\" wird erkannt, aber der angeforderte Wert kann nicht"
                            + " festgelegt werden."
                    },
                    {
                        MsgKey.ER_STRING_TOO_LONG,
                        "Die resultierende Zeichenfolge ist zu lang, um in eine DOMString zupassen:"
                            + " \"{0}\"."
                    },
                    {
                        MsgKey.ER_TYPE_MISMATCH_ERR,
                        "Der Werttyp f\u00FCr diesen Parameternamen ist nicht mit dem erwarteten"
                            + " Werttyp kompatibel. "
                    },
                    {
                    ...
                    {MsgKey.ER_UNSUPPORTED_ENCODING, "Nicht unterst\u00FCtzte Codierung gefunden."},
                    {
                    ...
                    },
                    {
                        ...
                        "Eine Instanz der Pr\u00FCfung f\u00FCr ordnungsgem\u00E4\u00DFe"
                            + " Formatierung konnte nicht erstellt werden. Der"
                            + " ordnungsgem\u00E4\u00DF formatierte Parameter wurde auf \"True\""
                            + " gesetzt, aber die Pr\u00FCfung auf ordnungsgem\u00E4\u00DFe"
                            + " Formatierung kann nicht ausgef\u00FChrt werden."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Ung\u00FCltiges XML-Zeichen (Unicode: 0x{0}) wurde in den"
                            + " Verarbeitungsanweisungsdaten gefunden."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_CDATA,
                        "Ung\u00FCltiges XML-Zeichen (Unicode: 0x{0}) wurde im Inhalt des"
                            + " CDATA-Abschnitts gefunden."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_TEXT,
                        "Ung\u00FCltiges XML-Zeichen (Unicode: 0x{0}) wurde in den Zeichendaten des"
                            + " Knotens gefunden."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_NODE_NAME,
                        "Ung\u00FCltige(s) XML-Zeichen wurde(n) im {0}-Knoten mit Namen \"{1}\""
                            + " gefunden."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Wert des Attributs \"{1}\", das mit Elementtyp \"{0}\" verkn\u00FCpft ist,"
                            + " darf nicht das Zeichen \"<\" enthalten."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Externe Entityreferenz \"&{0};\" ist in einem Attributwert nicht"
                            + " zul\u00E4ssig."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Der Ersatztext des Entityknotens \"{0}\" enth\u00E4lt einen Elementknoten"
                            + " \"{1}\" mit nicht gebundenem Pr\u00E4fix \"{2}\"."
                    },
                    {
                        MsgKey.ER_ATTR_UNBOUND_PREFIX_IN_ENTREF,
                        "Der Ersatztext des Entityknotens \"{0}\" enth\u00E4lt einen Attributknoten"
                            + " \"{1}\" mit nicht gebundenem Pr\u00E4fix \"{2}\"."
                    },
                    {
