    ...
    public Object[][] getContents() {
        Object[][] contents =
                new Object[][] {
                    ...
                    {MsgKey.ER_OIERROR, "Error de E/S"},
                    {
                        MsgKey.ER_ILLEGAL_ATTRIBUTE_POSITION,
                        "No se puede agregar el atributo {0} despu\u00E9s de nodos secundarios o"
                            + " antes de que se produzca un elemento. Se ignorar\u00E1 el atributo."
                    },
                    ...
                    },
                    {
                        ...
                        "Intento de realizar la salida del car\u00E1cter del valor integral {0},"
                            + " que no est\u00E1 representado en la codificaci\u00F3n de salida de"
                            + " {1}."
                    },
                    {
                    ...
                    {MsgKey.ER_FEATURE_NOT_FOUND, "No se reconoce el par\u00E1metro ''{0}''."},
                    {
                        MsgKey.ER_FEATURE_NOT_SUPPORTED,
                        "Se reconoce el par\u00E1metro ''{0}'' pero no se puede definir el valor"
                            + " solicitado."
                    },
                    {
                        MsgKey.ER_STRING_TOO_LONG,
                        "La cadena resultante es demasiado larga para que quepa en una cadena DOM:"
                            + " ''{0}''."
                    },
                    {
                        MsgKey.ER_TYPE_MISMATCH_ERR,
                        "El tipo de valor para este nombre de par\u00E1metro no es compatible con"
                    ...
                    {MsgKey.ER_UNABLE_TO_SERIALIZE_NODE, "El nodo no se ha podido serializar."},
                    {
                        MsgKey.ER_CDATA_SECTIONS_SPLIT,
                        "La secci\u00F3n CDATA contiene uno o m\u00E1s marcadores de"
                            + " terminaci\u00F3n ']]>'."
                    },
                    {
                        MsgKey.ER_WARNING_WF_NOT_CHECKED,
                        "No se ha podido crear una instancia del comprobador de formato correcto."
                            + " El par\u00E1metro de formato correcto se ha definido en true pero"
                            + " no se puede realizar la comprobaci\u00F3n de formato correcto."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Se ha encontrado un car\u00E1cter XML (Unicode: 0x{0}) no v\u00E1lido en"
                            + " el comentario."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Se ha encontrado un car\u00E1cter XML (Unicode: 0x{0}) no v\u00E1lido en"
                            + " los datos de caracteres del nodo."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_NODE_NAME,
                        "Se ha encontrado un car\u00E1cter XML no v\u00E1lido en el nodo {0}"
                            + " denominado ''{1}''."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "El valor del atributo \"{1}\" asociado a un tipo de elemento \"{0}\" no"
                    ...
                    },
                    {
                        ...
                        "La referencia de entidad externa \"&{0};\" no est\u00E1 permitida en un"
                            + " valor de atributo."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "El texto de sustituci\u00F3n del nodo de entidad \"{0}\" contiene un nodo"
                            + " de elemento \"{1}\"con un prefijo no enlazado \"{2}\"."
                    },
                    {
                        MsgKey.ER_ATTR_UNBOUND_PREFIX_IN_ENTREF,
                        "El texto de sustituci\u00F3n del nodo de entidad \"{0}\" contiene un nodo"
                            + " de atributo \"{1}\"con un prefijo no enlazado \"{2}\"."
                    },
                    {
