...
/**
 * An instance of this class is a ListResourceBundle that has the required getContents() method that
 * returns an array of message-key/message associations.
 *
 * <p>The message keys are defined in {@link MsgKey}. The messages that those keys map to are
 * defined here.
 *
 * <p>The messages in the English version are intended to be translated.
 *
 * <p>This class is not a public API, it is only public because it is used in
    ...
    public Object[][] getContents() {
        Object[][] contents =
                new Object[][] {
                    ...
                    {MsgKey.ER_BUFFER_SIZE_LESSTHAN_ZERO, "Taille du tampon <=0"},
                    {
                        MsgKey.ER_INVALID_UTF16_SURROGATE,
                        "Substitut UTF-16 non valide d\u00E9tect\u00E9 : {0} ?"
                    },
                    {MsgKey.ER_OIERROR, "Erreur d'E/S"},
                    {
                    ...
                    {MsgKey.ER_FEATURE_NOT_FOUND, "Le param\u00E8tre ''{0}'' n''est pas reconnu."},
                    {
                        MsgKey.ER_FEATURE_NOT_SUPPORTED,
                        "Le param\u00E8tre ''{0}'' est reconnu mais la valeur demand\u00E9e ne peut"
                            + " pas \u00EAtre d\u00E9finie."
                    },
                    {
                        MsgKey.ER_STRING_TOO_LONG,
                        "La cha\u00EEne obtenue est trop longue pour tenir dans un"
                            + " \u00E9l\u00E9ment DOMString : ''{0}''."
                    },
                    {
                        MsgKey.ER_TYPE_MISMATCH_ERR,
                        "Le type de valeur pour ce nom de param\u00E8tre n'est pas compatible avec"
                            + " le type de valeur attendu. "
                    },
                    {
                        MsgKey.ER_NO_OUTPUT_SPECIFIED,
                        "La destination de sortie dans laquelle \u00E9crire les donn\u00E9es est"
                            + " NULL."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Une instance du v\u00E9rificateur de format correct n'a pas pu \u00EAtre"
                            + " cr\u00E9\u00E9e. Le param\u00E8tre de format correct a"
                            + " \u00E9t\u00E9 d\u00E9fini sur True mais la v\u00E9rification de"
                            + " format correct n'a pas pu \u00EAtre r\u00E9alis\u00E9e."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Un caract\u00E8re XML non valide (Unicode : 0x{0}) a \u00E9t\u00E9"
                            + " d\u00E9tect\u00E9 dans le commentaire."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_PI,
                        "Un caract\u00E8re XML non valide (Unicode : 0x{0}) a \u00E9t\u00E9"
                            + " d\u00E9tect\u00E9 dans les donn\u00E9es d''instruction de"
                            + " traitement."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_CDATA,
                        "Un caract\u00E8re XML non valide (Unicode : 0x{0}) a \u00E9t\u00E9"
                            + " d\u00E9tect\u00E9 dans le contenu de la section CDATA."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_TEXT,
                        "Un caract\u00E8re XML non valide (Unicode : 0x{0}) a \u00E9t\u00E9"
                            + " d\u00E9tect\u00E9 dans le contenu des donn\u00E9es"
                            + " alphanum\u00E9riques du noeud."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_NODE_NAME,
                        "Un caract\u00E8re XML non valide a \u00E9t\u00E9 d\u00E9tect\u00E9 dans le"
                            + " noeud {0} nomm\u00E9 ''{1}''."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "La valeur de l''attribut \"{1}\" associ\u00E9 \u00E0 un type"
                            + " d''\u00E9l\u00E9ment \"{0}\" ne doit pas contenir le caract\u00E8re"
                            + " ''<''."
                    },
                    {
                        MsgKey.ER_WF_REF_TO_UNPARSED_ENT,
                        "La r\u00E9f\u00E9rence d''entit\u00E9 non analys\u00E9e \"&{0};\" n''est"
                            + " pas autoris\u00E9e."
                    },
                    {
                        MsgKey.ER_WF_REF_TO_EXTERNAL_ENT,
                        "La r\u00E9f\u00E9rence d''entit\u00E9 externe \"&{0};\" n''est pas"
                            + " autoris\u00E9e dans une valeur d''attribut."
                    },
                    {
                        MsgKey.ER_NS_PREFIX_CANNOT_BE_BOUND,
                        "Le pr\u00E9fixe \"{0}\" ne peut pas \u00EAtre li\u00E9 \u00E0 l''espace de"
                            + " noms \"{1}\"."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Le texte de remplacement du noeud d''entit\u00E9 \"{0}\" contient un noeud"
                            + " d''\u00E9l\u00E9ment \"{1}\" avec un pr\u00E9fixe non li\u00E9"
                            + " \"{2}\"."
                    },
                    {
                        MsgKey.ER_ATTR_UNBOUND_PREFIX_IN_ENTREF,
                        "Le texte de remplacement du noeud d''entit\u00E9 \"{0}\" contient un noeud"
                            + " d''attribut \"{1}\" avec un pr\u00E9fixe non li\u00E9 \"{2}\"."
                    },
                    {
                        MsgKey.ER_WRITING_INTERNAL_SUBSET,
                        "Une erreur s'est produite lors de l'\u00E9criture du sous-ensemble"
                            + " interne."
                    },
                };
