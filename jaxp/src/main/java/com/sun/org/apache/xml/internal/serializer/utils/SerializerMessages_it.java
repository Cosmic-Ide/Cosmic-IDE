    ...
    public Object[][] getContents() {
        Object[][] contents =
                new Object[][] {
                    ...
                    {MsgKey.ER_FEATURE_NOT_FOUND, "Il parametro {0} non \u00E8 riconosciuto."},
                    {
                        MsgKey.ER_FEATURE_NOT_SUPPORTED,
                        "Il parametro ''{0}'' \u00E8 stato riconosciuto, ma non \u00E8 possibile"
                            + " impostare il valore richiesto."
                    },
                    {
                        MsgKey.ER_STRING_TOO_LONG,
                        "La stringa risultante \u00E8 troppo lunga per adattarsi in DOMString:"
                            + " ''{0}''."
                    },
                    {
                        MsgKey.ER_TYPE_MISMATCH_ERR,
                        "Il tipo di valore per questo nome parametro non \u00E8 compatibile con il"
                            + " tipo di valore previsto. "
                    },
                    {
                    ...
                    {MsgKey.ER_UNABLE_TO_SERIALIZE_NODE, "Impossibile serializzare il nodo."},
                    {
                    ...
                    },
                    {
                        ...
                        "Impossibile creare un'istanza dello strumento di controllo della"
                            + " correttezza del formato. Il parametro con formato valido \u00E8"
                            + " impostato su true, ma non \u00E8 possibile eseguire il controllo"
                            + " della correttezza del formato."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "\u00C8 stato trovato un carattere XML non valido (Unicode: 0x{0}) nel"
                            + " commento."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_PI,
                        "\u00C8 stato trovato un carattere XML non valido (Unicode: 0x{0}) nei dati"
                            + " dell''istruzione di elaborazione."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_CDATA,
                        "\u00C8 stato trovato un carattere XML non valido (Unicode: 0x{0}) nei"
                            + " contenuti della sezione CDATA."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_TEXT,
                        "\u00C8 stato trovato un carattere XML non valido (Unicode: 0x{0}) nel"
                            + " contenuto dei dati carattere del nodo."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_NODE_NAME,
                        "\u00C8 stato trovato un carattere o caratteri XML non validi nel nodo {0}"
                            + " denominato ''{1}''."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Il valore dell''attributo \"{1}\" associato a un tipo di elemento \"{0}\""
                            + " non deve essere contenere il carattere ''<''."
                    },
                    {
                        MsgKey.ER_WF_REF_TO_UNPARSED_ENT,
                        "Il riferimento di entit\u00E0 non analizzata \"&{0};\" non \u00E8"
                            + " consentito."
                    },
                    {
                        MsgKey.ER_WF_REF_TO_EXTERNAL_ENT,
                        "Il riferimento di entit\u00E0 esterna \"&{0};\" non \u00E8 consentito in"
                    ...
                    },
                    {
                        ...
                        "Il testo di sostituzione del nodo entit\u00E0 \"{0}\" contiene un nodo"
                            + " elemento \"{1}\" con un prefisso non associato \"{2}\"."
                    },
                    {
                        MsgKey.ER_ATTR_UNBOUND_PREFIX_IN_ENTREF,
                        "Il testo di sostituzione del nodo entit\u00E0 \"{0}\" contiene un nodo"
                            + " attributo \"{1}\" con un prefisso non associato \"{2}\"."
                    },
                    {
