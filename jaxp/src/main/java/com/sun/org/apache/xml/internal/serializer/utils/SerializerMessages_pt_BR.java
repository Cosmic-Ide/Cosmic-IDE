        ...
        Object[][] contents =
                new Object[][] {
                    ...
                    },
                    {
                        ...
                        "Advert\u00EAncia: a vers\u00E3o do documento de sa\u00EDda deve ser"
                            + " obrigatoriamente ''{0}''. Esta vers\u00E3o do XML n\u00E3o \u00E9"
                            + " suportada. A vers\u00E3o do documento de sa\u00EDda ser\u00E1"
                            + " ''1.0''."
                    },
                    ...
                    },
                    {
                        ...
                        "O par\u00E2metro ''{0}'' \u00E9 reconhecido, mas o valor solicitado"
                            + " n\u00E3o pode ser definido."
                    },
                    {
                        MsgKey.ER_STRING_TOO_LONG,
                        "A string resultante \u00E9 muito longa para se ajustar a uma DOMString:"
                            + " ''{0}''."
                    },
                    {
                        MsgKey.ER_TYPE_MISMATCH_ERR,
                        "O tipo de valor do nome deste par\u00E2metro \u00E9 incompat\u00EDvel com"
                            + " o tipo de valor esperado."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "N\u00E3o foi poss\u00EDvel criar uma inst\u00E2ncia do verificador de"
                            + " Formato Correto. O par\u00E2metro formatado corretamente foi"
                            + " definido como verdadeiro, mas a verifica\u00E7\u00E3o de formato"
                            + " correto n\u00E3o pode ser executada."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Um caractere XML inv\u00E1lido (Unicode: 0x{0}) foi encontrado no"
                            + " coment\u00E1rio."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_PI,
                        "Um caractere XML inv\u00E1lido (Unicode: 0x{0}) foi encontrado nos dados"
                            + " da instru\u00E7\u00E3o de processamento."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Um caractere XML inv\u00E1lido (Unicode: 0x {0}) foi encontrado no"
                            + " conte\u00FAdo dos dados de caracteres do n\u00F3."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_NODE_NAME,
                        "Um ou mais caracteres XML inv\u00E1lidos foram encontrados no n\u00F3 {0}"
                            + " chamado ''{1}''."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "O valor do atributo \"{1}\" associado a um tipo de elemento \"{0}\""
                            + " n\u00E3o deve conter o caractere ''<''."
                    },
                    {
                        MsgKey.ER_WF_REF_TO_UNPARSED_ENT,
                        "A refer\u00EAncia da entidade n\u00E3o submetida a parsing \"&{0};\""
                            + " n\u00E3o \u00E9 permitida."
                    },
                    {
                        MsgKey.ER_WF_REF_TO_EXTERNAL_ENT,
                        "A refer\u00EAncia da entidade externa \"&{0};\" n\u00E3o \u00E9 permitida"
                            + " em um valor do atributo."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "O texto de substitui\u00E7\u00E3o do n\u00F3 \"{0}\" de entidade"
                            + " cont\u00E9m um n\u00F3 \"{1}\" de elemento com um prefixo"
                            + " desvinculado \"{2}\"."
                    },
                    {
                        MsgKey.ER_ATTR_UNBOUND_PREFIX_IN_ENTREF,
                        "O texto de substitui\u00E7\u00E3o do n\u00F3 \"{0}\" de entidade"
                            + " cont\u00E9m um n\u00F3 \"{1}\" de atributo com um prefixo"
                            + " desvinculado \"{2}\"."
                    },
                    {
