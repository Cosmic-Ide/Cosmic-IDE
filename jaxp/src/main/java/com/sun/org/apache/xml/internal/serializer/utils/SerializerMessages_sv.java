    ...
    public Object[][] getContents() {
        Object[][] contents =
                new Object[][] {
                    ...
                    {MsgKey.ER_FEATURE_NOT_FOUND, "Parametern ''{0}'' k\u00E4nns inte igen."},
                    {
                        MsgKey.ER_FEATURE_NOT_SUPPORTED,
                        "Parametern ''{0}'' k\u00E4nns igen men det beg\u00E4rda v\u00E4rdet kan"
                            + " inte anges."
                    },
                    {
                        MsgKey.ER_STRING_TOO_LONG,
                        "Resultatstr\u00E4ngen \u00E4r f\u00F6r l\u00E5ng och ryms inte i"
                            + " DOMString: ''{0}''."
                    },
                    {
                        MsgKey.ER_TYPE_MISMATCH_ERR,
                        "V\u00E4rdetypen f\u00F6r detta parameternamn \u00E4r inkompatibelt med"
                            + " f\u00F6rv\u00E4ntad v\u00E4rdetyp. "
                    },
                    {
                    ...
                    {MsgKey.ER_UNABLE_TO_SERIALIZE_NODE, "Noden kunde inte serialiseras."},
                    {
                    ...
                    },
                    {
                        ...
                        "En instans av Well-Formedness-kontrollen kunde inte skapas. Parametern"
                            + " well-formed har angetts till sant men Well-Formedness-kontrollen"
                            + " kan inte utf\u00F6ras."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Ett ogiltigt XML-tecken (Unicode: 0x{0}) hittades i"
                            + " bearbetningsinstruktionsdata."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_CDATA,
                        "Ett ogiltigt XML-tecken (Unicode: 0x{0}) hittades i inneh\u00E5llet i"
                            + " CDATASection."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_TEXT,
                        "Ett ogiltigt XML-tecken (Unicode: 0x{0}) hittades i"
                            + " teckendatainneh\u00E5llet f\u00F6r noden."
                    },
                    {
                        MsgKey.ER_WF_INVALID_CHARACTER_IN_NODE_NAME,
                        "Ett ogiltigt XML-tecken/ogiltiga XML-tecken hittades i {0}-noden med"
                            + " namnet ''{1}''."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Attributv\u00E4rdet \"{1}\" som associeras med elementtyp \"{0}\" f\u00E5r"
                            + " inte inneh\u00E5lla n\u00E5got ''<''-tecken."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Den externa enhetsreferensen \"&{0};\" till\u00E5ts inte i ett"
                            + " attributv\u00E4rde."
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "Ers\u00E4ttningstexten f\u00F6r enhetsnoden \"{0}\" inneh\u00E5ller"
                            + " elementnoden \"{1}\" med ett obundet prefix, \"{2}\"."
                    },
                    {
                        MsgKey.ER_ATTR_UNBOUND_PREFIX_IN_ENTREF,
                        "Ers\u00E4ttningstexten f\u00F6r enhetsnoden \"{0}\" inneh\u00E5ller"
                            + " attributnoden \"{1}\" med ett obundet prefix, \"{2}\"."
                    },
                    {
