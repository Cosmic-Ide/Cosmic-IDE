 ...
 *
 * @xsl.usage advanced @LastModified: Jan 2019
 */
public class XPathContext extends DTMManager // implements ExpressionContext
{
    ...
    public DTMIterator createDTMIterator(int node) {
        ...
        DTMIterator iter =
                new com.sun.org.apache.xpath.internal.axes.OneStepIteratorForward(Axis.SELF);
    ...
    public void popRTFContext() {
        ...
        if (m_which_rtfdtm == previous) {
            ...
            while (m_which_rtfdtm != previous) {
                ...
                boolean isEmpty =
                        ((SAX2RTFDTM) (m_rtfdtm_stack.get(m_which_rtfdtm))).popRewindMark();
                --m_which_rtfdtm;
            }
    }
