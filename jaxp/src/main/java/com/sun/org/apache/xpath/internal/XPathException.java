...
public class XPathException extends TransformerException {
    ...
    /**
     * Create an XPathException object that holds an error message, the stylesheet node that the
     * error originated from, and another exception that caused this exception.
     *
     * @param message The error message.
     * @param styleNode The stylesheet node that the error originated from.
    ...
    /**
     * Create an XPathException object that holds an error message, and another exception that
