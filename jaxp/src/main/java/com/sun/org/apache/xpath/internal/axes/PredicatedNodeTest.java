...
public abstract class PredicatedNodeTest extends NodeTest implements SubContextList {
    ...
    private void readObject(java.io.ObjectInputStream stream)
        ...
        /**
         * Initialize to the declared value. As noted at declaration, this variable is used only for
         * clones for getLastPos, it should have been excluded from serialization. For
         * compatibility, we'll keep it as is but initializing to the declared value.
         */
        m_predCount = -1;
    ...
    /**
     * Set the location path iterator owner for this walker. Besides initialization, this function
     * is called during cloning operations.
     *
