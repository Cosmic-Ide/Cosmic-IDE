 ...
 *
 * @xsl.usage advanced @LastModified: May 2019
 */
public class Compiler extends OpMap {
     ...
     *
     * <p>Note that this method is added so that when StackOverflowError is caught the address space
     * can be freed to this point allowing further activities such as reporting the error.
     *
    ...
    /**
     * This method handles the actual compilation process. It is called from the compileExpression
     * method as well as the subsequent processes. See the note for compileExpression.
     *
     * @param opPos The current position in the xpath.m_opMap array.
     * @return The result of the XPath.
     * @throws TransformerException if there is a syntax or other error.
     ...
     * com.sun.org.apache.xpath.internal.axes.LocPathIterator} children.
     *
     * @param opPos The current position in the m_opMap array.
     ...
     * com.sun.org.apache.xpath.internal.axes.AxesWalker} children.
     *
     * @param opPos The current position in the m_opMap array.
     * @return reference to {@link com.sun.org.apache.xpath.internal.axes.LocPathIterator} instance.
     * @throws TransformerException if a error occurs creating the Expression.
     ...
     *
     * @param opPos The current position in the m_opMap array.
     * @return reference to {@link com.sun.org.apache.xpath.internal.patterns.UnionPattern}
     *     instance.
     * @throws TransformerException if a error occurs creating the Expression.
     */
     ...
     *     com.sun.org.apache.xpath.internal.Expression}s, that will be filled in.
     * @throws TransformerException
     */
     ...
     *
     * @param opPos The current position in the m_opMap array.
     * @return reference to {@link com.sun.org.apache.xpath.internal.functions.FuncExtFunction}
     *     instance.
     * @throws TransformerException if a error occurs creating the Expression.
     */
