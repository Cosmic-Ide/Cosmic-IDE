...
/** The function table for XPath. @LastModified: Oct 2017 */
public class FunctionTable {
    ...
    static {
        ...
        m_functions[FUNC_HERE] = com.sun.org.apache.xpath.internal.functions.FuncHere.class;
    }
    ...
    static {
        ...
        m_functionID.put(Keywords.FUNC_KEY_STRING, FunctionTable.FUNC_KEY);
        ...
        m_functionID.put(Keywords.FUNC_GENERATE_ID_STRING, FunctionTable.FUNC_GENERATE_ID);
        ...
        m_functionID.put(
                Keywords.FUNC_SUBSTRING_BEFORE_STRING, FunctionTable.FUNC_SUBSTRING_BEFORE);
        ...
        m_functionID.put(Keywords.FUNC_SYSTEM_PROPERTY_STRING, FunctionTable.FUNC_SYSTEM_PROPERTY);
        m_functionID.put(
                Keywords.FUNC_EXT_FUNCTION_AVAILABLE_STRING,
                FunctionTable.FUNC_EXT_FUNCTION_AVAILABLE);
        m_functionID.put(
                Keywords.FUNC_EXT_ELEM_AVAILABLE_STRING, FunctionTable.FUNC_EXT_ELEM_AVAILABLE);
        ...
        m_functionID.put(
                Keywords.FUNC_UNPARSED_ENTITY_URI_STRING, FunctionTable.FUNC_UNPARSED_ENTITY_URI);
        m_functionID.put(Keywords.FUNC_DOCLOCATION_STRING, FunctionTable.FUNC_DOCLOCATION);
        m_functionID.put(Keywords.FUNC_HERE_STRING, FunctionTable.FUNC_HERE);
    }
     ...
     *     {@link com.sun.org.apache.xpath.internal.compiler.FunctionTable}, but may be a value
     *     installed by an external module.
    ...
    public int installFunction(String name, Class<?> func) {
        ...
        if (func != null && !Function.class.isAssignableFrom(func)) {
            throw new ClassCastException(
                    func.getName() + " cannot be cast to " + Function.class.getName());
        }
