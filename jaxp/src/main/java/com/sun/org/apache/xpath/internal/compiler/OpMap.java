...
/** This class represents the data structure basics of the XPath object. @LastModified: Nov 2017 */
public class OpMap {
    ...
    public int getFirstPredicateOpPos(int opPos) throws javax.xml.transform.TransformerException {
        ...
        if ((stepType >= OpCodes.AXES_START_TYPES) && (stepType <= OpCodes.AXES_END_TYPES)) {
            ...
            error(
                    com.sun.org.apache.xpath.internal.res.XPATHErrorResources.ER_UNKNOWN_OPCODE,
                    new Object[] {
    ...
    public void error(String msg, Object[] args) throws javax.xml.transform.TransformerException {
        ...
        java.lang.String fmsg =
                com.sun.org.apache.xalan.internal.res.XSLMessages.createXPATHMessage(msg, args);
