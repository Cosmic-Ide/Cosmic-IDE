 ...
 *
 * @xsl.usage general @LastModified: Apr 2022
 */
public class XPathParser {
     ...
     *     com.sun.org.apache.xpath.internal.compiler.FunctionTable}, but may be a value installed
    ...
    protected boolean PrimaryExpr() throws TransformerException {
        ...
        if ((m_tokenChar == Token.SQ) || (m_tokenChar == Token.DQ)) {
            ...
            matchFound = true;
        } else if (lookahead(Token.LPAREN, 1)
                || (lookahead(Token.COLON, 1) && lookahead(Token.LPAREN, 3))) {
     ...
     * Basis ::= AxisName '::' NodeTest | AbbreviatedBasis
     *
     * @return FROM_XXX axes type, found in {@link
