...
/**
 * An object of this class represents an extension call expression. When the expression executes, it
 * calls ExtensionsTable#extFunction, and then converts the result to the appropriate XObject.
 *
 * @xsl.usage advanced @LastModified: Oct 2017
 */
public class FuncExtFunction extends Function {
    ...
    /**
     * Unique method key, which is passed to ExtensionsTable#extFunction in order to allow caching
     * of the method.
     *
     * @serial
     */
    ...
    public Expression getArg(int n) {
        if (n >= 0 && n < m_argVec.size()) return m_argVec.get(n);
        else return null;
    }
    ...
    /**
     * Create a new FuncExtFunction based on the qualified name of the extension, and a unique
     * method key.
     *
     * @param namespace The namespace for the extension function, which should not normally be null
     *     or empty.
     * @param extensionName The local name of the extension.
     * @param methodKey Unique method key, which is passed to ExtensionsTable#extFunction in order
     *     to allow caching of the method.
     */
    public FuncExtFunction(
            java.lang.String namespace, java.lang.String extensionName, Object methodKey) {
        // try{throw new Exception("FuncExtFunction() " + namespace + " " + extensionName);} catch
    ...
    /**
     * Set the parent node. For an extension function, we also need to set the parent node for all
    ...
    /**
     * Constructs and throws a WrongNumberArgException with the appropriate message for this
     * function object. This class supports an arbitrary number of arguments, so this method must
     * never be called.
     *
     * @throws WrongNumberArgsException
     */
