...
/**
 * The XPathImpl class provides implementation for the methods defined in javax.xml.xpath.XPath
 * interface. This provides simple access to the results of an XPath expression.
 *
 * @author Ramesh Mandava
 *     <p>Updated 12/04/2014: New methods: evaluateExpression Refactored to share code with
...
public class XPathImpl extends XPathImplUtil implements javax.xml.xpath.XPath {
    ...
    private XObject eval(String expression, Object contextItem) throws TransformerException {
        ...
        XPath xpath =
                new XPath(expression, null, prefixResolver, XPath.SELECT, null, null, xmlSecMgr);
    ...
    public XPathExpression compile(String expression) throws XPathExpressionException {
        ...
        try {
            XPath xpath =
                    new XPath(
                            expression, null, prefixResolver, XPath.SELECT, null, null, xmlSecMgr);
