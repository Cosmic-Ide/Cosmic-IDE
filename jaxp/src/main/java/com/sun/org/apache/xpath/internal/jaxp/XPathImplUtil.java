 ...
 * XPathExpressionImpl @LastModified: Jan 2022
 */
class XPathImplUtil {
        ...
        if (contextItem == null && xpath.getExpression() instanceof LocPathIterator) {
            ...
            throw new TransformerException(
                    XSLMessages.createXPATHMessage(
                            XPATHErrorResources.ER_CONTEXT_CAN_NOT_BE_NULL, new Object[] {}));
        }
     ...
     * @throws TransformerException if the result can not be converted to the specified return type.
     */
    ...
    /**
     * Construct an XPathExpressionResult object based on the result of the evaluation and cast to
     * the specified class type.
     *
     * @param <T> The class type
     * @param resultObject the result of an evaluation
     * @param type The class type expected to be returned by the XPath expression.
     * @return an instance of the specified type or null if the XObject returned an UNKNOWN object
     *     type.
     * @throws TransformerException if there is an error converting the result to the specified
     *     type. It's unlikely to happen. This is mostly needed by the internal XPath engine.
     */
    ...
    <T> void requireNonNull(T param, String paramName) {
        if (param == null) {
            String fmsg =
                    XSLMessages.createXPATHMessage(
                            XPATHErrorResources.ER_ARG_CANNOT_BE_NULL, new Object[] {paramName});
