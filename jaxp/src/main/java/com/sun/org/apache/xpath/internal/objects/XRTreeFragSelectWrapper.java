...
/**
 * This class makes an select statement act like an result tree fragment. @LastModified: Apr 2022
 */
public class XRTreeFragSelectWrapper extends XRTreeFrag implements Cloneable {
    ...
    public DTMIterator asNodeIterator() {
        throw new RuntimeException(
                XSLMessages.createXPATHMessage(
                        XPATHErrorResources.ER_ASNODEITERATOR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER,
