...
public class NodeTest extends Expression {
    ...
    /**
     * Statically calculated score for this test. One of {@link #SCORE_NODETEST}, {@link
     * #SCORE_NONE}, {@link #SCORE_NSWILD}, {@link #SCORE_QNAME}, or {@link #SCORE_OTHER}.
     *
     * @serial
     */
    XNumber m_score;
     ...
     *
     * @see <a href="http://www.w3.org/TR/xslt#conflict">XSLT Specification - 5.5 Conflict
     *     Resolution for Template Rules</a>
     */
    ...
    /**
     * Initialize this node test by setting the whatToShow property and the namespace and local
     * name, and calculating the score that this test will return if a test succeeds.
     *
     * @param whatToShow Bit set defined mainly by {@link org.w3c.dom.traversal.NodeFilter}.
     * @param namespace The namespace to be tested.
     * @param name The local name to be tested.
     ...
     * @return the node type for the whatToShow. Since whatToShow can specify multiple types, it
     *     will return the first bit tested that is on, so the caller of this function should take
     *     care that this is the function they really want to call. If none of the known bits are
     *     set, this function will return zero.
     */
