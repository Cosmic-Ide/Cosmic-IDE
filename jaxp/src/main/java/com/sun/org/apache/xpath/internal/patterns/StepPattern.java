...
public class StepPattern extends NodeTest implements SubContextList, ExpressionOwner {
    ...
    /**
     * Calculate the local name or psuedo name of the node that this pattern will test, for hash
    ...
    public void calcTargetString() {
        ...
        switch (whatToShow) {
            ...
            case DTMFilter.SHOW_ELEMENT:
                if (WILD.equals(m_name)) m_targetString = PsuedoNames.PSEUDONAME_ANY;
     ...
     * @return {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_NODETEST}, {@link
     *     com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_NONE}, {@link
     *     com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_NSWILD}, {@link
     *     com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_QNAME}, or {@link
     ...
     * node that can pass this test in the sub context selection. In XSLT 1-based indexing, this
     ...
     *
     * @return A string representation of this step, built by reverse-engineering the contained
     *     info.
     */
    ...
    /**
     * Call the visitors on the subtree. Factored out from callVisitors so it may be called by
     * derived classes.
     */
