            ...
            new Object[][] {
                ...
                {ER_CURRENT_TAKES_NO_ARGS, "La fonction current() n'accepte pas d'argument."},
                {
                    ...
                    "L'impl\u00E9mentation de la fonction document() a \u00E9t\u00E9 remplac\u00E9e"
                        + " par com.sun.org.apache.xalan.internal.xslt.FuncDocument."
                },
                {
                    ER_CONTEXT_CAN_NOT_BE_NULL,
                    "Le contexte ne peut pas \u00EAtre NULL lorsque l'op\u00E9ration en"
                        + " d\u00E9pend."
                },
                {
                ...
                {ER_ERROR_OCCURED, "Une erreur est survenue."},
                {
                ...
                // ORDERED_NODE_SNAPSHOT_TYPE.
                {
                    ...
                    "La m\u00E9thode getSnapshotLength ne peut pas \u00EAtre appel\u00E9e sur"
                        + " l''\u00E9l\u00E9ment XPathResult de l''expression XPath ''{0}'' car son"
                        + " \u00E9l\u00E9ment XPathResultType est {1}. Cette m\u00E9thode est"
                        + " applicable uniquement aux types UNORDERED_NODE_SNAPSHOT_TYPE et"
                        + " ORDERED_NODE_SNAPSHOT_TYPE."
                },
                {
                    ER_NON_ITERATOR_TYPE,
                    "La m\u00E9thode iterateNext ne peut pas \u00EAtre appel\u00E9e sur"
                        + " l''\u00E9l\u00E9ment XPathResult de l''expression XPath ''{0}'' car son"
                        + " \u00E9l\u00E9ment XPathResultType est {1}. Cette m\u00E9thode est"
                        + " applicable uniquement aux types UNORDERED_NODE_ITERATOR_TYPE et"
                ...
                // UNORDERED_NODE_SNAPSHOT_TYPE and ORDERED_NODE_SNAPSHOT_TYPE.
                {
                    ...
                    "La m\u00E9thode snapshotItem ne peut pas \u00EAtre appel\u00E9e sur"
                        + " l''\u00E9l\u00E9ment XPathResult de l''expression XPath ''{0}'' car son"
                        + " \u00E9l\u00E9ment XPathResultType est {1}. Cette m\u00E9thode est"
                        + " applicable uniquement aux types UNORDERED_NODE_SNAPSHOT_TYPE et"
                        + " ORDERED_NODE_SNAPSHOT_TYPE."
