 ...
 *
 * @xsl.usage advanced @LastModified: May 2022
 */
public class XPATHErrorResources_it extends ListResourceBundle {
    ...
    public static final String ER_SOURCE_RETURN_TYPE_CANNOT_BE_NULL =
    ...
    private static final Object[][] _contents =
            new Object[][] {
                {"ERROR0000", "{0}"},
                {
                    ...
                    "La funzione current() non \u00E8 consentita in un pattern di corrispondenza."
                },
                {ER_CURRENT_TAKES_NO_ARGS, "La funzione current() non accetta argomenti."},
                {
                    ER_DOCUMENT_REPLACED,
                    "L'implementazione della funzione document() \u00E8 stata sostituita da"
                        + " com.sun.org.apache.xalan.internal.xslt.FuncDocument."
                },
                {
                    ER_CONTEXT_CAN_NOT_BE_NULL,
                    "Il contesto non pu\u00F2 essere nullo quando l'operazione dipende dal"
                        + " contesto."
                },
                {
                ...
                {ER_LOCALNAME_HAS_TOO_MANY_ARGS, "local-name() contiene troppi argomenti."},
                ...
                {ER_TRANSLATE_TAKES_3_ARGS, "La funzione translate() ha tre argomenti."},
                {
                    ER_UNPARSEDENTITYURI_TAKES_1_ARG,
                ...
                {ER_UNKNOWN_MATCH_OPERATION, "operazione di corrispondenza sconosciuta."},
                {
                    ...
                    "La lunghezza degli argomenti del testo del nodo processing-instruction()"
                        + " \u00E8 errata."
                },
                {ER_CANT_CONVERT_TO_NUMBER, "Impossibile convertire {0} in un numero"},
                {ER_CANT_CONVERT_TO_NODELIST, "Impossibile convertire {0} in NodeList."},
                {ER_CANT_CONVERT_TO_MUTABLENODELIST, "Impossibile convertire {0} in NodeSetDTM."},
                {ER_CANT_CONVERT_TO_TYPE, "Impossibile convertire {0} in type#{1}"},
                {
                    ER_EXPECTED_MATCH_PATTERN,
                    "\u00C8 previsto un pattern di corrispondenza in getMatchScore."
                },
                {ER_COULDNOT_GET_VAR_NAMED, "Impossibile recuperare la variabile denominata {0}"},
                {ER_UNKNOWN_OPCODE, "ERRORE. Codice di operazione sconosciuto: {0}"},
                {ER_EXTRA_ILLEGAL_TOKENS, "Esistono altri token non validi: {0}"},
                {ER_EXPECTED_DOUBLE_QUOTE, "valore non tra apici... sono previste le virgolette."},
                {ER_EXPECTED_SINGLE_QUOTE, "valore non tra apici... \u00E8 previsto un apice."},
                ...
                {
                    ER_BOOLEAN_ARG_NO_LONGER_OPTIONAL,
                    "L'argomento boolean(...) non \u00E8 pi\u00F9 facoltativo nella bozza XPath"
                        + " 19990709."
                },
                {
                    ER_FOUND_COMMA_BUT_NO_PRECEDING_ARG,
                ...
                },
                {
                    ...
                    "'..[predicate]' o '.[predicate]' \u00E8 una sintassi non valida.  Utilizzare"
                        + " 'self::node()[predicate]'."
                },
                {ER_ILLEGAL_AXIS_NAME, "nome asse non valido: {0}"},
                {ER_UNKNOWN_NODETYPE, "Tipo di nodo sconosciuto: {0}"},
                {
                    ER_PATTERN_LITERAL_NEEDS_BE_QUOTED,
                    "Il valore del pattern ({0}) deve essere compreso tra apici."
                },
                {ER_COULDNOT_BE_FORMATTED_TO_NUMBER, "Impossibile formattare {0} in un numero."},
                {
                    ER_COULDNOT_CREATE_XMLPROCESSORLIAISON,
                ...
                },
                {
                    ...
                    "Errore. L'espressione di selezione dell'xpath (-select) non \u00E8 stata"
                        + " trovata."
                },
                {
                    ER_COULDNOT_FIND_ENDOP_AFTER_OPLOCATIONPATH,
                ...
                {ER_ERROR_OCCURED, "Si \u00E8 verificato un errore."},
                {
                    ER_ILLEGAL_VARIABLE_REFERENCE,
                    "Il valore di VariableReference specificato per la variabile \u00E8 fuori"
                        + " contesto o senza definizione. Nome = {0}"
                },
                {
                    ER_AXES_NOT_ALLOWED,
                    "Solo gli assi child:: e attribute:: sono consentiti nei pattern di"
                        + " corrispondenza. Assi errati = {0}"
                },
                {ER_KEY_HAS_TOO_MANY_ARGS, "key() contiene un numero di argomenti errato."},
                {ER_COUNT_TAKES_1_ARG, "La funzione count deve avere un solo argomento."},
                {ER_COULDNOT_FIND_FUNCTION, "Impossibile trovare la funzione {0}"},
                {ER_UNSUPPORTED_ENCODING, "Codifica non supportata: {0}"},
                {
                    ER_PROBLEM_IN_DTM_NEXTSIBLING,
                    "Si \u00E8 verificato un problema in DTM in getNextSibling... Tentativo di"
                        + " recupero in corso."
                },
                {
                    ER_CANNOT_WRITE_TO_EMPTYNODELISTIMPL,
                ...
                {ER_SETDOMFACTORY_NOT_SUPPORTED, "setDOMFactory non supportato da XPathContext"},
                {
                ...
                },
                {
                    ...
                    "analisi (origine InputSource) non supportata in XPathContext. Impossibile"
                        + " aprire {0}."
                },
                {ER_SAX_API_NOT_HANDLED, "Caratteri API SAX (char ch[]... non gestiti da DTM."},
                {
                    ER_IGNORABLE_WHITESPACE_NOT_HANDLED,
                    "ignorableWhitespace(char ch[]... non gestito da DTM."
                },
                {ER_DTM_CANNOT_HANDLE_NODES, "DTMLiaison non pu\u00F2 gestire i nodi di tipo {0}"},
                {
                ...
                {ER_CANNOT_CREATE_URL, "Impossibile creare l''URL per {0}"},
                {ER_XPATH_READOBJECT, "In XPath.readObject: {0}"},
                {ER_FUNCTION_TOKEN_NOT_FOUND, "token di funzione non trovato."},
                {ER_CANNOT_DEAL_XPATH_TYPE, "Impossibile utilizzare il tipo XPath: {0}"},
                {ER_NODESET_NOT_MUTABLE, "Impossibile modificare questo NodeSet"},
                {ER_NODESETDTM_NOT_MUTABLE, "Impossibile modificare questo NodeSetDTM"},
                {ER_VAR_NOT_RESOLVABLE, "Impossibile risolvere la variabile: {0}"},
                {ER_NULL_ERROR_HANDLER, "Handler degli errori nullo"},
                {
                    ER_PROG_ASSERT_UNKNOWN_OPCODE,
                    "Asserzione del programmatore: opcode {0} sconosciuto"
                },
                {ER_ZERO_OR_ONE, "0 o 1"},
                {
                    ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER,
                ...
                {ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS, "fsb() non supportato per XStringForChars"},
                {ER_COULD_NOT_FIND_VAR, "Impossibile trovare la variabile con nome {0}"},
                {
                    ER_XSTRINGFORCHARS_CANNOT_TAKE_STRING,
                ...
                },
                {
                    ...
                    "Questo NodeSetDTM non pu\u00F2 eseguire l'indicizzazione o il conteggio delle"
                        + " funzioni."
                },
                {
                    ER_NODESET_CANNOT_INDEX,
                    "Questo NodeSet non pu\u00F2 eseguire l'indicizzazione o il conteggio delle"
                        + " funzioni."
                },
                {
                    ER_CANNOT_CALL_SETSHOULDCACHENODE,
                ...
                {ER_ONLY_ALLOWS, "{0} consente solo {1} argomenti"},
                {
                    ER_UNKNOWN_STEP,
                ...
                // the characters specified by the substitution text were encountered instead.
                {
                    ...
                    "\u00C8 previsto un percorso di posizione, ma \u00E8 stato trovato il seguente"
                        + " token:  {0}"
                },
                ...
                {
                    ER_EXPECTED_LOC_PATH_AT_END_EXPR,
                    "\u00C8 previsto un percorso di posizione, ma \u00E8 stata trovata la fine"
                ...
                // The message indicates that syntactically such an expression was expected,
                // but was not found.
                {ER_EXPECTED_REL_PATH_PATTERN, "\u00C8 previsto un pattern di percorso relativo."},
                ...
                // to a value of type boolean.
                {
                    ...
                    "XPathResult dell''espressione XPath ''{0}'' a un valore di XPathResultType"
                        + " pari a {1} che non pu\u00F2 essere convertito in un valore booleano."
                },
                ...
                // FIRST_ORDERED_NODE_TYPE.
                {
                    ...
                    "XPathResult dell''espressione XPath ''{0}'' a un valore di XPathResultType"
                        + " pari a {1} che non pu\u00F2 essere convertito in un nodo singolo. Il"
                        + " metodo getSingleNodeValue \u00E8 valido solo per i tipi"
                        + " ANY_UNORDERED_NODE_TYPE e FIRST_ORDERED_NODE_TYPE."
                },
                ...
                // ORDERED_NODE_SNAPSHOT_TYPE.
                {
                    ...
                    "Impossibile richiamare il metodo getSnapshotLength nell''XPathResult"
                        + " dell''espressione XPath ''{0}'' poich\u00E9 il valore di"
                        + " XPathResultType \u00E8 {1}. Questo metodo \u00E8 valido solo per i tipi"
                        + " UNORDERED_NODE_SNAPSHOT_TYPE e ORDERED_NODE_SNAPSHOT_TYPE."
                },
                {
                    ER_NON_ITERATOR_TYPE,
                    "Impossibile richiamare il metodo iterateNext nell''XPathResult"
                        + " dell''espressione XPath ''{0}'' poich\u00E9 il valore di"
                        + " XPathResultType \u00E8 {1}. Questo metodo \u00E8 valido solo per i tipi"
                        + " UNORDERED_NODE_ITERATOR_TYPE e ORDERED_NODE_ITERATOR_TYPE."
                },
                ...
                {
                    ER_DOC_MUTATED,
                    "Il documento \u00E8 cambiato da quando \u00E8 stato restituito l'ultimo"
                        + " risultato. L'iteratore non \u00E8 valido."
                },
                {ER_INVALID_XPATH_TYPE, "Tipo di argomento XPath non valido: {0}"},
                {ER_EMPTY_XPATH_RESULT, "Oggetto risultati XPath vuoto"},
                {
                    ER_INCOMPATIBLE_TYPES,
                    "XPathResult dell''espressione XPath ''{0}'' a un valore di XPathResultType"
                        + " pari a {1} che non pu\u00F2 essere convertito forzatamente nel valore"
                        + " XPathResultType {2}."
                },
                {
                    ER_NULL_RESOLVER,
                ...
                // to a value of type string.
                {
                    ...
                    "XPathResult dell''espressione XPath ''{0}'' a un valore di XPathResultType"
                        + " pari a {1} che non pu\u00F2 essere convertito in una stringa."
                },
                ...
                // UNORDERED_NODE_SNAPSHOT_TYPE and ORDERED_NODE_SNAPSHOT_TYPE.
                {
                    ...
                    "Impossibile richiamare il metodo snapshotItem nell''XPathResult"
                        + " dell''espressione XPath ''{0}'' poich\u00E9 il valore di"
                        + " XPathResultType \u00E8 {1}. Questo metodo \u00E8 valido solo per i tipi"
                        + " UNORDERED_NODE_SNAPSHOT_TYPE e ORDERED_NODE_SNAPSHOT_TYPE."
                },
                ...
                {
                    ER_WRONG_DOCUMENT,
                    "Il nodo di contesto non appartiene al documento associato a questo"
                        + " XPathEvaluator."
                },

                // Note to translators:  The XPath expression cannot be evaluated with respect
                // to this type of node.
                {ER_WRONG_NODETYPE, "Il tipo di nodo di contesto non \u00E8 supportato."},
                {ER_XPATH_ERROR, "Errore sconosciuto nell'XPath."},
                {
                    ER_CANT_CONVERT_XPATHRESULTTYPE_TO_NUMBER,
                    "XPathResult dell''espressione XPath ''{0}'' a un valore di XPathResultType"
                        + " pari a {1} che non pu\u00F2 essere convertito in un numero."
                },
                ...
                {
                    ER_EXTENSION_FUNCTION_CANNOT_BE_INVOKED,
                    "Impossibile richiamare la funzione di estensione ''{0}'' se la funzione"
                        + " XMLConstants.FEATURE_SECURE_PROCESSING \u00E8 impostata su true."
                },
                ...
                {ER_UNSUPPORTED_RETURN_TYPE, "Tipo restituito non supportato: {0}"},
                ...
                {ER_ARG_CANNOT_BE_NULL, "L''argomento {0} non pu\u00F2 essere nullo"},

                /** Field ER_OBJECT_MODEL_NULL */
                {
                    ER_OBJECT_MODEL_NULL,
                    "{0}#isObjectModelSupported( String objectModel ) non pu\u00F2 essere"
                        + " richiamato se objectModel == null"
                },
                ...
                },
                {
                    ...
                    "FEATURE_SECURE_PROCESSING: impossibile impostare la funzione su false se"
                        + " \u00E8 presente Security Manager: {1}#setFeature({0},{2})"
                },

                /** Field ER_NULL_XPATH_FUNCTION_RESOLVER */
                {
                    ER_NULL_XPATH_FUNCTION_RESOLVER,
                    "Tentativo di impostare un valore  nullo per"
...

                {
                    ...
                    "il nome di impostazioni nazionali nella funzione format-number non \u00E8"
                        + " ancora gestito."
                },
                {WG_PROPERTY_NOT_SUPPORTED, "Propriet\u00E0 XSL non supportata: {0}"},
                {
                    WG_DONT_DO_ANYTHING_WITH_NS,
                    "Non effettuare alcuna operazione sullo spazio di nomi {0} nella"
                        + " propriet\u00E0: {1}"
                },
                {
                    WG_SECURITY_EXCEPTION,
                    "SecurityException nel tentativo di accedere alla propriet\u00E0 di sistema XSL"
                        + " {0}"
                },
                {
                ...
                {WG_FUNCTION_TOKEN_NOT_FOUND, "token di funzione non trovato."},
                {WG_COULDNOT_FIND_FUNCTION, "Impossibile trovare la funzione {0}"},
                {WG_CANNOT_MAKE_URL_FROM, "Impossibile creare un URL da {0}"},
                {WG_EXPAND_ENTITIES_NOT_SUPPORTED, "Opzione -E non supportata per il parser DTM"},
                {
                ...
                {
                    "optionMatch",
                    "   [-match match pattern (per la diagnostica delle corrispondenze)]"
                },
                {
                    "optionAnyExpr",
                    "In alternativa, un'espressione xpath eseguir\u00E0 il dump della diagnostica."
                },
