    ...
    private static final Object[][] _contents =
            new Object[][] {
                ...
                },
                {
                    ...
                    "Kontexten kan inte vara null n\u00E4r \u00E5tg\u00E4rden \u00E4r"
                        + " kontextberoende."
                },
                ...
                {ER_EXTRA_ILLEGAL_TOKENS, "Extra otill\u00E5tna tecken: {0}"},
                {
                ...
                {ER_UNSUPPORTED_ENCODING, "Kodning utan st\u00F6d: {0}"},
                {
                ...
                {ER_FUNCTION_TOKEN_NOT_FOUND, "funktionstecken hittades inte."},
                ...
                // ORDERED_NODE_SNAPSHOT_TYPE.
                {
                    ...
                    "Metoden getSnapshotLength kan inte anropas vid XPathResult fr\u00E5n"
                        + " XPath-uttrycket ''{0}'' eftersom XPathResultType \u00E4r {1}. Metoden"
                        + " anv\u00E4nds endast till typ UNORDERED_NODE_SNAPSHOT_TYPE och"
                        + " ORDERED_NODE_SNAPSHOT_TYPE."
                },
                {
                ...
                // Note to translators:  The XPath expression cannot be evaluated with respect
                // to this type of node.
                {ER_WRONG_NODETYPE, "Kontextnodtypen st\u00F6ds inte."},
                {ER_XPATH_ERROR, "Ok\u00E4nt fel i XPath."},
                {
                    ER_CANT_CONVERT_XPATHRESULTTYPE_TO_NUMBER,
                    "XPathResult i XPath-uttrycket ''{0}'' inneh\u00E5ller XPathResultType {1} som"
                ...
                {ER_ARG_CANNOT_BE_NULL, "Argumentet {0} kan inte vara null"},
...

                {
                    ...
                    "spr\u00E5kkonventionsnamnet i funktionen format-number har \u00E4nnu inte"
                        + " hanterats!"
                },
