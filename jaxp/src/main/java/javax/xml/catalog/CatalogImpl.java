...
class CatalogImpl extends GroupEntry implements Catalog {
    ...
    */
     ...
     * @throws CatalogException If an error happens while parsing the specified catalog file.
     */
    ...
    public CatalogImpl(CatalogImpl parent, CatalogFeatures f, URI... uris) throws CatalogException {
        ...
        if (f == null) {
            throw new NullPointerException(
                    formatMessage(
                            CatalogMessages.ERR_NULL_ARGUMENT, new Object[] {"CatalogFeatures"}));
        }
                ...
                if (verifyCatalogFile(null, uri)) {
                    ...
                    try {
                        ...
                        CatalogMessages.reportRunTimeError(
                                CatalogMessages.ERR_INVALID_PATH, new Object[] {temp}, e);
                    }
                    break;
                }
            }
    ...
    public void reset() {
        ...
        entries.stream()
                .filter((entry) -> (entry.type == CatalogEntryType.GROUP))
                .forEach(
                        (entry) -> {
    ...
    /**
     * Sets the defer property. If the value is null or empty, or any String other than the defined,
     * it will be assumed as the default value.
     *
    ...
    /**
     * Sets the resolve property. If the value is null or empty, or any String other than the
                    ...
                    private Catalog nextCatalog() {
                        ...
                        if (c == null && inputFiles != null) {
                            while (c == null && inputFilesIndex < inputFiles.size()) {
                                c = getCatalog(null, URI.create(inputFiles.get(inputFilesIndex++)));
                            }
                        }
     ...
     *
     * @param parent the parent catalog for the alternative catalogs to be loaded. It will be null
     *     if the ones to be loaded are from the input list.
