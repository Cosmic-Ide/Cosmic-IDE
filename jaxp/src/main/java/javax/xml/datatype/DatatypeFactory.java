...
/**
 * Factory that creates new {@code javax.xml.datatype} {@code Object}s that map XML to/from Java
 * {@code Object}s.
 *
 * <p id="DatatypeFactory.newInstance">A new instance of the {@code DatatypeFactory} is created
 * through the {@link #newInstance()} method that uses the <a
 * href="../../../module-summary.html#LookupMechanism">JAXP Lookup Mechanism</a> to determine the
 * {@code DatatypeFactory} implementation class to load.
 *
...
public abstract class DatatypeFactory {
     ...
     * #DATATYPEFACTORY_IMPLEMENTATION_CLASS builtin system-default implementation}.
     *
     * @return A new instance of the {@code DatatypeFactory} builtin system-default implementation.
     * @since 9
     */
    ...
    /**
     * Obtain a new instance of a {@code DatatypeFactory}. This method uses the <a
     * href="../../../module-summary.html#LookupMechanism">JAXP Lookup Mechanism</a> to determine
     * the {@code DatatypeFactory} implementation class to load.
     *
     * @return New instance of a {@code DatatypeFactory}
     * @throws DatatypeConfigurationException If the implementation is not available or cannot be
     *     instantiated.
    ...
    /**
     * Obtain a new instance of a {@code DatatypeFactory} from class name. This function is useful
     * when there are multiple providers in the classpath. It gives more control to the application
     * as it can specify which provider should be loaded.
     *
     * <p>Once an application has obtained a reference to a {@code DatatypeFactory} it can use the
     * factory to configure and obtain datatype instances.
     *
    ...
    /**
     * Obtain a new instance of a {@code Duration} specifying the {@code Duration} as its string
     ...
     * @throws IllegalArgumentException If {@code lexicalRepresentation} is not a valid
     ...
     * available using the {@code get} methods of the created {@link Duration}. The values conform
     * to and are defined by:
     *
     * <ul>
    ...
    /**
     * Obtain a new instance of a {@code Duration} specifying the {@code Duration} as isPositive,
     ...
     *
     * @param isPositive Set to {@code false} to create a negative duration. When the length of the
     *     duration is zero, this parameter will be ignored.
     ...
     *     Duration}: if all the fields (years, months, ...) are null or if any of the fields is
     *     negative.
     * @throws UnsupportedOperationException If implementation cannot support requested values.
     */
    ...
    /**
     * Create a {@code Duration} of type {@code xdt:dayTimeDuration} by parsing its {@code String}
     * representation, "<em>PnDTnHnMnS</em>", <a
     * href="http://www.w3.org/TR/xpath-datamodel#dayTimeDuration">XQuery 1.0 and XPath 2.0 Data
     * Model, xdt:dayTimeDuration</a>.
     *
     * <p>The datatype {@code xdt:dayTimeDuration} is a subtype of {@code xs:duration} whose lexical
     * representation contains only day, hour, minute, and second components. This datatype resides
     * in the namespace {@code http://www.w3.org/2003/11/xpath-datatypes}.
     *
     ...
     * @throws IllegalArgumentException If {@code lexicalRepresentation} is not a valid
     *     representation of a {@code Duration} expressed only in terms of days and time.
     * @throws UnsupportedOperationException If implementation cannot support requested values.
     * @throws NullPointerException If {@code lexicalRepresentation} is {@code null}.
     */
    ...
    /**
     * Create a {@code Duration} of type {@code xdt:dayTimeDuration} using the specified {@code
     * day}, {@code hour}, {@code minute} and {@code second} as defined in <a
     * href="http://www.w3.org/TR/xpath-datamodel#dayTimeDuration">XQuery 1.0 and XPath 2.0 Data
     * Model, xdt:dayTimeDuration</a>.
     *
     * <p>The datatype {@code xdt:dayTimeDuration} is a subtype of {@code xs:duration} whose lexical
     ...
     * @return New {@code Duration} created with the specified {@code day}, {@code hour}, {@code
     *     minute} and {@code second}.
     * @throws IllegalArgumentException If the values are not a valid representation of a {@code
     *     Duration}: if all the fields (day, hour, ...) are null or if any of the fields is
     *     negative.
     * @throws UnsupportedOperationException If implementation cannot support requested values.
     */
    ...
    /**
     * Create a {@code Duration} of type {@code xdt:yearMonthDuration} by parsing its {@code String}
     * representation, "<em>PnYnM</em>", <a
     * href="http://www.w3.org/TR/xpath-datamodel#yearMonthDuration">XQuery 1.0 and XPath 2.0 Data
     * Model, xdt:yearMonthDuration</a>.
     *
     * <p>The datatype {@code xdt:yearMonthDuration} is a subtype of {@code xs:duration} whose
     * lexical representation contains only year and month components. This datatype resides in the
     * namespace {@link javax.xml.XMLConstants#W3C_XPATH_DATATYPE_NS_URI}.
     *
     ...
     * @return New {@code Duration} created using the specified {@code lexicalRepresentation}.
     * @throws IllegalArgumentException If {@code lexicalRepresentation} is not a valid
     *     representation of a {@code Duration} expressed only in terms of years and months.
     * @throws UnsupportedOperationException If implementation cannot support requested values.
     * @throws NullPointerException If {@code lexicalRepresentation} is {@code null}.
     */
    ...
    /**
     * Create a {@code Duration} of type {@code xdt:yearMonthDuration} using the specified {@code
     * year} and {@code month} as defined in <a
     * href="http://www.w3.org/TR/xpath-datamodel#yearMonthDuration">XQuery 1.0 and XPath 2.0 Data
     * Model, xdt:yearMonthDuration</a>.
     *
     * <p>The XML Schema specification states that values can be of an arbitrary size.
     ...
     * @throws IllegalArgumentException If the values are not a valid representation of a {@code
     *     Duration}: if all of the fields (year, month) are null or if any of the fields is
     *     negative.
     * @throws UnsupportedOperationException If implementation cannot support requested values.
     */
     ...
     *
     * @return New {@code XMLGregorianCalendar} with all date/time datatype fields set to {@link
     ...
     * @throws IllegalArgumentException If the {@code lexicalRepresentation} is not a valid {@code
     ...
     * java.util.GregorianCalendar} daylight savings timezone id in the XML Schema 1.0 date/time
     * datatype representation.
     *
     * <p>To compute the return value's {@code TimeZone} field,
     *
     * <ul>
     *   <li>when {@code this.getTimezone() != FIELD_UNDEFINED}, create a {@code java.util.TimeZone}
     *       with a custom timezone id using the {@code this.getTimezone()}.
     ...
     * for xsd:dateTime and related builtin datatypes. Note that {@code year} parameter supports
     ...
     *     XMLGregorianCalendar} instance as determined by {@link XMLGregorianCalendar#isValid()}.
     */
    public abstract XMLGregorianCalendar newXMLGregorianCalendar(
    ...
    /**
     * Constructor of value spaces that a {@code java.util.GregorianCalendar} instance would need to
     * convert to an {@code XMLGregorianCalendar} instance.
     *
     * <p>{@code XMLGregorianCalendar eon} and {@code fractionalSecond} are set to {@code null}
     *
     * <p>A {@link DatatypeConstants#FIELD_UNDEFINED} value indicates that field is not set.
     *
     * @param year of {@code XMLGregorianCalendar} to be created.
     ...
     *
     * <p>For example, an instance of {@code gYear} can be created invoking this factory with {@code
     * month} and {@code day} parameters set to {@link DatatypeConstants#FIELD_UNDEFINED}.
     *
     * <p>A {@link DatatypeConstants#FIELD_UNDEFINED} value indicates that field is not set.
     *
     * @param year of {@code XMLGregorianCalendar} to be created.
