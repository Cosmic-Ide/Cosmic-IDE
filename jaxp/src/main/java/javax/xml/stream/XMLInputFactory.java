 ...
 *
 * <p>The following table defines the standard properties of this specification. Each property
 * varies in the level of support required by each implementation. The level of support required is
...
public abstract class XMLInputFactory {
    /**
     * The property used to turn on/off namespace support, this is to support XML 1.0 documents,
    ...
    /**
     * Requires the parser to replace internal entity references with their replacement text and
    ...
    /** Protected constructor to prevent instantiation. Use {@link #newFactory()} instead. */
    protected XMLInputFactory() {}

    /**
     * Creates a new instance of the {@code XMLInputFactory} builtin system-default implementation.
     *
     * @return A new instance of the {@code XMLInputFactory} builtin system-default implementation.
     * @since 9
     */
    ...
    /**
     * Creates a new instance of the factory in exactly the same manner as the {@link #newFactory()}
     * method.
     *
    ...
    /**
     * Creates a new instance of the factory. This method uses the <a
     * href="../../../module-summary.html#LookupMechanism">JAXP Lookup Mechanism</a> to determine
     * the {@code XMLInputFactory} implementation class to load.
     *
     * <p>Once an application has obtained a reference to a {@code XMLInputFactory}, it can use the
     * factory to configure and obtain stream instances.
     *
     * @return an instance of the {@code XMLInputFactory}
     ...
     * @throws FactoryConfigurationError if an instance of this factory cannot be loaded
     * @deprecated This method has been deprecated to maintain API consistency. All newInstance
     *     methods have been replaced with corresponding newFactory methods. The replacement {@link
     *     #newFactory(java.lang.String, java.lang.ClassLoader)} method defines no changes in
     *     behavior.
     */
     ...
     *
     * <p>This method uses the following ordered lookup procedure to determine the XMLInputFactory
     * implementation class to load:
     *
     * <ul>
     *   <li>
     *       <p>Use the value of the system property identified by {@code factoryId}.
     *   <li>
     *       <p>Use the configuration file "stax.properties". The file is in standard {@link
     *       java.util.Properties} format and typically located in the {@code conf} directory of the
     *       Java installation. It contains the fully qualified name of the implementation class
     *       with the key being the system property defined above.
     *       <p>The stax.properties file is read only once by the implementation and its values are
     *       then cached for future use. If the file does not exist when the first attempt is made
     *       to read from it, no further attempts are made to check for its existence. It is not
     *       possible to change the value of any property in stax.properties after it has been read
     *       for the first time.
     *       <p>Use the jaxp configuration file "jaxp.properties". The file is in the same format as
     *       stax.properties and will only be read if stax.properties does not exist.
     *   <li>
     *       <p>If {@code factoryId} is "javax.xml.stream.XMLInputFactory", use the service-provider
     *       loading facility, defined by the {@link java.util.ServiceLoader} class, to attempt to
     *       {@linkplain java.util.ServiceLoader#load(java.lang.Class, java.lang.ClassLoader) locate
     *       and load} an implementation of the service using the specified {@code ClassLoader}. If
     *       {@code classLoader} is null, the {@linkplain
     ...
     *   <li>
     *       <p>Otherwise, throws a {@link FactoryConfigurationError}.
     * </ul>
     *
     * <p>Note that this is a new method that replaces the deprecated {@link
     * #newInstance(java.lang.String, java.lang.ClassLoader) newInstance(String factoryId,
     * ClassLoader classLoader)} method. No changes in behavior are defined by this replacement
     * method relative to the deprecated method.
     *
     * @apiNote The parameter factoryId defined here is inconsistent with that of other JAXP
     *     factories where the first parameter is fully qualified factory class name that provides
     ...
     * @return an instance of the {@code XMLStreamReader}
     * @throws UnsupportedOperationException if this method is not supported by this XMLInputFactory
     * @throws XMLStreamException if an error occurs
     */
    ...
    /**
     * Create a new XMLEventReader from an XMLStreamReader. After being used to construct the
     * XMLEventReader instance returned from this method the XMLStreamReader must not be used.
     *
    ...
    /**
     * The resolver that will be set on any XMLStreamReader or XMLEventReader created by this
     * factory instance.
     *
    ...
    /**
     * The reporter that will be set on any XMLStreamReader or XMLEventReader created by this
     * factory instance.
     *
    ...
    /**
     * Allows the user to set specific feature/property on the underlying implementation. The
     * underlying implementation is not required to support every setting of every property in the
     * specification and may use IllegalArgumentException to signal that an unsupported property may
     ...
     * javax.xml.XMLConstants#ACCESS_EXTERNAL_DTD} property.
     *
     * <ul>
     *   <li>
     *       <p>Access to external DTDs, external Entity References is restricted to the protocols
     *       specified by the property. If access is denied during parsing due to the restriction of
     *       this property, {@link javax.xml.stream.XMLStreamException} will be thrown by the {@link
     *       javax.xml.stream.XMLStreamReader#next()} or {@link
     *       javax.xml.stream.XMLEventReader#nextEvent()} method.
     * </ul>
     *
