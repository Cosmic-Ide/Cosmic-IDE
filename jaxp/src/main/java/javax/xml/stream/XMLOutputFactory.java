 ...
 *
 * <p>The property can be set with the following code line: {@code
 ...
 * StartElement. If the defaultNamespace is bound and in scope and the default namespace matches the
 ...
 * prefix will be removed during serialization.
 *
 ...
 * with a new prefix that is bound to the namespace URIs of those attributes.
 *
 ...
 * URI of the element or attribute using that prefix.
 *
 * @version 1.2
...
public abstract class XMLOutputFactory {
    ...
    /**
     * Creates a new instance of the {@code XMLOutputFactory} builtin system-default implementation.
     *
     * @return A new instance of the {@code XMLOutputFactory} builtin system-default implementation.
     * @since 9
     */
     ...
     * the {@code XMLOutputFactory} implementation class to load.
     *
     * <p>Once an application has obtained a reference to a {@code XMLOutputFactory}, it can use the
     ...
     * @throws FactoryConfigurationError if an instance of this factory cannot be loaded
     * @deprecated This method has been deprecated because it returns an instance of
     *     XMLInputFactory, which is of the wrong class. Use the new method {@link
     *     #newFactory(java.lang.String, java.lang.ClassLoader)} instead.
     */
     ...
     *
     * <p>This method uses the following ordered lookup procedure to determine the XMLOutputFactory
     ...
     *   <li>
     *       <p>If {@code factoryId} is "javax.xml.stream.XMLOutputFactory", use the
     *       service-provider loading facility, defined by the {@link java.util.ServiceLoader}
     *       class, to attempt to {@linkplain java.util.ServiceLoader#load(java.lang.Class,
     *       java.lang.ClassLoader) locate and load} an implementation of the service using the
     *       specified {@code ClassLoader}. If {@code classLoader} is null, the {@linkplain
     ...
     *     ClassLoader classLoader)} method. The original method was incorrectly defined to return
     *     XMLInputFactory.
     * @param factoryId Name of the factory to find, same as a property name
     * @param classLoader classLoader to use
     * @return the factory implementation
    ...
    public abstract XMLStreamWriter createXMLStreamWriter(
            java.io.OutputStream stream, String encoding) throws XMLStreamException;
