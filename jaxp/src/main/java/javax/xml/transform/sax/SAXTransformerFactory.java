...
public abstract class SAXTransformerFactory extends TransformerFactory {
     ...
     * value as an argument, the TransformerFactory returned from {@link
     * javax.xml.transform.TransformerFactory#newInstance} may be safely cast to a
    ...
    /**
     * If {@link javax.xml.transform.TransformerFactory#getFeature} returns true when passed this
     * value as an argument, the {@link #newXMLFilter(Source src)} and {@link
     * #newXMLFilter(Templates templates)} methods are supported.
     */
     ...
     * @throws TransformerConfigurationException If for some reason the TransformerHandler can not
     *     be created.
     */
     ...
     * @throws TransformerConfigurationException If for some reason the TransformerHandler cannot be
     *     created.
     */
     ...
     * @return A non-null reference to a TransformerHandler, that may be used as a ContentHandler
     *     for SAX parse events.
     * @throws TransformerConfigurationException If for some reason the TemplatesHandler cannot be
     *     created.
     */
