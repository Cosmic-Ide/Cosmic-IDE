...
/**
 * {@code XPath} provides access to the XPath evaluation environment and expressions. The XPath
 * evaluation is affected by the factors described in the following table.
 *
 * <p><a id="XPath-evaluation"></a>
 *
 * <table class="striped">
 ...
 * at any given time, and while the {@code evaluate} method is invoked, applications may not
 * recursively call the {@code evaluate} method.
 *
 * @author Norman Walsh
 * @author Jeff Suttor
...
public interface XPath {
     ...
     *
     * <p>{@code XPath} is reset to the same state as when it was created with {@link
     * XPathFactory#newXPath()}. {@code reset()} is designed to allow the reuse of existing {@code
     * XPath}s thus saving resources associated with the creation of new {@code XPath}s.
     *
     * <p>The reset {@code XPath} is not guaranteed to have the same {@link XPathFunctionResolver},
     * {@link XPathVariableResolver} or {@link NamespaceContext} {@code Object}s, e.g. {@link
     * Object#equals(Object obj)}. It is guaranteed to have a functionally equal {@code
     * XPathFunctionResolver}, {@code XPathVariableResolver} and {@code NamespaceContext}.
     */
    public void reset();
     ...
     *
     * <p>{@code null} is returned in no function resolver is in effect.
     *
     ...
     *
     * <p>If {@code expression} contains any {@link XPathFunction}s, they must be available via the
     * {@link XPathFunctionResolver}. An {@link XPathExpressionException} will be thrown if the
     * {@code XPathFunction} cannot be resovled with the {@code XPathFunctionResolver}.
     *
     * <p>If {@code expression} contains any variables, the {@link XPathVariableResolver} in effect
    ...
    /**
     * Evaluate an {@code XPath} expression in the specified context and return the result as the
     * specified type.
     *
     * <p>See <a href="#XPath-evaluation">Evaluation of XPath Expressions</a> for context item
     * evaluation, variable, function and {@code QName} resolution and return type conversion.
     *
     * <p>The parameter {@code item} represents the context the XPath expression will be operated
     * on. The type of the context is implementation-dependent. If the value is {@code null}, the
     * operation must have no dependency on the context, otherwise an XPathExpressionException will
     * be thrown.
     *
     ...
     * @return The result of evaluating an XPath expression as an {@code Object} of {@code
     *     returnType}.
     * @throws XPathExpressionException If {@code expression} cannot be evaluated.
     * @throws IllegalArgumentException If {@code returnType} is not one of the types defined in
     *     {@link XPathConstants} ( {@link XPathConstants#NUMBER NUMBER}, {@link
     *     XPathConstants#STRING STRING}, {@link XPathConstants#BOOLEAN BOOLEAN}, {@link
     *     XPathConstants#NODE NODE} or {@link XPathConstants#NODESET NODESET}).
    ...
    /**
     * Evaluate an XPath expression in the specified context and return the result as a {@code
     * String}.
     *
     * <p>This method calls {@link #evaluate(String expression, Object item, QName returnType)} with
     * a {@code returnType} of {@link XPathConstants#STRING}.
     *
     * <p>See <a href="#XPath-evaluation">Evaluation of XPath Expressions</a> for context item
    ...
    /**
     * Evaluate an XPath expression in the context of the specified {@code InputSource} and return
     ...
     * returnType)} with a {@code returnType} of {@link XPathConstants#STRING}.
     *
     * <p>See <a href="#XPath-evaluation">Evaluation of XPath Expressions</a> for context item
     * evaluation, variable, function and QName resolution and return type conversion.
     *
     ...
     * @return The {@code String} that is the result of evaluating the expression and converting the
     *     result to a {@code String}.
     * @throws XPathExpressionException If expression cannot be evaluated.
    ...
    /**
     * Evaluate an XPath expression in the specified context and return the result with the type
     * specified through the {@code class type}
     *
     * <p>The parameter {@code item} represents the context the XPath expression will be operated
     * on. The type of the context is implementation-dependent. If the value is {@code null}, the
     * operation must have no dependency on the context, otherwise an XPathExpressionException will
     ...
     * }</pre>
     *     Since the {@code evaluate} method does not support the {@link
     *     XPathEvaluationResult.XPathResultType#ANY ANY} type, specifying XPathEvaluationResult as
     *     the type will result in IllegalArgumentException. Any implementation supporting the
     *     {@link XPathEvaluationResult.XPathResultType#ANY ANY} type must override this method.
     * @param <T> The class type that will be returned by the XPath expression.
     * @param expression The XPath expression.
     * @param item The context the XPath expression will be evaluated in.
     * @param type The class type expected to be returned by the XPath expression, must be one of
     *     the types described in section <a href="package-summary.html#XPath.Datatypes.Class">3.2
     *     Class types</a> in the package summary.
     * @return The result of evaluating the expression.
     * @throws XPathExpressionException If the expression cannot be evaluated.
     * @throws IllegalArgumentException If {@code type} is not of the types corresponding to the
     *     types defined in the {@link XPathEvaluationResult.XPathResultType}, or
     *     XPathEvaluationResult is specified as the type but an implementation supporting the
    ...
    /**
     * Evaluate an XPath expression in the specified context. This is equivalent to calling {@link
     * #evaluateExpression(String expression, Object item, Class type)} with type {@link
     ...
     * }</pre>
     *     Since the {@code evaluate} method does not support the {@link
     *     XPathEvaluationResult.XPathResultType#ANY ANY} type, the default implementation of this
     *     method will always throw an IllegalArgumentException. Any implementation supporting the
     *     {@link XPathEvaluationResult.XPathResultType#ANY ANY} type must therefore override this
     *     method.
     * @param expression The XPath expression.
     * @param item The context the XPath expression will be evaluated in.
     * @return The result of evaluating the expression.
     * @throws XPathExpressionException If the expression cannot be evaluated.
     * @throws IllegalArgumentException If the implementation of this method does not support the
    ...
    /**
     * Evaluate an XPath expression in the context of the specified {@code source} and return the
     * result as specified.
     *
     * <p>This method builds a data model for the {@link InputSource} and calls {@link
     * #evaluateExpression(String expression, Object item, Class type)} on the resulting document
     * object. The data model is usually {@link org.w3c.dom.Document}
     *
     * @implSpec The default implementation in the XPath API is equivalent to:
     *     <pre>{@code
     ...
     * @throws XPathExpressionException If the expression cannot be evaluated.
     * @throws IllegalArgumentException If {@code type} is not of the types corresponding to the
     *     types defined in the {@link XPathEvaluationResult.XPathResultType XPathResultType}, or
     *     XPathEvaluationResult is specified as the type but an implementation supporting the
     *     {@link XPathEvaluationResult.XPathResultType#ANY ANY} type is not available.
