...
/**
 * The {@code XPathEvaluationResult} interface represents the result of the evaluation of an XPath
 * expression within the context of a particular node. The evaluation of an XPath expression can
 * result in various result types as defined in XML Path Language (XPath) Version 1.0.
 *
...
public interface XPathEvaluationResult<T> {
    ...
    /**
     * XPathResultType represents possible return types of an XPath evaluation. Provided as an enum
     * type, it allows the use of switch statement. At the same time, a mapping is provided between
     * the original QName types in {@link XPathConstants} and class types used in the generic
     * methods.
     */
    public static enum XPathResultType {
        /**
         * Any type that represents any of the 5 other types listed below. Maps to {@link
        ...
        /**
         * The XPath 1.0 Number data type. Maps to Java {@link Number}. Of the subtypes of Number,
         * only Double, Integer and Long are required.
         */
        ...
        /**
         * Returns the QName type as specified in {@link XPathConstants} that corresponds to the
         * specified class type.
         *
         * @param clsType a class type that the enum type supports
         * @return the QName type that matches with the specified class type, null if there is no
         *     match
         */
