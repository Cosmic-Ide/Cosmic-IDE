...
/**
 * {@code XPathFactoryConfigurationException} represents a configuration error in a {@code
 * XPathFactory} environment.
 *
 * @author Norman Walsh
 * @author Jeff Suttor
 * @since 1.5
...
public class XPathFactoryConfigurationException extends XPathException {
    ...
    /**
     * Constructs a new {@code XPathFactoryConfigurationException} with the specified detail {@code
     * message}.
     *
