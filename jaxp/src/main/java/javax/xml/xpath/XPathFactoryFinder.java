...
class XPathFactoryFinder {
     ...
     *
     * @param loader to be used to load resource and {@link XPathFactory} implementations during the
     *     resolution process. If this parameter is null, the default system class loader will be
     *     used.
     */
