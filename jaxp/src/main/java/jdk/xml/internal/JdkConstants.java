...
/**
 * This class holds constants shared across XML components. Historically, there had been a component
 * boundary within which some constants were duplicated for each component, such as Xerces and
 * Xalan.
 */
public final class JdkConstants {
     ...
     *
     * @deprecated Use {@code jdk.xml.} instead. Refer to specifications in the module summary.
     */
    @Deprecated(since = "17")
    ...
    /**
     * JDK node count limit in entities that limits the total number of nodes in all of entity
     * references.
     *
    ...
    /**
     * JDK property indicating whether the parser shall print out entity count information. Value: a
     * string "yes" means print, "no" or any other string means not.
     *
    ...
    /**
     * JDK TransformerFactory and Transformer attribute that specifies a class loader that will be
     * used for extension functions class loading Value: a "null", the default value, means that the
     * default EF class loading path will be used. Instance of ClassLoader: the specified instance
     * of ClassLoader will be used for extension functions loading during translation process
     */
     ...
     * For DOM Serializer.
     *
     * <p>Indicates that the serializer should treat the output as a standalone document. The JDK
     * specific standalone property controls whether a newline should be added after the XML header.
     *
     ...
     * For XSLTC.
     *
     * <p>Instructs the processor to act as if OutputKeys.STANDALONE is specified but without
     * writing it out in the declaration. This property may be used to mitigate the effect of Xalan
     ...
     *
     * <ul>
     *   <li><code>yes</code> to indicate the output is intended to be used as standalone
     *   <li><code>no</code> has no effect.
     * </ul>
     *
    ...
    /**
     * This property was added to align with those that used ORACLE_JAXP_PROPERTY_PREFIX as prefix.
     *
     * @deprecated Use {@link #SP_XSLTC_IS_STANDALONE} instead.
     */
    @Deprecated(since = "17")
    public static final String JDK_IS_STANDALONE =
            ORACLE_JAXP_PROPERTY_PREFIX + "xsltcIsStandalone";
    ...
    /**
     * jdk.xml.overrideDefaultParser: enables the use of a 3rd party's parser implementation to
     * override the system-default parser.
     */
    ...
    public static final boolean OVERRIDE_PARSER_DEFAULT =
            SecuritySupport.getJAXPSystemProperty(Boolean.class, OVERRIDE_PARSER, "false");

    /**
     * instructs the parser to return the data in a CData section in a single chunk when the
     * property is zero or unspecified, or in multiple chunks when it is greater than zero. The
     * parser shall split the data by linebreaks, and any chunks that are larger than the specified
     * size to ones that are equal to or smaller than the size.
     */
