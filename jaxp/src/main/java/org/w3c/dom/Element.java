...
public interface Element extends Node {
     ...
     *     support the feature <code>"XML"</code> and the language exposed through the Document does
     ...
     *     an XML name according to the XML version in use specified in the <code>
