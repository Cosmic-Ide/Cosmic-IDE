 ...
 *
 * <p>This class can contain basic error or warning information from either the XML parser or the
 * application: a parser writer or application writer can subclass it to provide additional
 * functionality. SAX handlers may throw this exception or any exception subclassed from it.
 *
 * <p>If the application needs to pass through other types of exceptions, it must wrap those
 * exceptions in a SAXException or an exception derived from a SAXException.
 *
 * <p>If the parser or application needs to include information about a specific location in an XML
 * document, it should use the {@link org.xml.sax.SAXParseException SAXParseException} subclass.
 *
 * @since 1.4, SAX 1.0
...
public class SAXException extends Exception {
     ...
     * default message for the SAXException.
     *
     ...
     *
     * <p>The existing exception will be embedded in the new one, but the new exception will have
     * its own message.
     *
     ...
     *
     * <p>If there is an embedded exception, and if the SAXException has no detail message of its
    ...
    /**
     * Reads the "exception" field from the stream. And initializes the "exception" if it wasn't
     * done before.
     *
