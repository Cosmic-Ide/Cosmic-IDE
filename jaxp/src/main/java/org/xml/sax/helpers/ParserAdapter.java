...
public class ParserAdapter implements XMLReader, DocumentHandler {
     ...
     *
     * @throws SAXException If the embedded driver cannot be instantiated or if the
     ...
     * @throws SAXNotRecognizedException If the feature can't be assigned or retrieved.
     * @throws SAXNotSupportedException If the feature can't be assigned that value.
     ...
     * @throws SAXNotSupportedException If the feature is not currently readable.
     * @see org.xml.sax.XMLReader#setFeature
     */
     ...
     * @throws SAXNotSupportedException If the property can't be assigned that value.
     ...
     * @throws SAXNotRecognizedException If the property value can't be assigned or retrieved.
     * @throws SAXNotSupportedException If the property value is not currently readable.
     ...
     * @throws java.io.IOException If there is a problem reading the raw content of the document.
                ...
                if (prefix != null) {
                    if (prefixes) {
                        if (uris)
                            ...
                            atts.addAttribute(
                                    NamespaceSupport.XMLNS, prefix, attQName.intern(), type, value);
     ...
     * @throws SAXException The client may throw an exception if there is an error callback.
     */
     ...
     * @throws SAXException The client may throw an exception.
     */
     ...
     * @throws SAXNotSupportedException If a document is currently being parsed.
     */
