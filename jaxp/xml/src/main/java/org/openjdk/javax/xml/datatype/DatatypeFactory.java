 ...
 *
 * <p>A new instance of the <code>DatatypeFactory</code> is created through the {@link
 * #newInstance()} method that uses the following implementation resolution mechanisms to determine
 * an implementation:
 *
 * <ol>
 *   <li>If the system property specified by {@link #DATATYPEFACTORY_PROPERTY}, "<code>
 *       javax.xml.datatype.DatatypeFactory</code>", exists, a class with the name of the property
 *       value is instantiated. Any Exception thrown during the instantiation process is wrapped as
 *       a {@link org.openjdk.javax.xml.datatype.DatatypeConfigurationException}.
 *   <li>If the file ${JAVA_HOME}/lib/jaxp.properties exists, it is loaded in a {@link
 ...
 *   <li>Uses the service-provider loading facilities, defined by the {@link
 *       java.util.ServiceLoader} class, to attempt to locate and load an implementation of the
 *       service using the {@linkplain java.util.ServiceLoader#load(java.lang.Class) default loading
 *       mechanism}: the service-provider loading facility will use the {@linkplain
 *       java.lang.Thread#getContextClassLoader() current thread's context class loader} to attempt
 *       to load the service. If the context class loader is null, the {@linkplain
 *       ClassLoader#getSystemClassLoader() system class loader} will be used. <br>
 *       In case of {@link java.util.ServiceConfigurationError service configuration error} a {@link
 *       org.openjdk.javax.xml.datatype.DatatypeConfigurationException} will be thrown.
 ...
 *       process is wrapped as a {@link
 *       org.openjdk.javax.xml.datatype.DatatypeConfigurationException}.
 * </ol>
 *
...
public abstract class DatatypeFactory {
     ...
     *
     * <p>Default value is <code>javax.xml.datatype.DatatypeFactory</code>.
     */
    ...
    /**
     * Default implementation class name as defined in <em>JSR 206: Java(TM) API for XML Processing
     * (JAXP) 1.3</em>.
     *
     * <p>Implementers should specify the name of an appropriate class to be instantiated if no
     * other implementation resolution mechanism succeeds.
     *
     * <p>Users should not refer to this field; it is intended only to document a factory
    ...
    /**
     * http://www.w3.org/TR/xpath-datamodel/#xdtschema defines two regexps to constrain the value
     * space of dayTimeDuration ([^YM]*[DT].*) and yearMonthDuration ([^DT]*). Note that these
     * expressions rely on the fact that the value must be an xs:Duration, they simply exclude some
     * Durations.
     */
     ...
     *
     * <p>Use {@link #newInstance()} to create a <code>DatatypeFactory</code>.
     */
    protected DatatypeFactory() {}

    /**
     * Obtain a new instance of a <code>DatatypeFactory</code>.
     *
     * <p>The implementation resolution mechanisms are <a
     * href="#DatatypeFactory.newInstance">defined</a> in this <code>Class</code>'s documentation.
     *
     * @return New instance of a <code>DatatypeFactory</code>
     * @throws org.openjdk.javax.xml.datatype.DatatypeConfigurationException If the implementation
     *     is not available or cannot be instantiated.
     * @see #newInstance(String factoryClassName, ClassLoader classLoader)
     */
    public static DatatypeFactory newInstance()
            throws org.openjdk.javax.xml.datatype.DatatypeConfigurationException {
    ...
    /**
     * Obtain a new instance of a <code>DatatypeFactory</code> from class name. This function is
     * useful when there are multiple providers in the classpath. It gives more control to the
     * application as it can specify which provider should be loaded.
     *
     * <p>Once an application has obtained a reference to a <code>DatatypeFactory</code> it can use
     * the factory to configure and obtain datatype instances.
     *
     ...
     *     class.
     * @return New instance of a <code>DatatypeFactory</code>
     * @throws org.openjdk.javax.xml.datatype.DatatypeConfigurationException if <code>
    ...
    public static DatatypeFactory newInstance(String factoryClassName, ClassLoader classLoader)
        ...
        return FactoryFinder.newInstance(
                DatatypeFactory.class, factoryClassName, classLoader, false);
    }
     ...
     * </blockquote>
     *
     * <p>All six values are set and available from the created {@link
     ...
     */
    public abstract org.openjdk.javax.xml.datatype.Duration newDuration(
     ...
     * available using the <code>get</code> methods of the created {@link
     * org.openjdk.javax.xml.datatype.Duration}. The values conform to and are defined by:
     *
     * <ul>
     ...
     *   <li>{@link org.openjdk.javax.xml.datatype.XMLGregorianCalendar} Date/Time Datatype Field
     *       Mapping Between XML Schema 1.0 and Java Representation
     * </ul>
     *
     ...
     * org.openjdk.javax.xml.datatype.Duration#getMonths()} and {@link
     * org.openjdk.javax.xml.datatype.Duration#getDays()} can be influenced.
     *
     ...
     *     Duration</code>: if all the fields (years, months, ...) are null or if any of the fields
     *     is negative.
     * @throws UnsupportedOperationException If implementation cannot support requested values.
     */
    public abstract org.openjdk.javax.xml.datatype.Duration newDuration(
     ...
     * isPositive, years, months, days, hours, minutes, seconds.
     *
     * <p>A {@link org.openjdk.javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} value indicates
     ...
     * @return New <code>Duration</code> created from the specified values.
     * @throws IllegalArgumentException If the values are not a valid representation of a <code>
     *     Duration</code>: if any of the fields is negative.
     ...
     */
    public org.openjdk.javax.xml.datatype.Duration newDuration(
            final boolean isPositive,
            final int years,
            final int months,
            final int days,
        ...
        BigInteger realYears =
                (years != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED)
                        ? BigInteger.valueOf((long) years)
                        : null;

        // months may not be set
        BigInteger realMonths =
                (months != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED)
                        ? BigInteger.valueOf((long) months)
                        : null;

        // days may not be set
        BigInteger realDays =
                (days != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED)
                        ? BigInteger.valueOf((long) days)
                        : null;

        // hours may not be set
        BigInteger realHours =
                (hours != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED)
                        ? BigInteger.valueOf((long) hours)
                        : null;

        // minutes may not be set
        BigInteger realMinutes =
                (minutes != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED)
                        ? BigInteger.valueOf((long) minutes)
                        : null;

        // seconds may not be set
        BigDecimal realSeconds =
                (seconds != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED)
                        ? BigDecimal.valueOf((long) seconds)
                        : null;

        return newDuration(
                isPositive, realYears, realMonths, realDays, realHours, realMinutes, realSeconds);
    }
     ...
     *
     * <p>All four values are set and available from the created {@link
     * org.openjdk.javax.xml.datatype.Duration}
     *
     * <p>The XML Schema specification states that values can be of an arbitrary size.
     * Implementations may chose not to or be incapable of supporting arbitrarily large and/or small
     ...
     * @throws NullPointerException If <code>lexicalRepresentation</code> is <code>null</code>.
     */
    public org.openjdk.javax.xml.datatype.Duration newDurationDayTime(
            final String lexicalRepresentation) {
     ...
     * in the namespace {@link XMLConstants#W3C_XPATH_DATATYPE_NS_URI}.
     *
     * <p>Both values are set and available from the created {@link
     * org.openjdk.javax.xml.datatype.Duration}
     *
     * <p>The XML Schema specification states that values can be of an arbitrary size.
     * Implementations may chose not to or be incapable of supporting arbitrarily large and/or small
     ...
     * @throws NullPointerException If <code>lexicalRepresentation</code> is <code>null</code>.
     */
    public org.openjdk.javax.xml.datatype.Duration newDurationYearMonth(
            final String lexicalRepresentation) {
     ...
     * important as there are variations in the Gregorian Calendar, e.g. leap years have different
     * days in the month = {@link java.util.Calendar#FEBRUARY} so the result of {@link
     * org.openjdk.javax.xml.datatype.Duration#getMonths()} can be influenced.
     *
    ...
    public org.openjdk.javax.xml.datatype.Duration newDurationYearMonth(
        ...
        org.openjdk.javax.xml.datatype.Duration fullDuration = newDuration(durationInMilliseconds);
        boolean isPositive = (fullDuration.getSign() == -1) ? false : true;
        BigInteger years =
                (BigInteger)
                        fullDuration.getField(
                                org.openjdk.javax.xml.datatype.DatatypeConstants.YEARS);
        if (years == null) {
        ...
        BigInteger months =
                (BigInteger)
                        fullDuration.getField(
                                org.openjdk.javax.xml.datatype.DatatypeConstants.MONTHS);
        if (months == null) {
     ...
     *
     * <p>All date/time datatype fields set to {@link
     * org.openjdk.javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} or null.
     *
     * @return New <code>XMLGregorianCalendar</code> with all date/time datatype fields set to
     *     {@link org.openjdk.javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} or null.
     */
    public abstract org.openjdk.javax.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar();
     ...
     *          {@link GregorianCalendar} to an {@link org.openjdk.javax.xml.datatype.XMLGregorianCalendar}
     *       </th>
     *     </tr>
     *     <tr>
     ...
     *       <td>{@link org.openjdk.javax.xml.datatype.XMLGregorianCalendar#setYear(int year)}</td>
     *     </tr>
     *     <tr>
     *       <td><code>MONTH + 1</code></td>
     *       <td>{@link org.openjdk.javax.xml.datatype.XMLGregorianCalendar#setMonth(int month)}</td>
     *     </tr>
     *     <tr>
     *       <td><code>DAY_OF_MONTH</code></td>
     *       <td>{@link org.openjdk.javax.xml.datatype.XMLGregorianCalendar#setDay(int day)}</td>
     *     </tr>
     *     <tr>
     *       <td><code>HOUR_OF_DAY, MINUTE, SECOND, MILLISECOND</code></td>
     *       <td>{@link org.openjdk.javax.xml.datatype.XMLGregorianCalendar#setTime(int hour, int minute, int second, BigDecimal fractional)}</td>
     *     </tr>
     *     <tr>
     *       <td>
     ...
     *         <em>(in minutes)</em>
     *       </td>
     *       <td>{@link org.openjdk.javax.xml.datatype.XMLGregorianCalendar#setTimezone(int offset)}<sup><em>*</em></sup>
     *       </td>
     *     </tr>
     *   </tbody>
     * </table>
     ...
     *     {@link org.openjdk.javax.xml.datatype.XMLGregorianCalendar} or if the composite values
     *     constitute an invalid <code>XMLGregorianCalendar</code> instance as determined by {@link
     *     org.openjdk.javax.xml.datatype.XMLGregorianCalendar#isValid()}.
     */
    public abstract org.openjdk.javax.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar(
    ...
    /**
     * Constructor of value spaces that a <code>java.util.GregorianCalendar</code> instance would
     * need to convert to an <code>XMLGregorianCalendar</code> instance.
     *
     ...
     *     org.openjdk.javax.xml.datatype.XMLGregorianCalendar#isValid()}.
     */
    public org.openjdk.javax.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar(
            final int year,
            final int month,
            final int day,
            final int hour,
        ...
        BigInteger realYear =
                (year != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED)
        ...
        if (millisecond != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) {
            if (millisecond < 0 || millisecond > 1000) {
                throw new IllegalArgumentException(
                        "javax.xml.datatype.DatatypeFactory#newXMLGregorianCalendar(int year, int"
                            + " month, int day, int hour, int minute, int second, int millisecond,"
                            + " int timezone)with invalid millisecond: "
                                + millisecond);
            }
        ...
        return newXMLGregorianCalendar(
                realYear, month, day, hour, minute, second, realMillisecond, timezone);
    }
     ...
     * @param month of <code>XMLGregorianCalendar</code> to be created.
     * @param day of <code>XMLGregorianCalendar</code> to be created.
     * @param timezone offset in minutes. {@link
     *     org.openjdk.javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} indicates optional
     *     field is not set.
     * @return <code>XMLGregorianCalendar</code> created from parameter values.
     * @see org.openjdk.javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED
     * @throws IllegalArgumentException If any individual parameter's value is outside the maximum
     *     value constraint for the field as determined by the Date/Time Data Mapping table in
     *     {@link org.openjdk.javax.xml.datatype.XMLGregorianCalendar} or if the composite values
     *     constitute an invalid <code>XMLGregorianCalendar</code> instance as determined by {@link
     *     org.openjdk.javax.xml.datatype.XMLGregorianCalendar#isValid()}.
     */
    public org.openjdk.javax.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendarDate(
        ...
        return newXMLGregorianCalendar(
                ...
                month,
                day,
                org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // hour
                org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // minute
                org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // second
                org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // millisecond
                timezone);
    }
     ...
     * @see org.openjdk.javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED
     */
    public org.openjdk.javax.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendarTime(
            final int hours, final int minutes, final int seconds, final int timezone) {

        return newXMLGregorianCalendar(
                org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // Year
                org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // Month
                org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // Day
                hours,
                minutes,
                seconds,
                org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED, // Millisecond
