...
public abstract class XMLEventFactory {
     ...
     *
     * <p>This static method creates a new factory instance. This method uses the following ordered
     * lookup procedure to determine the XMLEventFactory implementation class to load:
     *
     * <ul>
     *   <li>Use the javax.xml.stream.XMLEventFactory system property.
     *   <li>Use the properties file "lib/stax.properties" in the JRE directory. This configuration
     *       file is in standard java.util.Properties format and contains the fully qualified name
     *       of the implementation class with the key being the system property defined above.
     ...
     * </ul>
     *
     * <p>Once an application has obtained a reference to a XMLEventFactory it can use the factory
     * to configure and obtain stream instances.
     *
     * <p>Note that this is a new method that replaces the deprecated newInstance() method. No
     * changes in behavior are defined by this replacement method relative to the deprecated method.
     *
     ...
     *   <li>Use the properties file "lib/stax.properties" in the JRE directory. This configuration
     *       file is in standard java.util.Properties format and contains the fully qualified name
     *       of the implementation class with the key being the given {@code factoryId}.
     *   <li>If {@code factoryId} is "javax.xml.stream.XMLEventFactory", use the service-provider
     *       loading facilities, defined by the {@link java.util.ServiceLoader} class, to attempt to
     *       locate and load an implementation of the service using the specified {@code
     *       ClassLoader}. If {@code classLoader} is null, the {@linkplain
     ...
     *       attempt to load the service. If the context class loader is null, the {@linkplain
     *       ClassLoader#getSystemClassLoader() system class loader} will be used.
     *   <li>Otherwise, throws a {@link FactoryConfigurationError}.
     * </ul>
     *
    ...
    public abstract StartElement createStartElement(
            QName name, Iterator attributes, Iterator namespaces);
     ...
     * Create a comment
     *
     * @param text The text of the comment a Comment event
     */
