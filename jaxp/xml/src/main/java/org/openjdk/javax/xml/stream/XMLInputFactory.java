...
public abstract class XMLInputFactory {
     ...
     * lookup procedure to determine the XMLInputFactory implementation class to load:
     *
     * <ul>
     *   <li>Use the javax.xml.stream.XMLInputFactory system property.
     ...
     * </ul>
     *
     * <p>Once an application has obtained a reference to a XMLInputFactory it can use the factory
     ...
     *   <li>If {@code factoryId} is "javax.xml.stream.XMLInputFactory", use the service-provider
     ...
     *       this property, {@link XMLStreamException} will be thrown by the {@link
     *       XMLStreamReader#next()} or {@link XMLEventReader#nextEvent()} method.
     * </ul>
     *
