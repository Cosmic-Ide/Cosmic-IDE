 ...
 * setProperty("javax.xml.stream.isRepairingNamespaces",new Boolean(true|false));</code>
 *
...
public abstract class XMLOutputFactory {
     ...
     * lookup procedure to determine the XMLOutputFactory implementation class to load:
     *
     * <ul>
     *   <li>Use the javax.xml.stream.XMLOutputFactory system property.
     ...
     *       <p>Once an application has obtained a reference to a XMLOutputFactory it can use the
     ...
     *       changes in behavior are defined by this replacement method relative to the deprecated
     *       method.
     *
     ...
     *   <li>If {@code factoryId} is "javax.xml.stream.XMLOutputFactory", use the service-provider
