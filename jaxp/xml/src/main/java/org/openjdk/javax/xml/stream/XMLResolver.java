 ...
 * perform custom entity resolution it must register an instance of this interface with the
 * XMLInputFactory using the setXMLResolver method.
 *
 * @version 1.0
...
public interface XMLResolver {
    ...
    /**
     * Retrieves a resource. This resource can be of the following three return types: (1)
