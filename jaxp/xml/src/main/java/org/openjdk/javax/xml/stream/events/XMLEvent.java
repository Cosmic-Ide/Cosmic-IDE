...
/**
 * This is the base event interface for handling markup events. Events are value objects that are
 * used to communicate the XML 1.0 InfoSet to the Application. Events may be cached and referenced
...
public interface XMLEvent extends XMLStreamConstants {
    ...
    /**
     * Return the location of this event. The Location returned from this method is non-volatile and
