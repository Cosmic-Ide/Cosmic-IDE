...
/**
 * An object that implements this interface that can be called by the processor to turn a URI used
 * in document(), xsl:import, or xsl:include into a Source object.
 */
public interface URIResolver {
     ...
     * @param base The base URI against which the first argument will be made absolute if the
