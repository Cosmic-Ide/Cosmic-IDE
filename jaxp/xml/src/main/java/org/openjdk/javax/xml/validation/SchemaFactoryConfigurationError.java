...
/**
 * Thrown when a problem with configuration with the Schema Factories exists. This error will
 * typically be thrown when the class of a schema factory specified in the system properties cannot
...
public final class SchemaFactoryConfigurationError extends Error {
    ...
    /**
     * Create a new <code>SchemaFactoryConfigurationError</code> with the <code>String</code>
    ...
    /**
     * Create a new <code>SchemaFactoryConfigurationError</code> with the given <code>Throwable
     * </code> base cause.
     *
     * @param cause The exception or error to be encapsulated in a SchemaFactoryConfigurationError.
     */
