...
/**
 * <code>XPathVariableResolver</code> provides access to the set of user defined XPath variables.
 *
 ...
 * <strong><em>must</em></strong> not change.
 *
...
public interface XPathVariableResolver {
     ...
     *
     * <p>If <code>variableName</code> is <code>null</code>, then a <code>NullPointerException
     * </code> is thrown.
     *
     * @param variableName The <code>QName</code> of the variable name.
     * @return The variables value, or <code>null</code> if no variable named <code>variableName
     *     </code> exists. The value returned must be of a type appropriate for the underlying
     *     object model.
