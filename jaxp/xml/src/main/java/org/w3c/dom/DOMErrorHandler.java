 ...
 * (e.g. validating a document). A <code>DOMErrorHandler</code> object can be attached to a <code>
 * Document</code> using the "error-handler" on the <code>DOMConfiguration</code> interface. If more
 * than one error needs to be reported during an operation, the sequence and numbers of the errors
...
public interface DOMErrorHandler {
     ...
     *     <code>true</code>, the processing may continue depending on <code>DOMError.severity
     *     </code>.
     */
