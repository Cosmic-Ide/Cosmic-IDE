 ...
 * ordinary processing situations, such as out-of-bound errors when using <code>NodeList</code>.
 *
 * <p>Implementations should raise other exceptions under other circumstances. For example,
 * implementations should raise an implementation-dependent exception if a <code>null</code>
 * argument is passed when <code>null</code> was not expected.
 *
...
public class DOMException extends RuntimeException {
    ...
    /**
     * If a <code>Node</code> is used in a different document than the one that created it (that
     * doesn't support it).
     */
    ...
    /**
     * If an attempt is made to create or change an object in a way which is incorrect with regard
     * to namespaces.
     *
     * @since DOM Level 2
     */
    ...
    /**
     * If a call to a method such as <code>insertBefore</code> or <code>removeChild</code> would
     * make the <code>Node</code> invalid with respect to "partial validity", this exception would
     * be raised and the operation would not be done. This code is used in [<a
     * href='http://www.w3.org/TR/2004/REC-DOM-Level-3-Val-20040127/'>DOM Level 3 Validation</a>] .
    ...
    /**
     * If the type of an object is incompatible with the expected type of the parameter associated
     * to the object.
     *
     * @since DOM Level 3
     */
