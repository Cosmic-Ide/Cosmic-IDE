 ...
 *
 * <p>No lexical check is done on the content of a processing instruction and it is therefore
 * possible to have the character sequence <code>"?&gt;"</code> in the content, which is illegal a
 * processing instruction per section 2.6 of [<a
 * href='http://www.w3.org/TR/2004/REC-xml-20040204'>XML 1.0</a>]. The presence of this character
...
public interface ProcessingInstruction extends Node {
     ...
     * after the target to the character immediately preceding the <code>?&gt;</code>.
     */
