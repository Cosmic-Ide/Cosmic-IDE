 ...
 * being cloned, imported, or renamed. This can be used by the application to implement various
 * behaviors regarding the data it associates to the DOM nodes. This interface defines that handler.
 *
...
public interface UserDataHandler {
     ...
     * The node is deleted.
     *
     * <p><b>Note:</b> This may not be supported or may not be reliable in certain environments,
     * such as Java, where the implementation has no real control over when objects are actually
     * deleted.
     */
     ...
     * cloned. <br>
     * DOM applications must not raise exceptions in a <code>UserDataHandler</code>. The effect of
     ...
     * @param src Specifies the node being cloned, adopted, imported, or renamed. This is <code>null
     *     </code> when the node is being deleted.
     * @param dst Specifies the node newly created if any, or <code>null</code>.
     */
    public void handle(short operation, String key, Object data, org.w3c.dom.Node src, Node dst);
}
