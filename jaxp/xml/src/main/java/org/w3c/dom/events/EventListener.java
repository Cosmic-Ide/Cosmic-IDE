 ...
 * using the listener.
 *
 * <p>When a <code>Node</code> is copied using the <code>cloneNode</code> method the <code>
 * EventListener</code>s attached to the source <code>Node</code> are not attached to the copied
 * <code>Node</code>. If the user wishes the same <code>EventListener</code>s to be added to the
...
public interface EventListener {
     ...
     *     contains the <code>stopPropagation</code> and <code>preventDefault</code> methods which
     *     are used in determining the event's flow and default action.
     */
