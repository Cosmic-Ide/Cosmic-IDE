...
public interface HTMLAreaElement extends HTMLElement {
    ...
    /**
     * Comma-separated list of lengths, defining an active region geometry. See also <code>shape
     * </code> for the shape of the region. See the coords attribute definition in HTML 4.0.
     */
    ...
    /**
     * Specifies that this area is inactive, i.e., has no associated action. See the nohref
     * attribute definition in HTML 4.0.
     */
    ...
    /**
     * The shape of the active area. The coordinates are given by <code>coords</code> . See the
