 ...
 * </blockquote>
 *
 * <p>This was the main event-handling interface for SAX1; in SAX2, it has been replaced by {@link
 * org.xml.sax.ContentHandler ContentHandler}, which provides Namespace support and reporting of
 * skipped entities. This interface is included in SAX2 only to support legacy SAX1 applications.
 *
 ...
 *
 * <p>Application writers who do not want to implement the entire interface can derive a class from
 * HandlerBase, which implements the default functionality; parser writers can instantiate
 * HandlerBase to obtain a default handler. The application can find the location of any document
 * event using the Locator interface supplied by the Parser through the setDocumentLocator method.
 *
 * @deprecated This interface has been replaced by the SAX2 {@link org.xml.sax.ContentHandler
...
public interface DocumentHandler {
     ...
     * invoking any of the other methods in the DocumentHandler interface.
     *
     ...
     * @exception org.xml.sax.SAXException Any SAX exception, possibly wrapping another exception.
     */
    public abstract void endElement(String name) throws org.xml.sax.SAXException;
