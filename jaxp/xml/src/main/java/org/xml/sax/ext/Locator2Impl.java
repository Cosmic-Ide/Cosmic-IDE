 ...
 */
public class Locator2Impl extends LocatorImpl implements org.xml.sax.ext.Locator2 {
    ...
    public Locator2Impl(Locator locator) {
        super(locator);
        if (locator instanceof org.xml.sax.ext.Locator2) {
            org.xml.sax.ext.Locator2 l2 = (Locator2) locator;
