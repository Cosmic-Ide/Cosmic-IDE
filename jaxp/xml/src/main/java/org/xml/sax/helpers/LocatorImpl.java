 ...
 * </blockquote>
 *
 * <p>This class is available mainly for application writers, who can use it to make a persistent
 * snapshot of a locator at any point during a document parse:
 *
 * <pre>
 * Locator locator;
 * Locator startloc;
 ...
 * </pre>
 *
 * <p>Normally, parser writers will not use this class, since it is more efficient to provide
 * location information only when requested, rather than constantly updating a Locator object.
 *
 * @since SAX 1.0
...
public class LocatorImpl implements Locator {
     ...
     *
     * <p>This will not normally be useful, since the main purpose of this class is to make a
     * snapshot of an existing Locator.
     */
    public LocatorImpl() {}
