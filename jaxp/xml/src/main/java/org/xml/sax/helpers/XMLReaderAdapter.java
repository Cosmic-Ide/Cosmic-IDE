 ...
 * </blockquote>
 *
 * <p>This class wraps a SAX2 {@link org.xml.sax.XMLReader XMLReader} and makes it act as a SAX1
 * {@link org.xml.sax.Parser Parser}. The XMLReader must support a true value for the
 * http://xml.org/sax/features/namespace-prefixes property or parsing will fail with a {@link
 * org.xml.sax.SAXException SAXException}; if the XMLReader supports a false value for the
 * http://xml.org/sax/features/namespaces property, that will also be used to improve efficiency.
 *
 * @since SAX 2.0
...
public class XMLReaderAdapter implements Parser, ContentHandler {
     ...
     *
     * <p>Use the "org.xml.sax.driver" property to locate the SAX2 driver to embed.
     *
     * @exception org.xml.sax.SAXException If the embedded driver cannot be instantiated or if the
     ...
     * Create a new adapter.
     *
     * <p>Create a new adapter, wrapped around a SAX2 XMLReader. The adapter will make the XMLReader
     * act like a SAX1 Parser.
     *
     ...
     *
     * <p>This is not supported in SAX2, and will always throw an exception.
     *
     ...
     *
     * <p>Note that the SAX1 document handler has no Namespace support.
     *
     ...
     * Parse the document.
     *
     * <p>This method will throw an exception if the embedded XMLReader does not support the
     ...
     * @exception org.xml.sax.SAXException If there is a problem processing the document.
     ...
     *
     * @exception org.xml.sax.SAXException The client may raise a processing exception.
