...
import com.pranav.ide.dex.Code.CatchHandler;
import com.pranav.ide.dex.Code.Try;
import com.pranav.ide.dex.MethodHandle.MethodHandleType;
import com.pranav.ide.dex.util.ByteInput;
import com.pranav.ide.dex.util.ByteOutput;
import com.pranav.ide.dex.util.FileUtils;
...
public final class Dex {
    ...
    private final com.pranav.ide.dex.TableOfContents tableOfContents = new com.pranav.ide.dex.TableOfContents();
    ...
    public Dex(File file) throws IOException {
        if (FileUtils.hasArchiveSuffix(file.getName())) {
            ...
            ZipEntry entry = zipFile.getEntry(com.pranav.ide.dex.DexFormat.DEX_IN_JAR_NAME);
            if (entry != null) {
    ...
    public List<com.pranav.ide.dex.ProtoId> protoIds() {
        return protoIds;
    }

    public List<com.pranav.ide.dex.FieldId> fieldIds() {
        return fieldIds;
    }

    public List<com.pranav.ide.dex.MethodId> methodIds() {
        return methodIds;
    }

    public Iterable<com.pranav.ide.dex.ClassDef> classDefs() {
        return new ClassDefIterable();
    }

    public com.pranav.ide.dex.TypeList readTypeList(int offset) {
        if (offset == 0) {
            return com.pranav.ide.dex.TypeList.EMPTY;
        }
        return open(offset).readTypeList();
    }

    public com.pranav.ide.dex.ClassData readClassData(com.pranav.ide.dex.ClassDef classDef) {
    ...
    public com.pranav.ide.dex.Code readCode(com.pranav.ide.dex.ClassData.Method method) {
    ...
    public int descriptorIndexFromTypeIndex(int typeIndex) {
        ...
        int position = tableOfContents.typeIds.off + (com.pranav.ide.dex.SizeOf.TYPE_ID_ITEM * typeIndex);
    ...
    public final class Section implements ByteInput, ByteOutput {
        ...
        public int readUleb128() {
            return com.pranav.ide.dex.Leb128.readUnsignedLeb128(this);
        }

        public int readUleb128p1() {
            return com.pranav.ide.dex.Leb128.readUnsignedLeb128(this) - 1;
        }

        public int readSleb128() {
            return com.pranav.ide.dex.Leb128.readSignedLeb128(this);
        }
        ...
        public com.pranav.ide.dex.TypeList readTypeList() {
            int size = readInt();
            short[] types = readShortArray(size);
            alignToFourBytes();
            return new com.pranav.ide.dex.TypeList(Dex.this, types);
        }
        ...
        public String readString() {
            ...
            try {
                ...
                String result = com.pranav.ide.dex.Mutf8.decode(this, new char[expectedLength]);
        ...
        public com.pranav.ide.dex.FieldId readFieldId() {
            int declaringClassIndex = readUnsignedShort();
            int typeIndex = readUnsignedShort();
            int nameIndex = readInt();
            return new com.pranav.ide.dex.FieldId(Dex.this, declaringClassIndex, typeIndex, nameIndex);
        }

        public com.pranav.ide.dex.MethodId readMethodId() {
            int declaringClassIndex = readUnsignedShort();
            int protoIndex = readUnsignedShort();
            int nameIndex = readInt();
            return new com.pranav.ide.dex.MethodId(Dex.this, declaringClassIndex, protoIndex, nameIndex);
        }

        public com.pranav.ide.dex.ProtoId readProtoId() {
            int shortyIndex = readInt();
            int returnTypeIndex = readInt();
            int parametersOffset = readInt();
            return new com.pranav.ide.dex.ProtoId(Dex.this, shortyIndex, returnTypeIndex, parametersOffset);
        }

        public com.pranav.ide.dex.CallSiteId readCallSiteId() {
            int offset = readInt();
            return new CallSiteId(Dex.this, offset);
        }

        public com.pranav.ide.dex.MethodHandle readMethodHandle() {
        ...
        public com.pranav.ide.dex.ClassDef readClassDef() {
            ...
            return new com.pranav.ide.dex.ClassDef(Dex.this, offset, type, accessFlags, supertype,
                    interfacesOffset, sourceFileIndex, annotationsOffset, classDataOffset,
                    staticValuesOffset);
        }

        private com.pranav.ide.dex.Code readCode() {
            ...
            if (triesSize > 0) {
                ...
                skip(triesSize * com.pranav.ide.dex.SizeOf.TRY_ITEM);
        ...
        private com.pranav.ide.dex.ClassData readClassData() {
            ...
            com.pranav.ide.dex.ClassData.Field[] staticFields = readFields(staticFieldsSize);
            com.pranav.ide.dex.ClassData.Field[] instanceFields = readFields(instanceFieldsSize);
            com.pranav.ide.dex.ClassData.Method[] directMethods = readMethods(directMethodsSize);
            com.pranav.ide.dex.ClassData.Method[] virtualMethods = readMethods(virtualMethodsSize);
            return new com.pranav.ide.dex.ClassData(staticFields, instanceFields, directMethods, virtualMethods);
        }

        private com.pranav.ide.dex.ClassData.Field[] readFields(int count) {
            com.pranav.ide.dex.ClassData.Field[] result = new com.pranav.ide.dex.ClassData.Field[count];
            int fieldIndex = 0;
            for (int i = 0; i < count; i++) {
                fieldIndex += readUleb128(); // field index diff
                int accessFlags = readUleb128();
                result[i] = new com.pranav.ide.dex.ClassData.Field(fieldIndex, accessFlags);
            }
            return result;
        }

        private com.pranav.ide.dex.ClassData.Method[] readMethods(int count) {
            com.pranav.ide.dex.ClassData.Method[] result = new com.pranav.ide.dex.ClassData.Method[count];
            int methodIndex = 0;
            for (int i = 0; i < count; i++) {
        ...
        public com.pranav.ide.dex.Annotation readAnnotation() {
            byte visibility = readByte();
            int start = data.position();
            new com.pranav.ide.dex.EncodedValueReader(this, com.pranav.ide.dex.EncodedValueReader.ENCODED_ANNOTATION).skipValue();
            return new Annotation(Dex.this, visibility, new com.pranav.ide.dex.EncodedValue(getBytesFrom(start)));
        }

        public com.pranav.ide.dex.EncodedValue readEncodedArray() {
            int start = data.position();
            new com.pranav.ide.dex.EncodedValueReader(this, EncodedValueReader.ENCODED_ARRAY).skipValue();
        ...
        public void writeUleb128(int i) {
            try {
                com.pranav.ide.dex.Leb128.writeUnsignedLeb128(this, i);
    ...
    private final class StringTable extends AbstractList<String> implements RandomAccess {
        ...
        public String get(int index) {
            ...
            return open(tableOfContents.stringIds.off + (index * com.pranav.ide.dex.SizeOf.STRING_ID_ITEM))
                    .readString();
        }
    ...
    private final class ProtoIdTable extends AbstractList<com.pranav.ide.dex.ProtoId> implements RandomAccess {
        @Override
        public ProtoId get(int index) {
            checkBounds(index, tableOfContents.protoIds.size);
            return open(tableOfContents.protoIds.off + (com.pranav.ide.dex.SizeOf.PROTO_ID_ITEM * index))
                    .readProtoId();
        }
    ...
    private final class FieldIdTable extends AbstractList<com.pranav.ide.dex.FieldId> implements RandomAccess {
        @Override
        public FieldId get(int index) {
            checkBounds(index, tableOfContents.fieldIds.size);
            return open(tableOfContents.fieldIds.off + (com.pranav.ide.dex.SizeOf.MEMBER_ID_ITEM * index))
                    .readFieldId();
        }
    ...
    private final class MethodIdTable extends AbstractList<com.pranav.ide.dex.MethodId> implements RandomAccess {
        @Override
    ...
    private final class ClassDefIterator implements Iterator<com.pranav.ide.dex.ClassDef> {
        ...
        @Override
        public com.pranav.ide.dex.ClassDef next() {
            if (!hasNext()) {
    ...
    private final class ClassDefIterable implements Iterable<com.pranav.ide.dex.ClassDef> {
        @Override
        public Iterator<com.pranav.ide.dex.ClassDef> iterator() {
