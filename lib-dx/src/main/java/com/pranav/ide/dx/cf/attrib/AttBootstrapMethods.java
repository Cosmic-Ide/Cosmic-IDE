...
public class AttBootstrapMethods extends BaseAttribute {
    ...
    private final com.pranav.ide.dx.cf.code.BootstrapMethodsList bootstrapMethods;

    private final int byteLength;

    public AttBootstrapMethods(com.pranav.ide.dx.cf.code.BootstrapMethodsList bootstrapMethods) {
