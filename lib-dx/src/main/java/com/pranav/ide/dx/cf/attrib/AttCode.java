...
package com.pranav.ide.dx.cf.attrib;
...
import com.pranav.ide.dx.util.MutabilityException;
...
public final class AttCode extends BaseAttribute {
     ...
     */
    private final com.pranav.ide.dx.cf.code.BytecodeArray code;

    /**
     * {@code non-null;} the exception table
     */
    private final com.pranav.ide.dx.cf.code.ByteCatchList catches;

    /**
     * {@code non-null;} the associated list of attributes
     */
    private final com.pranav.ide.dx.cf.iface.AttributeList attributes;
     ...
     */
    public AttCode(int maxStack, int maxLocals, com.pranav.ide.dx.cf.code.BytecodeArray code,
                   com.pranav.ide.dx.cf.code.ByteCatchList catches, com.pranav.ide.dx.cf.iface.AttributeList attributes) {
        ...
        try {
            if (catches.isMutable()) {
                throw new com.pranav.ide.dx.util.MutabilityException("catches.isMutable()");
            }
