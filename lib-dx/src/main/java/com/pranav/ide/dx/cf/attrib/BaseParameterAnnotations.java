...
public abstract class BaseParameterAnnotations extends BaseAttribute {
     ...
     */
    private final com.pranav.ide.dx.rop.annotation.AnnotationsList parameterAnnotations;
    ...
    public BaseParameterAnnotations(String attributeName,
                                    com.pranav.ide.dx.rop.annotation.AnnotationsList parameterAnnotations, int byteLength) {
        super(attributeName);
