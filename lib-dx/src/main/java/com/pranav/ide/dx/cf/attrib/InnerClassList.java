...
public final class InnerClassList extends FixedSizeList {
     ...
     */
    public void set(int n, com.pranav.ide.dx.rop.cst.CstType innerClass, com.pranav.ide.dx.rop.cst.CstType outerClass,
                    com.pranav.ide.dx.rop.cst.CstString innerName, int accessFlags) {
    ...
    public static class Item {
         ...
         */
        private final com.pranav.ide.dx.rop.cst.CstType innerClass;

        /**
         * {@code null-ok;} outer class that this class is a member of, if any
         */
        private final com.pranav.ide.dx.rop.cst.CstType outerClass;

        /**
         * {@code null-ok;} original simple name of this class, if not anonymous
         */
        private final com.pranav.ide.dx.rop.cst.CstString innerName;
         ...
         * @param accessFlags original declared access flags
         */
        public Item(com.pranav.ide.dx.rop.cst.CstType innerClass, com.pranav.ide.dx.rop.cst.CstType outerClass,
                    com.pranav.ide.dx.rop.cst.CstString innerName, int accessFlags) {
            if (innerClass == null) {
         ...
         */
        public com.pranav.ide.dx.rop.cst.CstType getInnerClass() {
            return innerClass;
        }
