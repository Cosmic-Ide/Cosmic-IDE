...
public final class RawAttribute extends BaseAttribute {
     ...
     */
    private final com.pranav.ide.dx.util.ByteArray data;
     ...
     */
    public RawAttribute(String name, com.pranav.ide.dx.util.ByteArray data, com.pranav.ide.dx.rop.cst.ConstantPool pool) {
        super(name);
    ...
    /**
     * Constructs an instance from a sub-array of a {@link com.pranav.ide.dx.util.ByteArray}.
     *
     * @param name   {@code non-null;} attribute name
     ...
     * @param pool   {@code null-ok;} constant pool to use for cpi resolution
     */
    public RawAttribute(String name, com.pranav.ide.dx.util.ByteArray data, int offset,
                        int length, com.pranav.ide.dx.rop.cst.ConstantPool pool) {
