...
/**
 * Base implementation of {@link com.pranav.ide.dx.cf.code.Machine}.
 *
 * <p><b>Note:</b> For the most part, the documentation for this class
 * ignores the distinction between {@link com.pranav.ide.dx.rop.type.Type} and {@link
 * com.pranav.ide.dx.rop.type.TypeBearer}.</p>
 */
public abstract class BaseMachine implements Machine {
    /* {@code non-null;} the prototype for the associated method */
    private final com.pranav.ide.dx.rop.type.Prototype prototype;
    /**
     * {@code non-null;} results
     */
    private final com.pranav.ide.dx.rop.type.TypeBearer[] results;
    /**
     * {@code non-null;} primary arguments
     */
    private com.pranav.ide.dx.rop.type.TypeBearer[] args;
    /**
     ...
     */
    private com.pranav.ide.dx.rop.type.Type auxType;
    /**
     ...
     */
    private com.pranav.ide.dx.rop.cst.Constant auxCst;
    /**
     ...
     */
    private com.pranav.ide.dx.cf.code.SwitchList auxCases;
    /**
     * {@code null-ok;} auxiliary initial value list for newarray
     */
    private ArrayList<com.pranav.ide.dx.rop.cst.Constant> auxInitValues;
    /**
     ...
     */
    private com.pranav.ide.dx.rop.code.RegisterSpec localTarget;
    /**
     ...
     *                  associated method
     */
    public BaseMachine(com.pranav.ide.dx.rop.type.Prototype prototype) {
        if (prototype == null) {
            throw new NullPointerException("prototype == null");
        }

        this.prototype = prototype;
        args = new com.pranav.ide.dx.rop.type.TypeBearer[10];
        results = new com.pranav.ide.dx.rop.type.TypeBearer[6];
        clearArgs();
    }
     ...
     */
    public static void throwLocalMismatch(com.pranav.ide.dx.rop.type.TypeBearer found,
                                          TypeBearer local) {
     ...
     */
    @Override
    public com.pranav.ide.dx.rop.type.Prototype getPrototype() {
        return prototype;
    }
     ...
     */
    @Override
    public final void popArgs(com.pranav.ide.dx.cf.code.Frame frame, int count) {
        com.pranav.ide.dx.cf.code.ExecutionStack stack = frame.getStack();

        clearArgs();

        if (count > args.length) {
            // Grow args, and add a little extra room to grow even more.
            args = new com.pranav.ide.dx.rop.type.TypeBearer[count + 10];
        }
     ...
     */
    @Override
    public void popArgs(com.pranav.ide.dx.cf.code.Frame frame, Prototype prototype) {
        ...
        for (int i = 0; i < size; i++) {
            if (!com.pranav.ide.dx.cf.code.Merger.isPossiblyAssignableFrom(types.getType(i), args[i])) {
    ...
    @Override
    public final void popArgs(com.pranav.ide.dx.cf.code.Frame frame, com.pranav.ide.dx.rop.type.Type type) {
        // Use the above method to do the actual popping...
        popArgs(frame, 1);

        // ...and then verify the popped type.
        if (!com.pranav.ide.dx.cf.code.Merger.isPossiblyAssignableFrom(type, args[0])) {
     ...
     */
    @Override
    public final void popArgs(com.pranav.ide.dx.cf.code.Frame frame, com.pranav.ide.dx.rop.type.Type type1, com.pranav.ide.dx.rop.type.Type type2) {
        // Use the above method to do the actual popping...
        popArgs(frame, 2);

        // ...and then verify the popped types.

        if (!com.pranav.ide.dx.cf.code.Merger.isPossiblyAssignableFrom(type1, args[0])) {
            throw new SimException("expected type " + type1.toHuman() +
                    " but found " + args[0].getType().toHuman());
        }

        if (!com.pranav.ide.dx.cf.code.Merger.isPossiblyAssignableFrom(type2, args[1])) {
    ...
    @Override
    public final void popArgs(com.pranav.ide.dx.cf.code.Frame frame, com.pranav.ide.dx.rop.type.Type type1, com.pranav.ide.dx.rop.type.Type type2,
                              com.pranav.ide.dx.rop.type.Type type3) {
        // Use the above method to do the actual popping...
        popArgs(frame, 3);
        ...
        if (!com.pranav.ide.dx.cf.code.Merger.isPossiblyAssignableFrom(type3, args[2])) {
     ...
     */
    @Override
    public final void localArg(com.pranav.ide.dx.cf.code.Frame frame, int idx) {
        clearArgs();
     ...
     */
    @Override
    public final void auxType(com.pranav.ide.dx.rop.type.Type type) {
        auxType = type;
    }
     ...
     */
    @Override
    public final void auxCstArg(com.pranav.ide.dx.rop.cst.Constant cst) {
        if (cst == null) {
     ...
     */
    @Override
    public final void auxSwitchArg(com.pranav.ide.dx.cf.code.SwitchList cases) {
        if (cases == null) {
     ...
     */
    @Override
    public final void auxInitValues(ArrayList<com.pranav.ide.dx.rop.cst.Constant> initValues) {
     ...
     */
    @Override
    public final void localTarget(int idx, com.pranav.ide.dx.rop.type.Type type, LocalItem local) {
        localTarget = com.pranav.ide.dx.rop.code.RegisterSpec.makeLocalOptional(idx, type, local);
    }
     ...
     */
    protected final com.pranav.ide.dx.rop.type.TypeBearer arg(int n) {
        if (n >= argCount) {
     ...
     */
    protected final com.pranav.ide.dx.rop.type.Type getAuxType() {
        return auxType;
    }
     ...
     */
    protected final com.pranav.ide.dx.rop.cst.Constant getAuxCst() {
        return auxCst;
    }
    ...
    protected final RegisterSpec getLocalTarget(boolean isMove) {
        ...
        com.pranav.ide.dx.rop.type.TypeBearer result = results[0];
        com.pranav.ide.dx.rop.type.Type resultType = result.getType();
        com.pranav.ide.dx.rop.type.Type localType = localTarget.getType();
     ...
     */
    protected final void setResult(com.pranav.ide.dx.rop.type.TypeBearer result) {
        if (result == null) {
     ...
     * @see #setResult
     */
    protected final void addResult(com.pranav.ide.dx.rop.type.TypeBearer result) {
        if (result == null) {
            throw new NullPointerException("result == null");
        }
     ...
     */
    protected final com.pranav.ide.dx.rop.type.TypeBearer result(int n) {
        if (n >= resultCount) {
