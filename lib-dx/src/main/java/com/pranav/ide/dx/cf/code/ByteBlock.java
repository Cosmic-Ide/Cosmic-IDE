...
public final class ByteBlock implements LabeledItem {
     ...
     */
    private final com.pranav.ide.dx.util.IntList successors;
     ...
     *                   handler targets
     */
    public ByteBlock(int label, int start, int end, com.pranav.ide.dx.util.IntList successors,
                     com.pranav.ide.dx.cf.code.ByteCatchList catches) {
        if (label < 0) {
    ...
    public String toString() {
        return '{' + com.pranav.ide.dx.util.Hex.u2(label) + ": " + com.pranav.ide.dx.util.Hex.u2(start) + ".." +
                Hex.u2(end) + '}';
    }
