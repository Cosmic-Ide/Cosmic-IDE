...
public final class ExecutionStack extends MutabilityControl {
     ...
     */
    private final com.pranav.ide.dx.rop.type.TypeBearer[] stack;
    ...
    public ExecutionStack(int maxStack) {
        super(maxStack != 0);
        stack = new com.pranav.ide.dx.rop.type.TypeBearer[maxStack];
     ...
     */
    private static String stackElementString(com.pranav.ide.dx.rop.type.TypeBearer type) {
        if (type == null) {
            return "<invalid>";
        }
     ...
     *                      stack for the value
     */
    public void push(com.pranav.ide.dx.rop.type.TypeBearer type) {
        throwIfImmutable();
     ...
     */
    public com.pranav.ide.dx.rop.type.TypeBearer peek(int n) {
        if (n < 0) {
     ...
     */
    public com.pranav.ide.dx.rop.type.TypeBearer pop() {
        throwIfImmutable();

        com.pranav.ide.dx.rop.type.TypeBearer result = peek(0);
     ...
     */
    public void change(int n, com.pranav.ide.dx.rop.type.TypeBearer type) {
        throwIfImmutable();
        ...
        com.pranav.ide.dx.rop.type.TypeBearer orig = stack[idx];
