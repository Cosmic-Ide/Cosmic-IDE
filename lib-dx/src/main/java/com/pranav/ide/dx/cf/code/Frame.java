...
public final class Frame {
     ...
     */
    private final com.pranav.ide.dx.cf.code.LocalsArray locals;

    /**
     * {@code non-null;} the stack
     */
    private final com.pranav.ide.dx.cf.code.ExecutionStack stack;

    /**
     * {@code null-ok;} stack of labels of subroutines that this block is nested in
     */
    private final com.pranav.ide.dx.util.IntList subroutines;
     ...
     */
    private Frame(com.pranav.ide.dx.cf.code.LocalsArray locals, com.pranav.ide.dx.cf.code.ExecutionStack stack) {
        this(locals, stack, com.pranav.ide.dx.util.IntList.EMPTY);
    }
     ...
     */
    private Frame(com.pranav.ide.dx.cf.code.LocalsArray locals,
                  com.pranav.ide.dx.cf.code.ExecutionStack stack, com.pranav.ide.dx.util.IntList subroutines) {
        if (locals == null) {
    ...
    public Frame(int maxLocals, int maxStack) {
        this(new OneLocalsArray(maxLocals), new com.pranav.ide.dx.cf.code.ExecutionStack(maxStack));
    }
     ...
     */
    private static com.pranav.ide.dx.cf.code.LocalsArray adjustLocalsForSubroutines(
            com.pranav.ide.dx.cf.code.LocalsArray locals, com.pranav.ide.dx.util.IntList subroutines) {
     ...
     */
    public void makeInitialized(com.pranav.ide.dx.rop.type.Type type) {
     ...
     */
    public com.pranav.ide.dx.cf.code.LocalsArray getLocals() {
        return locals;
    }
     ...
     */
    public com.pranav.ide.dx.cf.code.ExecutionStack getStack() {
        return stack;
    }
     ...
     */
    public com.pranav.ide.dx.util.IntList getSubroutines() {
        return subroutines;
    }
    ...
    public Frame subFrameForLabel(int startLabel, int subLabel) {
        com.pranav.ide.dx.cf.code.LocalsArray subLocals = null;

        if (locals instanceof LocalsArraySet) {
            subLocals = ((LocalsArraySet) locals).subArrayForLabel(subLabel);
        }

        com.pranav.ide.dx.util.IntList newSubroutines;
        try {
    ...
    public Frame mergeWith(Frame other) {
        com.pranav.ide.dx.cf.code.LocalsArray resultLocals;
        com.pranav.ide.dx.cf.code.ExecutionStack resultStack;
        com.pranav.ide.dx.util.IntList resultSubroutines;
     ...
     */
    private com.pranav.ide.dx.util.IntList mergeSubroutineLists(com.pranav.ide.dx.util.IntList otherSubroutines) {
        if (subroutines.equals(otherSubroutines)) {
            return subroutines;
        }

        com.pranav.ide.dx.util.IntList resultSubroutines = new com.pranav.ide.dx.util.IntList();
    ...
    public Frame mergeWithSubroutineCaller(Frame other, int subLabel,
        ...
        com.pranav.ide.dx.util.IntList newOtherSubroutines = other.subroutines.mutableCopy();
        ...
        if (subroutines.equals(newOtherSubroutines)) {
             ...
             */
            com.pranav.ide.dx.util.IntList nonResultSubroutines;
    ...
    public Frame makeNewSubroutineStartFrame(int subLabel, int callerLabel) {
        com.pranav.ide.dx.util.IntList newSubroutines = subroutines.mutableCopy();
