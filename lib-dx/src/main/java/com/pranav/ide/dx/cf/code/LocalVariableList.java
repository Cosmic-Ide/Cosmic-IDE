...
public final class LocalVariableList extends FixedSizeList {
    ...
    public static LocalVariableList mergeDescriptorsAndSignatures(
        ...
        for (int i = 0; i < descriptorSize; i++) {
            ...
            if (signatureItem != null) {
                com.pranav.ide.dx.rop.cst.CstString signature = signatureItem.getSignature();
     ...
     */
    public void set(int n, int startPc, int length, com.pranav.ide.dx.rop.cst.CstString name,
                    com.pranav.ide.dx.rop.cst.CstString descriptor, com.pranav.ide.dx.rop.cst.CstString signature, int index) {
    ...
    public static class Item {
         ...
         */
        private final com.pranav.ide.dx.rop.cst.CstString name;

        /**
         * {@code null-ok;} the variable's type descriptor
         */
        private final com.pranav.ide.dx.rop.cst.CstString descriptor;

        /**
         * {@code null-ok;} the variable's type signature
         */
        private final com.pranav.ide.dx.rop.cst.CstString signature;
         ...
         * @param index      {@code >= 0;} the variable's local index
         */
        public Item(int startPc, int length, com.pranav.ide.dx.rop.cst.CstString name,
                    com.pranav.ide.dx.rop.cst.CstString descriptor, com.pranav.ide.dx.rop.cst.CstString signature, int index) {
            if (startPc < 0) {
         ...
         */
        public com.pranav.ide.dx.rop.cst.CstString getDescriptor() {
            return descriptor;
        }
         ...
         * @return {@code null-ok;} the variable's type descriptor
         */
        public com.pranav.ide.dx.rop.code.LocalItem getLocalItem() {
         ...
         */
        private com.pranav.ide.dx.rop.cst.CstString getSignature() {
            return signature;
        }
         ...
         */
        public com.pranav.ide.dx.rop.type.Type getType() {
