...
public abstract class LocalsArray extends MutabilityControl implements ToHuman {
     ...
     */
    public abstract void set(int idx, com.pranav.ide.dx.rop.type.TypeBearer type);
     ...
     */
    public abstract com.pranav.ide.dx.rop.type.TypeBearer getOrNull(int idx);
     ...
     */
    public abstract com.pranav.ide.dx.rop.type.TypeBearer get(int idx);
     ...
     *                      category-2 value
     */
    public abstract com.pranav.ide.dx.rop.type.TypeBearer getCategory1(int idx);
