 ...
 */
public class LocalsArraySet extends com.pranav.ide.dx.cf.code.LocalsArray {
     ...
     */
    private final com.pranav.ide.dx.cf.code.OneLocalsArray primary;

    /**
     * Indexed by label of caller block: the locals specific to each caller's
     * invocation of the subroutine.
     */
    private final ArrayList<com.pranav.ide.dx.cf.code.LocalsArray> secondaries;
    ...
    public LocalsArraySet(int maxLocals) {
        super(maxLocals != 0);
        primary = new com.pranav.ide.dx.cf.code.OneLocalsArray(maxLocals);
     ...
     *                    caller label.
     */
    public LocalsArraySet(com.pranav.ide.dx.cf.code.OneLocalsArray primary,
                          ArrayList<com.pranav.ide.dx.cf.code.LocalsArray> secondaries) {
    ...
    private LocalsArraySet(LocalsArraySet toCopy) {
        ...
        for (int i = 0; i < sz; i++) {
            com.pranav.ide.dx.cf.code.LocalsArray la = toCopy.secondaries.get(i);
    ...
    public void setImmutable() {
        ...
        for (com.pranav.ide.dx.cf.code.LocalsArray la : secondaries) {
            if (la != null) {
                la.setImmutable();
            }
        }
     ...
     */
    @Override
    public com.pranav.ide.dx.cf.code.LocalsArray copy() {
    ...
    public void annotate(ExceptionWithContext ex) {
        ...
        for (int label = 0; label < sz; label++) {
            com.pranav.ide.dx.cf.code.LocalsArray la = secondaries.get(label);
        ...
        for (int label = 0; label < sz; label++) {
            ...
            if (la != null) {
                sb.append("(locals array set: primary for caller ")
                        .append(Hex.u2(label)).append(")\n")
                        .append(la.getPrimary().toHuman())
                        .append('\n');
            }
        }
     ...
     */
    @Override
    public void set(int idx, com.pranav.ide.dx.rop.type.TypeBearer type) {
        throwIfImmutable();
     ...
     */
    @Override
    public com.pranav.ide.dx.rop.type.TypeBearer getOrNull(int idx) {
     ...
     */
    @Override
    public com.pranav.ide.dx.rop.type.TypeBearer get(int idx) {
     ...
     */
    @Override
    public com.pranav.ide.dx.rop.type.TypeBearer getCategory1(int idx) {
    ...
    private LocalsArraySet mergeWithSet(LocalsArraySet other) {
        com.pranav.ide.dx.cf.code.OneLocalsArray newPrimary;
        ArrayList<com.pranav.ide.dx.cf.code.LocalsArray> newSecondaries;
        ...
        for (int i = 0; i < sz; i++) {
            com.pranav.ide.dx.cf.code.LocalsArray la1 = (i < sz1 ? secondaries.get(i) : null);
            com.pranav.ide.dx.cf.code.LocalsArray la2 = (i < sz2 ? other.secondaries.get(i) : null);
            com.pranav.ide.dx.cf.code.LocalsArray resultla = null;
            ...
            if (la1 == la2) {
                ...
                try {
                    ...
                    ex.addContext(
                            "Merging locals set for caller block " + com.pranav.ide.dx.util.Hex.u2(i));
                }
            }
     ...
     * new merged instance.
     */
    private LocalsArraySet mergeWithOne(com.pranav.ide.dx.cf.code.OneLocalsArray other) {
        com.pranav.ide.dx.cf.code.OneLocalsArray newPrimary;
        ArrayList<com.pranav.ide.dx.cf.code.LocalsArray> newSecondaries;
        boolean secondariesChanged = false;
        ...
        int sz = secondaries.size();
        for (int i = 0; i < sz; i++) {
            com.pranav.ide.dx.cf.code.LocalsArray la = secondaries.get(i);
            com.pranav.ide.dx.cf.code.LocalsArray resultla = null;
     ...
     */
    @Override
    public LocalsArraySet merge(com.pranav.ide.dx.cf.code.LocalsArray other) {
        ...
        try {
            if (other instanceof LocalsArraySet) {
                ...
                result = mergeWithOne((com.pranav.ide.dx.cf.code.OneLocalsArray) other);
            }
        } catch (SimException ex) {
     ...
     */
    private com.pranav.ide.dx.cf.code.LocalsArray getSecondaryForLabel(int label) {
    ...
    (com.pranav.ide.dx.cf.code.LocalsArray other, int predLabel) {

        com.pranav.ide.dx.cf.code.LocalsArray mine = getSecondaryForLabel(predLabel);
        com.pranav.ide.dx.cf.code.LocalsArray newSecondary;
        com.pranav.ide.dx.cf.code.OneLocalsArray newPrimary;
        ...
        if ((newSecondary == mine) && (newPrimary == primary)) {
            ...
            ArrayList<com.pranav.ide.dx.cf.code.LocalsArray> newSecondaries = new ArrayList<>(sz);
            for (int i = 0; i < sz; i++) {
                com.pranav.ide.dx.cf.code.LocalsArray la = null;
     ...
     * is not in this set.
     */
    public com.pranav.ide.dx.cf.code.LocalsArray subArrayForLabel(int subLabel) {
