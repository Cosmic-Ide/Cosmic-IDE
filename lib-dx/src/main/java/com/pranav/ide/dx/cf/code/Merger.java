...
public final class Merger {
     ...
     */
    public static com.pranav.ide.dx.cf.code.OneLocalsArray mergeLocals(com.pranav.ide.dx.cf.code.OneLocalsArray locals1,
                                                                       com.pranav.ide.dx.cf.code.OneLocalsArray locals2) {
        if (locals1 == locals2) {
            // Easy out.
            return locals1;
        }
        ...
        for (int i = 0; i < sz; i++) {
            com.pranav.ide.dx.rop.type.TypeBearer tb1 = locals1.getOrNull(i);
            com.pranav.ide.dx.rop.type.TypeBearer tb2 = locals2.getOrNull(i);
            com.pranav.ide.dx.rop.type.TypeBearer resultType = mergeType(tb1, tb2);
            if (resultType != tb1) {
                /*
     ...
     */
    public static com.pranav.ide.dx.cf.code.ExecutionStack mergeStack(com.pranav.ide.dx.cf.code.ExecutionStack stack1,
                                                                      com.pranav.ide.dx.cf.code.ExecutionStack stack2) {
        if (stack1 == stack2) {
            // Easy out.
            return stack1;
        }
        ...
        for (int i = 0; i < sz; i++) {
            com.pranav.ide.dx.rop.type.TypeBearer tb1 = stack1.peek(i);
            com.pranav.ide.dx.rop.type.TypeBearer tb2 = stack2.peek(i);
            com.pranav.ide.dx.rop.type.TypeBearer resultType = mergeType(tb1, tb2);
            if (resultType != tb1) {
                /*
                 * We only need to do anything when the result differs
     ...
     */
    public static com.pranav.ide.dx.rop.type.TypeBearer mergeType(com.pranav.ide.dx.rop.type.TypeBearer ft1, com.pranav.ide.dx.rop.type.TypeBearer ft2) {
        if ((ft1 == null) || ft1.equals(ft2)) {
            return ft1;
        } else if (ft2 == null) {
            return null;
        } else {
            com.pranav.ide.dx.rop.type.Type type1 = ft1.getType();
            com.pranav.ide.dx.rop.type.Type type2 = ft2.getType();

            if (type1 == type2) {
                return type1;
            } else if (type1.isReference() && type2.isReference()) {
                if (type1 == com.pranav.ide.dx.rop.type.Type.KNOWN_NULL) {
                    /*
                     * A known-null merges with any other reference type to
                     * be that reference type.
                     */
                    return type2;
                } else if (type2 == com.pranav.ide.dx.rop.type.Type.KNOWN_NULL) {
                    /*
                    ...
                    com.pranav.ide.dx.rop.type.TypeBearer componentUnion =
                    ...
                    if (componentUnion == null) {
                         ...
                         */
                        return com.pranav.ide.dx.rop.type.Type.OBJECT;
                    }
                    return ((com.pranav.ide.dx.rop.type.Type) componentUnion).getArrayType();
                } else {
                    /*
                 ...
                 * the type int.
                 */
                return com.pranav.ide.dx.rop.type.Type.INT;
            } else {
                return null;
            }
        }
     ...
     */
    public static boolean isPossiblyAssignableFrom(com.pranav.ide.dx.rop.type.TypeBearer supertypeBearer,
                                                   TypeBearer subtypeBearer) {
        com.pranav.ide.dx.rop.type.Type supertype = supertypeBearer.getType();
        com.pranav.ide.dx.rop.type.Type subtype = subtypeBearer.getType();
        ...
        if (superBt == com.pranav.ide.dx.rop.type.Type.BT_ADDR) {
            supertype = com.pranav.ide.dx.rop.type.Type.OBJECT;
            superBt = com.pranav.ide.dx.rop.type.Type.BT_OBJECT;
        }

        if (subBt == com.pranav.ide.dx.rop.type.Type.BT_ADDR) {
            subtype = com.pranav.ide.dx.rop.type.Type.OBJECT;
            subBt = com.pranav.ide.dx.rop.type.Type.BT_OBJECT;
        }

        if ((superBt != com.pranav.ide.dx.rop.type.Type.BT_OBJECT) || (subBt != com.pranav.ide.dx.rop.type.Type.BT_OBJECT)) {
            /*
        ...
        if (supertype == com.pranav.ide.dx.rop.type.Type.KNOWN_NULL) {
            /*
             ...
             */
            return false;
        } else if (subtype == com.pranav.ide.dx.rop.type.Type.KNOWN_NULL) {
            /*
             * A known-null subtype is in fact assignable to any
             * reference type.
             */
            return true;
        } else if (supertype == com.pranav.ide.dx.rop.type.Type.OBJECT) {
            /*
             ...
             */
            return (supertype == com.pranav.ide.dx.rop.type.Type.SERIALIZABLE) ||
