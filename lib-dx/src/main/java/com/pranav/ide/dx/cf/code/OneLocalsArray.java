...
public class OneLocalsArray extends LocalsArray {
     ...
     */
    private final com.pranav.ide.dx.rop.type.TypeBearer[] locals;
    ...
    public OneLocalsArray(int maxLocals) {
        super(maxLocals != 0);
        locals = new com.pranav.ide.dx.rop.type.TypeBearer[maxLocals];
    }
    ...
    public void annotate(ExceptionWithContext ex) {
        for (int i = 0; i < locals.length; i++) {
            com.pranav.ide.dx.rop.type.TypeBearer type = locals[i];
            String s = (type == null) ? "<invalid>" : type.toString();
            ex.addContext("locals[" + com.pranav.ide.dx.util.Hex.u2(i) + "]: " + s);
        }
    }
    ...
    public String toHuman() {
        ...
        for (int i = 0; i < locals.length; i++) {
            com.pranav.ide.dx.rop.type.TypeBearer type = locals[i];
            String s = (type == null) ? "<invalid>" : type.toString();
            sb.append("locals[" + com.pranav.ide.dx.util.Hex.u2(i) + "]: " + s + "\n");
        }
    ...
    public void makeInitialized(com.pranav.ide.dx.rop.type.Type type) {
        ...
        com.pranav.ide.dx.rop.type.Type initializedType = type.getInitializedType();
    ...
    public void set(int idx, com.pranav.ide.dx.rop.type.TypeBearer type) {
        ...
        if (idx != 0) {
            com.pranav.ide.dx.rop.type.TypeBearer prev = locals[idx - 1];
    ...
    public com.pranav.ide.dx.rop.type.TypeBearer get(int idx) {
        com.pranav.ide.dx.rop.type.TypeBearer result = locals[idx];
    ...
    public com.pranav.ide.dx.rop.type.TypeBearer getCategory1(int idx) {
        com.pranav.ide.dx.rop.type.TypeBearer result = get(idx);
     ...
     */
    @Override
    public com.pranav.ide.dx.rop.type.TypeBearer getCategory2(int idx) {
        com.pranav.ide.dx.rop.type.TypeBearer result = get(idx);
