...
import com.pranav.ide.dx.rop.code.FillArrayDataInsn;
import com.pranav.ide.dx.rop.code.Insn;
import com.pranav.ide.dx.rop.code.InvokePolymorphicInsn;
...
import com.pranav.ide.dx.rop.code.SwitchInsn;
...
/**
 * Machine implementation for use by {@link com.pranav.ide.dx.cf.code.Ropper}.
 */
/*package*/ final class RopperMachine extends ValueAwareMachine {
    /**
     * {@code non-null;} array reflection class
     */
    private static final com.pranav.ide.dx.rop.cst.CstType ARRAY_REFLECT_TYPE =
            new com.pranav.ide.dx.rop.cst.CstType(com.pranav.ide.dx.rop.type.Type.internClassName("java/lang/reflect/Array"));

    /**
     * {@code non-null;} method constant for use in converting
     * {@code multianewarray} instructions
     */
    private static final com.pranav.ide.dx.rop.cst.CstMethodRef MULTIANEWARRAY_METHOD =
            new com.pranav.ide.dx.rop.cst.CstMethodRef(ARRAY_REFLECT_TYPE,
                    new CstNat(new com.pranav.ide.dx.rop.cst.CstString("newInstance"),
                            new CstString("(Ljava/lang/Class;[I)" +
                                    "Ljava/lang/Object;")));

    /**
     * {@code non-null;} {@link com.pranav.ide.dx.cf.code.Ropper} controlling this instance
     */
    private final com.pranav.ide.dx.cf.code.Ropper ropper;
     ...
     */
    private final com.pranav.ide.dx.rop.code.TranslationAdvice advice;
     ...
     */
    private final ArrayList<com.pranav.ide.dx.rop.code.Insn> insns;

    /**
     * {@code non-null;} catches for the block currently being processed
     */
    private com.pranav.ide.dx.rop.type.TypeList catches;
     ...
     */
    private com.pranav.ide.dx.rop.code.Rop returnOp;

    /**
     * {@code null-ok;} the source position for the return block or {@code null}
     * if it is not yet known
     */
    private com.pranav.ide.dx.rop.code.SourcePosition returnPosition;
    ...
    public RopperMachine(Ropper ropper, ConcreteMethod method,
        ...
        this.insns = new ArrayList<com.pranav.ide.dx.rop.code.Insn>(25);
        this.catches = null;
     ...
     */
    public ArrayList<com.pranav.ide.dx.rop.code.Insn> getInsns() {
        return insns;
    }
     ...
     */
    public com.pranav.ide.dx.rop.code.Rop getReturnOp() {
        return returnOp;
    }
     ...
     */
    public com.pranav.ide.dx.rop.code.SourcePosition getReturnPosition() {
     ...
     */
    public void startBlock(com.pranav.ide.dx.rop.type.TypeList catches) {
    ...
    public void run(Frame frame, int offset, int opcode) {
        ...
        com.pranav.ide.dx.rop.code.RegisterSpecList sources = getSources(opcode, stackPointer);
        int sourceCount = sources.size();

        super.run(frame, offset, opcode);

        com.pranav.ide.dx.rop.code.SourcePosition pos = method.makeSourcePosistion(offset);
        com.pranav.ide.dx.rop.code.RegisterSpec localTarget = getLocalTarget(opcode == com.pranav.ide.dx.cf.code.ByteOps.ISTORE);
        int destCount = resultCount();
        com.pranav.ide.dx.rop.code.RegisterSpec dest;
        ...
        if (destCount == 0) {
            ...
            dest = com.pranav.ide.dx.rop.code.RegisterSpec.make(stackPointer, result(0));
        } else {
            /*
            ...
            com.pranav.ide.dx.rop.code.RegisterSpec[] scratchRegs = new com.pranav.ide.dx.rop.code.RegisterSpec[sourceCount];

            for (int i = 0; i < sourceCount; i++) {
                com.pranav.ide.dx.rop.code.RegisterSpec src = sources.get(i);
                com.pranav.ide.dx.rop.type.TypeBearer type = src.getTypeBearer();
                com.pranav.ide.dx.rop.code.RegisterSpec scratch = src.withReg(scratchAt);
                insns.add(new com.pranav.ide.dx.rop.code.PlainInsn(com.pranav.ide.dx.rop.code.Rops.opMove(type), pos, scratch, src));
            ...
            for (int pattern = getAuxInt(); pattern != 0; pattern >>= 4) {
                ...
                com.pranav.ide.dx.rop.code.RegisterSpec scratch = scratchRegs[which];
                com.pranav.ide.dx.rop.type.TypeBearer type = scratch.getTypeBearer();
                insns.add(new com.pranav.ide.dx.rop.code.PlainInsn(com.pranav.ide.dx.rop.code.Rops.opMove(type), pos,
        ...
        com.pranav.ide.dx.rop.type.TypeBearer destType = (dest != null) ? dest : com.pranav.ide.dx.rop.type.Type.VOID;
        com.pranav.ide.dx.rop.cst.Constant cst = getAuxCst();
        int ropOpcode;
        com.pranav.ide.dx.rop.code.Rop rop;
        ...
        if (opcode == com.pranav.ide.dx.cf.code.ByteOps.MULTIANEWARRAY) {
             ...
             * dimensions.
             */
            com.pranav.ide.dx.rop.code.RegisterSpec dimsReg =
                    com.pranav.ide.dx.rop.code.RegisterSpec.make(dest.getNextReg(), com.pranav.ide.dx.rop.type.Type.INT_ARRAY);
            rop = com.pranav.ide.dx.rop.code.Rops.opFilledNewArray(com.pranav.ide.dx.rop.type.Type.INT_ARRAY, sourceCount);
            insn = new com.pranav.ide.dx.rop.code.ThrowingCstInsn(rop, pos, sources, catches,
                    com.pranav.ide.dx.rop.cst.CstType.INT_ARRAY);
            insns.add(insn);

            // Add a move-result for the new-filled-array
            rop = com.pranav.ide.dx.rop.code.Rops.opMoveResult(com.pranav.ide.dx.rop.type.Type.INT_ARRAY);
            insn = new com.pranav.ide.dx.rop.code.PlainInsn(rop, pos, dimsReg, com.pranav.ide.dx.rop.code.RegisterSpecList.EMPTY);
            insns.add(insn);
             ...
             */
            com.pranav.ide.dx.rop.type.Type componentType = ((com.pranav.ide.dx.rop.cst.CstType) cst).getClassType();
            for (int i = 0; i < sourceCount; i++) {
                componentType = componentType.getComponentType();
            }

            com.pranav.ide.dx.rop.code.RegisterSpec classReg =
                    com.pranav.ide.dx.rop.code.RegisterSpec.make(dest.getReg(), com.pranav.ide.dx.rop.type.Type.CLASS);
            ...
            if (componentType.isPrimitive()) {
                 ...
                 * TYPE class.
                 */
                com.pranav.ide.dx.rop.cst.CstFieldRef typeField =
                        CstFieldRef.forPrimitiveType(componentType);
                insn = new com.pranav.ide.dx.rop.code.ThrowingCstInsn(com.pranav.ide.dx.rop.code.Rops.GET_STATIC_OBJECT, pos,
                 ...
                 */
                insn = new com.pranav.ide.dx.rop.code.ThrowingCstInsn(com.pranav.ide.dx.rop.code.Rops.CONST_OBJECT, pos,
                        com.pranav.ide.dx.rop.code.RegisterSpecList.EMPTY, catches,
                        new com.pranav.ide.dx.rop.cst.CstType(componentType));
            }

            insns.add(insn);

            // Add a move-result-pseudo for the get-static or const
            rop = com.pranav.ide.dx.rop.code.Rops.opMoveResultPseudo(classReg.getType());
            insn = new com.pranav.ide.dx.rop.code.PlainInsn(rop, pos, classReg, com.pranav.ide.dx.rop.code.RegisterSpecList.EMPTY);
            insns.add(insn);
            ...
            com.pranav.ide.dx.rop.code.RegisterSpec objectReg =
                    com.pranav.ide.dx.rop.code.RegisterSpec.make(dest.getReg(), com.pranav.ide.dx.rop.type.Type.OBJECT);

            insn = new com.pranav.ide.dx.rop.code.ThrowingCstInsn(
                    com.pranav.ide.dx.rop.code.Rops.opInvokeStatic(MULTIANEWARRAY_METHOD.getPrototype()),
                    pos, com.pranav.ide.dx.rop.code.RegisterSpecList.make(classReg, dimsReg),
                    catches, MULTIANEWARRAY_METHOD);
            insns.add(insn);

            // Add a move-result.
            rop = com.pranav.ide.dx.rop.code.Rops.opMoveResult(MULTIANEWARRAY_METHOD.getPrototype()
                    .getReturnType());
            insn = new com.pranav.ide.dx.rop.code.PlainInsn(rop, pos, objectReg, com.pranav.ide.dx.rop.code.RegisterSpecList.EMPTY);
            insns.add(insn);
            ...
            opcode = com.pranav.ide.dx.cf.code.ByteOps.CHECKCAST;
            sources = com.pranav.ide.dx.rop.code.RegisterSpecList.make(objectReg);
        } else if (opcode == com.pranav.ide.dx.cf.code.ByteOps.JSR) {
            // JSR has no Rop instruction
            hasJsr = true;
            return;
        } else if (opcode == com.pranav.ide.dx.cf.code.ByteOps.RET) {
            try {
        ...
        rop = com.pranav.ide.dx.rop.code.Rops.ropFor(ropOpcode, destType, sources, cst);

        com.pranav.ide.dx.rop.code.Insn moveResult = null;
        if (dest != null && rop.isCallLike()) {
            ...
            Type returnType;
            if (rop.getOpcode() == com.pranav.ide.dx.rop.code.RegOps.INVOKE_CUSTOM) {
                returnType = ((CstCallSiteRef) cst).getReturnType();
            } else {
                returnType = ((com.pranav.ide.dx.rop.cst.CstMethodRef) cst).getPrototype().getReturnType();
            }
            moveResult = new com.pranav.ide.dx.rop.code.PlainInsn(com.pranav.ide.dx.rop.code.Rops.opMoveResult(returnType),
                    pos, dest, com.pranav.ide.dx.rop.code.RegisterSpecList.EMPTY);
            ...
            moveResult = new com.pranav.ide.dx.rop.code.PlainInsn(
                    com.pranav.ide.dx.rop.code.Rops.opMoveResultPseudo(dest.getTypeBearer()),
                    pos, dest, com.pranav.ide.dx.rop.code.RegisterSpecList.EMPTY);

            dest = null;
        }
        if (ropOpcode == com.pranav.ide.dx.rop.code.RegOps.NEW_ARRAY) {
            /*
            ...
            com.pranav.ide.dx.rop.type.TypeBearer firstType = sources.get(0).getTypeBearer();
            com.pranav.ide.dx.rop.type.TypeBearer lastType = sources.get(1).getTypeBearer();
            ...
            if ((lastType.isConstant() || firstType.isConstant()) &&
                ...
                if (lastType.isConstant()) {
                     ...
                     * constant here.
                     */
                    cst = (com.pranav.ide.dx.rop.cst.Constant) lastType;
                    sources = sources.withoutLast();

                    // For subtraction, change to addition and invert constant
                    if (rop.getOpcode() == com.pranav.ide.dx.rop.code.RegOps.SUB) {
                        ropOpcode = com.pranav.ide.dx.rop.code.RegOps.ADD;
                        com.pranav.ide.dx.rop.cst.CstInteger cstInt = (com.pranav.ide.dx.rop.cst.CstInteger) lastType;
                     ...
                     * constant here.
                     */
                    cst = (com.pranav.ide.dx.rop.cst.Constant) firstType;
        ...
        ArrayList<com.pranav.ide.dx.rop.cst.Constant> initValues = getInitValues();
        ...
        if (cases != null) {
            if (cases.size() == 0) {
                ...
                insn = new com.pranav.ide.dx.rop.code.PlainInsn(com.pranav.ide.dx.rop.code.Rops.GOTO, pos, null,
                        com.pranav.ide.dx.rop.code.RegisterSpecList.EMPTY);
                primarySuccessorIndex = 0;
            } else {
        ...
        } else if (ropOpcode == com.pranav.ide.dx.rop.code.RegOps.RETURN) {
            /*
             ...
             */
            if (sources.size() != 0) {
                com.pranav.ide.dx.rop.code.RegisterSpec source = sources.get(0);
                TypeBearer type = source.getTypeBearer();
                if (source.getReg() != 0) {
                    insns.add(new com.pranav.ide.dx.rop.code.PlainInsn(com.pranav.ide.dx.rop.code.Rops.opMove(type), pos,
                            com.pranav.ide.dx.rop.code.RegisterSpec.make(0, type),
                            source));
                }
            }
            insn = new com.pranav.ide.dx.rop.code.PlainInsn(com.pranav.ide.dx.rop.code.Rops.GOTO, pos, null, com.pranav.ide.dx.rop.code.RegisterSpecList.EMPTY);
            primarySuccessorIndex = 0;
            updateReturnOp(rop, pos);
            returns = true;
        } else if (cst != null) {
            if (canThrow) {
                if (rop.getOpcode() == com.pranav.ide.dx.rop.code.RegOps.INVOKE_POLYMORPHIC) {
            ...
            catchesUsed = true;
            if (opcode == com.pranav.ide.dx.cf.code.ByteOps.ATHROW) {
                /*
        ...
        if (initValues != null) {
            ...
            insn = new FillArrayDataInsn(Rops.FILL_ARRAY_DATA, pos,
                    com.pranav.ide.dx.rop.code.RegisterSpecList.make(moveResult.getResult()), initValues,
                    cst);
            insns.add(insn);
        }
    }
     ...
     */
    private com.pranav.ide.dx.rop.code.RegisterSpecList getSources(int opcode, int stackPointer) {
        int count = argCount();

        if (count == 0) {
            // We get an easy out if there aren't any sources.
            return com.pranav.ide.dx.rop.code.RegisterSpecList.EMPTY;
        }
        ...
        if (localIndex >= 0) {
            ...
            sources = new com.pranav.ide.dx.rop.code.RegisterSpecList(1);
            sources.set(0, com.pranav.ide.dx.rop.code.RegisterSpec.make(localIndex, arg(0)));
        } else {
            sources = new com.pranav.ide.dx.rop.code.RegisterSpecList(count);
            int regAt = stackPointer;
            for (int i = 0; i < count; i++) {
                com.pranav.ide.dx.rop.code.RegisterSpec spec = com.pranav.ide.dx.rop.code.RegisterSpec.make(regAt, arg(i));
                sources.set(i, spec);
            ...
            switch (opcode) {
                case com.pranav.ide.dx.cf.code.ByteOps.IASTORE: {
                    ...
                    com.pranav.ide.dx.rop.code.RegisterSpec array = sources.get(0);
                    com.pranav.ide.dx.rop.code.RegisterSpec index = sources.get(1);
                    com.pranav.ide.dx.rop.code.RegisterSpec value = sources.get(2);
                    sources.set(0, value);
                    sources.set(1, array);
                    sources.set(2, index);
                    break;
                ...
                case com.pranav.ide.dx.cf.code.ByteOps.PUTFIELD: {
                    ...
                    com.pranav.ide.dx.rop.code.RegisterSpec obj = sources.get(0);
     ...
     */
    private void updateReturnOp(com.pranav.ide.dx.rop.code.Rop op, com.pranav.ide.dx.rop.code.SourcePosition pos) {
        if (op == null) {
     ...
     */
    private int jopToRopOpcode(int jop, com.pranav.ide.dx.rop.cst.Constant cst) {
        switch (jop) {
            case com.pranav.ide.dx.cf.code.ByteOps.POP:
            case com.pranav.ide.dx.cf.code.ByteOps.POP2:
            ...
            case com.pranav.ide.dx.cf.code.ByteOps.D2F: {
                return com.pranav.ide.dx.rop.code.RegOps.CONV;
            }
            case com.pranav.ide.dx.cf.code.ByteOps.I2B: {
                return com.pranav.ide.dx.rop.code.RegOps.TO_BYTE;
            }
            case com.pranav.ide.dx.cf.code.ByteOps.I2C: {
                return com.pranav.ide.dx.rop.code.RegOps.TO_CHAR;
            }
            case com.pranav.ide.dx.cf.code.ByteOps.I2S: {
                return com.pranav.ide.dx.rop.code.RegOps.TO_SHORT;
            }
            ...
            case com.pranav.ide.dx.cf.code.ByteOps.DCMPL: {
                return com.pranav.ide.dx.rop.code.RegOps.CMPL;
            }
            case com.pranav.ide.dx.cf.code.ByteOps.FCMPG:
            case com.pranav.ide.dx.cf.code.ByteOps.DCMPG: {
                return com.pranav.ide.dx.rop.code.RegOps.CMPG;
            }
            ...
            case com.pranav.ide.dx.cf.code.ByteOps.IFNULL: {
                return com.pranav.ide.dx.rop.code.RegOps.IF_EQ;
            }
            ...
            case com.pranav.ide.dx.cf.code.ByteOps.INVOKEVIRTUAL: {
                ...
                if (ref.getDefiningClass().equals(method.getDefiningClass())) {
                    for (int i = 0; i < methods.size(); ++i) {
                        ...
                        if (AccessFlags.isPrivate(m.getAccessFlags()) &&
                            ...
                            return com.pranav.ide.dx.rop.code.RegOps.INVOKE_DIRECT;
                        }
                    }
                }
                ...
                if (ref.isSignaturePolymorphic()) {
                    return com.pranav.ide.dx.rop.code.RegOps.INVOKE_POLYMORPHIC;
                }
                return com.pranav.ide.dx.rop.code.RegOps.INVOKE_VIRTUAL;
            }
            case com.pranav.ide.dx.cf.code.ByteOps.INVOKESPECIAL: {
                ...
                return com.pranav.ide.dx.rop.code.RegOps.INVOKE_SUPER;
            }
            case com.pranav.ide.dx.cf.code.ByteOps.INVOKESTATIC: {
                return com.pranav.ide.dx.rop.code.RegOps.INVOKE_STATIC;
            }
            case com.pranav.ide.dx.cf.code.ByteOps.INVOKEINTERFACE: {
                return com.pranav.ide.dx.rop.code.RegOps.INVOKE_INTERFACE;
            }
            case com.pranav.ide.dx.cf.code.ByteOps.INVOKEDYNAMIC: {
                return com.pranav.ide.dx.rop.code.RegOps.INVOKE_CUSTOM;
            }
            case com.pranav.ide.dx.cf.code.ByteOps.NEW: {
                return com.pranav.ide.dx.rop.code.RegOps.NEW_INSTANCE;
            }
            case com.pranav.ide.dx.cf.code.ByteOps.NEWARRAY:
            case com.pranav.ide.dx.cf.code.ByteOps.ANEWARRAY: {
                return com.pranav.ide.dx.rop.code.RegOps.NEW_ARRAY;
            }
            case com.pranav.ide.dx.cf.code.ByteOps.ARRAYLENGTH: {
                return com.pranav.ide.dx.rop.code.RegOps.ARRAY_LENGTH;
            }
            case com.pranav.ide.dx.cf.code.ByteOps.ATHROW: {
                return com.pranav.ide.dx.rop.code.RegOps.THROW;
            }
            case com.pranav.ide.dx.cf.code.ByteOps.CHECKCAST: {
                return com.pranav.ide.dx.rop.code.RegOps.CHECK_CAST;
            }
            case com.pranav.ide.dx.cf.code.ByteOps.INSTANCEOF: {
                return com.pranav.ide.dx.rop.code.RegOps.INSTANCE_OF;
            }
            case com.pranav.ide.dx.cf.code.ByteOps.MONITORENTER: {
                return com.pranav.ide.dx.rop.code.RegOps.MONITOR_ENTER;
            }
    ...
    private Insn makeInvokePolymorphicInsn(Rop rop, SourcePosition pos, RegisterSpecList sources,
        ...
        com.pranav.ide.dx.rop.cst.CstMethodRef cstMethodRef = (CstMethodRef) cst;
