...
public final class SwitchList extends MutabilityControl {
     ...
     */
    private final com.pranav.ide.dx.util.IntList values;
     ...
     * default target
     */
    private final com.pranav.ide.dx.util.IntList targets;
    ...
    public SwitchList(int size) {
        super(true);
        this.values = new com.pranav.ide.dx.util.IntList(size);
        this.targets = new com.pranav.ide.dx.util.IntList(size + 1);
        this.size = size;
    }
     ...
     */
    public com.pranav.ide.dx.util.IntList getTargets() {
        return targets;
    }
