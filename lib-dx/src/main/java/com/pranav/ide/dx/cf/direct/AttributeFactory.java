...
import com.pranav.ide.dx.cf.attrib.RawAttribute;
...
public class AttributeFactory {
     ...
     * @return {@code non-null;} an appropriately-constructed {@link com.pranav.ide.dx.cf.iface.Attribute}
     */
    public final com.pranav.ide.dx.cf.iface.Attribute parse(DirectClassFile cf, int context, int offset,
        ...
        com.pranav.ide.dx.rop.cst.CstString name = null;
        ...
        try {
            ...
            if (observer != null) {
                ...
                observer.parsed(bytes, offset + 2, 4,
                        "length: " + com.pranav.ide.dx.util.Hex.u4(length));
            }
     ...
     * an instance of {@link com.pranav.ide.dx.cf.attrib.RawAttribute}. Subclasses are expected to
     ...
     * @return {@code non-null;} an appropriately-constructed {@link com.pranav.ide.dx.cf.iface.Attribute}
     */
    protected com.pranav.ide.dx.cf.iface.Attribute parse0(DirectClassFile cf, int context, String name,
