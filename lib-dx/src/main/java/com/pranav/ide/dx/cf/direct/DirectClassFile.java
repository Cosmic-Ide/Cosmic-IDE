...
import com.pranav.ide.dx.cf.cst.ConstantPoolParser;
import com.pranav.ide.dx.cf.iface.Attribute;
import com.pranav.ide.dx.cf.iface.AttributeList;
import com.pranav.ide.dx.cf.iface.ClassFile;
...
public class DirectClassFile implements ClassFile {
     ...
     */
    private com.pranav.ide.dx.rop.cst.StdConstantPool pool;
     ...
     * before the file is successfully parsed
     */
    private com.pranav.ide.dx.rop.cst.CstType thisClass;

    /**
     * {@code null-ok;} the class file field {@code super_class}, interpreted
     * as a type constant if non-zero
     */
    private com.pranav.ide.dx.rop.cst.CstType superClass;
     ...
     */
    private com.pranav.ide.dx.cf.direct.AttributeFactory attributeFactory;

    /**
     * {@code null-ok;} parse observer, if any
     */
    private com.pranav.ide.dx.cf.iface.ParseObserver observer;
     ...
     *                    path-package consistency checking)
     */
    public DirectClassFile(com.pranav.ide.dx.util.ByteArray bytes, String filePath,
                           boolean strictParse) {
        if (bytes == null) {
    ...
    public DirectClassFile(byte[] bytes, String filePath,
                           boolean strictParse) {
        this(new com.pranav.ide.dx.util.ByteArray(bytes), filePath, strictParse);
    }
     ...
     */
    public void setObserver(com.pranav.ide.dx.cf.iface.ParseObserver observer) {
     ...
     */
    public void setAttributeFactory(com.pranav.ide.dx.cf.direct.AttributeFactory attributeFactory) {
    ...
    /**
     * Gets the {@link com.pranav.ide.dx.util.ByteArray} that this instance's data comes from.
     *
     * @return {@code non-null;} the bytes
     */
    public com.pranav.ide.dx.util.ByteArray getBytes() {
        return bytes;
    }
     ...
     */
    @Override
    public com.pranav.ide.dx.rop.cst.CstType getThisClass() {
        parseToInterfacesIfNecessary();
        return thisClass;
    }
     ...
     */
    @Override
    public com.pranav.ide.dx.rop.cst.CstType getSuperclass() {
        parseToInterfacesIfNecessary();
        return superClass;
    }
     ...
     */
    @Override
    public com.pranav.ide.dx.rop.type.TypeList getInterfaces() {
        parseToInterfacesIfNecessary();
        return interfaces;
    }
     ...
     */
    @Override
    public com.pranav.ide.dx.cf.iface.AttributeList getAttributes() {
        parseToEndIfNecessary();
        return attributes;
    }
     ...
     */
    @Override
    public com.pranav.ide.dx.cf.code.BootstrapMethodsList getBootstrapMethods() {
        com.pranav.ide.dx.cf.attrib.AttBootstrapMethods bootstrapMethodsAttribute =
                (com.pranav.ide.dx.cf.attrib.AttBootstrapMethods) getAttributes().findFirst(AttBootstrapMethods.ATTRIBUTE_NAME);
    ...
    public CstString getSourceFile() {
        ...
        Attribute attSf = attribs.findFirst(com.pranav.ide.dx.cf.attrib.AttSourceFile.ATTRIBUTE_NAME);

        if (attSf instanceof com.pranav.ide.dx.cf.attrib.AttSourceFile) {
    ...
    /**
     * Constructs and returns an instance of {@link com.pranav.ide.dx.rop.type.TypeList} whose
     ...
     */
    public com.pranav.ide.dx.rop.type.TypeList makeTypeList(int offset, int size) {
        if (size == 0) {
    ...
    private void parse() {
        try {
            parse0();
        } catch (com.pranav.ide.dx.cf.iface.ParseException ex) {
            ex.addContext("...while parsing " + filePath);
            throw ex;
        } catch (RuntimeException ex) {
            com.pranav.ide.dx.cf.iface.ParseException pe = new com.pranav.ide.dx.cf.iface.ParseException(ex);
    ...
    private void parse0() {
        if (bytes.size() < 10) {
            throw new com.pranav.ide.dx.cf.iface.ParseException("severely truncated class file");
        }

        if (observer != null) {
            observer.parsed(bytes, 0, 0, "begin classfile");
            observer.parsed(bytes, 0, 4, "magic: " + com.pranav.ide.dx.util.Hex.u4(getMagic0()));
            observer.parsed(bytes, 4, 2,
                    "minor_version: " + com.pranav.ide.dx.util.Hex.u2(getMinorVersion0()));
            observer.parsed(bytes, 6, 2,
                    "major_version: " + com.pranav.ide.dx.util.Hex.u2(getMajorVersion0()));
        }
        ...
        if (strictParse) {
            ...
            if (!isGoodMagic(getMagic0())) {
                throw new com.pranav.ide.dx.cf.iface.ParseException("bad class file magic (" + com.pranav.ide.dx.util.Hex.u4(getMagic0()) + ")");
            }

            if (!isGoodVersion(getMinorVersion0(), getMajorVersion0())) {
                throw new com.pranav.ide.dx.cf.iface.ParseException("unsupported class file version " +
                        getMajorVersion0() + "." +
                        getMinorVersion0());
            }
        }

        com.pranav.ide.dx.cf.cst.ConstantPoolParser cpParser = new ConstantPoolParser(bytes);
        ...
        thisClass = (com.pranav.ide.dx.rop.cst.CstType) pool.get(cpi);
        cpi = bytes.getUnsignedShort(at + 4); // u2 super_class;
        superClass = (com.pranav.ide.dx.rop.cst.CstType) pool.get0Ok(cpi);
        ...
        if (observer != null) {
            ...
            observer.parsed(bytes, at + 6, 2,
                    "interfaces_count: " + com.pranav.ide.dx.util.Hex.u2(count));
            if (count != 0) {
        ...
        if (strictParse) {
            ...
            if (!(filePath.endsWith(".class") &&
                ...
                throw new com.pranav.ide.dx.cf.iface.ParseException("class name (" + thisClassName +
                        ") does not match path (" +
                        filePath + ")");
            }
        }
        ...
        com.pranav.ide.dx.cf.direct.FieldListParser flParser =
                new com.pranav.ide.dx.cf.direct.FieldListParser(this, thisClass, at, attributeFactory);
        flParser.setObserver(observer);
        fields = flParser.getList();
        at = flParser.getEndOffset();

        com.pranav.ide.dx.cf.direct.MethodListParser mlParser =
                new com.pranav.ide.dx.cf.direct.MethodListParser(this, thisClass, at, attributeFactory);
        mlParser.setObserver(observer);
        methods = mlParser.getList();
        at = mlParser.getEndOffset();

        com.pranav.ide.dx.cf.direct.AttributeListParser alParser =
                new com.pranav.ide.dx.cf.direct.AttributeListParser(this, AttributeFactory.CTX_CLASS, at,
                        attributeFactory);
    ...
    /**
     * Implementation of {@link com.pranav.ide.dx.rop.type.TypeList} whose data comes directly
     ...
     * {@code Class}.
     */
    private static class DcfTypeList implements com.pranav.ide.dx.rop.type.TypeList {
        /**
        ...
        public DcfTypeList(ByteArray bytes, int offset, int size,
            ...
            for (int i = 0; i < size; i++) {
                ...
                try {
                    type = (com.pranav.ide.dx.rop.cst.CstType) pool.get(idx);
         ...
         */
        @Override
        public com.pranav.ide.dx.rop.type.Type getType(int n) {
