...
import com.pranav.ide.dx.cf.iface.StdField;
import com.pranav.ide.dx.cf.iface.StdFieldList;
 ...
 */
final /*package*/ class FieldListParser extends com.pranav.ide.dx.cf.direct.MemberListParser {
    /**
     * {@code non-null;} list in progress
     */
    private final com.pranav.ide.dx.cf.iface.StdFieldList fields;
    ...
    public FieldListParser(DirectClassFile cf, CstType definer, int offset,
        ...
        fields = new com.pranav.ide.dx.cf.iface.StdFieldList(getCount());
    }
    ...
    protected Member set(int n, int accessFlags, CstNat nat,
        ...
        com.pranav.ide.dx.cf.iface.StdField field =
