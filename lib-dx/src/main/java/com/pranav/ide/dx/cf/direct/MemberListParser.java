...
import com.pranav.ide.dx.cf.iface.Member;
...
abstract /*package*/ class MemberListParser {
     ...
     */
    private final com.pranav.ide.dx.rop.cst.CstType definer;
     ...
     */
    public MemberListParser(DirectClassFile cf, com.pranav.ide.dx.rop.cst.CstType definer,
     ...
     */
    protected abstract com.pranav.ide.dx.cf.iface.Member set(int n, int accessFlags, com.pranav.ide.dx.rop.cst.CstNat nat,
    ...
    private void parse() {
        ...
        for (int i = 0; i < count; i++) {
            try {
                ...
                com.pranav.ide.dx.rop.cst.CstString desc = (CstString) pool.get(descIdx);
                ...
                com.pranav.ide.dx.rop.cst.CstNat nat = new CstNat(name, desc);
                ...
                com.pranav.ide.dx.cf.iface.ParseException pe = new ParseException(ex);
