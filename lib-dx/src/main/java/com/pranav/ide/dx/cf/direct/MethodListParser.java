...
import com.pranav.ide.dx.cf.iface.StdMethod;
import com.pranav.ide.dx.cf.iface.StdMethodList;
 ...
 */
final /*package*/ class MethodListParser extends com.pranav.ide.dx.cf.direct.MemberListParser {
    /**
     * {@code non-null;} list in progress
     */
    final private com.pranav.ide.dx.cf.iface.StdMethodList methods;
    ...
    public MethodListParser(DirectClassFile cf, CstType definer,
        ...
        methods = new com.pranav.ide.dx.cf.iface.StdMethodList(getCount());
    }
    ...
    protected Member set(int n, int accessFlags, CstNat nat,
        ...
        com.pranav.ide.dx.cf.iface.StdMethod meth =
