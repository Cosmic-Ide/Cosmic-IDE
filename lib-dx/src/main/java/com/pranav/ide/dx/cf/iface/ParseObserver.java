...
public interface ParseObserver {
     ...
     */
    void startParsingMember(com.pranav.ide.dx.util.ByteArray bytes, int offset, String name,
                            String descriptor);
     ...
     */
    void endParsingMember(com.pranav.ide.dx.util.ByteArray bytes, int offset, String name,
