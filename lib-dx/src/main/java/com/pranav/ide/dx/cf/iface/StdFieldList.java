...
/**
 * Standard implementation of {@link com.pranav.ide.dx.cf.iface.FieldList}, which directly stores
 * an array of {@link com.pranav.ide.dx.cf.iface.Field} objects and can be made immutable.
 */
public final class StdFieldList extends FixedSizeList implements FieldList {
     ...
     */
    @Override
    public com.pranav.ide.dx.cf.iface.Field get(int n) {
        return (com.pranav.ide.dx.cf.iface.Field) get0(n);
    }
