...
public abstract class StdMember implements Member {
     ...
     */
    private final com.pranav.ide.dx.rop.cst.CstType definingClass;
     ...
     */
    private final com.pranav.ide.dx.rop.cst.CstNat nat;
     ...
     */
    public StdMember(com.pranav.ide.dx.rop.cst.CstType definingClass, int accessFlags, com.pranav.ide.dx.rop.cst.CstNat nat,
                     com.pranav.ide.dx.cf.iface.AttributeList attributes) {
     ...
     */
    @Override
    public final com.pranav.ide.dx.rop.cst.CstString getName() {
        return nat.getName();
    }
