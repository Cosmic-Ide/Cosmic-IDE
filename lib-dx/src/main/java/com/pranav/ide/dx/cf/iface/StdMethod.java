...
/**
 * Standard implementation of {@link com.pranav.ide.dx.cf.iface.Method}, which directly stores
...
public final class StdMethod extends StdMember implements Method {
     ...
     */
    private final com.pranav.ide.dx.rop.type.Prototype effectiveDescriptor;
    ...
    public StdMethod(CstType definingClass, int accessFlags, CstNat nat,
        ...
        effectiveDescriptor =
                com.pranav.ide.dx.rop.type.Prototype.intern(descStr, definingClass.getClassType(),
