...
/**
 * Standard implementation of {@link com.pranav.ide.dx.cf.iface.MethodList}, which directly stores
 * an array of {@link com.pranav.ide.dx.cf.iface.Method} objects and can be made immutable.
 */
public final class StdMethodList extends FixedSizeList implements MethodList {
     ...
     */
    @Override
    public com.pranav.ide.dx.cf.iface.Method get(int n) {
        return (com.pranav.ide.dx.cf.iface.Method) get0(n);
    }
