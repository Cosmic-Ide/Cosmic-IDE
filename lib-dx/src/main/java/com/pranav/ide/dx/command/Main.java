...
package com.pranav.ide.dx.command;
...
public class Main {
    private static final String USAGE_MESSAGE =
            "usage:\n" +
                    ...
                    "  dx --version\n" +
                    "    Print the version of this tool (" + com.pranav.ide.dx.Version.VERSION + ").\n" +
                    "  dx --help\n" +
                    "    Print this message.";
    ...
    public static void main(String[] args) {
        ...
        try {
            for (int i = 0; i < args.length; i++) {
                ...
                gotCmd = true;
                if (arg.equals("--dex")) {
                    com.pranav.ide.dx.command.dexer.Main.main(without(args, i));
                    break;
                } else if (arg.equals("--dump")) {
                    com.pranav.ide.dx.command.dump.Main.main(without(args, i));
                    break;
                } else if (arg.equals("--annotool")) {
                    com.pranav.ide.dx.command.annotool.Main.main(
                            without(args, i));
                    break;
                } else if (arg.equals("--find-usages")) {
                    com.pranav.ide.dx.command.findusages.Main.main(without(args, i));
                    break;
