...
package com.pranav.ide.dx.command.annotool;
...
import com.pranav.ide.dx.cf.attrib.BaseAnnotations;
...
class AnnotationLister {
     ...
     */
    private final com.pranav.ide.dx.command.annotool.Main.Arguments args;
    ...
    AnnotationLister(com.pranav.ide.dx.command.annotool.Main.Arguments args) {
        this.args = args;
    }
    ...
    private void visitClassAnnotation(DirectClassFile cf,
        ...
        for (com.pranav.ide.dx.rop.annotation.Annotation anAnn : ann.getAnnotations().getAnnotations()) {
            String annClassName
    ...
    private void printMatchPackage(String packageName) {
        for (com.pranav.ide.dx.command.annotool.Main.PrintType pt : args.printTypes) {
            switch (pt) {
                case CLASS:
                case INNERCLASS:
                case METHOD:
