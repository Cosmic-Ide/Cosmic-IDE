...
package com.pranav.ide.dx.command.dexer;
...
import com.pranav.ide.dx.Version;
import com.pranav.ide.dx.cf.code.SimException;
import com.pranav.ide.dx.cf.direct.ClassPathOpener;
import com.pranav.ide.dx.cf.direct.ClassPathOpener.FileNameFilter;
...
import com.pranav.ide.dx.command.UsageException;
import com.pranav.ide.dx.dex.DexOptions;
import com.pranav.ide.dx.dex.cf.CfOptions;
import com.pranav.ide.dx.dex.cf.CfTranslator;
...
import com.pranav.ide.dx.merge.CollisionPolicy;
import com.pranav.ide.dx.merge.DexMerger;
...
public class Main {
     ...
     */
    private final List<Future<Boolean>> addToDexFutures =
            new ArrayList<Future<Boolean>>();
    /**
     * Futures for {@code dexOutPool} task.
     */
    private final List<Future<byte[]>> dexOutputFutures = new ArrayList<Future<byte[]>>();
    /**
     * Lock object used to to coordinate dex file rotation, and
     * multi-threaded translation.
     */
    private final Object dexRotationLock = new Object();
    private final List<byte[]> dexOutputArrays = new ArrayList<byte[]>();
    ...
    private com.pranav.ide.dx.dex.file.ClassDefItem translateClass(byte[] bytes, DirectClassFile cf) {
        try {
    ...
    private boolean addClassToDex(com.pranav.ide.dx.dex.file.ClassDefItem clazz) {
    ...
    private void dumpMethod(DexFile dex, String fqName,
        ...
        com.pranav.ide.dx.dex.file.ClassDefItem clazz = dex.getClassOrNull(className);
        ...
        TreeMap<com.pranav.ide.dx.rop.cst.CstNat, EncodedMethod> meths =
        ...
        for (EncodedMethod meth : meths.values()) {
            ...
            com.pranav.ide.dx.rop.annotation.Annotations methodAnnotations =
            ...
            if (methodAnnotations != null) {
                ...
                for (com.pranav.ide.dx.rop.annotation.Annotation a : methodAnnotations.getAnnotations()) {
                    pw.println("    " + a);
                }
            }
    ...
    private class DirectClassFileConsumer implements Callable<Boolean> {
        ...
        private Boolean call(DirectClassFile cf) {
            ...
            Future<com.pranav.ide.dx.dex.file.ClassDefItem> cdif = classTranslatorPool.submit(
     ...
     */
    private class ClassTranslatorTask implements Callable<com.pranav.ide.dx.dex.file.ClassDefItem> {
        ...
        @Override
        public com.pranav.ide.dx.dex.file.ClassDefItem call() {
            com.pranav.ide.dx.dex.file.ClassDefItem clazz = translateClass(bytes, classFile);
            return clazz;
        }
    }
    ...
    private class ClassDefItemConsumer implements Callable<Boolean> {
        ...
        String name;
        Future<com.pranav.ide.dx.dex.file.ClassDefItem> futureClazz;
        int maxMethodIdsInClass;
        int maxFieldIdsInClass;

        private ClassDefItemConsumer(String name, Future<com.pranav.ide.dx.dex.file.ClassDefItem> futureClazz,
