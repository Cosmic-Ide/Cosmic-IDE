...
package com.pranav.ide.dx.command.dump;

import com.pranav.ide.dx.cf.code.BasicBlocker;
import com.pranav.ide.dx.cf.code.ByteBlock;
import com.pranav.ide.dx.cf.code.ByteBlockList;
...
import com.pranav.ide.dx.cf.direct.CodeObserver;
...
public class BlockDumper
    ...
    public void endParsingMember(ByteArray bytes, int offset, String name,
        ...
        if ((member.getAccessFlags() & (com.pranav.ide.dx.rop.code.AccessFlags.ACC_ABSTRACT |
                com.pranav.ide.dx.rop.code.AccessFlags.ACC_NATIVE)) != 0) {
            return;
        }
