...
public class DotDumper implements ParseObserver {
    ...
    private final com.pranav.ide.dx.command.dump.Args args;
    private final DexOptions dexOptions;
    private DirectClassFile classFile;

    DotDumper(byte[] bytes, String filePath, com.pranav.ide.dx.command.dump.Args args) {
        this.bytes = bytes;
    ...
    static void dump(byte[] bytes, String filePath, com.pranav.ide.dx.command.dump.Args args) {
