...
import com.pranav.ide.dx.cf.iface.AttributeList;
import com.pranav.ide.dx.cf.iface.Method;
import com.pranav.ide.dx.cf.iface.MethodList;
import com.pranav.ide.dx.dex.file.AnnotationUtils;
...
import com.pranav.ide.dx.util.Warning;
...
/*package*/ class AttributeTranslator {
     ...
     */
    public static com.pranav.ide.dx.rop.type.TypeList getExceptions(com.pranav.ide.dx.cf.iface.Method method) {
        com.pranav.ide.dx.cf.iface.AttributeList attribs = method.getAttributes();
        com.pranav.ide.dx.cf.attrib.AttExceptions exceptions = (com.pranav.ide.dx.cf.attrib.AttExceptions)
                attribs.findFirst(AttExceptions.ATTRIBUTE_NAME);

        if (exceptions == null) {
            return com.pranav.ide.dx.rop.type.StdTypeList.EMPTY;
        }
    ...
    /**
     * Gets the annotations out of a given {@link com.pranav.ide.dx.cf.iface.AttributeList}. This
     ...
     */
    public static com.pranav.ide.dx.rop.annotation.Annotations getAnnotations(com.pranav.ide.dx.cf.iface.AttributeList attribs) {
        com.pranav.ide.dx.rop.annotation.Annotations result = getAnnotations0(attribs);
        com.pranav.ide.dx.rop.annotation.Annotation signature = getSignature(attribs);
        com.pranav.ide.dx.rop.annotation.Annotation sourceDebugExtension = getSourceDebugExtension(attribs);

        if (signature != null) {
            result = com.pranav.ide.dx.rop.annotation.Annotations.combine(result, signature);
        }

        if (sourceDebugExtension != null) {
            result = com.pranav.ide.dx.rop.annotation.Annotations.combine(result, sourceDebugExtension);
        }
     ...
     * @return {@code non-null;} the set of annotations, which may be empty
     */
    public static com.pranav.ide.dx.rop.annotation.Annotations getClassAnnotations(com.pranav.ide.dx.cf.direct.DirectClassFile cf,
                                                                                   CfOptions args) {
        com.pranav.ide.dx.rop.cst.CstType thisClass = cf.getThisClass();
        com.pranav.ide.dx.cf.iface.AttributeList attribs = cf.getAttributes();
        com.pranav.ide.dx.rop.annotation.Annotations result = getAnnotations(attribs);
        com.pranav.ide.dx.rop.annotation.Annotation enclosingMethod = translateEnclosingMethod(attribs);

        try {
            com.pranav.ide.dx.rop.annotation.Annotations innerClassAnnotations =
                    translateInnerClasses(thisClass, attribs,
                            enclosingMethod == null);
            if (innerClassAnnotations != null) {
                result = com.pranav.ide.dx.rop.annotation.Annotations.combine(result, innerClassAnnotations);
            }
        } catch (com.pranav.ide.dx.util.Warning warn) {
            args.warn.println("warning: " + warn.getMessage());
        }

        if (enclosingMethod != null) {
            result = com.pranav.ide.dx.rop.annotation.Annotations.combine(result, enclosingMethod);
        }

        if (AccessFlags.isAnnotation(cf.getAccessFlags())) {
            com.pranav.ide.dx.rop.annotation.Annotation annotationDefault =
                    translateAnnotationDefaults(cf);
            if (annotationDefault != null) {
                result = com.pranav.ide.dx.rop.annotation.Annotations.combine(result, annotationDefault);
            }
        }
     ...
     * @return {@code non-null;} the set of annotations, which may be empty
     */
    public static com.pranav.ide.dx.rop.annotation.Annotations getMethodAnnotations(com.pranav.ide.dx.cf.iface.Method method) {
        com.pranav.ide.dx.rop.annotation.Annotations result = getAnnotations(method.getAttributes());
        TypeList exceptions = getExceptions(method);

        if (exceptions.size() != 0) {
            com.pranav.ide.dx.rop.annotation.Annotation throwsAnnotation =
                    AnnotationUtils.makeThrows(exceptions);
            result = com.pranav.ide.dx.rop.annotation.Annotations.combine(result, throwsAnnotation);
        }
     ...
     * @return {@code non-null;} the set of annotations, which may be empty
     */
    private static com.pranav.ide.dx.rop.annotation.Annotations getAnnotations0(com.pranav.ide.dx.cf.iface.AttributeList attribs) {
        com.pranav.ide.dx.cf.attrib.AttRuntimeVisibleAnnotations visible =
                (com.pranav.ide.dx.cf.attrib.AttRuntimeVisibleAnnotations)
                        attribs.findFirst(AttRuntimeVisibleAnnotations.ATTRIBUTE_NAME);
        com.pranav.ide.dx.cf.attrib.AttRuntimeInvisibleAnnotations invisible =
                (com.pranav.ide.dx.cf.attrib.AttRuntimeInvisibleAnnotations)
                        attribs.findFirst(AttRuntimeInvisibleAnnotations.ATTRIBUTE_NAME);

        if (visible == null) {
            if (invisible == null) {
                return com.pranav.ide.dx.rop.annotation.Annotations.EMPTY;
            }
        ...
        return com.pranav.ide.dx.rop.annotation.Annotations.combine(visible.getAnnotations(),
                invisible.getAnnotations());
    }

    /**
     * Gets the {@code Signature} attribute out of a given
     * {@link com.pranav.ide.dx.cf.iface.AttributeList}, if any, translating it to an annotation.
     *
     * @param attribs {@code non-null;} the attributes list to search in
     * @return {@code null-ok;} the converted {@code Signature} annotation,
     * if there was an attribute to translate
     */
    private static com.pranav.ide.dx.rop.annotation.Annotation getSignature(com.pranav.ide.dx.cf.iface.AttributeList attribs) {
        com.pranav.ide.dx.cf.attrib.AttSignature signature = (com.pranav.ide.dx.cf.attrib.AttSignature)
    ...
    private static com.pranav.ide.dx.rop.annotation.Annotation getSourceDebugExtension(com.pranav.ide.dx.cf.iface.AttributeList attribs) {
        com.pranav.ide.dx.cf.attrib.AttSourceDebugExtension extension = (com.pranav.ide.dx.cf.attrib.AttSourceDebugExtension)
     ...
     */
    private static com.pranav.ide.dx.rop.annotation.Annotation translateEnclosingMethod(com.pranav.ide.dx.cf.iface.AttributeList attribs) {
        com.pranav.ide.dx.cf.attrib.AttEnclosingMethod enclosingMethod = (com.pranav.ide.dx.cf.attrib.AttEnclosingMethod)
        ...
        com.pranav.ide.dx.rop.cst.CstType enclosingClass = enclosingMethod.getEnclosingClass();
     ...
     * {@link com.pranav.ide.dx.cf.iface.AttributeList}, if any, translating it to one or more of an
     ...
     */
    private static com.pranav.ide.dx.rop.annotation.Annotations translateInnerClasses(com.pranav.ide.dx.rop.cst.CstType thisClass,
                                                                                      com.pranav.ide.dx.cf.iface.AttributeList attribs, boolean needEnclosingClass) {
        com.pranav.ide.dx.cf.attrib.AttInnerClasses innerClasses = (com.pranav.ide.dx.cf.attrib.AttInnerClasses)
        ...
        com.pranav.ide.dx.cf.attrib.InnerClassList list = innerClasses.getInnerClasses();
        int size = list.size();
        com.pranav.ide.dx.cf.attrib.InnerClassList.Item foundThisClass = null;
        ArrayList<com.pranav.ide.dx.rop.type.Type> membersList = new ArrayList<Type>();

        for (int i = 0; i < size; i++) {
            InnerClassList.Item item = list.get(i);
            com.pranav.ide.dx.rop.cst.CstType innerClass = item.getInnerClass();
        ...
        com.pranav.ide.dx.rop.annotation.Annotations result = new Annotations();
        ...
        if (foundThisClass != null) {
            ...
            if (needEnclosingClass) {
                com.pranav.ide.dx.rop.cst.CstType outer = foundThisClass.getOuterClass();
                if (outer == null) {
                    throw new Warning(
        ...
        if (membersSize != 0) {
            com.pranav.ide.dx.rop.type.StdTypeList typeList = new StdTypeList(membersSize);
     ...
     * empty
     */
    public static com.pranav.ide.dx.rop.annotation.AnnotationsList getParameterAnnotations(com.pranav.ide.dx.cf.iface.Method method) {
        com.pranav.ide.dx.cf.iface.AttributeList attribs = method.getAttributes();
        com.pranav.ide.dx.cf.attrib.AttRuntimeVisibleParameterAnnotations visible =
                (com.pranav.ide.dx.cf.attrib.AttRuntimeVisibleParameterAnnotations)
                        attribs.findFirst(
                                AttRuntimeVisibleParameterAnnotations.ATTRIBUTE_NAME);
        com.pranav.ide.dx.cf.attrib.AttRuntimeInvisibleParameterAnnotations invisible =
                (com.pranav.ide.dx.cf.attrib.AttRuntimeInvisibleParameterAnnotations)
                        attribs.findFirst(
                                AttRuntimeInvisibleParameterAnnotations.ATTRIBUTE_NAME);

        if (visible == null) {
            if (invisible == null) {
                return com.pranav.ide.dx.rop.annotation.AnnotationsList.EMPTY;
            }
     ...
     */
    private static com.pranav.ide.dx.rop.annotation.Annotation translateAnnotationDefaults(DirectClassFile cf) {
        CstType thisClass = cf.getThisClass();
        MethodList methods = cf.getMethods();
        int sz = methods.size();
        com.pranav.ide.dx.rop.annotation.Annotation result =
        ...
        for (int i = 0; i < sz; i++) {
            ...
            com.pranav.ide.dx.cf.attrib.AttAnnotationDefault oneDefault = (com.pranav.ide.dx.cf.attrib.AttAnnotationDefault)
                    attribs.findFirst(AttAnnotationDefault.ATTRIBUTE_NAME);

            if (oneDefault != null) {
                com.pranav.ide.dx.rop.annotation.NameValuePair pair = new NameValuePair(
                        one.getNat().getName(),
                        oneDefault.getValue());
                result.add(pair);
                any = true;
