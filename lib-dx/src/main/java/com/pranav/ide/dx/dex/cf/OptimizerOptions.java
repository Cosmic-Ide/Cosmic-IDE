...
public class OptimizerOptions {
     ...
     */
    public void compareOptimizerStep(com.pranav.ide.dx.rop.code.RopMethod nonOptRmeth,
                                     int paramSize, boolean isStatic, CfOptions args,
                                     TranslationAdvice advice, com.pranav.ide.dx.rop.code.RopMethod rmeth) {
        EnumSet<com.pranav.ide.dx.ssa.Optimizer.OptionalStep> steps;

        steps = EnumSet.allOf(com.pranav.ide.dx.ssa.Optimizer.OptionalStep.class);

        // This is the step to skip.
        steps.remove(com.pranav.ide.dx.ssa.Optimizer.OptionalStep.CONST_COLLECTOR);
