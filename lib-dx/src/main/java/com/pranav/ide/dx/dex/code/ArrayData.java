...
import com.pranav.ide.dx.rop.cst.CstLiteral32;
import com.pranav.ide.dx.rop.cst.CstLiteral64;
...
public final class ArrayData extends VariableSizeInsn {
     ...
     * instance
     */
    private final com.pranav.ide.dx.dex.code.CodeAddress user;

    /**
     * {@code non-null;} initial values to be filled into an array
     */
    private final ArrayList<com.pranav.ide.dx.rop.cst.Constant> values;

    /**
     * non-null: type of constant that initializes the array
     */
    private final com.pranav.ide.dx.rop.cst.Constant arrayType;
    ...
    public ArrayData(SourcePosition position, CodeAddress user,
                     ArrayList<com.pranav.ide.dx.rop.cst.Constant> values,
                     com.pranav.ide.dx.rop.cst.Constant arrayType) {
        super(position, com.pranav.ide.dx.rop.code.RegisterSpecList.EMPTY);
        ...
        if (arrayType == com.pranav.ide.dx.rop.cst.CstType.BYTE_ARRAY ||
                arrayType == com.pranav.ide.dx.rop.cst.CstType.BOOLEAN_ARRAY) {
            elemWidth = 1;
        } else if (arrayType == com.pranav.ide.dx.rop.cst.CstType.SHORT_ARRAY ||
                arrayType == com.pranav.ide.dx.rop.cst.CstType.CHAR_ARRAY) {
            elemWidth = 2;
        } else if (arrayType == com.pranav.ide.dx.rop.cst.CstType.INT_ARRAY ||
                arrayType == com.pranav.ide.dx.rop.cst.CstType.FLOAT_ARRAY) {
            elemWidth = 4;
        } else if (arrayType == com.pranav.ide.dx.rop.cst.CstType.LONG_ARRAY ||
    ...
    public void writeTo(AnnotatedOutput out) {
        ...
        switch (elemWidth) {
            case 1: {
                for (int i = 0; i < sz; i++) {
                    com.pranav.ide.dx.rop.cst.Constant cst = values.get(i);
                    out.writeByte((byte) ((com.pranav.ide.dx.rop.cst.CstLiteral32) cst).getIntBits());
                }
                break;
            }
            case 2: {
                for (int i = 0; i < sz; i++) {
                    com.pranav.ide.dx.rop.cst.Constant cst = values.get(i);
                    out.writeShort((short) ((com.pranav.ide.dx.rop.cst.CstLiteral32) cst).getIntBits());
                }
                break;
            }
            case 4: {
