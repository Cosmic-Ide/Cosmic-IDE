...
public final class CatchHandlerList extends FixedSizeList
    ...
    public boolean catchesAll() {
        ...
        return last.getExceptionType().equals(com.pranav.ide.dx.rop.cst.CstType.OBJECT);
    }
     ...
     */
    public void set(int n, com.pranav.ide.dx.rop.cst.CstType exceptionType, int handler) {
    ...
    public static class Entry implements Comparable<Entry> {
         ...
         */
        private final com.pranav.ide.dx.rop.cst.CstType exceptionType;
         ...
         * @param handler       {@code >= 0;} exception handler address
         */
        public Entry(com.pranav.ide.dx.rop.cst.CstType exceptionType, int handler) {
            if (handler < 0) {
