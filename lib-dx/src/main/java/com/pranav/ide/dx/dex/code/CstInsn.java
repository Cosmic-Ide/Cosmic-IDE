...
public final class CstInsn extends FixedSizeInsn {
     ...
     */
    private final com.pranav.ide.dx.rop.cst.Constant constant;
     ...
     */
    public CstInsn(com.pranav.ide.dx.dex.code.Dop opcode, SourcePosition position,
                   com.pranav.ide.dx.rop.code.RegisterSpecList registers, com.pranav.ide.dx.rop.cst.Constant constant) {
    ...
    public String cstString() {
        if (constant instanceof com.pranav.ide.dx.rop.cst.CstString) {
    ...
    public String cstComment() {
        ...
        if (index < 65536) {
            sb.append(com.pranav.ide.dx.util.Hex.u2(index));
        } else {
