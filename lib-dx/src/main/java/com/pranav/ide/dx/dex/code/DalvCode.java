...
public final class DalvCode {
     ...
     * constants in {@link com.pranav.ide.dx.dex.code.PositionList}
     */
     ...
     */
    private com.pranav.ide.dx.dex.code.OutputFinisher unprocessedInsns;
     ...
     * {@link #finishProcessingIfNecessary}
     */
    private com.pranav.ide.dx.dex.code.PositionList positions;

    /**
     * {@code null-ok;} local variable list; set in
     * {@link #finishProcessingIfNecessary}
     */
    private com.pranav.ide.dx.dex.code.LocalList locals;

    /**
     * {@code null-ok;} the processed instruction list; set in
     * {@link #finishProcessingIfNecessary}
     */
    private com.pranav.ide.dx.dex.code.DalvInsnList insns;

    /**
     * Constructs an instance.
     *
     * @param positionInfo       how much position info to preserve; one of the
     *                           static constants in {@link com.pranav.ide.dx.dex.code.PositionList}
    ...
    private void finishProcessingIfNecessary() {
        ...
        positions = com.pranav.ide.dx.dex.code.PositionList.make(insns, positionInfo);
        locals = com.pranav.ide.dx.dex.code.LocalList.make(insns);
    ...
    public boolean hasPositions() {
        return (positionInfo != com.pranav.ide.dx.dex.code.PositionList.NONE)
     ...
     */
    public HashSet<com.pranav.ide.dx.rop.cst.Constant> getInsnConstants() {
