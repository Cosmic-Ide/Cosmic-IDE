...
import com.pranav.ide.dx.util.TwoColumnOutput;
...
public abstract class DalvInsn {
     ...
     */
    private final com.pranav.ide.dx.dex.code.Dop opcode;
    /**
     ...
     */
    private final com.pranav.ide.dx.rop.code.RegisterSpecList registers;
    /**
     ...
     * com.pranav.ide.dx.rop.code.RegisterSpecList#EMPTY}.</p>
     *
     ...
     *                  ins and outs)
     */
    public DalvInsn(com.pranav.ide.dx.dex.code.Dop opcode, com.pranav.ide.dx.rop.code.SourcePosition position,
     ...
     */
    public static SimpleInsn makeMove(com.pranav.ide.dx.rop.code.SourcePosition position,
                                      com.pranav.ide.dx.rop.code.RegisterSpec dest, com.pranav.ide.dx.rop.code.RegisterSpec src) {
        ...
        com.pranav.ide.dx.dex.code.Dop opcode;
        ...
        return new SimpleInsn(opcode, position,
                com.pranav.ide.dx.rop.code.RegisterSpecList.make(dest, src));
    }
     ...
     */
    public final com.pranav.ide.dx.dex.code.Dop getOpcode() {
        return opcode;
    }
     ...
     */
    public final com.pranav.ide.dx.rop.code.RegisterSpecList getRegisters() {
        return registers;
    }
    ...
    public DalvInsn getLowRegVersion() {
        com.pranav.ide.dx.rop.code.RegisterSpecList regs =
    ...
    public DalvInsn expandedPrefix(BitSet compatRegs) {
        com.pranav.ide.dx.rop.code.RegisterSpecList regs = registers;
