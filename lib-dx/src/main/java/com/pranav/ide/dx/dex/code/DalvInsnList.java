...
import com.pranav.ide.dx.util.IndentingWriter;
...
/**
 * List of {@link com.pranav.ide.dx.dex.code.DalvInsn} instances.
 */
public final class DalvInsnList extends FixedSizeList {
     ...
     * class
     */
    public static DalvInsnList makeImmutable(ArrayList<com.pranav.ide.dx.dex.code.DalvInsn> list,
                                             int regCount) {
        int size = list.size();
     ...
     */
    public com.pranav.ide.dx.dex.code.DalvInsn get(int n) {
        return (com.pranav.ide.dx.dex.code.DalvInsn) get0(n);
    }
     ...
     */
    public void set(int n, com.pranav.ide.dx.dex.code.DalvInsn insn) {
        set0(n, insn);
    }
    ...
    public int codeSize() {
        ...
        com.pranav.ide.dx.dex.code.DalvInsn last = get(sz - 1);
    ...
    public void writeTo(AnnotatedOutput out) {
        ...
        if (out.annotates()) {
            ...
            for (int i = 0; i < sz; i++) {
                com.pranav.ide.dx.dex.code.DalvInsn insn = (com.pranav.ide.dx.dex.code.DalvInsn) get0(i);
    ...
    public int getOutsSize() {
        ...
        for (int i = 0; i < sz; i++) {
            ...
            if (insn instanceof com.pranav.ide.dx.dex.code.CstInsn) {
                ...
                if (cst instanceof com.pranav.ide.dx.rop.cst.CstBaseMethodRef) {
                    com.pranav.ide.dx.rop.cst.CstBaseMethodRef methodRef = (CstBaseMethodRef) cst;
                    boolean isStatic =
                            (insn.getOpcode().getFamily() == com.pranav.ide.dx.io.Opcodes.INVOKE_STATIC);
                    count = methodRef.getParameterWordCount(isStatic);
                } else if (cst instanceof com.pranav.ide.dx.rop.cst.CstCallSiteRef) {
                    com.pranav.ide.dx.rop.cst.CstCallSiteRef invokeDynamicRef = (CstCallSiteRef) cst;
                ...
                com.pranav.ide.dx.rop.cst.CstProtoRef proto = (CstProtoRef) mci.getConstant(1);
    ...
    public void debugPrint(Writer out, String prefix, boolean verbose) {
        com.pranav.ide.dx.util.IndentingWriter iw = new IndentingWriter(out, 0, prefix);
        int sz = size();

        try {
            for (int i = 0; i < sz; i++) {
                com.pranav.ide.dx.dex.code.DalvInsn insn = (DalvInsn) get0(i);
                String s;
