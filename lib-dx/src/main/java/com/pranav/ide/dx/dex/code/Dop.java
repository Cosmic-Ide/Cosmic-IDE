...
public final class Dop {
    ...
    public Dop(int opcode, int family, int nextOpcode, InsnFormat format,
               boolean hasResult) {
        if (!com.pranav.ide.dx.io.Opcodes.isValidShape(opcode)) {
            throw new IllegalArgumentException("bogus opcode");
        }

        if (!com.pranav.ide.dx.io.Opcodes.isValidShape(family)) {
            throw new IllegalArgumentException("bogus family");
        }

        if (!com.pranav.ide.dx.io.Opcodes.isValidShape(nextOpcode)) {
    ...
    public Dop getOppositeTest() {
        switch (opcode) {
            case com.pranav.ide.dx.io.Opcodes.IF_EQ:
                return Dops.IF_NE;
            case com.pranav.ide.dx.io.Opcodes.IF_NE:
                return Dops.IF_EQ;
            case com.pranav.ide.dx.io.Opcodes.IF_LT:
                return Dops.IF_GE;
            case com.pranav.ide.dx.io.Opcodes.IF_GE:
                return Dops.IF_LT;
            case com.pranav.ide.dx.io.Opcodes.IF_GT:
                return Dops.IF_LE;
            case com.pranav.ide.dx.io.Opcodes.IF_LE:
                return Dops.IF_GT;
            case com.pranav.ide.dx.io.Opcodes.IF_EQZ:
                return Dops.IF_NEZ;
            case com.pranav.ide.dx.io.Opcodes.IF_NEZ:
                return Dops.IF_EQZ;
            case com.pranav.ide.dx.io.Opcodes.IF_LTZ:
                return Dops.IF_GEZ;
            case com.pranav.ide.dx.io.Opcodes.IF_GEZ:
                return Dops.IF_LTZ;
            case com.pranav.ide.dx.io.Opcodes.IF_GTZ:
                return Dops.IF_LEZ;
            case Opcodes.IF_LEZ:
                return Dops.IF_GTZ;
        }
