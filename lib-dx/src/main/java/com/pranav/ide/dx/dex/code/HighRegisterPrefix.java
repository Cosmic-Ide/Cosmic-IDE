...
public final class HighRegisterPrefix extends VariableSizeInsn {
     ...
     */
    private com.pranav.ide.dx.dex.code.SimpleInsn[] insns;
     ...
     */
    public HighRegisterPrefix(com.pranav.ide.dx.rop.code.SourcePosition position,
     ...
     */
    private static SimpleInsn moveInsnFor(com.pranav.ide.dx.rop.code.RegisterSpec src, int destIndex) {
    ...
    public int codeSize() {
        ...
        for (com.pranav.ide.dx.dex.code.SimpleInsn insn : insns) {
    ...
    private void calculateInsnsIfNecessary() {
        ...
        com.pranav.ide.dx.rop.code.RegisterSpecList registers = getRegisters();
        int sz = registers.size();

        insns = new com.pranav.ide.dx.dex.code.SimpleInsn[sz];

        for (int i = 0, outAt = 0; i < sz; i++) {
            com.pranav.ide.dx.rop.code.RegisterSpec src = registers.get(i);
     ...
     */
    @Override
    public com.pranav.ide.dx.dex.code.DalvInsn withRegisters(com.pranav.ide.dx.rop.code.RegisterSpecList registers) {
    ...
    protected String listingString0(boolean noteIndices) {
        ...
        for (int i = 0, outAt = 0; i < sz; i++) {
            com.pranav.ide.dx.rop.code.RegisterSpec src = registers.get(i);
            com.pranav.ide.dx.dex.code.SimpleInsn insn = moveInsnFor(src, outAt);
