 ...
 * handlers know how to translate {@link com.pranav.ide.dx.dex.code.DalvInsn} instances into
...
public abstract class InsnFormat {
     ...
     */
    protected static String regListString(com.pranav.ide.dx.rop.code.RegisterSpecList list) {
        int sz = list.size();
     ...
     * @return {@code non-null;} the string form
     */
    protected static String regRangeString(com.pranav.ide.dx.rop.code.RegisterSpecList list) {
        int size = list.size();
        ...
        switch (size) {
            ...
            default: {
                com.pranav.ide.dx.rop.code.RegisterSpec lastReg = list.get(size - 1);
     ...
     * @return {@code non-null;} the string form
     */
    protected static String literalBitsString(com.pranav.ide.dx.rop.cst.CstLiteralBits value) {
    ...
    protected static String literalBitsComment(CstLiteralBits value,
        ...
        if (value instanceof com.pranav.ide.dx.rop.cst.CstLiteral64) {
        ...
        switch (width) {
            case 4:
                sb.append(com.pranav.ide.dx.util.Hex.uNibble((int) bits));
                break;
            case 8:
                sb.append(com.pranav.ide.dx.util.Hex.u1((int) bits));
                break;
            case 16:
                sb.append(com.pranav.ide.dx.util.Hex.u2((int) bits));
                break;
            case 32:
                sb.append(com.pranav.ide.dx.util.Hex.u4((int) bits));
                break;
            case 64:
                sb.append(com.pranav.ide.dx.util.Hex.u8(bits));
                break;
            default: {
     ...
     * branch target
     */
    protected static String branchString(com.pranav.ide.dx.dex.code.DalvInsn insn) {
        com.pranav.ide.dx.dex.code.TargetInsn ti = (com.pranav.ide.dx.dex.code.TargetInsn) insn;
        int address = ti.getTargetAddress();

        return (address == (char) address) ? com.pranav.ide.dx.util.Hex.u2(address) : com.pranav.ide.dx.util.Hex.u4(address);
    }
     ...
     * @return {@code non-null;} the comment
     */
    protected static String branchComment(com.pranav.ide.dx.dex.code.DalvInsn insn) {
        com.pranav.ide.dx.dex.code.TargetInsn ti = (TargetInsn) insn;
        int offset = ti.getTargetOffset();

        return (offset == (short) offset) ? com.pranav.ide.dx.util.Hex.s2(offset) : Hex.s4(offset);
    }
     ...
     */
    protected static int argIndex(com.pranav.ide.dx.dex.code.DalvInsn insn) {
     ...
     */
    protected static short opcodeUnit(com.pranav.ide.dx.dex.code.DalvInsn insn, int arg) {
        if ((arg & 0xff) != arg) {
     ...
     */
    protected static void write(com.pranav.ide.dx.util.AnnotatedOutput out, short c0) {
        out.writeShort(c0);
    }
     ...
     */
    protected static void write(com.pranav.ide.dx.util.AnnotatedOutput out, short c0, short c1) {
        out.writeShort(c0);
        out.writeShort(c1);
    }
     ...
     */
    protected static void write(com.pranav.ide.dx.util.AnnotatedOutput out, short c0, int c1c2) {
     ...
     * @return {@code non-null;} the string form
     */
    public final String listingString(com.pranav.ide.dx.dex.code.DalvInsn insn, boolean noteIndices) {
     ...
     * @return {@code non-null;} the string form
     */
    public abstract String insnArgString(com.pranav.ide.dx.dex.code.DalvInsn insn);
     ...
     * @return {@code non-null;} the string form
     */
    public abstract String insnCommentString(com.pranav.ide.dx.dex.code.DalvInsn insn,
                                             boolean noteIndices);
     ...
     */
    public abstract boolean isCompatible(com.pranav.ide.dx.dex.code.DalvInsn insn);
     ...
     */
    public BitSet compatibleRegs(com.pranav.ide.dx.dex.code.DalvInsn insn) {
        return new BitSet();
    }
     ...
     * appropriate for this instance, or {@code false} if not
     */
    public boolean branchFits(com.pranav.ide.dx.dex.code.TargetInsn insn) {
        return false;
    }
     ...
     */
    public abstract void writeTo(com.pranav.ide.dx.util.AnnotatedOutput out, com.pranav.ide.dx.dex.code.DalvInsn insn);
}
