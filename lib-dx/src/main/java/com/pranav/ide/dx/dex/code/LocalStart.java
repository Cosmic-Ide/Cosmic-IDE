...
public final class LocalStart extends ZeroSizeInsn {
     ...
     * by this instance
     */
    private final com.pranav.ide.dx.rop.code.RegisterSpec local;
     ...
     */
    public LocalStart(SourcePosition position, com.pranav.ide.dx.rop.code.RegisterSpec local) {
        super(position);
     ...
     */
    public static String localString(com.pranav.ide.dx.rop.code.RegisterSpec spec) {
     ...
     */
    @Override
    public com.pranav.ide.dx.dex.code.DalvInsn withRegisterOffset(int delta) {
     ...
     */
    @Override
    public com.pranav.ide.dx.dex.code.DalvInsn withRegisters(RegisterSpecList registers) {
