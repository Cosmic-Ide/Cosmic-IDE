...
public final class MultiCstInsn extends FixedSizeInsn {
     ...
     */
    private final com.pranav.ide.dx.rop.cst.Constant[] constants;
     ...
     */
    public MultiCstInsn(com.pranav.ide.dx.dex.code.Dop opcode, com.pranav.ide.dx.rop.code.SourcePosition position,
                        com.pranav.ide.dx.rop.code.RegisterSpecList registers, com.pranav.ide.dx.rop.cst.Constant[] constants) {
    ...
    private MultiCstInsn(com.pranav.ide.dx.dex.code.Dop opcode, SourcePosition position,
                         com.pranav.ide.dx.rop.code.RegisterSpecList registers, com.pranav.ide.dx.rop.cst.Constant[] constants, int[] index,
                         int classIndex) {
        super(opcode, position, registers);
        this.constants = constants;
        this.index = index;
    ...
    public String cstComment() {
        ...
        for (int i = 0; i < constants.length; ++i) {
            ...
            if (currentIndex < 65536) {
                sb.append(com.pranav.ide.dx.util.Hex.u2(currentIndex));
            } else {
