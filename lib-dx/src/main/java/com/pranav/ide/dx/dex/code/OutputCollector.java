...
/**
 * Destination for {@link com.pranav.ide.dx.dex.code.DalvInsn} instances being output. This class
...
public final class OutputCollector {
     ...
     * list in-progress)
     */
    private final com.pranav.ide.dx.dex.code.OutputFinisher finisher;
     ...
     */
    private ArrayList<com.pranav.ide.dx.dex.code.DalvInsn> suffix;
    ...
    public OutputCollector(DexOptions dexOptions, int initialCapacity, int suffixInitialCapacity,
        ...
        this.finisher = new com.pranav.ide.dx.dex.code.OutputFinisher(dexOptions, initialCapacity, regCount, paramSize);
        this.suffix = new ArrayList<com.pranav.ide.dx.dex.code.DalvInsn>(suffixInitialCapacity);
    }
     ...
     * an {@link com.pranav.ide.dx.dex.code.OutputFinisher}.
     *
