...
import com.pranav.ide.dex.DexException;
...
public final class OutputFinisher {
     ...
     */
    private ArrayList<com.pranav.ide.dx.dex.code.DalvInsn> insns;
    /**
    ...
    public OutputFinisher(DexOptions dexOptions, int initialCapacity, int regCount, int paramSize) {
        ...
        this.insns = new ArrayList<com.pranav.ide.dx.dex.code.DalvInsn>(initialCapacity);
     ...
     * named locals
     */
    private static boolean hasLocalInfo(com.pranav.ide.dx.dex.code.DalvInsn insn) {
        if (insn instanceof com.pranav.ide.dx.dex.code.LocalSnapshot) {
            com.pranav.ide.dx.rop.code.RegisterSpecSet specs = ((com.pranav.ide.dx.dex.code.LocalSnapshot) insn).getLocals();
            int size = specs.size();
            ...
            com.pranav.ide.dx.rop.code.RegisterSpec spec = ((LocalStart) insn).getLocal();
     ...
     * named locals
     */
    private static boolean hasLocalInfo(com.pranav.ide.dx.rop.code.RegisterSpec spec) {
        return (spec != null)
     ...
     * @param insn   {@code non-null;} instruction to scrutinize
     */
    private static void addConstants(HashSet<com.pranav.ide.dx.rop.cst.Constant> result,
                                     com.pranav.ide.dx.dex.code.DalvInsn insn) {
        if (insn instanceof com.pranav.ide.dx.dex.code.CstInsn) {
            com.pranav.ide.dx.rop.cst.Constant cst = ((com.pranav.ide.dx.dex.code.CstInsn) insn).getConstant();
            result.add(cst);
        ...
        } else if (insn instanceof com.pranav.ide.dx.dex.code.LocalSnapshot) {
     ...
     */
    private static void addConstants(HashSet<com.pranav.ide.dx.rop.cst.Constant> result,
                                     com.pranav.ide.dx.rop.code.RegisterSpec spec) {
        if (spec == null) {
            return;
        }

        LocalItem local = spec.getLocalItem();
        com.pranav.ide.dx.rop.cst.CstString name = local.getName();
        CstString signature = local.getSignature();
        com.pranav.ide.dx.rop.type.Type type = spec.getType();

        if (type != com.pranav.ide.dx.rop.type.Type.KNOWN_NULL) {
            result.add(com.pranav.ide.dx.rop.cst.CstType.intern(type));
        } else {
            ...
            result.add(com.pranav.ide.dx.rop.cst.CstType.intern(Type.OBJECT));
        }
    ...
    private static void assignIndices(CstInsn insn,
        ...
        if (cst instanceof com.pranav.ide.dx.rop.cst.CstMemberRef) {
            com.pranav.ide.dx.rop.cst.CstMemberRef member = (com.pranav.ide.dx.rop.cst.CstMemberRef) cst;
            com.pranav.ide.dx.rop.cst.CstType definer = member.getDefiningClass();
    ...
    private static void assignIndices(MultiCstInsn insn, DalvCode.AssignIndicesCallback callback) {
        for (int i = 0; i < insn.getNumberOfConstants(); ++i) {
            ...
            if (cst instanceof com.pranav.ide.dx.rop.cst.CstMemberRef) {
                com.pranav.ide.dx.rop.cst.CstMemberRef member = (CstMemberRef) cst;
     ...
     */
    public HashSet<com.pranav.ide.dx.rop.cst.Constant> getAllConstants() {
        HashSet<com.pranav.ide.dx.rop.cst.Constant> result = new HashSet<com.pranav.ide.dx.rop.cst.Constant>(20);

        for (com.pranav.ide.dx.dex.code.DalvInsn insn : insns) {
     ...
     */
    public void add(com.pranav.ide.dx.dex.code.DalvInsn insn) {
        insns.add(insn);
        updateInfo(insn);
    }
     ...
     */
    public void insert(int at, com.pranav.ide.dx.dex.code.DalvInsn insn) {
        insns.add(at, insn);
        updateInfo(insn);
    }

    public com.pranav.ide.dx.dex.code.DalvInsn get(int at) {
        return insns.get(at);
    }
     ...
     */
    private void updateInfo(com.pranav.ide.dx.dex.code.DalvInsn insn) {
     ...
     *                  reversed branch
     */
    public void reverseBranch(int which, com.pranav.ide.dx.dex.code.CodeAddress newTarget) {
        int size = insns.size();
        int index = size - which - 1;
        com.pranav.ide.dx.dex.code.TargetInsn targetInsn;

        try {
            targetInsn = (com.pranav.ide.dx.dex.code.TargetInsn) insns.get(index);
    ...
    public void assignIndices(DalvCode.AssignIndicesCallback callback) {
        for (com.pranav.ide.dx.dex.code.DalvInsn insn : insns) {
            if (insn instanceof com.pranav.ide.dx.dex.code.CstInsn) {
                assignIndices((com.pranav.ide.dx.dex.code.CstInsn) insn, callback);
            } else if (insn instanceof MultiCstInsn) {
    ...
    public DalvInsnList finishProcessingAndGetList() {
        ...
        com.pranav.ide.dx.dex.code.Dop[] opcodes = makeOpcodesArray();
     ...
     */
    private com.pranav.ide.dx.dex.code.Dop[] makeOpcodesArray() {
        int size = insns.size();
        com.pranav.ide.dx.dex.code.Dop[] result = new com.pranav.ide.dx.dex.code.Dop[size];

        for (int i = 0; i < size; i++) {
            com.pranav.ide.dx.dex.code.DalvInsn insn = insns.get(i);
     ...
     */
    private boolean reserveRegisters(com.pranav.ide.dx.dex.code.Dop[] opcodes) {
        ...
        for (; ; ) {
            ...
            for (int i = 0; i < size; i++) {
                 ...
                 */
                com.pranav.ide.dx.dex.code.DalvInsn insn = insns.get(i);
                if (!(insn instanceof com.pranav.ide.dx.dex.code.CodeAddress)) {
                    /*
     ...
     */
    private int calculateReservedCount(com.pranav.ide.dx.dex.code.Dop[] opcodes) {
        int size = insns.size();
        ...
        for (int i = 0; i < size; i++) {
            com.pranav.ide.dx.dex.code.DalvInsn insn = insns.get(i);
            com.pranav.ide.dx.dex.code.Dop originalOpcode = opcodes[i];
            com.pranav.ide.dx.dex.code.Dop newOpcode = findOpcodeForInsn(insn, originalOpcode);
            ...
            if (newOpcode == null) {
                 ...
                 */
                com.pranav.ide.dx.dex.code.Dop expandedOp = findExpandedOpcodeForInsn(insn);
     ...
     * simple opcode fits
     */
    private com.pranav.ide.dx.dex.code.Dop findOpcodeForInsn(com.pranav.ide.dx.dex.code.DalvInsn insn, com.pranav.ide.dx.dex.code.Dop guess) {
        /*
        ...
        while (guess != null) {
            if (guess.getFormat().isCompatible(insn)) {
                ...
                if (!dexOptions.forceJumbo ||
                        guess.getOpcode() != com.pranav.ide.dx.io.Opcodes.CONST_STRING) {
                    break;
                }
            }

            guess = com.pranav.ide.dx.dex.code.Dops.getNextOrNull(guess, dexOptions);
        }
     ...
     */
    private com.pranav.ide.dx.dex.code.Dop findExpandedOpcodeForInsn(com.pranav.ide.dx.dex.code.DalvInsn insn) {
        com.pranav.ide.dx.dex.code.Dop result = findOpcodeForInsn(insn.getLowRegVersion(), insn.getOpcode());
        if (result == null) {
     ...
     *                opcode selections
     */
    private void massageInstructions(com.pranav.ide.dx.dex.code.Dop[] opcodes) {
        if (reservedCount == 0) {
            /*
            ...
            for (int i = 0; i < size; i++) {
                com.pranav.ide.dx.dex.code.DalvInsn insn = insns.get(i);
                com.pranav.ide.dx.dex.code.Dop originalOpcode = insn.getOpcode();
                com.pranav.ide.dx.dex.code.Dop currentOpcode = opcodes[i];
     ...
     */
    private ArrayList<com.pranav.ide.dx.dex.code.DalvInsn> performExpansion(com.pranav.ide.dx.dex.code.Dop[] opcodes) {
        int size = insns.size();
        ArrayList<com.pranav.ide.dx.dex.code.DalvInsn> result = new ArrayList<com.pranav.ide.dx.dex.code.DalvInsn>(size * 2);

        ArrayList<com.pranav.ide.dx.dex.code.CodeAddress> closelyBoundAddresses = new ArrayList<com.pranav.ide.dx.dex.code.CodeAddress>();

        for (int i = 0; i < size; i++) {
            com.pranav.ide.dx.dex.code.DalvInsn insn = insns.get(i);
            com.pranav.ide.dx.dex.code.Dop originalOpcode = insn.getOpcode();
            com.pranav.ide.dx.dex.code.Dop currentOpcode = opcodes[i];
            com.pranav.ide.dx.dex.code.DalvInsn prefix;
            com.pranav.ide.dx.dex.code.DalvInsn suffix;
            ...
            if (insn instanceof com.pranav.ide.dx.dex.code.CodeAddress) {
                ...
                if (((com.pranav.ide.dx.dex.code.CodeAddress) insn).getBindsClosely()) {
                    closelyBoundAddresses.add((com.pranav.ide.dx.dex.code.CodeAddress) insn);
                    continue;
                }
            }
            ...
            if (!(insn instanceof ZeroSizeInsn) && closelyBoundAddresses.size() > 0) {
                for (com.pranav.ide.dx.dex.code.CodeAddress codeAddress : closelyBoundAddresses) {
    ...
    private boolean fixBranches() {
        ...
        for (int i = 0; i < size; i++) {
            com.pranav.ide.dx.dex.code.DalvInsn insn = insns.get(i);
            if (!(insn instanceof com.pranav.ide.dx.dex.code.TargetInsn)) {
                // This loop only needs to inspect TargetInsns.
                continue;
            }

            com.pranav.ide.dx.dex.code.Dop opcode = insn.getOpcode();
            com.pranav.ide.dx.dex.code.TargetInsn target = (com.pranav.ide.dx.dex.code.TargetInsn) insn;
            ...
            if (opcode.getFamily() == Opcodes.GOTO) {
                 ...
                 */
                com.pranav.ide.dx.dex.code.CodeAddress newTarget;
                try {
                    newTarget = (com.pranav.ide.dx.dex.code.CodeAddress) insns.get(i + 1);
                } catch (IndexOutOfBoundsException ex) {
                ...
                com.pranav.ide.dx.dex.code.TargetInsn gotoInsn =
                        new TargetInsn(Dops.GOTO, target.getPosition(),
                                com.pranav.ide.dx.rop.code.RegisterSpecList.EMPTY, target.getTarget());
    ...
    private void shiftParameters(int delta) {
        ...
        com.pranav.ide.dx.ssa.BasicRegisterMapper mapper = new BasicRegisterMapper(lastParameter);
