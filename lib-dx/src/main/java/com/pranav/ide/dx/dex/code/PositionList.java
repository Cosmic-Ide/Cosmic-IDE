...
public final class PositionList extends FixedSizeList {
    ...
    public static PositionList make(DalvInsnList insns, int howMuch) {
        ...
        com.pranav.ide.dx.rop.code.SourcePosition noInfo = com.pranav.ide.dx.rop.code.SourcePosition.NO_INFO;
        com.pranav.ide.dx.rop.code.SourcePosition cur = noInfo;
        int sz = insns.size();
    ...
    public static class Entry {
         ...
         */
        public Entry(int address, com.pranav.ide.dx.rop.code.SourcePosition position) {
            if (address < 0) {
