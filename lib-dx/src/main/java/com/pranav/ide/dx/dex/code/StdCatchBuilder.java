...
/**
 * Constructor of {@link com.pranav.ide.dx.dex.code.CatchTable} instances from {@link com.pranav.ide.dx.rop.code.RopMethod}
 * and associated data.
 */
public final class StdCatchBuilder implements CatchBuilder {
     ...
     */
    private final com.pranav.ide.dx.dex.code.BlockAddresses addresses;
     ...
     */
    public StdCatchBuilder(com.pranav.ide.dx.rop.code.RopMethod method, int[] order,
                           com.pranav.ide.dx.dex.code.BlockAddresses addresses) {
        if (method == null) {
     ...
     */
    public static com.pranav.ide.dx.dex.code.CatchTable build(RopMethod method, int[] order,
                                                              com.pranav.ide.dx.dex.code.BlockAddresses addresses) {
        int len = order.length;
        BasicBlockList blocks = method.getBlocks();
        ArrayList<com.pranav.ide.dx.dex.code.CatchTable.Entry> resultList =
                new ArrayList<com.pranav.ide.dx.dex.code.CatchTable.Entry>(len);
        com.pranav.ide.dx.dex.code.CatchHandlerList currentHandlers = com.pranav.ide.dx.dex.code.CatchHandlerList.EMPTY;
        com.pranav.ide.dx.rop.code.BasicBlock currentStartBlock = null;
        com.pranav.ide.dx.rop.code.BasicBlock currentEndBlock = null;

        for (int i = 0; i < len; i++) {
            com.pranav.ide.dx.rop.code.BasicBlock block = blocks.labelToBlock(order[i]);
            ...
            com.pranav.ide.dx.dex.code.CatchHandlerList handlers = handlersFor(block, addresses);
             ...
             */
            if (currentHandlers.size() != 0) {
                com.pranav.ide.dx.dex.code.CatchTable.Entry entry =
        ...
        if (resultSz == 0) {
            return com.pranav.ide.dx.dex.code.CatchTable.EMPTY;
        }

        com.pranav.ide.dx.dex.code.CatchTable result = new com.pranav.ide.dx.dex.code.CatchTable(resultSz);
    ...
    /**
     * Makes the {@link com.pranav.ide.dx.dex.code.CatchHandlerList} for the given basic block.
     *
     * @param block     {@code non-null;} block to get entries for
     * @param addresses {@code non-null;} address objects for each block
     * @return {@code non-null;} array of entries
     */
    private static com.pranav.ide.dx.dex.code.CatchHandlerList handlersFor(com.pranav.ide.dx.rop.code.BasicBlock block,
                                                                           com.pranav.ide.dx.dex.code.BlockAddresses addresses) {
        ...
        if (catchSize == 0) {
            return com.pranav.ide.dx.dex.code.CatchHandlerList.EMPTY;
        }
        ...
        for (int i = 0; i < catchSize; i++) {
            com.pranav.ide.dx.rop.type.Type type = catches.getType(i);
        ...
        com.pranav.ide.dx.dex.code.CatchHandlerList result = new com.pranav.ide.dx.dex.code.CatchHandlerList(catchSize);

        for (int i = 0; i < catchSize; i++) {
            com.pranav.ide.dx.rop.cst.CstType oneType = new CstType(catches.getType(i));
            com.pranav.ide.dx.dex.code.CodeAddress oneHandler = addresses.getStart(successors.get(i));
    ...
    /**
     * Makes a {@link com.pranav.ide.dx.dex.code.CatchTable.Entry} for the given block range and
     * handlers.
     *
     ...
     * @param addresses {@code non-null;} address objects for each block
     */
    private static com.pranav.ide.dx.dex.code.CatchTable.Entry makeEntry(com.pranav.ide.dx.rop.code.BasicBlock start,
                                                                         com.pranav.ide.dx.rop.code.BasicBlock end, CatchHandlerList handlers,
                                                                         com.pranav.ide.dx.dex.code.BlockAddresses addresses) {
        /*
         * We start at the *last* instruction of the start block, since
         * that's the instruction that can throw...
         */
        com.pranav.ide.dx.dex.code.CodeAddress startAddress = addresses.getLast(start);
     ...
     */
    private static boolean rangeIsValid(com.pranav.ide.dx.rop.code.BasicBlock start, BasicBlock end,
     ...
     */
    @Override
    public com.pranav.ide.dx.dex.code.CatchTable build() {
    ...
    public boolean hasAnyCatches() {
        ...
        for (int i = 0; i < size; i++) {
            com.pranav.ide.dx.rop.code.BasicBlock block = blocks.get(i);
            com.pranav.ide.dx.rop.type.TypeList catches = block.getLastInsn().getCatches();
            if (catches.size() != 0) {
                return true;
            }
        }
     ...
     */
    @Override
    public HashSet<com.pranav.ide.dx.rop.type.Type> getCatchTypes() {
        HashSet<com.pranav.ide.dx.rop.type.Type> result = new HashSet<com.pranav.ide.dx.rop.type.Type>(20);
        com.pranav.ide.dx.rop.code.BasicBlockList blocks = method.getBlocks();
        int size = blocks.size();
