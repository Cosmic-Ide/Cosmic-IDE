...
public final class SwitchData extends VariableSizeInsn {
     ...
     */
    private final com.pranav.ide.dx.util.IntList cases;

    /**
     * {@code non-null;} corresponding list of code addresses; the branch
     * target for each case
     */
    private final com.pranav.ide.dx.dex.code.CodeAddress[] targets;
     ...
     */
    public SwitchData(SourcePosition position, com.pranav.ide.dx.dex.code.CodeAddress user,
                      com.pranav.ide.dx.util.IntList cases, CodeAddress[] targets) {
     ...
     */
    private static long packedCodeSize(com.pranav.ide.dx.util.IntList cases) {
        int sz = cases.size();
     ...
     */
    private static long sparseCodeSize(com.pranav.ide.dx.util.IntList cases) {
        int sz = cases.size();
    ...
    public void writeTo(AnnotatedOutput out) {
        ...
        if (packed) {
            ...
            out.writeShort(com.pranav.ide.dx.io.Opcodes.PACKED_SWITCH_PAYLOAD);
    ...
    protected String listingString0(boolean noteIndices) {
        ...
        sb.append(com.pranav.ide.dx.util.Hex.u2(baseAddress));
        ...
        for (int i = 0; i < sz; i++) {
            ...
            sb.append(cases.get(i));
            sb.append(": ");
            sb.append(com.pranav.ide.dx.util.Hex.u4(absTarget));
            sb.append(" // ");
