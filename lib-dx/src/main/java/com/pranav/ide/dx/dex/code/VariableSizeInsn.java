 ...
 */
public abstract class VariableSizeInsn extends com.pranav.ide.dx.dex.code.DalvInsn {
    /**
     ...
     */
    @Override
    public final com.pranav.ide.dx.dex.code.DalvInsn withOpcode(Dop opcode) {
