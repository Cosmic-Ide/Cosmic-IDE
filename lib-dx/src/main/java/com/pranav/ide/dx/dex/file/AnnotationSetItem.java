 ...
 */
public final class AnnotationSetItem extends com.pranav.ide.dx.dex.file.OffsettedItem {
    /**
     ...
     */
    private final com.pranav.ide.dx.rop.annotation.Annotations annotations;
     ...
     * writing.
     */
    private final com.pranav.ide.dx.dex.file.AnnotationItem[] items;
     ...
     */
    public AnnotationSetItem(com.pranav.ide.dx.rop.annotation.Annotations annotations, DexFile dexFile) {
        super(ALIGNMENT, writeSize(annotations));

        this.annotations = annotations;
        this.items = new com.pranav.ide.dx.dex.file.AnnotationItem[annotations.size()];

        int at = 0;
        for (Annotation a : annotations.getAnnotations()) {
            items[at] = new com.pranav.ide.dx.dex.file.AnnotationItem(a, dexFile);
            at++;
        }
    }
     ...
     */
    private static int writeSize(com.pranav.ide.dx.rop.annotation.Annotations annotations) {
    ...
    protected void place0(Section addedTo, int offset) {
        ...
        com.pranav.ide.dx.dex.file.AnnotationItem.sortByTypeIdIndex(items);
    }
    ...
    protected void writeTo0(DexFile file, AnnotatedOutput out) {
        ...
        if (annotates) {
            ...
            out.annotate(4, "  size: " + com.pranav.ide.dx.util.Hex.u4(size));
        }
