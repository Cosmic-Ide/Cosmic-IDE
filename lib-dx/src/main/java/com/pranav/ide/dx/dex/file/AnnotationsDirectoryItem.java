 ...
 */
public final class AnnotationsDirectoryItem extends com.pranav.ide.dx.dex.file.OffsettedItem {
    /**
     ...
     */
    private com.pranav.ide.dx.dex.file.AnnotationSetItem classAnnotations;

    /**
     * {@code null-ok;} the annotated fields, if any
     */
    private ArrayList<com.pranav.ide.dx.dex.file.FieldAnnotationStruct> fieldAnnotations;

    /**
     * {@code null-ok;} the annotated methods, if any
     */
    private ArrayList<com.pranav.ide.dx.dex.file.MethodAnnotationStruct> methodAnnotations;

    /**
     * {@code null-ok;} the annotated parameters, if any
     */
    private ArrayList<com.pranav.ide.dx.dex.file.ParameterAnnotationStruct> parameterAnnotations;
     ...
     */
    @Override
    public int compareTo0(com.pranav.ide.dx.dex.file.OffsettedItem other) {
        if (!isInternable()) {
     ...
     */
    public void setClassAnnotations(Annotations annotations, com.pranav.ide.dx.dex.file.DexFile dexFile) {
        if (annotations == null) {
        ...
        classAnnotations = new com.pranav.ide.dx.dex.file.AnnotationSetItem(annotations, dexFile);
    }
    ...
    public void addFieldAnnotations(CstFieldRef field,
                                    Annotations annotations, com.pranav.ide.dx.dex.file.DexFile dexFile) {
        if (fieldAnnotations == null) {
            fieldAnnotations = new ArrayList<com.pranav.ide.dx.dex.file.FieldAnnotationStruct>();
        }

        fieldAnnotations.add(new com.pranav.ide.dx.dex.file.FieldAnnotationStruct(field,
                new com.pranav.ide.dx.dex.file.AnnotationSetItem(annotations, dexFile)));
    }
    ...
    public void addMethodAnnotations(CstMethodRef method,
        ...
        if (methodAnnotations == null) {
            methodAnnotations = new ArrayList<com.pranav.ide.dx.dex.file.MethodAnnotationStruct>();
        }

        methodAnnotations.add(new com.pranav.ide.dx.dex.file.MethodAnnotationStruct(method,
    ...
    public void addParameterAnnotations(CstMethodRef method,
                                        AnnotationsList list, com.pranav.ide.dx.dex.file.DexFile dexFile) {
        if (parameterAnnotations == null) {
            parameterAnnotations = new ArrayList<com.pranav.ide.dx.dex.file.ParameterAnnotationStruct>();
        }

        parameterAnnotations.add(new com.pranav.ide.dx.dex.file.ParameterAnnotationStruct(method, list, dexFile));
    }
    ...
    public Annotations getMethodAnnotations(CstMethodRef method) {
        ...
        for (com.pranav.ide.dx.dex.file.MethodAnnotationStruct item : methodAnnotations) {
    ...
    public AnnotationsList getParameterAnnotations(CstMethodRef method) {
        ...
        for (com.pranav.ide.dx.dex.file.ParameterAnnotationStruct item : parameterAnnotations) {
            if (item.getMethod().equals(method)) {
    ...
    public void addContents(com.pranav.ide.dx.dex.file.DexFile file) {
        ...
        if (fieldAnnotations != null) {
            for (com.pranav.ide.dx.dex.file.FieldAnnotationStruct item : fieldAnnotations) {
