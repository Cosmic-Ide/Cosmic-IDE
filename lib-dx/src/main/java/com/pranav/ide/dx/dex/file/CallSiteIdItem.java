...
public final class CallSiteIdItem extends IndexedItem implements Comparable {
     ...
     */
    final com.pranav.ide.dx.rop.cst.CstCallSiteRef invokeDynamicRef;

    com.pranav.ide.dx.dex.file.CallSiteItem data;
    ...
    public void addContents(DexFile file) {
        ...
        com.pranav.ide.dx.dex.file.CallSiteItem callSiteItem = callSiteIds.getCallSiteItem(callSite);
