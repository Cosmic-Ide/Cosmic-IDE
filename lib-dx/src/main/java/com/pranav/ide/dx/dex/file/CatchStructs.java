...
import com.pranav.ide.dx.dex.code.CatchHandlerList;
import com.pranav.ide.dx.dex.code.CatchTable;
...
public final class CatchStructs {
     ...
     */
    private final com.pranav.ide.dx.dex.code.DalvCode code;

    /**
     * {@code null-ok;} the underlying table; set in
     * {@link #finishProcessingIfNecessary}
     */
    private com.pranav.ide.dx.dex.code.CatchTable table;
     ...
     * {@link #encode}
     */
    private TreeMap<com.pranav.ide.dx.dex.code.CatchHandlerList, Integer> handlerOffsets;
    ...
    public void encode(DexFile file) {
        ...
        handlerOffsets = new TreeMap<com.pranav.ide.dx.dex.code.CatchHandlerList, Integer>();
        ...
        com.pranav.ide.dx.util.ByteArrayAnnotatedOutput out = new ByteArrayAnnotatedOutput();
        ...
        for (Map.Entry<com.pranav.ide.dx.dex.code.CatchHandlerList, Integer> mapping :
                handlerOffsets.entrySet()) {
            com.pranav.ide.dx.dex.code.CatchHandlerList list = mapping.getKey();
            ...
            for (int i = 0; i < listSize; i++) {
                com.pranav.ide.dx.dex.code.CatchHandlerList.Entry entry = list.get(i);
                out.writeUleb128(
     ...
     */
    public void writeTo(DexFile file, com.pranav.ide.dx.util.AnnotatedOutput out) {
        finishProcessingIfNecessary();
        ...
        for (int i = 0; i < tableSize; i++) {
            com.pranav.ide.dx.dex.code.CatchTable.Entry one = table.get(i);
            ...
            if (insnCount >= 65536) {
                throw new UnsupportedOperationException(
                        "bogus exception range: " + com.pranav.ide.dx.util.Hex.u4(start) + ".." +
                                com.pranav.ide.dx.util.Hex.u4(end));
            }
    ...
    private void annotateEntries(String prefix, PrintWriter printTo,
                                 com.pranav.ide.dx.util.AnnotatedOutput annotateTo) {
        finishProcessingIfNecessary();
        ...
        for (int i = 0; i < size; i++) {
            ...
            com.pranav.ide.dx.dex.code.CatchHandlerList handlers = entry.getHandlers();
            String s1 = subPrefix + "try " + com.pranav.ide.dx.util.Hex.u2or4(entry.getStart())
                    + ".." + com.pranav.ide.dx.util.Hex.u2or4(entry.getEnd());
        ...
        annotateTo.annotate(encodedHandlerHeaderSize,
                subPrefix + "size: " + com.pranav.ide.dx.util.Hex.u2(handlerOffsets.size()));

        int lastOffset = 0;
        com.pranav.ide.dx.dex.code.CatchHandlerList lastList = null;
