...
public final class ClassDefItem extends IndexedItem {
     ...
     * in {@link #addContents}
     */
    private com.pranav.ide.dx.dex.file.EncodedArrayItem staticValuesItem;
    ...
    public void addContents(com.pranav.ide.dx.dex.file.DexFile file) {
        com.pranav.ide.dx.dex.file.TypeIdsSection typeIds = file.getTypeIds();
     ...
     */
    @Override
    public void writeTo(com.pranav.ide.dx.dex.file.DexFile file, AnnotatedOutput out) {
        boolean annotates = out.annotates();
        TypeIdsSection typeIds = file.getTypeIds();
        int classIdx = typeIds.indexOf(thisClass);
        int superIdx = (superclass == null) ? -1 :
                typeIds.indexOf(superclass);
        int interOff = com.pranav.ide.dx.dex.file.OffsettedItem.getAbsoluteOffsetOr0(interfaces);
