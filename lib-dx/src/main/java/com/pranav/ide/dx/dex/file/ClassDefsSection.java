...
public final class ClassDefsSection extends UniformItemSection {
     ...
     */
    private final TreeMap<com.pranav.ide.dx.rop.type.Type, ClassDefItem> classDefs;
    ...
    public ClassDefsSection(DexFile file) {
        ...
        classDefs = new TreeMap<com.pranav.ide.dx.rop.type.Type, ClassDefItem>();
        orderedDefs = null;
    }
    ...
    public void writeHeaderPart(AnnotatedOutput out) {
        ...
        if (out.annotates()) {
            out.annotate(4, "class_defs_size: " + com.pranav.ide.dx.util.Hex.u4(sz));
    ...
    protected void orderItems() {
         ...
         */
        for (com.pranav.ide.dx.rop.type.Type type : classDefs.keySet()) {
     ...
     */
    private int orderItems0(com.pranav.ide.dx.rop.type.Type type, int idx, int maxDepth) {
