...
public final class CodeItem extends OffsettedItem {
     ...
     */
    private final com.pranav.ide.dx.rop.cst.CstMethodRef ref;
     ...
     */
    private final com.pranav.ide.dx.rop.type.TypeList throwsList;
    /**
     * {@code null-ok;} the catches, if needed; set in {@link #addContents}
     */
    private com.pranav.ide.dx.dex.file.CatchStructs catches;
    /**
     ...
     */
    public CodeItem(com.pranav.ide.dx.rop.cst.CstMethodRef ref, com.pranav.ide.dx.dex.code.DalvCode code, boolean isStatic,
                    TypeList throwsList) {
        super(ALIGNMENT, -1);
    ...
    public void addContents(DexFile file) {
        ...
        for (com.pranav.ide.dx.rop.cst.Constant c : code.getInsnConstants()) {
    ...
    public void debugPrint(PrintWriter out, String prefix, boolean verbose) {
        ...
        com.pranav.ide.dx.dex.code.DalvInsnList insns = code.getInsns();
        out.println("regs: " + com.pranav.ide.dx.util.Hex.u2(getRegistersSize()) +
                "; ins: " + com.pranav.ide.dx.util.Hex.u2(getInsSize()) + "; outs: " +
                com.pranav.ide.dx.util.Hex.u2(getOutsSize()));
     ...
     */
    @Override
    protected void writeTo0(DexFile file, com.pranav.ide.dx.util.AnnotatedOutput out) {
        ...
        if (annotates) {
            ...
            out.annotate(2, "  registers_size: " + com.pranav.ide.dx.util.Hex.u2(regSz));
            out.annotate(2, "  ins_size:       " + com.pranav.ide.dx.util.Hex.u2(insSz));
            out.annotate(2, "  outs_size:      " + com.pranav.ide.dx.util.Hex.u2(outsSz));
            out.annotate(2, "  tries_size:     " + com.pranav.ide.dx.util.Hex.u2(triesSz));
            out.annotate(4, "  debug_off:      " + com.pranav.ide.dx.util.Hex.u4(debugOff));
