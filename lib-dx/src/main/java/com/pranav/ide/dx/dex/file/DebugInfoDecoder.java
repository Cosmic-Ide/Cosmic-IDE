...
import static com.pranav.ide.dx.dex.file.DebugInfoConstants.DBG_SET_EPILOGUE_BEGIN;
import static com.pranav.ide.dx.dex.file.DebugInfoConstants.DBG_SET_FILE;
...
import com.pranav.ide.dx.dex.code.DalvInsnList;
...
public class DebugInfoDecoder {
     ...
     */
    private final com.pranav.ide.dx.dex.file.DexFile file;
    ...
    DebugInfoDecoder(byte[] encoded, int codesize, int regSize,
                     boolean isStatic, CstMethodRef ref, com.pranav.ide.dx.dex.file.DexFile file) {
        if (encoded == null) {
     ...
     */
    public static void validateEncode(byte[] info, com.pranav.ide.dx.dex.file.DexFile file,
