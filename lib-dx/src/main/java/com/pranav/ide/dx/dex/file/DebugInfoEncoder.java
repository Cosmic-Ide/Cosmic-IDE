...
import static com.pranav.ide.dx.dex.file.DebugInfoConstants.DBG_ADVANCE_LINE;
import static com.pranav.ide.dx.dex.file.DebugInfoConstants.DBG_ADVANCE_PC;
import static com.pranav.ide.dx.dex.file.DebugInfoConstants.DBG_END_LOCAL;
import static com.pranav.ide.dx.dex.file.DebugInfoConstants.DBG_END_SEQUENCE;
import static com.pranav.ide.dx.dex.file.DebugInfoConstants.DBG_FIRST_SPECIAL;
import static com.pranav.ide.dx.dex.file.DebugInfoConstants.DBG_LINE_BASE;
import static com.pranav.ide.dx.dex.file.DebugInfoConstants.DBG_LINE_RANGE;
import static com.pranav.ide.dx.dex.file.DebugInfoConstants.DBG_RESTART_LOCAL;
import static com.pranav.ide.dx.dex.file.DebugInfoConstants.DBG_SET_PROLOGUE_END;
import static com.pranav.ide.dx.dex.file.DebugInfoConstants.DBG_START_LOCAL;
import static com.pranav.ide.dx.dex.file.DebugInfoConstants.DBG_START_LOCAL_EXTENDED;

import com.pranav.ide.dex.util.ExceptionWithContext;
import com.pranav.ide.dx.dex.code.LocalList;
...
public final class DebugInfoEncoder {
     ...
     */
    private final com.pranav.ide.dx.dex.code.PositionList positions;

    /**
     * {@code null-ok;} local variables to encode
     */
    private final com.pranav.ide.dx.dex.code.LocalList locals;

    private final com.pranav.ide.dx.util.ByteArrayAnnotatedOutput output;
     ...
     */
    private final com.pranav.ide.dx.dex.code.LocalList.Entry[] lastEntryForReg;
    /**
     ...
     */
    private com.pranav.ide.dx.util.AnnotatedOutput annotateTo;
    /**
     ...
     * @param ref
     */
    public DebugInfoEncoder(com.pranav.ide.dx.dex.code.PositionList positions, com.pranav.ide.dx.dex.code.LocalList locals,
        ...
        lastEntryForReg = new com.pranav.ide.dx.dex.code.LocalList.Entry[regSize];
    }
    ...
    private byte[] convert0() throws IOException {
        ArrayList<com.pranav.ide.dx.dex.code.PositionList.Entry> sortedPositions = buildSortedPositions();
        ArrayList<com.pranav.ide.dx.dex.code.LocalList.Entry> methodArgs = extractMethodArguments();
    ...
    private int emitLocalsAtAddress(int curLocalIdx)
        ...
        while ((curLocalIdx < sz)
            ...
            com.pranav.ide.dx.dex.code.LocalList.Entry entry = locals.get(curLocalIdx++);
            int reg = entry.getRegister();
            com.pranav.ide.dx.dex.code.LocalList.Entry prevEntry = lastEntryForReg[reg];
            ...
            if (entry.isStart()) {
                ...
                if (entry.getDisposition()
                        != com.pranav.ide.dx.dex.code.LocalList.Disposition.END_REPLACED) {
                    emitLocalEnd(entry);
                }
            }
        }
    ...
    private int emitPositionsAtAddress(int curPositionIdx,
                                       ArrayList<com.pranav.ide.dx.dex.code.PositionList.Entry> sortedPositions)
            throws IOException {
        int positionsSz = sortedPositions.size();
     ...
     * @throws IOException
     */
    private void emitHeader(ArrayList<com.pranav.ide.dx.dex.code.PositionList.Entry> sortedPositions,
                            ArrayList<com.pranav.ide.dx.dex.code.LocalList.Entry> methodArgs) throws IOException {
        ...
        if (sortedPositions.size() > 0) {
            com.pranav.ide.dx.dex.code.PositionList.Entry entry = sortedPositions.get(0);
         ...
         */
        if (!isStatic) {
            for (com.pranav.ide.dx.dex.code.LocalList.Entry arg : methodArgs) {
        ...
        for (int i = 0; i < szParamTypes; i++) {
            ...
            com.pranav.ide.dx.dex.code.LocalList.Entry found = null;
            ...
            if (annotate) {
                ...
                annotate(output.getCursor() - mark,
                        "parameter " + parameterName + " "
                                + com.pranav.ide.dx.rop.code.RegisterSpec.PREFIX + curParam);
            }
        ...
        for (com.pranav.ide.dx.dex.code.LocalList.Entry arg : lastEntryForReg) {
            if (arg == null) {
                continue;
            }

            com.pranav.ide.dx.rop.cst.CstString signature = arg.getSignature();
     ...
     */
    private ArrayList<com.pranav.ide.dx.dex.code.PositionList.Entry> buildSortedPositions() {
        int sz = (positions == null) ? 0 : positions.size();
        ArrayList<com.pranav.ide.dx.dex.code.PositionList.Entry> result = new ArrayList<>(sz);
        ...
        Collections.sort(result, new Comparator<com.pranav.ide.dx.dex.code.PositionList.Entry>() {
            @Override
            public int compare(com.pranav.ide.dx.dex.code.PositionList.Entry a, com.pranav.ide.dx.dex.code.PositionList.Entry b) {
     ...
     */
    private ArrayList<com.pranav.ide.dx.dex.code.LocalList.Entry> extractMethodArguments() {
        ArrayList<com.pranav.ide.dx.dex.code.LocalList.Entry> result
        ...
        for (int i = 0; i < sz; i++) {
            com.pranav.ide.dx.dex.code.LocalList.Entry e = locals.get(i);
        ...
        Collections.sort(result, new Comparator<com.pranav.ide.dx.dex.code.LocalList.Entry>() {
            @Override
            public int compare(com.pranav.ide.dx.dex.code.LocalList.Entry a, com.pranav.ide.dx.dex.code.LocalList.Entry b) {
     ...
     */
    private String entryAnnotationString(com.pranav.ide.dx.dex.code.LocalList.Entry e) {
        ...
        com.pranav.ide.dx.rop.cst.CstString name = e.getName();
        if (name == null) {
            sb.append("null");
        } else {
        ...
        com.pranav.ide.dx.rop.cst.CstType type = e.getType();
        if (type == null) {
            sb.append("null");
        } else {
        ...
        com.pranav.ide.dx.rop.cst.CstString signature = e.getSignature();
    ...
    /**
     * Emits a {@link com.pranav.ide.dx.dex.file.DebugInfoConstants#DBG_RESTART_LOCAL DBG_RESTART_LOCAL}
     * sequence.
     *
     * @param entry entry associated with this restart
     * @throws IOException
     */
    private void emitLocalRestart(com.pranav.ide.dx.dex.code.LocalList.Entry entry)
            throws IOException {
    ...
    /**
     * Emits a {@link com.pranav.ide.dx.dex.file.DebugInfoConstants#DBG_START_LOCAL DBG_START_LOCAL} or
     * {@link com.pranav.ide.dx.dex.file.DebugInfoConstants#DBG_START_LOCAL_EXTENDED
     * DBG_START_LOCAL_EXTENDED} sequence.
     *
     * @param entry entry to emit
     * @throws IOException
     */
    private void emitLocalStart(com.pranav.ide.dx.dex.code.LocalList.Entry entry)
            throws IOException {
    ...
    /**
     * Emits a {@link com.pranav.ide.dx.dex.file.DebugInfoConstants#DBG_START_LOCAL_EXTENDED
     * DBG_START_LOCAL_EXTENDED} sequence.
     *
     * @param entry entry to emit
     * @throws IOException
     */
    private void emitLocalStartExtended(com.pranav.ide.dx.dex.code.LocalList.Entry entry)
            throws IOException {
    ...
    /**
     * Emits a {@link com.pranav.ide.dx.dex.file.DebugInfoConstants#DBG_END_LOCAL DBG_END_LOCAL} sequence.
     *
    ...
    /**
     * Emits an {@link com.pranav.ide.dx.dex.file.DebugInfoConstants#DBG_ADVANCE_LINE DBG_ADVANCE_LINE}
     * sequence.
     *
    ...
    /**
     * Emits an  {@link com.pranav.ide.dx.dex.file.DebugInfoConstants#DBG_ADVANCE_PC DBG_ADVANCE_PC}
     * sequence.
     *
