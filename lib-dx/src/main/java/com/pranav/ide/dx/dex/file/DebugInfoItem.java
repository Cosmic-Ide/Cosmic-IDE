...
public class DebugInfoItem extends OffsettedItem {
     ...
     */
    public void annotateTo(com.pranav.ide.dx.dex.file.DexFile file, AnnotatedOutput out, String prefix) {
     ...
     */
    @Override
    protected void writeTo0(com.pranav.ide.dx.dex.file.DexFile file, AnnotatedOutput out) {
        if (out.annotates()) {
            /*
     ...
     */
    private byte[] encode(com.pranav.ide.dx.dex.file.DexFile file, String prefix, PrintWriter debugPrint,
    ...
    private byte[] encode0(DexFile file, String prefix, PrintWriter debugPrint,
        ...
        com.pranav.ide.dx.dex.file.DebugInfoEncoder encoder =
