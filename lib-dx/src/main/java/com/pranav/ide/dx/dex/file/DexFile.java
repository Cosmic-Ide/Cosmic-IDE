...
public final class DexFile {
     ...
     * straightforward way. See {@link com.pranav.ide.dx.dex.file.MapItem#addMap} for more detail.
     */
     ...
     */
    private final com.pranav.ide.dx.dex.file.StringIdsSection stringIds;

    /**
     * {@code non-null;} type identifiers section
     */
    private final com.pranav.ide.dx.dex.file.TypeIdsSection typeIds;

    /**
     * {@code non-null;} prototype identifiers section
     */
    private final com.pranav.ide.dx.dex.file.ProtoIdsSection protoIds;

    /**
     * {@code non-null;} field identifiers section
     */
    private final com.pranav.ide.dx.dex.file.FieldIdsSection fieldIds;
     ...
     */
    private final com.pranav.ide.dx.dex.file.ClassDefsSection classDefs;
     ...
     */
    private final com.pranav.ide.dx.dex.file.CallSiteIdsSection callSiteIds;

    /**
     * {@code null-ok;} method handles section, only exists for SDK >= 26
     */
    private final com.pranav.ide.dx.dex.file.MethodHandlesSection methodHandles;
     ...
     */
    public DexFile(final com.pranav.ide.dx.dex.DexOptions dexOptions) {
        ...
        stringIds = new com.pranav.ide.dx.dex.file.StringIdsSection(this);
        typeIds = new com.pranav.ide.dx.dex.file.TypeIdsSection(this);
        protoIds = new com.pranav.ide.dx.dex.file.ProtoIdsSection(this);
        fieldIds = new com.pranav.ide.dx.dex.file.FieldIdsSection(this);
        methodIds = new MethodIdsSection(this);
        classDefs = new com.pranav.ide.dx.dex.file.ClassDefsSection(this);
        ...
        if (dexOptions.apiIsSupported(DexFormat.API_METHOD_HANDLES)) {
             ...
             */
            callSiteIds = new com.pranav.ide.dx.dex.file.CallSiteIdsSection(this);
            methodHandles = new com.pranav.ide.dx.dex.file.MethodHandlesSection(this);
    ...
    public ClassDefItem getClassOrNull(String name) {
        try {
            com.pranav.ide.dx.rop.type.Type type = Type.internClassName(name);
            return (ClassDefItem) classDefs.get(new com.pranav.ide.dx.rop.cst.CstType(type));
    ...
    public void writeTo(OutputStream out, Storage storage, Writer humanOut, boolean verbose)
        ...
        com.pranav.ide.dx.util.ByteArrayAnnotatedOutput result = toDex0(annotate, verbose, storage);
     ...
     */
    public com.pranav.ide.dx.util.ByteArrayAnnotatedOutput writeTo(Storage storage) {
    ...
    public byte[] toDex(Writer humanOut, boolean verbose)
            throws IOException {
        boolean annotate = (humanOut != null);
        com.pranav.ide.dx.util.ByteArrayAnnotatedOutput result = toDex0(annotate, verbose, null);
     ...
     */
    /*package*/ void internIfAppropriate(com.pranav.ide.dx.rop.cst.Constant cst) {
        if (cst == null) {
            throw new NullPointerException("cst == null");
        }

        if (cst instanceof com.pranav.ide.dx.rop.cst.CstString) {
            stringIds.intern((com.pranav.ide.dx.rop.cst.CstString) cst);
        } else if (cst instanceof com.pranav.ide.dx.rop.cst.CstType) {
            typeIds.intern((com.pranav.ide.dx.rop.cst.CstType) cst);
        } else if (cst instanceof com.pranav.ide.dx.rop.cst.CstBaseMethodRef) {
            methodIds.intern((com.pranav.ide.dx.rop.cst.CstBaseMethodRef) cst);
        } else if (cst instanceof com.pranav.ide.dx.rop.cst.CstFieldRef) {
            fieldIds.intern((com.pranav.ide.dx.rop.cst.CstFieldRef) cst);
        } else if (cst instanceof com.pranav.ide.dx.rop.cst.CstEnumRef) {
            fieldIds.intern(((com.pranav.ide.dx.rop.cst.CstEnumRef) cst).getFieldRef());
        } else if (cst instanceof com.pranav.ide.dx.rop.cst.CstProtoRef) {
            protoIds.intern(((com.pranav.ide.dx.rop.cst.CstProtoRef) cst).getPrototype());
        } else if (cst instanceof com.pranav.ide.dx.rop.cst.CstMethodHandle) {
            methodHandles.intern((com.pranav.ide.dx.rop.cst.CstMethodHandle) cst);
        }
    }

    /**
     * Gets the {@link com.pranav.ide.dx.dex.file.IndexedItem} corresponding to the given constant,
    ...
    /**
     * Returns the contents of this instance as a {@code .dex} file,
     * in a {@link com.pranav.ide.dx.util.ByteArrayAnnotatedOutput} instance.
     *
     * @param annotate whether or not to keep annotations
     * @param verbose  if annotating, whether to be verbose
     * @return {@code non-null;} a {@code .dex} file for this instance
     */
    private com.pranav.ide.dx.util.ByteArrayAnnotatedOutput toDex0(boolean annotate,
                                                                   boolean verbose,
                                                                   Storage storage) {
        /*
        ...
        com.pranav.ide.dx.util.ByteArrayAnnotatedOutput out = new ByteArrayAnnotatedOutput(barr);
     ...
     */
    public com.pranav.ide.dx.dex.file.Statistics getStatistics() {
        com.pranav.ide.dx.dex.file.Statistics stats = new Statistics();
