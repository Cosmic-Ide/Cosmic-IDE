 ...
 */
public final class EncodedArrayItem extends com.pranav.ide.dx.dex.file.OffsettedItem {
    /**
     ...
     */
    private final com.pranav.ide.dx.rop.cst.CstArray array;
    ...
    public void addContents(DexFile file) {
        com.pranav.ide.dx.dex.file.ValueEncoder.addContents(file, array);
    }
    ...
    protected void place0(Section addedTo, int offset) {
        ...
        com.pranav.ide.dx.dex.file.ValueEncoder encoder = new com.pranav.ide.dx.dex.file.ValueEncoder(addedTo.getFile(), out);
    ...
    protected void writeTo0(DexFile file, AnnotatedOutput out) {
        ...
        if (annotates) {
             ...
             * get emitted.
             */
            com.pranav.ide.dx.dex.file.ValueEncoder encoder = new ValueEncoder(file, out);
