...
public final class EncodedMethod extends EncodedMember
     ...
     */
    private final com.pranav.ide.dx.rop.cst.CstMethodRef method;
     ...
     */
    public EncodedMethod(com.pranav.ide.dx.rop.cst.CstMethodRef method, int accessFlags,
        ...
        if (code == null) {
            ...
            boolean isStatic = (accessFlags & com.pranav.ide.dx.rop.code.AccessFlags.ACC_STATIC) != 0;
    ...
    public String toString() {
        ...
        sb.append('{');
        sb.append(com.pranav.ide.dx.util.Hex.u2(getAccessFlags()));
        sb.append(' ');
        sb.append(method);
    ...
    public int encode(DexFile file, AnnotatedOutput out,
        ...
        boolean shouldHaveCode = (accessFlags &
                (com.pranav.ide.dx.rop.code.AccessFlags.ACC_ABSTRACT | com.pranav.ide.dx.rop.code.AccessFlags.ACC_NATIVE)) == 0;
        ...
        if (out.annotates()) {
            ...
            out.annotate(Leb128.unsignedLeb128Size(diff),
                    "    method_idx:   " + com.pranav.ide.dx.util.Hex.u4(methodIdx));
