...
public final class FieldAnnotationStruct
     ...
     */
    private final com.pranav.ide.dx.rop.cst.CstFieldRef field;

    /**
     * {@code non-null;} the associated annotations
     */
    private com.pranav.ide.dx.dex.file.AnnotationSetItem annotations;
     ...
     */
    public FieldAnnotationStruct(com.pranav.ide.dx.rop.cst.CstFieldRef field,
    ...
    public void writeTo(DexFile file, AnnotatedOutput out) {
        ...
        if (out.annotates()) {
            ...
            out.annotate(4, "      field_idx:       " + com.pranav.ide.dx.util.Hex.u4(fieldIdx));
