...
public final class FieldIdsSection extends MemberIdsSection {
     ...
     * com.pranav.ide.dx.dex.file.FieldIdItem} instances
     */
    private final TreeMap<com.pranav.ide.dx.rop.cst.CstFieldRef, com.pranav.ide.dx.dex.file.FieldIdItem> fieldIds;
    ...
    public FieldIdsSection(DexFile file) {
        ...
        fieldIds = new TreeMap<com.pranav.ide.dx.rop.cst.CstFieldRef, com.pranav.ide.dx.dex.file.FieldIdItem>();
    }
    ...
    public com.pranav.ide.dx.dex.file.IndexedItem get(Constant cst) {
        ...
        IndexedItem result = fieldIds.get((com.pranav.ide.dx.rop.cst.CstFieldRef) cst);
    ...
    public void writeHeaderPart(AnnotatedOutput out) {
        ...
        if (out.annotates()) {
            out.annotate(4, "field_ids_size:  " + com.pranav.ide.dx.util.Hex.u4(sz));
     ...
     */
    public synchronized com.pranav.ide.dx.dex.file.FieldIdItem intern(com.pranav.ide.dx.rop.cst.CstFieldRef field) {
        if (field == null) {
        ...
        com.pranav.ide.dx.dex.file.FieldIdItem result = fieldIds.get(field);

        if (result == null) {
            result = new com.pranav.ide.dx.dex.file.FieldIdItem(field);
