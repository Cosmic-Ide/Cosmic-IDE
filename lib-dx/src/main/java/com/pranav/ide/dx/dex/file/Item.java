...
public abstract class Item {
    ...
    /**
     * Populates a {@link com.pranav.ide.dx.dex.file.DexFile} with items from within this instance.
     ...
     */
    public abstract void addContents(com.pranav.ide.dx.dex.file.DexFile file);

    /**
     * Writes the representation of this instance to the given data section,
     * using the given {@link com.pranav.ide.dx.dex.file.DexFile} to look things up as needed.
