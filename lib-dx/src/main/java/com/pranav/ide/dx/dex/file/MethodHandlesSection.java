...
public final class MethodHandlesSection extends UniformItemSection {
    ...
    private final TreeMap<com.pranav.ide.dx.rop.cst.CstMethodHandle, MethodHandleItem> methodHandles = new TreeMap<>();
    ...
    public IndexedItem get(Constant cst) {
        ...
        IndexedItem result = methodHandles.get((com.pranav.ide.dx.rop.cst.CstMethodHandle) cst);
        if (result == null) {
    ...
    public synchronized void intern(com.pranav.ide.dx.rop.cst.CstMethodHandle methodHandle) {
