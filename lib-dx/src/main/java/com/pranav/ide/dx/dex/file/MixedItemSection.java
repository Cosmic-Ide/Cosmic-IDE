 ...
 * {@link com.pranav.ide.dx.dex.file.OffsettedItem} objects, which may each be of a different concrete
 * class and/or size.
 *
...
public final class MixedItemSection extends Section {
     ...
     */
    private static final Comparator<com.pranav.ide.dx.dex.file.OffsettedItem> TYPE_SORTER =
            (item1, item2) -> {
     ...
     */
    private final ArrayList<com.pranav.ide.dx.dex.file.OffsettedItem> items;
    /**
     * {@code non-null;} items that have been explicitly interned
     */
    private final HashMap<com.pranav.ide.dx.dex.file.OffsettedItem, com.pranav.ide.dx.dex.file.OffsettedItem> interns;
    /**
     ...
     */
    public MixedItemSection(String name, com.pranav.ide.dx.dex.file.DexFile file, int alignment,
                            SortType sort) {
    ...
    public int getAbsoluteItemOffset(Item item) {
        com.pranav.ide.dx.dex.file.OffsettedItem oi = (com.pranav.ide.dx.dex.file.OffsettedItem) item;
     ...
     */
    public void add(com.pranav.ide.dx.dex.file.OffsettedItem item) {
        throwIfPrepared();
     ...
     */
    public synchronized <T extends com.pranav.ide.dx.dex.file.OffsettedItem> T intern(T item) {
        throwIfPrepared();

        com.pranav.ide.dx.dex.file.OffsettedItem result = interns.get(item);
     ...
     */
    public <T extends com.pranav.ide.dx.dex.file.OffsettedItem> T get(T item) {
        throwIfNotPrepared();
    ...
    public void writeIndexAnnotation(AnnotatedOutput out, ItemType itemType,
        ...
        TreeMap<String, com.pranav.ide.dx.dex.file.OffsettedItem> index =
                new TreeMap<>();

        for (com.pranav.ide.dx.dex.file.OffsettedItem item : items) {
        ...
        for (Map.Entry<String, com.pranav.ide.dx.dex.file.OffsettedItem> entry : index.entrySet()) {
            String label = entry.getKey();
            com.pranav.ide.dx.dex.file.OffsettedItem item = entry.getValue();
    ...
    protected void prepare0() {
        com.pranav.ide.dx.dex.file.DexFile file = getFile();
        ...
        for (; ; ) {
            ...
            for (/*i*/; i < sz; i++) {
                com.pranav.ide.dx.dex.file.OffsettedItem one = items.get(i);
     ...
     * will call {@link com.pranav.ide.dx.dex.file.OffsettedItem#place} on each item. If an item
