...
public final class ParameterAnnotationStruct
     ...
     */
    private final com.pranav.ide.dx.dex.file.UniformListItem<com.pranav.ide.dx.dex.file.AnnotationSetRefItem> annotationsItem;
    ...
    public ParameterAnnotationStruct(CstMethodRef method,
                                     AnnotationsList annotationsList, com.pranav.ide.dx.dex.file.DexFile dexFile) {
        if (method == null) {
        ...
        ArrayList<com.pranav.ide.dx.dex.file.AnnotationSetRefItem> arrayList = new
                ArrayList<com.pranav.ide.dx.dex.file.AnnotationSetRefItem>(size);

        for (int i = 0; i < size; i++) {
            Annotations annotations = annotationsList.get(i);
            com.pranav.ide.dx.dex.file.AnnotationSetItem item = new AnnotationSetItem(annotations, dexFile);
            arrayList.add(new com.pranav.ide.dx.dex.file.AnnotationSetRefItem(item));
        }

        this.annotationsItem = new UniformListItem<com.pranav.ide.dx.dex.file.AnnotationSetRefItem>(
