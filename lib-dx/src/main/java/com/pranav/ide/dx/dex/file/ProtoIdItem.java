...
public final class ProtoIdItem extends IndexedItem {
     ...
     */
    private final com.pranav.ide.dx.rop.cst.CstString shortForm;
     ...
     */
    public ProtoIdItem(com.pranav.ide.dx.rop.type.Prototype prototype) {
        if (prototype == null) {
        ...
        com.pranav.ide.dx.rop.type.StdTypeList parameters = prototype.getParameterTypes();
     ...
     */
    private static com.pranav.ide.dx.rop.cst.CstString makeShortForm(Prototype prototype) {
        com.pranav.ide.dx.rop.type.StdTypeList parameters = prototype.getParameterTypes();
    ...
    public void writeTo(DexFile file, AnnotatedOutput out) {
        ...
        if (out.annotates()) {
            ...
            sb.append(")");
            out.annotate(0, indexString() + ' ' + sb);
            out.annotate(4, "  shorty_idx:      " + com.pranav.ide.dx.util.Hex.u4(shortyIdx) +
                    " // " + shortForm.toQuoted());
            out.annotate(4, "  return_type_idx: " + com.pranav.ide.dx.util.Hex.u4(returnIdx) +
