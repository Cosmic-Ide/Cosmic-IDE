...
public final class ProtoIdsSection extends UniformItemSection {
     ...
     */
    private final TreeMap<com.pranav.ide.dx.rop.type.Prototype, ProtoIdItem> protoIds;
    ...
    public ProtoIdsSection(DexFile file) {
        ...
        protoIds = new TreeMap<com.pranav.ide.dx.rop.type.Prototype, ProtoIdItem>();
    }
    ...
    public com.pranav.ide.dx.dex.file.IndexedItem get(Constant cst) {
        ...
        if (!(cst instanceof com.pranav.ide.dx.rop.cst.CstProtoRef)) {
            throw new IllegalArgumentException("cst not instance of CstProtoRef");
        }

        throwIfNotPrepared();
        com.pranav.ide.dx.rop.cst.CstProtoRef protoRef = (CstProtoRef) cst;
    ...
    public void writeHeaderPart(AnnotatedOutput out) {
        ...
        if (out.annotates()) {
            out.annotate(4, "proto_ids_size:  " + com.pranav.ide.dx.util.Hex.u4(sz));
     ...
     */
    public synchronized ProtoIdItem intern(com.pranav.ide.dx.rop.type.Prototype prototype) {
        if (prototype == null) {
