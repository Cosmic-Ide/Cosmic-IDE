...
public final class StringIdsSection
     ...
     */
    private final TreeMap<com.pranav.ide.dx.rop.cst.CstString, StringIdItem> strings;
    ...
    public StringIdsSection(DexFile file) {
        ...
        strings = new TreeMap<com.pranav.ide.dx.rop.cst.CstString, StringIdItem>();
    }
    ...
    public IndexedItem get(Constant cst) {
        ...
        IndexedItem result = strings.get((com.pranav.ide.dx.rop.cst.CstString) cst);
    ...
    public void writeHeaderPart(AnnotatedOutput out) {
        ...
        if (out.annotates()) {
            out.annotate(4, "string_ids_size: " + com.pranav.ide.dx.util.Hex.u4(sz));
    ...
    public StringIdItem intern(String string) {
        return intern(new StringIdItem(new com.pranav.ide.dx.rop.cst.CstString(string)));
    }
     ...
     * @return {@code non-null;} the interned string
     */
    public StringIdItem intern(com.pranav.ide.dx.rop.cst.CstString string) {
    ...
    public synchronized StringIdItem intern(StringIdItem string) {
        ...
        com.pranav.ide.dx.rop.cst.CstString value = string.getValue();
