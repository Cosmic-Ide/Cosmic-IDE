...
public abstract class UniformItemSection extends Section {
    ...
    /**
     * Gets the item corresponding to the given {@link com.pranav.ide.dx.rop.cst.Constant}. This
     ...
     * com.pranav.ide.dx.dex.file.IndexedItem} instances.
     *
     * @param cst {@code non-null;} constant to look for
     * @return {@code non-null;} the corresponding item found in this instance
     */
    public abstract com.pranav.ide.dx.dex.file.IndexedItem get(Constant cst);
    ...
    public final int getAbsoluteItemOffset(Item item) {
         ...
         */
        com.pranav.ide.dx.dex.file.IndexedItem ii = (IndexedItem) item;
