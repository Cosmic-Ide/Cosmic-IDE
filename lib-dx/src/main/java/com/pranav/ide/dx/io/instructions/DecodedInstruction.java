...
package com.pranav.ide.dx.io.instructions;

import com.pranav.ide.dex.DexException;
import com.pranav.ide.dx.io.IndexType;
import com.pranav.ide.dx.io.OpcodeInfo;
...
public abstract class DecodedInstruction {
     ...
     */
    private final com.pranav.ide.dx.io.instructions.InstructionCodec format;
     ...
     * null-ok; index type
     */
    private final com.pranav.ide.dx.io.IndexType indexType;
     ...
     */
    public DecodedInstruction(com.pranav.ide.dx.io.instructions.InstructionCodec format, int opcode,
                              int index, com.pranav.ide.dx.io.IndexType indexType, int target, long literal) {
        if (format == null) {
    ...
    public static DecodedInstruction decode(CodeInput in) throws EOFException {
        ...
        int opcode = com.pranav.ide.dx.io.Opcodes.extractOpcodeFromUnit(opcodeUnit);
        com.pranav.ide.dx.io.instructions.InstructionCodec format = OpcodeInfo.getFormat(opcode);
    ...
    public static DecodedInstruction[] decodeAll(short[] encodedInstructions) {
        ...
        com.pranav.ide.dx.io.instructions.ShortArrayCodeInput in = new ShortArrayCodeInput(encodedInstructions);
    ...
    public final short getTargetUnit(int baseAddress) {
        ...
        if (relativeTarget != (short) relativeTarget) {
            throw new DexException("Target out of range: "
                    + com.pranav.ide.dx.util.Hex.s4(relativeTarget));
        }
    ...
    public final int getLiteralInt() {
        if (literal != (int) literal) {
            throw new DexException("Literal out of range: " + com.pranav.ide.dx.util.Hex.u8(literal));
        }
    ...
    public final short getRegisterCountUnit() {
        ...
        if ((registerCount & ~0xffff) != 0) {
            throw new DexException("Register count out of range: "
                    + com.pranav.ide.dx.util.Hex.u8(registerCount));
        }
    ...
    public final short getAUnit() {
        ...
        if ((a & ~0xffff) != 0) {
            throw new DexException("Register A out of range: " + com.pranav.ide.dx.util.Hex.u8(a));
        }
    ...
    public final short getBUnit() {
        ...
        if ((b & ~0xffff) != 0) {
            throw new DexException("Register B out of range: " + com.pranav.ide.dx.util.Hex.u8(b));
        }
    ...
    public final short getCUnit() {
        ...
        if ((c & ~0xffff) != 0) {
            throw new DexException("Register C out of range: " + com.pranav.ide.dx.util.Hex.u8(c));
        }
    ...
    public final short getDUnit() {
        ...
        if ((d & ~0xffff) != 0) {
            throw new DexException("Register D out of range: " + com.pranav.ide.dx.util.Hex.u8(d));
        }
