 ...
 */
public class InvokePolymorphicRangeDecodedInstruction extends com.pranav.ide.dx.io.instructions.DecodedInstruction {
    ...
    @Override
    public com.pranav.ide.dx.io.instructions.DecodedInstruction withProtoIndex(int newIndex, int newProtoIndex) {
