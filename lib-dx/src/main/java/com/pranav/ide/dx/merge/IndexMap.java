...
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_ANNOTATION;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_ARRAY;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_BOOLEAN;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_BYTE;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_CHAR;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_DOUBLE;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_ENUM;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_FIELD;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_FLOAT;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_INT;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_LONG;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_METHOD;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_METHOD_HANDLE;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_METHOD_TYPE;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_NULL;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_SHORT;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_STRING;
import static com.pranav.ide.dex.EncodedValueReader.ENCODED_TYPE;
...
import com.pranav.ide.dex.EncodedValue;
import com.pranav.ide.dex.EncodedValueCodec;
import com.pranav.ide.dex.EncodedValueReader;
import com.pranav.ide.dex.FieldId;
import com.pranav.ide.dex.Leb128;
...
public final class IndexMap {
    ...
    public EncodedValue adjustEncodedValue(EncodedValue encodedValue) {
        com.pranav.ide.dx.util.ByteArrayAnnotatedOutput out = new com.pranav.ide.dx.util.ByteArrayAnnotatedOutput(32);
    ...
    public Annotation adjust(Annotation annotation) {
        com.pranav.ide.dx.util.ByteArrayAnnotatedOutput out = new ByteArrayAnnotatedOutput(32);
