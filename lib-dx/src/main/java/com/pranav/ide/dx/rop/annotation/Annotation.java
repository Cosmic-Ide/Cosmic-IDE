...
package com.pranav.ide.dx.rop.annotation;
...
import com.pranav.ide.dx.util.ToHuman;
...
public final class Annotation extends MutabilityControl
     ...
     */
    private final com.pranav.ide.dx.rop.annotation.AnnotationVisibility visibility;

    /**
     * {@code non-null;} map from names to {@link com.pranav.ide.dx.rop.annotation.NameValuePair} instances
     */
    private final TreeMap<com.pranav.ide.dx.rop.cst.CstString, com.pranav.ide.dx.rop.annotation.NameValuePair> elements;
     ...
     */
    public Annotation(com.pranav.ide.dx.rop.cst.CstType type, com.pranav.ide.dx.rop.annotation.AnnotationVisibility visibility) {
        if (type == null) {
        ...
        this.elements = new TreeMap<com.pranav.ide.dx.rop.cst.CstString, com.pranav.ide.dx.rop.annotation.NameValuePair>();
    }
    ...
    public int compareTo(Annotation other) {
        ...
        Iterator<com.pranav.ide.dx.rop.annotation.NameValuePair> thisIter = elements.values().iterator();
        Iterator<com.pranav.ide.dx.rop.annotation.NameValuePair> otherIter = other.elements.values().iterator();

        while (thisIter.hasNext() && otherIter.hasNext()) {
            com.pranav.ide.dx.rop.annotation.NameValuePair thisOne = thisIter.next();
            com.pranav.ide.dx.rop.annotation.NameValuePair otherOne = otherIter.next();
    ...
    public String toHuman() {
        ...
        boolean first = true;
        for (com.pranav.ide.dx.rop.annotation.NameValuePair pair : elements.values()) {
            if (first) {
                first = false;
            } else {
                sb.append(", ");
     ...
     */
    public void put(com.pranav.ide.dx.rop.annotation.NameValuePair pair) {
        throwIfImmutable();
     ...
     */
    public void add(com.pranav.ide.dx.rop.annotation.NameValuePair pair) {
        throwIfImmutable();
