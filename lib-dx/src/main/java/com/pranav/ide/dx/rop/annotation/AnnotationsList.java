...
/**
 * List of {@link com.pranav.ide.dx.rop.annotation.Annotations} instances.
 */
public final class AnnotationsList
    ...
    public static AnnotationsList combine(AnnotationsList list1,
        ...
        for (int i = 0; i < size; i++) {
            com.pranav.ide.dx.rop.annotation.Annotations a1 = list1.get(i);
            com.pranav.ide.dx.rop.annotation.Annotations a2 = list2.get(i);
            result.set(i, com.pranav.ide.dx.rop.annotation.Annotations.combine(a1, a2));
        }
     ...
     */
    public com.pranav.ide.dx.rop.annotation.Annotations get(int n) {
        return (com.pranav.ide.dx.rop.annotation.Annotations) get0(n);
    }
