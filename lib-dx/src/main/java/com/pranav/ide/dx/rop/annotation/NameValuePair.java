...
public final class NameValuePair implements Comparable<NameValuePair> {
     ...
     */
    private final com.pranav.ide.dx.rop.cst.Constant value;
     ...
     */
    public NameValuePair(com.pranav.ide.dx.rop.cst.CstString name, com.pranav.ide.dx.rop.cst.Constant value) {
        if (name == null) {
