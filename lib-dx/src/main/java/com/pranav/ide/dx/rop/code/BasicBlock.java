...
import com.pranav.ide.dx.util.LabeledItem;
...
public final class BasicBlock implements LabeledItem {
     ...
     */
    private final com.pranav.ide.dx.rop.code.InsnList insns;
     ...
     *                         unconditional throw)
     */
    public BasicBlock(int label, com.pranav.ide.dx.rop.code.InsnList insns, IntList successors,
        ...
        for (int i = sz - 2; i >= 0; i--) {
            com.pranav.ide.dx.rop.code.Rop one = insns.get(i).getOpcode();
            if (one.getBranchingness() != com.pranav.ide.dx.rop.code.Rop.BRANCH_NONE) {
                throw new IllegalArgumentException("insns[" + i + "] is a " +
                        "branch or can throw");
            }
        }

        com.pranav.ide.dx.rop.code.Insn lastInsn = insns.get(sz - 1);
     ...
     */
    public com.pranav.ide.dx.rop.code.Insn getFirstInsn() {
        return insns.get(0);
    }
     ...
     */
    public com.pranav.ide.dx.rop.code.Insn getLastInsn() {
    ...
    public boolean hasExceptionHandlers() {
        com.pranav.ide.dx.rop.code.Insn lastInsn = insns.getLast();
