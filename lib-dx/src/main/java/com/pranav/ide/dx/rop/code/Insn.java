...
public abstract class Insn implements ToHuman {
     ...
     */
    private final com.pranav.ide.dx.rop.code.Rop opcode;

    /**
     * {@code non-null;} source position
     */
    private final com.pranav.ide.dx.rop.code.SourcePosition position;
     ...
     */
    private final com.pranav.ide.dx.rop.code.RegisterSpecList sources;
     ...
     */
    public Insn(com.pranav.ide.dx.rop.code.Rop opcode, com.pranav.ide.dx.rop.code.SourcePosition position, RegisterSpec result,
     ...
     */
    public final com.pranav.ide.dx.rop.code.RegisterSpecList getSources() {
        return sources;
    }
    ...
    public interface Visitor {
        /**
         * Visits a {@link com.pranav.ide.dx.rop.code.PlainInsn}.
         *
         * @param insn {@code non-null;} the instruction to visit
         */
        void visitPlainInsn(com.pranav.ide.dx.rop.code.PlainInsn insn);

        /**
         * Visits a {@link com.pranav.ide.dx.rop.code.PlainCstInsn}.
         *
         * @param insn {@code non-null;} the instruction to visit
         */
        void visitPlainCstInsn(com.pranav.ide.dx.rop.code.PlainCstInsn insn);

        /**
         * Visits a {@link com.pranav.ide.dx.rop.code.SwitchInsn}.
         *
         * @param insn {@code non-null;} the instruction to visit
         */
        void visitSwitchInsn(com.pranav.ide.dx.rop.code.SwitchInsn insn);
        ...
        /**
         * Visits a {@link com.pranav.ide.dx.rop.code.FillArrayDataInsn}.
         *
         * @param insn {@code non-null;} the instruction to visit
         */
        void visitFillArrayDataInsn(com.pranav.ide.dx.rop.code.FillArrayDataInsn insn);
