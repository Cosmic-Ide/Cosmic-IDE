...
public class LocalItem implements Comparable<LocalItem> {
     ...
     */
    private LocalItem(com.pranav.ide.dx.rop.cst.CstString name, com.pranav.ide.dx.rop.cst.CstString signature) {
        this.name = name;
     ...
     */
    public static LocalItem make(com.pranav.ide.dx.rop.cst.CstString name, com.pranav.ide.dx.rop.cst.CstString signature) {
     ...
     */
    private static int compareHandlesNulls(com.pranav.ide.dx.rop.cst.CstString a, com.pranav.ide.dx.rop.cst.CstString b) {
        if (a == b) {
            return 0;
        } else if (a == null) {
            return -1;
