...
public final class LocalVariableExtractor {
     ...
     */
    public static LocalVariableInfo extract(com.pranav.ide.dx.rop.code.RopMethod method) {
    ...
    private void processBlock(int label) {
        com.pranav.ide.dx.rop.code.RegisterSpecSet primaryState = resultInfo.mutableCopyOfStarts(label);
