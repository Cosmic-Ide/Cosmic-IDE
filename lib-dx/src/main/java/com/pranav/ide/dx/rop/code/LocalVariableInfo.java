 ...
 * com.pranav.ide.dx.rop.code.RopMethod}.
 */
public final class LocalVariableInfo
     ...
     */
    private final HashMap<com.pranav.ide.dx.rop.code.Insn, RegisterSpec> insnAssignments;
    ...
    public LocalVariableInfo(RopMethod method) {
        ...
        this.blockStarts = new com.pranav.ide.dx.rop.code.RegisterSpecSet[maxLabel];
        this.insnAssignments =
                new HashMap<com.pranav.ide.dx.rop.code.Insn, RegisterSpec>(blocks.getInstructionCount());
     ...
     */
    public void setStarts(int label, com.pranav.ide.dx.rop.code.RegisterSpecSet specs) {
        throwIfImmutable();
     ...
     */
    public boolean mergeStarts(int label, com.pranav.ide.dx.rop.code.RegisterSpecSet specs) {
        com.pranav.ide.dx.rop.code.RegisterSpecSet start = getStarts0(label);
     ...
     */
    public com.pranav.ide.dx.rop.code.RegisterSpecSet getStarts(int label) {
        com.pranav.ide.dx.rop.code.RegisterSpecSet result = getStarts0(label);
     ...
     * @return {@code non-null;} the associated register set
     */
    public com.pranav.ide.dx.rop.code.RegisterSpecSet getStarts(BasicBlock block) {
     ...
     * @return {@code non-null;} the associated register set
     */
    public com.pranav.ide.dx.rop.code.RegisterSpecSet mutableCopyOfStarts(int label) {
        com.pranav.ide.dx.rop.code.RegisterSpecSet result = getStarts0(label);
     ...
     */
    public void addAssignment(com.pranav.ide.dx.rop.code.Insn insn, RegisterSpec spec) {
        throwIfImmutable();
