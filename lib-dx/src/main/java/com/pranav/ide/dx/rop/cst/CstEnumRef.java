...
public final class CstEnumRef extends CstMemberRef {
     ...
     */
    private com.pranav.ide.dx.rop.cst.CstFieldRef fieldRef;
    ...
    /**
     * Get a {@link com.pranav.ide.dx.rop.cst.CstFieldRef} that corresponds with this instance.
     *
     * @return {@code non-null;} the corresponding field reference
     */
    public com.pranav.ide.dx.rop.cst.CstFieldRef getFieldRef() {
        if (fieldRef == null) {
