...
package com.pranav.ide.dx.rop.cst;
...
public final class CstInvokeDynamic extends Constant {
     ...
     */
    private final List<com.pranav.ide.dx.rop.cst.CstCallSiteRef> references;
    /**
     * {@code null-ok;} the class declaring invoke dynamic instance
     */
    private com.pranav.ide.dx.rop.cst.CstType declaringClass;
    /**
     * {@code null-ok;} the associated call site
     */
    private com.pranav.ide.dx.rop.cst.CstCallSite callSite;
     ...
     */
    public com.pranav.ide.dx.rop.cst.CstCallSiteRef addReference() {
        com.pranav.ide.dx.rop.cst.CstCallSiteRef ref = new com.pranav.ide.dx.rop.cst.CstCallSiteRef(this, references.size());
        references.add(ref);
        return ref;
    }
     ...
     */
    public void setDeclaringClass(com.pranav.ide.dx.rop.cst.CstType declaringClass) {
     ...
     */
    public void setCallSite(com.pranav.ide.dx.rop.cst.CstCallSite callSite) {
