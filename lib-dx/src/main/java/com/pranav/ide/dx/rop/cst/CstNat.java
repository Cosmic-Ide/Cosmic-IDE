 ...
 */
public final class CstNat extends com.pranav.ide.dx.rop.cst.Constant {
    /**
    ...
    public static final CstNat PRIMITIVE_TYPE_NAT =
            new CstNat(new com.pranav.ide.dx.rop.cst.CstString("TYPE"),
                    new com.pranav.ide.dx.rop.cst.CstString("Ljava/lang/Class;"));
     ...
     */
    public CstNat(com.pranav.ide.dx.rop.cst.CstString name, com.pranav.ide.dx.rop.cst.CstString descriptor) {
        if (name == null) {
