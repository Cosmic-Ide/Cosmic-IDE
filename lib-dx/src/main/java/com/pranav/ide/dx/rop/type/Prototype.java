...
package com.pranav.ide.dx.rop.type;
...
public final class Prototype implements Comparable<Prototype> {
     ...
     */
    private final com.pranav.ide.dx.rop.type.Type returnType;

    /**
     * {@code non-null;} list of parameter types
     */
    private final com.pranav.ide.dx.rop.type.StdTypeList parameterTypes;

    /**
     * {@code null-ok;} list of parameter frame types, if calculated
     */
    private com.pranav.ide.dx.rop.type.StdTypeList parameterFrameTypes;
     ...
     */
    private Prototype(String descriptor, com.pranav.ide.dx.rop.type.Type returnType,
                      com.pranav.ide.dx.rop.type.StdTypeList parameterTypes) {
        if (descriptor == null) {
    ...
    public static Prototype fromDescriptor(String descriptor) {
        ...
        com.pranav.ide.dx.rop.type.Type[] params = makeParameterArray(descriptor);
        int paramCount = 0;
        int at = 1;
        ...
        for (; ; ) {
            ...
            params[paramCount] =
                    com.pranav.ide.dx.rop.type.Type.intern(descriptor.substring(startAt, at));
            paramCount++;
        }

        com.pranav.ide.dx.rop.type.Type returnType = com.pranav.ide.dx.rop.type.Type.internReturnType(descriptor.substring(at));
        com.pranav.ide.dx.rop.type.StdTypeList parameterTypes = new com.pranav.ide.dx.rop.type.StdTypeList(paramCount);
     ...
     */
    private static com.pranav.ide.dx.rop.type.Type[] makeParameterArray(String descriptor) {
        ...
        return new com.pranav.ide.dx.rop.type.Type[maxParams];
    }
     ...
     */
    public static Prototype intern(String descriptor, com.pranav.ide.dx.rop.type.Type definer,
     ...
     * @return {@code non-null;} the interned instance
     */
    public static Prototype internInts(com.pranav.ide.dx.rop.type.Type returnType, int count) {
        // Make the descriptor...
    ...
    public int compareTo(Prototype other) {
        ...
        for (int i = 0; i < size; i++) {
            com.pranav.ide.dx.rop.type.Type thisType = parameterTypes.get(i);
            com.pranav.ide.dx.rop.type.Type otherType = other.parameterTypes.get(i);
     ...
     */
    public com.pranav.ide.dx.rop.type.Type getReturnType() {
        return returnType;
    }
     ...
     */
    public com.pranav.ide.dx.rop.type.StdTypeList getParameterTypes() {
     ...
     * "intlike" types (see {@link com.pranav.ide.dx.rop.type.Type#isIntlike}) are replaced by
     * {@link com.pranav.ide.dx.rop.type.Type#INT}.
     *
     * @return {@code non-null;} the list of parameter frame types
     */
    public com.pranav.ide.dx.rop.type.StdTypeList getParameterFrameTypes() {
        if (parameterFrameTypes == null) {
            int sz = parameterTypes.size();
            com.pranav.ide.dx.rop.type.StdTypeList list = new com.pranav.ide.dx.rop.type.StdTypeList(sz);
            boolean any = false;
            for (int i = 0; i < sz; i++) {
                com.pranav.ide.dx.rop.type.Type one = parameterTypes.get(i);
                if (one.isIntlike()) {
                    any = true;
                    one = com.pranav.ide.dx.rop.type.Type.INT;
                }
                list.set(i, one);
            }
