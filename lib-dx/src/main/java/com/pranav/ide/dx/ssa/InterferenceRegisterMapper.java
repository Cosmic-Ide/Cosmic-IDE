...
import com.pranav.ide.dx.ssa.back.InterferenceGraph;
import com.pranav.ide.dx.util.BitIntSet;
...
public class InterferenceRegisterMapper extends BasicRegisterMapper {
     ...
     */
    private final com.pranav.ide.dx.ssa.back.InterferenceGraph oldRegInterference;
     ...
     * @return true if oldReg will interfere with newReg
     */
    public boolean interferes(com.pranav.ide.dx.rop.code.RegisterSpec oldSpec, int newReg) {
