...
public class LocalVariableExtractor {
     ...
     */
    private final com.pranav.ide.dx.ssa.SsaMethod method;
    ...
    private LocalVariableExtractor(SsaMethod method) {
        ...
        ArrayList<com.pranav.ide.dx.ssa.SsaBasicBlock> blocks = method.getBlocks();
     ...
     */
    public static LocalVariableInfo extract(com.pranav.ide.dx.ssa.SsaMethod method) {
    ...
    private void processBlock(int blockIndex) {
        com.pranav.ide.dx.rop.code.RegisterSpecSet primaryState
                = resultInfo.mutableCopyOfStarts(blockIndex);
        SsaBasicBlock block = blocks.get(blockIndex);
        List<com.pranav.ide.dx.ssa.SsaInsn> insns = block.getInsns();
         ...
         * exception targets.
         */
        com.pranav.ide.dx.ssa.SsaInsn lastInsn = insns.get(insnSz - 1);
        ...
        com.pranav.ide.dx.rop.code.RegisterSpecSet secondaryState = primaryState;
        ...
        for (int i = 0; i < insnSz; i++) {
            ...
            com.pranav.ide.dx.rop.code.RegisterSpec already = primaryState.get(result);
            /*
