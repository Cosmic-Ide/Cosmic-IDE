...
public final class NormalSsaInsn extends SsaInsn implements Cloneable {
     ...
     */
    private com.pranav.ide.dx.rop.code.Insn insn;
     ...
     */
    NormalSsaInsn(final com.pranav.ide.dx.rop.code.Insn insn, final SsaBasicBlock block) {
    ...
    public final void mapSourceRegisters(RegisterMapper mapper) {
        com.pranav.ide.dx.rop.code.RegisterSpecList oldSources = insn.getSources();
        com.pranav.ide.dx.rop.code.RegisterSpecList newSources = mapper.map(oldSources);
     ...
     */
    public final void changeOneSource(int index, com.pranav.ide.dx.rop.code.RegisterSpec newSpec) {
        com.pranav.ide.dx.rop.code.RegisterSpecList origSources = insn.getSources();
        int sz = origSources.size();
        com.pranav.ide.dx.rop.code.RegisterSpecList newSources = new com.pranav.ide.dx.rop.code.RegisterSpecList(sz);
        ...
        com.pranav.ide.dx.rop.code.RegisterSpec origSpec = origSources.get(index);
     ...
     */
    public final void setNewSources(com.pranav.ide.dx.rop.code.RegisterSpecList newSources) {
        com.pranav.ide.dx.rop.code.RegisterSpecList origSources = insn.getSources();
     ...
     */
    @Override
    public com.pranav.ide.dx.rop.code.RegisterSpecList getSources() {
     ...
     */
    @Override
    public com.pranav.ide.dx.rop.code.Insn toRopInsn() {
     ...
     */
    @Override
    public com.pranav.ide.dx.rop.code.Rop getOpcode() {
     ...
     */
    @Override
    public com.pranav.ide.dx.rop.code.Insn getOriginalRopInsn() {
        return insn;
    }
     ...
     */
    @Override
    public com.pranav.ide.dx.rop.code.RegisterSpec getLocalAssignment() {
        RegisterSpec assignment;

        if (insn.getOpcode().getOpcode() == com.pranav.ide.dx.rop.code.RegOps.MARK_LOCAL) {
    ...
    public boolean isNormalMoveInsn() {
        return insn.getOpcode().getOpcode() == com.pranav.ide.dx.rop.code.RegOps.MOVE;
    }
    ...
    public boolean isMoveException() {
        return insn.getOpcode().getOpcode() == com.pranav.ide.dx.rop.code.RegOps.MOVE_EXCEPTION;
    }
    ...
    public boolean hasSideEffect() {
        com.pranav.ide.dx.rop.code.Rop opcode = getOpcode();
