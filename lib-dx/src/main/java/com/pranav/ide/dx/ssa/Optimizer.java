...
import com.pranav.ide.dx.ssa.back.LivenessAnalyzer;
import com.pranav.ide.dx.ssa.back.SsaToRop;
...
public class Optimizer {
    ...
    private static com.pranav.ide.dx.rop.code.TranslationAdvice advice;
     ...
     */
    public static com.pranav.ide.dx.rop.code.TranslationAdvice getAdvice() {
        return advice;
    }
     ...
     */
    public static com.pranav.ide.dx.rop.code.RopMethod optimize(com.pranav.ide.dx.rop.code.RopMethod rmeth, int paramWidth,
                                                                boolean isStatic, boolean inPreserveLocals,
                                                                com.pranav.ide.dx.rop.code.TranslationAdvice inAdvice) {
    ...
    public static com.pranav.ide.dx.rop.code.RopMethod optimize(com.pranav.ide.dx.rop.code.RopMethod rmeth, int paramWidth,
                                                                boolean isStatic, boolean inPreserveLocals,
                                                                com.pranav.ide.dx.rop.code.TranslationAdvice inAdvice, EnumSet<OptionalStep> steps) {
        com.pranav.ide.dx.ssa.SsaMethod ssaMeth = null;
        ...
        com.pranav.ide.dx.rop.code.RopMethod resultMeth = com.pranav.ide.dx.ssa.back.SsaToRop.convertToRopMethod(ssaMeth, false);
     ...
     * @return optimized method
     */
    private static com.pranav.ide.dx.rop.code.RopMethod optimizeMinimizeRegisters(com.pranav.ide.dx.rop.code.RopMethod rmeth,
                                                                                  int paramWidth, boolean isStatic,
                                                                                  EnumSet<OptionalStep> steps) {
        com.pranav.ide.dx.ssa.SsaMethod ssaMeth;
        com.pranav.ide.dx.rop.code.RopMethod resultMeth;
    ...
    private static void runSsaFormSteps(com.pranav.ide.dx.ssa.SsaMethod ssaMeth,
                                        EnumSet<OptionalStep> steps) {
    ...
    public static com.pranav.ide.dx.ssa.SsaMethod debugEdgeSplit(com.pranav.ide.dx.rop.code.RopMethod rmeth, int paramWidth,
                                                                 boolean isStatic, boolean inPreserveLocals,
                                                                 com.pranav.ide.dx.rop.code.TranslationAdvice inAdvice) {
    ...
    public static com.pranav.ide.dx.ssa.SsaMethod debugPhiPlacement(com.pranav.ide.dx.rop.code.RopMethod rmeth, int paramWidth,
                                                                    boolean isStatic, boolean inPreserveLocals,
                                                                    com.pranav.ide.dx.rop.code.TranslationAdvice inAdvice) {
    ...
    public static com.pranav.ide.dx.ssa.SsaMethod debugRenaming(com.pranav.ide.dx.rop.code.RopMethod rmeth, int paramWidth,
                                                                boolean isStatic, boolean inPreserveLocals,
                                                                com.pranav.ide.dx.rop.code.TranslationAdvice inAdvice) {
    ...
    public static com.pranav.ide.dx.ssa.SsaMethod debugDeadCodeRemover(com.pranav.ide.dx.rop.code.RopMethod rmeth,
    ...
    public static com.pranav.ide.dx.ssa.SsaMethod debugNoRegisterAllocation(RopMethod rmeth,
                                                                            int paramWidth, boolean isStatic, boolean inPreserveLocals,
