 ...
 */
public final class PhiInsn extends com.pranav.ide.dx.ssa.SsaInsn {
    /**
     ...
     */
    private com.pranav.ide.dx.rop.code.RegisterSpecList sources;
     ...
     */
    public PhiInsn(com.pranav.ide.dx.rop.code.RegisterSpec resultReg, com.pranav.ide.dx.ssa.SsaBasicBlock block) {
     ...
     * @param block     block containing this insn.
     */
    public PhiInsn(final int resultReg, final com.pranav.ide.dx.ssa.SsaBasicBlock block) {
        /*
         * The result type here is bogus: The type depends on the
         * operand and will be derived later.
         */
        super(com.pranav.ide.dx.rop.code.RegisterSpec.make(resultReg, Type.VOID), block);
     ...
     */
    public void updateSourcesToDefinitions(com.pranav.ide.dx.ssa.SsaMethod ssaMeth) {
        for (Operand o : operands) {
            com.pranav.ide.dx.rop.code.RegisterSpec def
    ...
    public void changeResultType(TypeBearer type, LocalItem local) {
        setResult(com.pranav.ide.dx.rop.code.RegisterSpec.makeLocalOptional(
     ...
     */
    public void addPhiOperand(com.pranav.ide.dx.rop.code.RegisterSpec registerSpec,
                              com.pranav.ide.dx.ssa.SsaBasicBlock predBlock) {
     ...
     * @param registerSpec register spec, including type and reg of operand
     */
    public void removePhiRegister(com.pranav.ide.dx.rop.code.RegisterSpec registerSpec) {
    ...
    public final void mapSourceRegisters(RegisterMapper mapper) {
        for (Operand o : operands) {
            com.pranav.ide.dx.rop.code.RegisterSpec old = o.regSpec;
     ...
     */
    public List<com.pranav.ide.dx.ssa.SsaBasicBlock> predBlocksForReg(int reg, SsaMethod ssaMeth) {
        ArrayList<com.pranav.ide.dx.ssa.SsaBasicBlock> ret = new ArrayList<SsaBasicBlock>();
    ...
    protected final String toHumanWithInline(String extra) {
        ...
        com.pranav.ide.dx.rop.code.RegisterSpec result = getResult();
    ...
    private static class Operand {
        ...
        public com.pranav.ide.dx.rop.code.RegisterSpec regSpec;
