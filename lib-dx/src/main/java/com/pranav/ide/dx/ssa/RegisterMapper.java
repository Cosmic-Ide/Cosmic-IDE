...
public abstract class RegisterMapper {
     ...
     */
    public abstract com.pranav.ide.dx.rop.code.RegisterSpec map(com.pranav.ide.dx.rop.code.RegisterSpec registerSpec);

    /**
     * @param sources old register list
     * @return new mapped register list, or old if nothing has changed.
     */
    public final com.pranav.ide.dx.rop.code.RegisterSpecList map(com.pranav.ide.dx.rop.code.RegisterSpecList sources) {
        int sz = sources.size();
        com.pranav.ide.dx.rop.code.RegisterSpecList newSources = new RegisterSpecList(sz);
     ...
     */
    public final com.pranav.ide.dx.rop.code.RegisterSpecSet map(com.pranav.ide.dx.rop.code.RegisterSpecSet sources) {
        int sz = sources.getMaxSize();
        com.pranav.ide.dx.rop.code.RegisterSpecSet newSources = new RegisterSpecSet(getNewRegisterCount());
