...
public final class SsaBasicBlock {
     ...
     */
    private static void setRegsUsed(BitSet regsUsed, com.pranav.ide.dx.rop.code.RegisterSpec rs) {
     ...
     * registers) used.
     */
    private static boolean checkRegUsed(BitSet regsUsed, com.pranav.ide.dx.rop.code.RegisterSpec rs) {
        int reg = rs.getReg();
     ...
     */
    public void addPhiInsnForReg(com.pranav.ide.dx.rop.code.RegisterSpec resultSpec) {
     ...
     */
    public void addInsnToHead(com.pranav.ide.dx.rop.code.Insn insn) {
     ...
     */
    public void addMoveToEnd(com.pranav.ide.dx.rop.code.RegisterSpec result, com.pranav.ide.dx.rop.code.RegisterSpec source) {
        /*
        ...
        if (lastInsn.getResult() != null || lastInsn.getSources().size() > 0) {
             ...
             */
            com.pranav.ide.dx.rop.code.RegisterSpecList sources = com.pranav.ide.dx.rop.code.RegisterSpecList.make(source);
            NormalSsaInsn toAdd = new NormalSsaInsn(
                    new com.pranav.ide.dx.rop.code.PlainInsn(com.pranav.ide.dx.rop.code.Rops.opMove(result.getType()),
                            com.pranav.ide.dx.rop.code.SourcePosition.NO_INFO, result, sources), this);
     ...
     * @param source move source
     */
    public void addMoveToBeginning(com.pranav.ide.dx.rop.code.RegisterSpec result, com.pranav.ide.dx.rop.code.RegisterSpec source) {
        if (result.getReg() == source.getReg()) {
            // Sometimes we end up with no-op moves. Ignore them here.
            return;
        }
    ...
    private void scheduleUseBeforeAssigned(List<SsaInsn> toSchedule) {
        ...
        while (insertPlace < sz) {
            ...
            if (oldInsertPlace == insertPlace) {
                ...
                com.pranav.ide.dx.rop.code.RegisterSpec result = insnToSplit.getResult();
                com.pranav.ide.dx.rop.code.RegisterSpec tempSpec = result.withReg(
                ...
                com.pranav.ide.dx.rop.code.RegisterSpecList newSources = com.pranav.ide.dx.rop.code.RegisterSpecList.make(tempSpec);
            ...
            if (firstNonPhiMoveInsn.isMoveException()) {
                if (true) {
                    ...
                    if (!moveExceptionInterferes) {
                         ...
                         * and move it back.
                         */
                        com.pranav.ide.dx.rop.code.RegisterSpec originalResultSpec
