...
public abstract class SsaInsn implements ToHuman, Cloneable {
     ...
     */
    private com.pranav.ide.dx.rop.code.RegisterSpec result;
     ...
     *               never change.
     */
    protected SsaInsn(com.pranav.ide.dx.rop.code.RegisterSpec result, com.pranav.ide.dx.ssa.SsaBasicBlock block) {
        if (block == null) {
     ...
     */
    public static SsaInsn makeFromRop(com.pranav.ide.dx.rop.code.Insn insn, com.pranav.ide.dx.ssa.SsaBasicBlock block) {
    ...
    /**
     * Like {@link com.pranav.ide.dx.rop.code.Insn getResult()}.
     *
     * @return result register
     */
    public com.pranav.ide.dx.rop.code.RegisterSpec getResult() {
        return result;
    }
     ...
     */
    protected void setResult(com.pranav.ide.dx.rop.code.RegisterSpec result) {
        if (result == null) {
    ...
    /**
     * Like {@link com.pranav.ide.dx.rop.code.Insn getSources()}.
     *
     ...
     */
    public final void setResultLocal(com.pranav.ide.dx.rop.code.LocalItem local) {
        LocalItem oldItem = result.getLocalItem();

        if (local != oldItem && (local == null
                || !local.equals(result.getLocalItem()))) {
            result = com.pranav.ide.dx.rop.code.RegisterSpec.makeLocalOptional(
     ...
     */
    public final void mapRegisters(com.pranav.ide.dx.ssa.RegisterMapper mapper) {
        com.pranav.ide.dx.rop.code.RegisterSpec oldResult = result;
     ...
     */
    abstract public com.pranav.ide.dx.rop.code.Insn getOriginalRopInsn();
     ...
     * @see com.pranav.ide.dx.rop.code.Insn#getLocalAssignment()
     */
