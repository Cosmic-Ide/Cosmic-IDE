...
public final class SsaMethod {
     ...
     */
    private ArrayList<com.pranav.ide.dx.ssa.SsaBasicBlock> blocks;
    /**
     ...
     */
    private com.pranav.ide.dx.ssa.SsaInsn[] definitionList;

    /**
     * indexed by register: the list of all insns that use a register
     */
    private ArrayList<com.pranav.ide.dx.ssa.SsaInsn>[] useList;

    /**
     * A version of useList with each List unmodifiable
     */
    private List<com.pranav.ide.dx.ssa.SsaInsn>[] unmodifiableUseList;
     ...
     *                   pointer argument
     */
    private SsaMethod(com.pranav.ide.dx.rop.code.RopMethod ropMethod, int paramWidth, boolean isStatic) {
     ...
     *                   pointer argument
     */
    public static SsaMethod newFromRopMethod(com.pranav.ide.dx.rop.code.RopMethod ropMethod,
     ...
     */
    static BitSet bitSetFromLabelList(com.pranav.ide.dx.rop.code.BasicBlockList blocks,
                                      IntList labelList) {
     ...
     */
    public static IntList indexListFromLabelList(com.pranav.ide.dx.rop.code.BasicBlockList ropBlocks,
                                                 IntList labelList) {
     ...
     */
    private static com.pranav.ide.dx.ssa.SsaInsn getGoto(com.pranav.ide.dx.ssa.SsaBasicBlock block) {
        return new NormalSsaInsn(
                new com.pranav.ide.dx.rop.code.PlainInsn(com.pranav.ide.dx.rop.code.Rops.GOTO, com.pranav.ide.dx.rop.code.SourcePosition.NO_INFO,
                        null, com.pranav.ide.dx.rop.code.RegisterSpecList.EMPTY), block);
    }
    ...
    private void convertRopToSsaBlocks(RopMethod rmeth) {
        ...
        blocks = new ArrayList<com.pranav.ide.dx.ssa.SsaBasicBlock>(sz + 2);

        for (int i = 0; i < sz; i++) {
            com.pranav.ide.dx.ssa.SsaBasicBlock sbb = com.pranav.ide.dx.ssa.SsaBasicBlock.newFromRop(rmeth, i, this);
            blocks.add(sbb);
        }
        ...
        com.pranav.ide.dx.ssa.SsaBasicBlock entryBlock
    ...
    /*package*/ void makeExitBlock() {
        ...
        com.pranav.ide.dx.ssa.SsaBasicBlock exitBlock
                = new com.pranav.ide.dx.ssa.SsaBasicBlock(exitBlockIndex, maxLabel++, this);

        blocks.add(exitBlock);

        for (com.pranav.ide.dx.ssa.SsaBasicBlock block : blocks) {
     ...
     * @return new block
     */
    public com.pranav.ide.dx.ssa.SsaBasicBlock makeNewGotoBlock() {
        int newIndex = blocks.size();
        com.pranav.ide.dx.ssa.SsaBasicBlock newBlock = new com.pranav.ide.dx.ssa.SsaBasicBlock(newIndex, maxLabel++, this);
     ...
     */
    public com.pranav.ide.dx.ssa.SsaBasicBlock getEntryBlock() {
     ...
     * there is none
     */
    public com.pranav.ide.dx.ssa.SsaBasicBlock getExitBlock() {
     ...
     */
    public ArrayList<com.pranav.ide.dx.ssa.SsaBasicBlock> getBlocks() {
        return blocks;
    }
    ...
    public void mapRegisters(RegisterMapper mapper) {
        for (com.pranav.ide.dx.ssa.SsaBasicBlock block : getBlocks()) {
     ...
     */
    public com.pranav.ide.dx.ssa.SsaInsn getDefinitionForRegister(int reg) {
        if (backMode) {
        ...
        definitionList = new com.pranav.ide.dx.ssa.SsaInsn[getRegCount()];

        forEachInsn(new com.pranav.ide.dx.ssa.SsaInsn.Visitor() {
            @Override
    ...
    private void buildUseList() {
        ...
        forEachInsn(new com.pranav.ide.dx.ssa.SsaInsn.Visitor() {
             ...
             */
            private void addToUses(com.pranav.ide.dx.ssa.SsaInsn insn) {
                com.pranav.ide.dx.rop.code.RegisterSpecList rl = insn.getSources();
                int sz = rl.size();
     ...
     */
    /*package*/ void onSourceChanged(com.pranav.ide.dx.ssa.SsaInsn insn,
                                     com.pranav.ide.dx.rop.code.RegisterSpec oldSource, com.pranav.ide.dx.rop.code.RegisterSpec newSource) {
     ...
     *                   previously used
     */
    /*package*/ void onSourcesChanged(com.pranav.ide.dx.ssa.SsaInsn insn,
                                      com.pranav.ide.dx.rop.code.RegisterSpecList oldSources) {
        if (useList == null) return;
        ...
        com.pranav.ide.dx.rop.code.RegisterSpecList sources = insn.getSources();
     ...
     */
    private void removeFromUseList(com.pranav.ide.dx.ssa.SsaInsn insn, com.pranav.ide.dx.rop.code.RegisterSpecList oldSources) {
        if (oldSources == null) {
            return;
        }
     ...
     */
    /*package*/ void onInsnAdded(com.pranav.ide.dx.ssa.SsaInsn insn) {
     ...
     */
    /*package*/ void onInsnRemoved(com.pranav.ide.dx.ssa.SsaInsn insn) {
        if (useList != null) {
            removeFromUseList(insn, insn.getSources());
        }

        com.pranav.ide.dx.rop.code.RegisterSpec resultReg = insn.getResult();
     ...
     */
    /*package*/ void updateOneDefinition(com.pranav.ide.dx.ssa.SsaInsn insn,
                                         com.pranav.ide.dx.rop.code.RegisterSpec oldResult) {
     ...
     */
    public List<com.pranav.ide.dx.ssa.SsaInsn> getUseListForRegister(int reg) {
     ...
     */
    public ArrayList<com.pranav.ide.dx.ssa.SsaInsn>[] getUseListCopy() {
        if (useList == null) {
            buildUseList();
        }

        ArrayList<com.pranav.ide.dx.ssa.SsaInsn>[] useListCopy
                = (ArrayList<com.pranav.ide.dx.ssa.SsaInsn>[]) (new ArrayList[registerCount]);

        for (int i = 0; i < registerCount; i++) {
            useListCopy[i] = (ArrayList<com.pranav.ide.dx.ssa.SsaInsn>) (new ArrayList<>(useList[i]));
        }
    ...
    public boolean isRegALocal(RegisterSpec spec) {
        com.pranav.ide.dx.ssa.SsaInsn defn = getDefinitionForRegister(spec.getReg());
        ...
        for (com.pranav.ide.dx.ssa.SsaInsn use : getUseListForRegister(spec.getReg())) {
            com.pranav.ide.dx.rop.code.Insn insn = use.getOriginalRopInsn();
     ...
     */
    public void forEachInsn(com.pranav.ide.dx.ssa.SsaInsn.Visitor visitor) {
        for (com.pranav.ide.dx.ssa.SsaBasicBlock block : blocks) {
    ...
    public void forEachBlockDepthFirst(boolean reverse,
                                       com.pranav.ide.dx.ssa.SsaBasicBlock.Visitor v) {
        BitSet visited = new BitSet(blocks.size());

        // We push the parent first, then the child on the stack.
        Stack<com.pranav.ide.dx.ssa.SsaBasicBlock> stack = new Stack<com.pranav.ide.dx.ssa.SsaBasicBlock>();

        com.pranav.ide.dx.ssa.SsaBasicBlock rootBlock = reverse ? getExitBlock() : getEntryBlock();
        ...
        while (stack.size() > 0) {
            com.pranav.ide.dx.ssa.SsaBasicBlock cur = stack.pop();
            com.pranav.ide.dx.ssa.SsaBasicBlock parent = stack.pop();
     ...
     */
    public void forEachBlockDepthFirstDom(com.pranav.ide.dx.ssa.SsaBasicBlock.Visitor v) {
        ...
        while (stack.size() > 0) {
            com.pranav.ide.dx.ssa.SsaBasicBlock cur = stack.pop();
            ArrayList<com.pranav.ide.dx.ssa.SsaBasicBlock> curDomChildren = cur.getDomChildren();

            if (!visited.get(cur.getIndex())) {
                // We walk the tree this way for historical reasons...
                for (int i = curDomChildren.size() - 1; i >= 0; i--) {
                    com.pranav.ide.dx.ssa.SsaBasicBlock child = curDomChildren.get(i);
                    stack.add(child);
                }
                visited.set(cur.getIndex());
     ...
     */
    public void deleteInsns(Set<com.pranav.ide.dx.ssa.SsaInsn> deletedInsns) {
        for (com.pranav.ide.dx.ssa.SsaInsn deletedInsn : deletedInsns) {
            SsaBasicBlock block = deletedInsn.getBlock();
            ArrayList<com.pranav.ide.dx.ssa.SsaInsn> insns = block.getInsns();

            for (int i = insns.size() - 1; i >= 0; i--) {
                com.pranav.ide.dx.ssa.SsaInsn insn = insns.get(i);
            ...
            com.pranav.ide.dx.ssa.SsaInsn lastInsn = (insnsSz == 0) ? null : insns.get(insnsSz - 1);
