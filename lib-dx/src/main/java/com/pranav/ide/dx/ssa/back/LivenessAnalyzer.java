...
public class LivenessAnalyzer {
     ...
     */
    private final com.pranav.ide.dx.ssa.back.InterferenceGraph interference;
    ...
    private LivenessAnalyzer(SsaMethod ssaMeth, int reg,
                             com.pranav.ide.dx.ssa.back.InterferenceGraph interference) {
     ...
     */
    public static com.pranav.ide.dx.ssa.back.InterferenceGraph constructInterferenceGraph(
            SsaMethod ssaMeth) {
        int szRegs = ssaMeth.getRegCount();
        com.pranav.ide.dx.ssa.back.InterferenceGraph interference = new com.pranav.ide.dx.ssa.back.InterferenceGraph(szRegs);
    ...
    private void liveOutAtStatement() {
        ...
        com.pranav.ide.dx.rop.code.RegisterSpec rs = statement.getResult();
