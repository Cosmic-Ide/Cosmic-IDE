...
public class MutabilityControl {
    ...
    /**
     * Throws {@link com.pranav.ide.dx.util.MutabilityException} if this instance is
     * immutable.
     */
    public final void throwIfImmutable() {
        if (!mutable) {
            throw new com.pranav.ide.dx.util.MutabilityException("immutable instance");
        }
    }

    /**
     * Throws {@link com.pranav.ide.dx.util.MutabilityException} if this instance is mutable.
     */
