...
public final class TwoColumnOutput {
     ...
     */
    private final com.pranav.ide.dx.util.IndentingWriter leftColumn;

    /**
     * {@code non-null;} right column writer
     */
    private final com.pranav.ide.dx.util.IndentingWriter rightColumn;
    ...
    public TwoColumnOutput(Writer out, int leftWidth, int rightWidth,
        ...
        this.leftColumn = new com.pranav.ide.dx.util.IndentingWriter(leftWriter, leftWidth);
        this.rightColumn =
