...
public class KeyBindingEvent extends EditorKeyEvent {
     ...
     * @param canEditorHandle <code>true</code> if the editor can handle this event, <code>false
     *     </code> otherwise.
     */
    public KeyBindingEvent(
            CodeEditor editor, KeyEvent src, Type type, int keyCode, boolean canEditorHandle) {
