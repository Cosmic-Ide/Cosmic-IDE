 ...
 * CompletionItem#performCompletion(CodeEditor, Content, int, int)} or {@link
 * CompletionItem#performCompletion(CodeEditor, Content, CharPosition)} to customize your own
 * completion method so that you can develop complex actions.
 *
...
public abstract class CompletionItem {
     ...
     * @see #performCompletion(CodeEditor, Content, CharPosition) Editor calls this method to do
     *     completion
     */
    public abstract void performCompletion(
