...
/**
 * Helpers to manage the "collapsed" metadata of an entire StackElement stack. The following
 * assumptions have been made: - languageId < 256 => needs 8 bits - unique color count < 512 =>
 * needs 9 bits
 *
 * <p>The binary format is: - ------------------------------------------- 3322 2222 2222 1111 1111
 * 1100 0000 0000 1098 7654 3210 9876 5432 1098 7654 3210 -
 * ------------------------------------------- xxxx xxxx xxxx xxxx xxxx xxxx xxxx xxxx bbbb bbbb
 * bfff ffff ffFF FTTT LLLL LLLL - ------------------------------------------- - L = LanguageId (8
 * bits) - T = StandardTokenType (3 bits) - F = FontStyle (3 bits) - f = foreground color (9 bits) -
