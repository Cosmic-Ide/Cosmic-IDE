...
import io.github.rosemoe.sora.lang.smart.enter.NewlineHandleResult;
import io.github.rosemoe.sora.lang.smart.enter.NewlineHandler;
                            ...
                            for (NewlineHandler handler : handlers) {
                                if (handler != null) {
                                    if (handler.matchesRequirement(beforeText, afterText)) {
                                        try {
                                            NewlineHandleResult result =
                                                    handler.handleNewline(
                                                            beforeText, afterText, getTabWidth());
                                            if (result != null) {
                                                ...
                                                if (delta != 0) {
                                                    int newSel =
                                                            Math.max(
                                                                    getCursor().getLeft() - delta,
                                                                    0);
                                                    CharPosition charPosition =
                                                            getCursor()
                                                                    .getIndexer()
                                                                    .getCharPosition(newSel);
                                                    setSelection(
                                                            charPosition.line, charPosition.column);
                                                }
                                                consumed = true;
                                            } else {
                                                continue;
                ...
                if (event.isCtrlPressed() && !event.isAltPressed()) {
                    ...
                    if (event.isPrintingKey() && isEditable()) {
                        ...
                        if (replacement == null
                                ...
                                || (replacement.shouldNotDoReplace(getText())
                            ...
                            if (getCursor().isSelected()
                                    && (autoSurroundPair = replacement.getAutoSurroundPair())
                                            != null) {
                                ...
                                if (delta != 0) {
                                    ...
                                    CharPosition charPosition =
                                            getCursor().getIndexer().getCharPosition(newSel);
